...
- [`bb26f91`](https://github.com/ashcoft/nextcloud-cad-viewer/commit/bb26f915990acfd4d5d5a211ce7f811cf4eb40a9) Thanks [@openhands-agent](https://github.com/openhands-agent)! - Fixed release workflow to sync version to appinfo/info.xml alongside package.json and CHANGELOG.md

## 0.0.18

### Patch Changes

- [`22c7c35`](https://github.com/ashcoft/nextcloud-cad-viewer/commit/22c7c35bd8bd96a8bc66a0dc62790840438c4be5) Thanks [@openhands-agent](https://github.com/openhands-agent)! - Fixed release workflow to properly auto-release with Nextcloud app package for patch, minor, and major updates
