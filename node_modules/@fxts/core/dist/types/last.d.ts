type LastReturnType<T> = T extends readonly [...rest: any[], a: infer L] ? L : T extends readonly never[] ? undefined : T extends AsyncIterable<infer U> ? Promise<U | undefined> : T extends Iterable<infer U> ? U | undefined : never;
/**
