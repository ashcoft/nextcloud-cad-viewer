...
type ReturnForkType<A extends Iterable<unknown> | AsyncIterable<unknown>> = A extends AsyncIterable<any> ? AsyncIterableIterator<IterableInfer<A>> : IterableIterator<IterableInfer<A>>;
/**
 ...
 * ```
 */
declare function fork<A extends Iterable<unknown> | AsyncIterable<unknown>>(iterable: A): ReturnForkType<A>;
export default fork;
