...
var AcDb2dVertex = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDb2dVertex.prototype, "dxfTypeName", {
        get: function () {
            return 'VERTEX';
        },
        enumerable: false,
     ...
     */
    AcDb2dVertex.prototype.subGetOsnapPoints = function (_osnapMode, _pickPoint, _lastPoint, snapPoints) {
     ...
     * @returns undefined
     */
    AcDb2dVertex.prototype.subWorldDraw = function (_renderer) {
        return undefined;
    };
    /**
     ...
     */
    AcDb2dVertex.prototype.dxfOutFields = function (filer) {
