...
import { acdbHostApplicationServices, setAcDbLayoutManagerFactory } from '../../base/AcDbHostApplicationServices';
 ...
 * ```
 */
var AcDbLayoutManager = /** @class */ (function () {
    function AcDbLayoutManager() {
        /**
     ...
     * ```
     */
    AcDbLayoutManager.prototype.countLayouts = function (db) {
     ...
     * ```
     */
    AcDbLayoutManager.prototype.findLayoutNamed = function (name, db) {
     ...
     * ```
     */
    AcDbLayoutManager.prototype.findActiveLayout = function () {
     ...
     * ```
     */
    AcDbLayoutManager.prototype.setCurrentLayoutId = function (id, db) {
        var currentDb = this.getWorkingDatabase(db);
        var layout = currentDb.objects.layout.getIdAt(id);
     ...
     * ```
     */
    AcDbLayoutManager.prototype.setCurrentLayoutBtrId = function (id, db) {
        var currentDb = this.getWorkingDatabase(db);
        var layout = currentDb.objects.layout.getBtrIdAt(id);
        return this.setCurrentLayoutInternal(layout, currentDb);
    };
    /**
     ...
     * ```
     */
    AcDbLayoutManager.prototype.setCurrentLayout = function (name, db) {
        var currentDb = this.getWorkingDatabase(db);
        var layout = currentDb.objects.layout.getAt(name);
        return this.setCurrentLayoutInternal(layout, currentDb);
    };
    /**
     ...
     * ```
     */
    AcDbLayoutManager.prototype.renameLayout = function (oldName, newName, db) {
        var currentDb = this.getWorkingDatabase(db);
        var layout = currentDb.objects.layout.getAt(oldName);
        if (layout) {
     ...
     */
    AcDbLayoutManager.prototype.layoutExists = function (name, db) {
    ...
    AcDbLayoutManager.prototype.deleteLayout = function (name, db) {
        var layouts = this.getWorkingDatabase(db).objects.layout;
     ...
     */
    AcDbLayoutManager.prototype.getActiveLayout = function (db) {
        var currentDb = this.getWorkingDatabase(db);
        return currentDb.objects.layout.getBtrIdAt(currentDb.currentSpaceId);
    };
    AcDbLayoutManager.prototype.getWorkingDatabase = function (db) {
...
export { AcDbLayoutManager };
setAcDbLayoutManagerFactory(function () { return new AcDbLayoutManager(); });
//# sourceMappingURL=AcDbLayoutManager.js.map