...
var AcDbRenderingCache = /** @class */ (function () {
     ...
     * ```
     */
    AcDbRenderingCache.prototype.draw = function (renderer, blockTableRecord, color, attributes, cache, transform, normal) {
        var e_1, _a;
        ...
        if (blockTableRecord != null) {
            ...
            if (block_1 && attributes && attributes.length > 0) {
                ...
                block_1.bakeTransformToChildren();
                attributes.forEach(function (attrib) { return block_1.addChild(attrib); });
            }
            return block_1;
        }
        else {
