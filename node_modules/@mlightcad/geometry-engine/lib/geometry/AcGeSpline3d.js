...
var AcGeSpline3d = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcGeSpline3d.prototype, "controlPoints", {
        get: function () {
            return this._controlPoints.map(function (point) { return ({
                x: point.x,
                y: point.y,
                z: point.z || 0
            }); });
    ...
    Object.defineProperty(AcGeSpline3d.prototype, "fitPoints", {
        get: function () {
            var _a;
            return (_a = this._fitPoints) === null || _a === void 0 ? void 0 : _a.map(function (point) { return ({
                x: point.x,
                y: point.y,
                z: point.z || 0
            }); });
    ...
    AcGeSpline3d.prototype.clone = function () {
        if (this._fitPoints && this._knotParameterization) {
            return new AcGeSpline3d(this._fitPoints.map(function (point) { return ({
                x: point.x,
                y: point.y,
                z: point.z || 0
            }); }), this._knotParameterization, this._degree, this._closed, this._startTangent
                ? {
        ...
        return new AcGeSpline3d(this._controlPoints.map(function (point) { return ({
            x: point.x,
            y: point.y,
            z: point.z || 0
        }); }), this._nurbsCurve.knots(), this._nurbsCurve.weights(), this._degree, this._closed);
    };
    /**
