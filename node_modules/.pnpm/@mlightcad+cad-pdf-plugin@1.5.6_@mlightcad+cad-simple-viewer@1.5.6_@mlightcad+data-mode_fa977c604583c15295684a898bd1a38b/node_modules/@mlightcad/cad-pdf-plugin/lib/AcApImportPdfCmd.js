 ...
 */
var AcApImportPdfCmd = /** @class */ (function (_super) {
    __extends(AcApImportPdfCmd, _super);
    function AcApImportPdfCmd() {
     ...
     */
    AcApImportPdfCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var convertor;
            return __generator(this, function (_a) {
                convertor = new AcApPdfImportConvertor();
                convertor.importFromFilePicker(context);
                return [2 /*return*/];
            });
        });
    };
    return AcApImportPdfCmd;
}(AcEdCommand));
export { AcApImportPdfCmd };
//# sourceMappingURL=AcApImportPdfCmd.js.map