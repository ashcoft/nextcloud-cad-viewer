    ...
    Object.defineProperty(AcDbEntity.prototype, "resolvedColor", {
        ...
        get: function () {
            ...
            if (color.isByLayer) {
                ...
                var currentColor = this.database.cecolor;
                if (currentColor) {
                    color = currentColor;
                    if (color.isByLayer) {
                        var currentLayerName = this.database.clayer || this.layer;
                        var currentLayer = this.database.tables.layerTable.getAt(currentLayerName);
                        if (((_a = currentLayer === null || currentLayer === void 0 ? void 0 : currentLayer.color) === null || _a === void 0 ? void 0 : _a.RGB) != null) {
