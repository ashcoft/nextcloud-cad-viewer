import { ImageDefDXFObject, LayoutDXFObject, MLeaderStyleDXFObject, MLineStyleDXFObject, ParsedDxf } from '@mlightcad/dxf-json';
import { AcDbLayout, AcDbMLeaderStyle, AcDbMlineStyle, AcDbRasterImageDef } from '../object';
/**
 ...
 * ```
 */
export declare class AcDbObjectConverter {
    /**
     ...
     * ```
     */
    convertLayout(layout: LayoutDXFObject, model: ParsedDxf): AcDbLayout;
    /**
     ...
     * ```
     */
    convertImageDef(image: ImageDefDXFObject): AcDbRasterImageDef;
    /**
     * Converts a DXF mleader style object to an AcDbMLeaderStyle.
     */
    convertMLeaderStyle(style: MLeaderStyleDXFObject): AcDbMLeaderStyle;
    /**
     * Converts a DXF mline style object to an AcDbMlineStyle.
     */
    convertMLineStyle(style: MLineStyleDXFObject): AcDbMlineStyle;
    /**
...
//# sourceMappingURL=AcDbObjectConverter.d.ts.map