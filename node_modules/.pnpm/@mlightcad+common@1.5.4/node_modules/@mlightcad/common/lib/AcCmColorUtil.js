...
var AcCmColorUtil = /** @class */ (function () {
     ...
     * ```
     */
    AcCmColorUtil.getColorByIndex = function (index) {
     ...
     */
    AcCmColorUtil.getIndexByColor = function (color) {
     ...
     * ```
     */
    AcCmColorUtil.getColorByName = function (name) {
     ...
     */
    AcCmColorUtil.getNameByColor = function (rgb) {
        var e_1, _a;
        try {
            for (var _b = __values(Object.entries(COLOR_NAMES)), _c = _b.next(); !_c.done; _c = _b.next()) {
     ...
     * @returns {string | undefined} The color name if found, undefined otherwise.
     */
    AcCmColorUtil.getNameByIndex = function (index) {
