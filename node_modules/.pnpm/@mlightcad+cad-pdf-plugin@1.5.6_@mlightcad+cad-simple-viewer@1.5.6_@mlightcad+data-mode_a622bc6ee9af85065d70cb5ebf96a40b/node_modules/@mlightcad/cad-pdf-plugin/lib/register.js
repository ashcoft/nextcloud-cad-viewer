 ...
 */
export var PDF_PLUGIN_TRIGGERS = ['cpdf', 'ipdf'];
/**
 ...
 */
export function registerLazyPdfPlugin(pluginManager) {
    var _this = this;
    pluginManager.registerLazyPlugin({
        name: PDF_PLUGIN_NAME,
        triggers: __spreadArray([], __read(PDF_PLUGIN_TRIGGERS), false),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, createPdfPlugin()];
                }
            });
        }); }
    });
