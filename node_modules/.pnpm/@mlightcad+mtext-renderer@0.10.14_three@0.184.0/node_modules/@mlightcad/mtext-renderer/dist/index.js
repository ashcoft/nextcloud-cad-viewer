...
function $o(t) {
  for (var e = [], r = [], n = [], a = [], i = [], s = [], o = [], c, u = 0, h = 0, d = 0, l = 0, p = 0, x = 0; x < t.glyphs.length; x += 1) {
    ...
    if (v.name !== ".notdef") {
      var F = v.getMetrics();
      e.push(F.xMin), r.push(F.yMin), n.push(F.xMax), a.push(F.yMax), s.push(F.leftSideBearing), o.push(F.rightSideBearing), i.push(v.advanceWidth);
    }
  }
  var w = {
    xMin: Math.min.apply(null, e),
...
function Ih(t, e) {
  ...
  var H = ie(i, w);
  if (a.tables.name = Bi.parse(H.data, H.offset, n), a.names = a.tables.name, l && F) {
    var W = r === 0, z = ie(i, F), le = Rh.parse(z.data, z.offset, a.numGlyphs, W), ce = ie(i, l);
...
(function(t) {
  ...
  t.Buffer = o, t.SlowBuffer = F, t.INSPECT_MAX_BYTES = 50;
  var a = 2147483647;
...
class Sn extends Qa {
  ...
  constructor(e, r, n, a) {
    var i;
    super(), this.fontSize = r, this.shape = n, this.font = a, this.code = e, a.data.header.fontType === ve.BIGFONT ? this.width = this.calcWidth() : this.width = ((i = n.lastPoint) == null ? void 0 : i.x) ?? this.calcWidth();
  }
  calcWidth() {
