 ...
 */
export function registerLazySvgPlugin(pluginManager) {
    var _this = this;
    pluginManager.registerLazyPlugin({
        name: SVG_PLUGIN_NAME,
        triggers: __spreadArray([], __read(SVG_PLUGIN_TRIGGERS), false),
        loader: function () { return __awaiter(_this, void 0, void 0, function () {
            var createSvgPlugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('@mlightcad/cad-svg-plugin')];
                    case 1:
                        createSvgPlugin = (_a.sent()).createSvgPlugin;
                        return [2 /*return*/, createSvgPlugin()];
                }
            });
        }); }
    });
