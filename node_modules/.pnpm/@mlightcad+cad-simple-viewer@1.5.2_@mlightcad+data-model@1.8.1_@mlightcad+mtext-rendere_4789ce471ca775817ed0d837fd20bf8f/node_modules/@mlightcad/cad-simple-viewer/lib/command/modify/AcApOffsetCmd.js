 ...
 */
function copyEntityTraits(source, target) {
...
function buildOffsetCurves(curve, offsetDistance, sidePoint) {
    try {
        ...
        offsetCurves.forEach(function (offsetCurve) { return copyEntityTraits(curve, offsetCurve); });
        return offsetCurves;
    }
    catch (_a) {
        return [];
...
var AcApOffsetPreviewJig = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcApOffsetPreviewJig.prototype, "entity", {
        /**
        ...
        get: function () {
            var _a;
            return (_a = this._previewCurves[0]) !== null && _a !== void 0 ? _a : null;
        },
        enumerable: false,
        configurable: true
    });
...
var AcApOffsetCmd = /** @class */ (function (_super) {
    ...
    AcApOffsetCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var blockTable, annotation, offsetDistance, currentCurve, DistanceState, SelectCurveState, SidePointState, machine;
                    ...
                    case 0:
                        ...
                        DistanceState = /** @class */ (function () {
                            ...
                            DistanceState.prototype.buildPrompt = function () {
                                ...
                                var message = lastDistance != null
                                    ? "".concat(AcApI18n.t('jig.offset.distance'), " <").concat(lastDistance, ">")
                                    : AcApI18n.t('jig.offset.distance');
                                var prompt = new AcEdPromptDistanceOptions(message);
                            ...
                            DistanceState.prototype.handleResult = function (result) {
                                ...
                                if (!Number.isFinite(result.value) ||
                                    ...
                                    AcApDocManager.instance.editor.showMessage(AcApI18n.t('jig.offset.invalidDistance'), 'warning');
                                    return 'finish';
                                }
                        ...
                        SelectCurveState = /** @class */ (function () {
                            ...
                            SelectCurveState.prototype.handleResult = function (result) {
                                ...
                                var validIds = context.doc.openMode == AcEdOpenMode.Review
                                    ? annotation.filterAnnotationEntities([result.objectId])
                                    : [result.objectId];
                                var entity = blockTable.getEntityById(validIds[0]);
                                if (!isOffsettableCurve(entity)) {
                                    AcApDocManager.instance.editor.showMessage(AcApI18n.t('jig.offset.invalidSelection'), 'warning');
                                    return 'continue';
                                }
                                currentCurve = entity;
                        ...
                        SidePointState = /** @class */ (function () {
                            ...
                            SidePointState.prototype.handleResult = function (result) {
                                ...
                                if (offsetCurves.length === 0) {
                                    AcApDocManager.instance.editor.showMessage(AcApI18n.t('jig.offset.offsetFailed'), 'warning');
                                }
                                else {
