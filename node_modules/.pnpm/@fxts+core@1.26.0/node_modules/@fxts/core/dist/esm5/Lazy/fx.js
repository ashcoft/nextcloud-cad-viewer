...
import takeUntilInclusive from "./takeUntilInclusive.js";
...
var FxAsyncIterable = /** @class */ (function () {
    ...
    FxAsyncIterable.prototype.zip = function (iterable) {
        return new FxAsyncIterable(zip(isAsyncIterable(iterable) ? iterable : toAsync(iterable), this.asyncIterable));
    };
    /**
    ...
    FxAsyncIterable.prototype.head = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, head(this.asyncIterable)];
            });
        });
    };
    /**
