import { __asyncDelegator, __asyncGenerator, __asyncValues, __await, __awaiter, __generator, __values } from "tslib";
import { throwIfPromiseError } from "../_internal/error.js";
...
function sync(f, iterable1, iterable2) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                set = new Set(map(function (a) { return throwIfPromiseError(f(a)); }, iterable1));
                return [5 /*yield**/, __values(pipe(iterable2, filter(function (a) { return pipe1(f(a), function (b) { return set.has(b); }); }), uniq))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(pipe(iterable2, filter(function (a) { return pipe1(f(a), function (b) { return set.has(b); }); }), uniq))))];
