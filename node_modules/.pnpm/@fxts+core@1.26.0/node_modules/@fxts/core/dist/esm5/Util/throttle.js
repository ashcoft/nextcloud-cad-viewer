...
function throttle(func, wait, options) {
    if (options === void 0) { options = { leading: true, trailing: true }; }
    var timeoutId;
    var lastCallTime;
    var lastArgs;
    var throttled = function () {
            ...
            if (options.trailing) {
                timeoutId = setTimeout(function () {
                    ...
                    if (lastArgs !== undefined &&
                        ...
                        func.apply(void 0, __spreadArray([], __read(lastArgs), false));
                    }
        ...
        if (options.trailing && !timeoutId) {
            var remainingTime = wait - (currentTime - lastCallTime);
            timeoutId = setTimeout(function () {
                if (lastArgs !== undefined) {
                    func.apply(void 0, __spreadArray([], __read(lastArgs), false));
