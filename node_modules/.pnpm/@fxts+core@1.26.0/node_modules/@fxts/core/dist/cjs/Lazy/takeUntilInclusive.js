...
function takeUntilInclusive(f, iterable) {
    if (iterable === undefined) {
        return function (iterable) {
            return takeUntilInclusive(f, iterable);
        };
    }
...
exports.default = takeUntilInclusive;
//# sourceMappingURL=takeUntilInclusive.js.map