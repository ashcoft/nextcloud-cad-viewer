...
type ReturnFlatType<A extends Iterable<unknown> | AsyncIterable<unknown>, B extends number = 1> = A extends Iterable<unknown> ? IterableIterator<DeepFlatSync<IterableInfer<A>, B>> : A extends AsyncIterable<unknown> ? AsyncIterableIterator<DeepFlat<Awaited<IterableInfer<A>>, B>> : never;
/**
