...
var _vector1 = /*@__PURE__*/ new AcGeVector3d();
var _vector2 = /*@__PURE__*/ new AcGeVector3d();
var _normalMatrix = /*@__PURE__*/ new AcGeMatrix2d();
/**
 * A two dimensional surface that extends infinitely in 3d space, represented in Hessian normal form
 * by a unit length normal vector and a constant.
 */
var AcGePlane = /** @class */ (function () {
    /**
     * Create one plane
     ...
     */
    function AcGePlane(normal, constant) {
        if (normal === void 0) { normal = new AcGeVector3d(1, 0, 0); }
     ...
     */
    AcGePlane.prototype.set = function (normal, constant) {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.setComponents = function (x, y, z, w) {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.setFromNormalAndCoplanarPoint = function (normal, point) {
        this.normal.copy(normal);
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.setFromCoplanarPoints = function (a, b, c) {
        var normal = _vector1
            .subVectors(c, b)
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.copy = function (plane) {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.normalize = function () {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.negate = function () {
        this.constant *= -1;
        this.normal.negate();
        return this;
    };
     ...
     */
    AcGePlane.prototype.distanceToPoint = function (point) {
     ...
     */
    AcGePlane.prototype.projectPoint = function (point, target) {
        return target
            .copy(point)
     ...
     */
    AcGePlane.prototype.intersectsBox = function (box) {
     ...
     */
    AcGePlane.prototype.coplanarPoint = function (target) {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.applyMatrix4 = function (matrix, optionalNormalMatrix) {
     ...
     * @returns Return this plane
     */
    AcGePlane.prototype.translate = function (offset) {
     ...
     */
    AcGePlane.prototype.equals = function (plane) {
     ...
     */
    AcGePlane.prototype.clone = function () {
        return new AcGePlane().copy(this);
    };
    return AcGePlane;
}());
export { AcGePlane };
//# sourceMappingURL=AcGePlane.js.map