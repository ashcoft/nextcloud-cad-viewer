...
var AcGeLine3d = /** @class */ (function (_super) {
     ...
     */
    AcGeLine3d.prototype.nearestPoint = function (point) {
     ...
     */
    AcGeLine3d.prototype.offset = function (offsetDist) {
        var s = this.startPoint;
        var e = this.endPoint;
        var len = Math.hypot(e.x - s.x, e.y - s.y);
        if (len === 0)
            return this.clone();
        var dir = new AcGeVector3d(e.x - s.x, e.y - s.y, 0).normalize();
        var perp = new AcGeVector3d(-dir.y, dir.x, 0);
        return new AcGeLine3d(new AcGePoint3d(s.x + perp.x * offsetDist, s.y + perp.y * offsetDist, s.z), new AcGePoint3d(e.x + perp.x * offsetDist, e.y + perp.y * offsetDist, e.z));
    };
    return AcGeLine3d;
}(AcGeCurve3d));
export { AcGeLine3d };
