...
import { LineSegments2 as H } from "three/examples/jsm/lines/LineSegments2.js";
import { LineSegmentsGeometry as U } from "three/examples/jsm/lines/LineSegmentsGeometry.js";
import { ACGI_PAPER_SPACE_BACKGROUND as lt, AcGiContext as Rt, AcCmColor as it, acgiForegroundColorForBackground as Ut, AcCmTransparency as Jt, AcGiLineWeight as _t, AcGePoint3d as Me, deepClone as tt, acgiResolveSubEntityTraitsRgbFromBackground as ve, log as T, ACGI_MODEL_SPACE_BACKGROUND as Ie, acgiIsLightBackground as Ae, ACGI_DARK_THEME_FOREGROUND as Te, ACGI_LIGHT_THEME_FOREGROUND as Le, AcGeGeometryUtil as ze, AcCmEventManager as ge, AcGePoint2d as ot, AcGeBox2d as fe, AcGeVector2d as ut } from "@mlightcad/data-model";
import { MTextColor as Ee, FontManager as rt, ShxParserFont as Pe, createDefaultColorSettings as dt, UnifiedRenderer as te, DefaultFontLoader as Ge } from "@mlightcad/mtext-renderer";
import { CSS2DObject as Re } from "three/examples/jsm/renderers/CSS2DRenderer.js";
import { LineMaterial as bt } from "three/examples/jsm/lines/LineMaterial.js";
import { PolyBool as De, GeometryEpsilon as Fe } from "@velipso/polybool";
import { mergeGeometries as Ve } from "three/examples/jsm/utils/BufferGeometryUtils.js";
import { OrbitControls as Oe } from "three/examples/jsm/controls/OrbitControls";
const me = 1e6;
function ke(c) {
...
function Ne(c, t, e = me) {
  return ye(c, t) >= e;
}
function We(c, t) {
  return c == null || !Ne(c, t);
}
function ri(c) {
  if (c.length === 0)
    return;
...
const Ue = {
  ...
  resolveDrawMode(c) {
    ...
    return ke(t) ? "unbatch" : "batch";
  }
}, He = /* @__PURE__ */ new h.Vector3(), z = [
  0.5,
  0,
  0,
  0.48429158056431554,
  ...
  [
    34,
    {
      ...
      indices: new Uint16Array([...E, 26, 27, 28, 29])
    }
  ],
  [
    35,
  ...
  [
    36,
    {
      position: new Float32Array([...z, 0, 0, 0, 0, 0.5, 0]),
      indices: new Uint16Array([...E, 26, 27])
    }
  ],
  [
    64,
...
class N {
  ...
  create(t = null, e = { x: 0, y: 0, z: 0 }) {
    const n = {};
    if (t == null || t == 0)
      n.point = new h.BufferGeometry().setFromPoints([ee]);
    else if (t != 1) {
...
const ee = /* @__PURE__ */ new h.Vector3(0, 0, 0);
function ai(c) {
  return c;
}
function F(c) {
...
const P = /* @__PURE__ */ new h.Vector3(), gt = /* @__PURE__ */ new h.Vector3();
class p {
  /**
  ...
  static toNonIndexed(t) {
    ...
    for (const i in t.attributes)
      e.setAttribute(
        i,
        p.createGeometryAttributeByIndex(
          t.attributes[i],
          n
        )
      );
  ...
  static computeLineDistance(t) {
    ...
    if (n.index && (n = p.toNonIndexed(n)), n.index === null) {
      ...
      if (e)
        for (let o = 0, a = r.count; o < a; o += 2)
          P.fromBufferAttribute(r, o).applyMatrix4(i), gt.fromBufferAttribute(r, o + 1).applyMatrix4(i), s[o] = o === 0 ? 0 : s[o - 1], s[o + 1] = s[o] + P.distanceTo(gt);
      else {
        s[0] = 0;
        for (let o = 1, a = r.count; o < a; o++)
          P.fromBufferAttribute(r, o - 1).applyMatrix4(i), gt.fromBufferAttribute(r, o).applyMatrix4(i), s[o] = s[o - 1], s[o] += P.distanceTo(gt);
      }
      n.setAttribute(
        "lineDistance",
  ...
  static apply2dTransform(t, e, n = 0, i = 1) {
    ...
    if (n != 0) {
      ...
      for (let u = 0; u < o.length; u += s) {
        const g = o[u], f = o[u + 1], d = g * a - f * l, m = g * l + f * a;
        o[u] = d * i + e.x, o[u + 1] = m * i + e.y;
      }
    } else
  ...
  static apply3dTransform(t, e, n) {
    const i = t.attributes.position, r = i.itemSize, s = i.array, o = Math.cos(n.x), a = Math.sin(n.x), l = Math.cos(n.y), u = Math.sin(n.y), g = Math.cos(n.z), f = Math.sin(n.z);
    for (let d = 0; d < s.length; d += r) {
      let m = s[d], y = s[d + 1], x = s[d + 2], _ = y * o - x * a, S = y * a + x * o;
      y = _, x = S;
      let C = m * l + x * u;
      S = -m * u + x * l, m = C, x = S, C = m * g - y * f, _ = m * f + y * g, m = C, y = _, s[d] = m + e.x, s[d + 1] = y + e.y, s[d + 2] = x + e.z;
    }
   ...
   */
  static isFinitePoint(t) {
    return !!t && Number.isFinite(t.x) && Number.isFinite(t.y) && Number.isFinite(t.z ?? 0);
  }
  /**
   ...
   * inputs during CAD file conversion.
   */
  static safeComputeBoundingSphere(t, e) {
    const n = p.safeComputeBoundingBox(t);
    if (!n)
      return t.boundingSphere = null, null;
    const i = e ?? new h.Sphere();
    return n.getBoundingSphere(i), t.boundingSphere = i, i;
  }
  /**
   ...
   */
  static sanitizeGeometryPositions(t, e = 2) {
    ...
    if (p.hasFinitePositions(t))
      return !0;
    const i = (a) => {
      const l = a * n.itemSize;
      for (let u = 0; u < n.itemSize; u++)
        if (!Number.isFinite(n.array[l + u]))
          return !1;
      return !0;
    }, r = t.getIndex();
    if (!r) {
      ...
      if (a.length === 0)
        return !1;
      const l = new Float32Array(a.length * n.itemSize);
      return a.forEach((u, g) => {
        const f = u * n.itemSize, d = g * n.itemSize;
        for (let m = 0; m < n.itemSize; m++)
          l[d + m] = n.array[f + m];
      }), t.setAttribute(
        "position",
        new h.BufferAttribute(l, n.itemSize)
      ), !0;
    }
    const s = [];
    for (let a = 0; a + e <= r.count; a += e) {
      let l = !0;
      for (let u = 0; u < e; u++)
        if (!i(r.getX(a + u))) {
          l = !1;
    ...
    if (s.length === 0)
      return !1;
    const o = s.some((a) => a > 65535) ? Uint32Array : Uint16Array;
    return t.setIndex(new h.BufferAttribute(new o(s), 1)), !0;
  }
  /**
   ...
   */
  static safeApplyMatrix4(t, e, n = 2) {
    if (t.boundingBox = null, t.boundingSphere = null, !p.sanitizeGeometryPositions(t, n))
      return !1;
    const i = t.getAttribute("position");
    for (let r = 0; r < i.count; r++)
      P.fromBufferAttribute(i, r), P.applyMatrix4(e), i.setXYZ(r, P.x, P.y, P.z);
...
class v {
   ...
   */
  static buildColorSettingsFromTraits(t, e = lt) {
    const n = Rt.fromBackgroundColor(e), i = this.normalizeEntityColor(t.color), r = n.resolveSubEntityTraitsRgb({ ...t, color: i });
    return {
      layer: t.layer,
  ...
  static rematerializeTextHierarchy(t, e, n) {
    ...
    t.traverse((o) => {
      if (!("material" in o))
        return;
      const a = o, l = v.resolveTextMaterialKind(a);
      l == null || !(Array.isArray(a.material) ? a.material : [a.material]).some(
        (f) => v.shouldRematerializeMaterial(
          f,
          e,
          n
        )
  ...
  static shouldRematerializeMaterial(t, e, n) {
    ...
    if (i.isByLayerColor === !0 && i.layer != null && i.layer !== e.layer)
      return !0;
    const r = n.currentBackgroundColor, o = Rt.fromBackgroundColor(r).resolveSubEntityTraitsRgb(
      {
        ...Q.createDefaultTraits(),
        color: e.color,
        layer: e.layer
    ...
    return !!(v.getMaterialDisplayRgb(t) === lt && o !== lt && i.isForeground !== !0 && (e.color.isByLayer || e.color.isByBlock));
  }
...
function hi(c) {
  return !(st(c).objectId == null || V(c).layerName != null && c.children.length > 0);
}
function pe(c) {
...
function _e(c, t) {
  ...
  for (let r = 0; r < i; r++)
    _e(c.children[r], t.children[r]);
}
const Qe = new h.Color(583902);
class Y {
  /**
  ...
  static setMaterialColor(t, e = Qe) {
    if (Array.isArray(t)) {
...
const Ke = /\.(shx|ttf|otf|woff2?)$/i, ie = {
  name: "",
  standardFlag: 0,
  fixedTextHeight: 0,
  widthFactor: 1,
...
function Ze(c) {
  return c.trim().replace(Ke, "").toLowerCase();
}
function be(c) {
  var n;
  const t = (n = c.name) == null ? void 0 : n.trim();
  if (t)
    return { byName: t };
  const e = c.shapeNumber;
  return e != null && e !== 0 ? { byCode: e } : {};
}
function re(c, t) {
  const e = Ze(t), n = c.size, { byName: i, byCode: r } = be(c), s = rt.instance;
  if (i ? s.getShapeByName(i, e, n) : r != null ? s.getShapeByCode(r, e, n) : void 0)
    return !0;
  const a = s.getFontByName(e, !1);
  if ((a == null ? void 0 : a.type) !== "shx")
    return !1;
  const l = new Pe(a.data);
  try {
    const u = i ? l.getShapeByName(i, n) : r != null ? l.getCharShape(r, n) : void 0, g = u == null ? void 0 : u.polylines;
    return !!(g != null && g.some((f) => f.length >= 2));
  } finally {
    l.release();
  }
}
function qe(c, t, e) {
  var i;
  if (t != null) {
    const r = (i = t.font) == null ? void 0 : i.trim();
    if (r && re(c, r))
      return { ...t };
  }
  const n = e.database;
  if (!n)
    return { ...ie };
  for (const r of n.tables.textStyleTable.shapeFiles) {
    const s = r.fileName || r.textStyle.font;
    if (s && re(c, s))
      return { ...r.textStyle };
  }
  return { ...ie };
...
var Se = /* @__PURE__ */ ((c) => (c[c.None = 0] = "None", c[c.Active = 1] = "Active", c[c.Visible = 2] = "Visible", c))(Se || {});
const Je = 3;
function L(c) {
  return (c & 1) !== 0;
}
...
class sn extends Xt {
  collapse(t, e) {
    ...
    if (e.hiddenDrawSnapshot || (e.hiddenDrawSnapshot = {
      ...
      const l = i[a], u = i[a + 1], g = i[a + 2];
      for (let f = s; f < s + o; f++) {
        const d = f * r;
        i[d] = l, i[d + 1] = u, i[d + 2] = g;
      }
    }
    return n.needsUpdate = !0, !0;
  }
...
const at = class at {
   ...
   */
  static apply(t, e, n, i = Ft(t)) {
    return L(e.flags) ? at.strategies[i].apply(
      t,
      e,
      n
    ) : !1;
...
let Vt = at;
function $t(c, t, e, n) {
  return Vt.apply(c, t, e, n);
}
function Ct(c, t) {
  const e = Ft(c);
  for (const n of t)
    L(n.flags) && (delete n.hiddenDrawSnapshot, W(n.flags) || $t(c, n, !1, e));
}
function on(c) {
  const t = c.length;
  let e = 0;
  return t > 0 && (e = jt.estimateObjectSize(c[0])), {
    count: t,
    size: t * e
  };
}
...
function Mt(c, t, e, n) {
  let i, r = e;
  return c.length > 0 ? (c.sort(en), i = c.shift(), t[i] = n) : (i = e, r++, t.push(n)), { geometryId: i, geometryCount: r };
}
function q(c, t) {
  return c === -1 ? t : c;
}
...
function an(c, t, e) {
  return c >= t.length || !L(t[c].flags) ? !1 : (t[c].flags = Se.None, e.push(c), !0);
}
function cn(c, t, e) {
  if (c < 0 || c >= t.length || !L(t[c].flags))
    throw new Error(
...
function Kt(c, t, e, n) {
  ...
  if (c.vertexCount = e.getAttribute("position").count, hn(
    t,
    e,
    s,
    o
  ...
  c.boundingBox = null, L(c.flags) && (delete c.hiddenDrawSnapshot, W(c.flags) || $t(
    t,
    c,
    !1
  ));
...
function un(c, t) {
  ...
  for (let n = 0, i = t.length; n < i; n++) {
    const r = t[n];
    L(r.flags) && r.boundingBox != null && e.union(r.boundingBox);
  }
  return e;
}
function dn(c, t, e) {
...
function At(c, t) {
  return class extends c {
    ...
    validateGeometryId(n) {
      cn(n, this._geometryInfo, t.typeName);
    }
    /**
    ...
    unionActiveVisibleBoundingBoxInto(n, i) {
      ...
      for (let s = 0; s < this._geometryCount; s++) {
        ...
        if (!L(o.flags) || !W(o.flags) || i != null && i.excludeObjectIds && o.objectId && i.excludeObjectIds.has(o.objectId))
          continue;
     ...
     */
    setVisibleAt(n, i) {
      if (this.validateGeometryId(n), W(this._geometryInfo[n].flags) === i)
        return this;
     ...
     */
    getVisibleAt(n) {
      return this.validateGeometryId(n), W(this._geometryInfo[n].flags);
    }
    /**
    ...
    _initializeRaycastObject(n) {
      gn(n, this.geometry, this.material), n.position.copy(this.position), n.quaternion.copy(this.quaternion), n.scale.copy(this.scale), n.updateMatrix(), n.updateMatrixWorld(!0);
    }
    /**
    ...
    _setRaycastObjectInfo(n, i, r, s) {
      const o = this;
      o.getBoundingBoxAt(i, this._box), o.getBoundingSphereAt(i, this._sphere), fn(n, r, s, this._box, this._sphere);
    }
    /**
      ...
      if (W(s.flags))
        if (s.bboxIntersectionCheck) {
          ...
          for (let l = 0, u = this._typedBatchIntersects.length; l < u; l++) {
            const g = this._typedBatchIntersects[l];
            g.object = this, g.batchId = n, g.objectId = s.objectId, r.push(g);
          }
...
const Z = /* @__PURE__ */ new h.Box3(), yn = /* @__PURE__ */ new h.Vector3(), zt = /* @__PURE__ */ new h.Vector3(), xn = At(
  h.LineSegments,
  {
  ...
  _resizeSpaceIfNeeded(t) {
    const e = t.getIndex(), n = e == null ? this._maxIndexCount : J({
      currentMaxCount: this._maxIndexCount,
      nextStart: this._nextIndexStart,
      requiredCount: e.count,
      growthFactor: ct.GROWTH_FACTOR
    }), i = t.getAttribute("position"), r = i == null ? this._maxVertexCount : J({
  ...
  addGeometry(t, e = -1, n = -1, i = new h.Vector3()) {
    ...
    const { geometryId: a, geometryCount: l } = Mt(
      this._availableGeometryIds,
      this._geometryInfo,
      this._geometryCount,
      o
  ...
  optimize() {
    ...
    let r = 0, s = 0;
    const o = this._geometryInfo.map((a, l) => ({ info: a, id: l })).filter((a) => L(a.info.flags)).sort((a, l) => a.info.vertexStart - l.info.vertexStart);
    for (const { info: a } of o) {
      const l = a.vertexCount, u = e ? a.indexCount : 0, g = a.vertexStart, f = r, d = f - g;
      if (d !== 0 && l > 0)
        for (const m in n) {
          const y = n[m], { array: x, itemSize: _ } = y;
          x.copyWithin(
            f * _,
            g * _,
            (g + l) * _
          ), y.addUpdateRange(f * _, l * _), y.needsUpdate = !0;
        }
      if (e && i && u > 0) {
      ...
      a.vertexStart = f, r += a.reservedVertexCount, s += a.reservedIndexCount;
    }
    if (e && i) {
      const a = i.array;
  ...
  getBoundingBoxAt(t, e) {
    ...
    if (i.boundingBox === null) {
      ...
      for (let u = a, g = a + l; u < g; u++) {
        let f = u;
        s && (f = s.getX(f)), r.expandByPoint(yn.fromBufferAttribute(o, f));
      }
      i.boundingBox = r;
    }
  ...
  getBoundingSphereAt(t, e) {
    return t >= this._geometryCount ? null : (this.getBoundingBoxAt(t, Z), Z.getBoundingSphere(e), e);
  }
  /**
  ...
  setGeometrySize(t, e) {
    ...
    n.index && K(n.index.array, i.index.array);
  ...
  _intersectWith(t, e, n) {
    ...
    if (this._setRaycastObjectInfo(
      ...
      this.getBoundingBoxAt(t, Z), Z.applyMatrix4(this.matrixWorld);
      const s = e.params.Line.threshold;
      if (s > 0 && Z.expandByScalar(s), e.ray.intersectBox(Z, zt)) {
...
ct.GROWTH_FACTOR = 1.25;
let Ot = ct;
const G = /* @__PURE__ */ new h.Box3(), ft = /* @__PURE__ */ new h.Vector3(), mt = /* @__PURE__ */ new h.Vector3(), et = [], k = /* @__PURE__ */ new H(
  new U()
), pn = At(H, {
  typeName: "AcTrBatchedLine2",
  createObject: () => new H(new U()),
  getDrawRange: (c, t) => ({
    start: t.vertexStart,
    count: t.vertexCount
  })
}), Bt = class Bt extends pn {
  constructor(t = 1e3, e) {
  ...
  _resizeSpaceIfNeeded(t) {
    const e = t.getAttribute("instanceStart").count, n = J({
  ...
  addGeometry(t, e = -1, n = new h.Vector3()) {
    ...
    const { geometryId: s, geometryCount: o } = Mt(
      this._availableGeometryIds,
      this._geometryInfo,
      this._geometryCount,
      r
  ...
  setGeometryAt(t, e) {
    ...
    Dt(o, r, l), Dt(a, s, l);
    for (let u = i, g = n.reservedVertexCount; u < g; u++) {
      const f = l + u;
      for (let d = 0; d < 3; d++)
        r.setComponent(f, d, 0), s.setComponent(f, d, 0);
    }
  ...
  optimize() {
    ...
    let e = 0;
    const n = this._geometryInfo.map((s, o) => ({ info: s, id: o })).filter((s) => L(s.info.flags)).sort((s, o) => s.info.vertexStart - o.info.vertexStart);
  ...
  getBoundingBoxAt(t, e) {
    ...
    if (n.boundingBox === null) {
      ...
      for (let o = n.vertexStart, a = n.vertexStart + n.vertexCount; o < a; o++)
        i.expandByPoint(ft.fromBufferAttribute(r, o)), i.expandByPoint(mt.fromBufferAttribute(s, o));
      n.boundingBox = i;
    }
   ...
   */
  getBoundingSphereAt(t, e) {
    return t >= this._geometryCount ? null : (this.getBoundingBoxAt(t, G), G.getBoundingSphere(e), e);
  }
  getGeometryAt(t) {
    return this.validateGeometryId(t), this._geometryInfo[t];
  }
  ...
  setGeometrySize(t) {
    ...
    K(n, i), this._copyStaticAttributes(e), this._geometryInitialized = !0, this._syncDrawRange(), e.dispose();
  }
  /**
  ...
  _intersectWith(t, e, n) {
    ...
    if (!W(i.flags))
      return;
    if (i.bboxIntersectionCheck) {
      if (this.getBoundingBoxAt(t, G), G.applyMatrix4(this.matrixWorld), e.ray.intersectBox(G, ft)) {
        const s = e.ray.origin.distanceTo(ft);
        n.push({
          distance: s,
          point: ft.clone(),
          object: this,
    ...
    if (k.geometry = r, k.material = this.material, k.position.copy(this.position), k.quaternion.copy(this.quaternion), k.scale.copy(this.scale), k.updateMatrix(), k.updateMatrixWorld(!0), k.raycast(e, et), et.length === 0) {
      this.getBoundingBoxAt(t, G), G.applyMatrix4(this.matrixWorld);
      const s = e.params.Line.threshold;
      if (s > 0 && G.expandByScalar(s), e.ray.intersectBox(G, mt)) {
        const o = e.ray.origin.distanceTo(mt);
        n.push({
          distance: o,
          point: mt.clone(),
          object: this,
...
let wt = Bt;
const se = /* @__PURE__ */ new h.Box3(), _n = /* @__PURE__ */ new h.Vector3(), bn = At(
  h.Mesh,
  {
  ...
  optimize() {
    const t = this.geometry, e = t.index !== null, n = t.attributes, i = t.index;
    let r = 0, s = 0;
    const o = this._geometryInfo.map((a, l) => ({ info: a, i: l })).filter((a) => L(a.info.flags)).sort((a, l) => a.info.vertexStart - l.info.vertexStart);
    for (const { info: a } of o) {
      const l = a.vertexCount, u = e ? a.indexCount : 0, g = a.vertexStart, f = a.indexStart;
      if (g !== r) {
        for (const d in n) {
          const m = n[d], { array: y, itemSize: x } = m;
          y.copyWithin(
            r * x,
            g * x,
            (g + l) * x
  ...
  getBoundingBoxAt(t, e) {
    ...
    if (i.boundingBox === null) {
      ...
      for (let u = a, g = a + l; u < g; u++) {
        let f = u;
        s && (f = s.getX(f)), r.expandByPoint(_n.fromBufferAttribute(o, f));
      }
      i.boundingBox = r;
    }
    return e.copy(i.boundingBox), e;
...
ht.GROWTH_FACTOR = 1.25;
let kt = ht;
const oe = /* @__PURE__ */ new h.Box3(), wn = /* @__PURE__ */ new h.Vector3(), Bn = At(
  h.Points,
  {
   ...
   */
  _resizeSpaceIfNeeded(t) {
    const e = t.getAttribute("position"), n = e == null ? this._maxVertexCount : J({
      currentMaxCount: this._maxVertexCount,
      nextStart: this._nextVertexStart,
      requiredCount: e.count,
  ...
  optimize() {
    let t = 0;
    const e = this.geometry, n = this._geometryInfo, i = n.map((r, s) => s).filter((r) => L(n[r].flags)).sort(
    ...
    for (let r = 0; r < i.length; r++) {
      ...
      if (a !== t) {
        for (const u in e.attributes) {
          const g = e.attributes[u], { array: f, itemSize: d } = g;
          f.copyWithin(
            t * d,
            a * d,
            (a + l) * d
          ), g.addUpdateRange(t * d, l * d), g.needsUpdate = !0;
        }
        o.vertexStart = t;
      }
      t += l;
  ...
  getBoundingBoxAt(t, e) {
    ...
    if (i.boundingBox === null) {
      ...
      for (let a = i.vertexStart, l = i.vertexStart + i.vertexCount; a < l; a++) {
        let u = a;
        s && (u = s.getX(u)), r.expandByPoint(wn.fromBufferAttribute(o, u));
      }
      i.boundingBox = r;
    }
    return e.copy(i.boundingBox), e;
   ...
   */
  getBoundingSphereAt(t, e) {
    return t >= this._geometryCount ? null : (this.getBoundingBoxAt(t, oe), oe.getBoundingSphere(e), e);
  }
  /**
   * Returns the geometry-info record for one slot after validation.
   *
  ...
  setGeometrySize(t) {
    ...
    const n = this.geometry;
    e.index && K(e.index.array, n.index.array);
...
let Nt = St;
const M = class M extends h.Group {
  /**
   * Creates an empty batched group with highlight and unbatched child containers.
   */
  constructor() {
    super(), this._pointBatches = /* @__PURE__ */ new Map(), this._pointSymbolBatches = /* @__PURE__ */ new Map(), this._lineBatches = /* @__PURE__ */ new Map(), this._lineWithIndexBatches = /* @__PURE__ */ new Map(), this._line2Batches = /* @__PURE__ */ new Map(), this._meshBatches = /* @__PURE__ */ new Map(), this._meshWithIndexBatches = /* @__PURE__ */ new Map(), this._entitiesMap = /* @__PURE__ */ new Map(), this._unbatchedEntities = /* @__PURE__ */ new Map(), this._unbatchedObjects = new h.Group(), this._selectedObjects = ne(new h.Group()), this._hoverObjects = ne(new h.Group()), this.add(this._unbatchedObjects), this.add(this._selectedObjects), this.add(this._hoverObjects);
  }
  /**
  ...
  addEntity(t) {
    ...
    const l = (u) => {
      if (!Be(u))
        return;
      const g = B(u), f = !!g.bboxIntersectionCheck;
      if (g.noBatch) {
        const d = this.cloneUnbatchedObject(u);
        d.visible = n && u.visible, B(d).bboxIntersectionCheck = f, this._unbatchedObjects.add(d), s.push(d), o = !0;
        return;
      }
      if (u instanceof H) {
        const d = this.addLine2(u, {
          objectId: e,
          bboxIntersectionCheck: f
        });
        d && (i.push(d), this.applyBatchSlotVisibility(d, n && u.visible));
        return;
      }
      if (u instanceof h.LineSegments) {
        const d = this.addLine(u, {
          position: g.position,
          objectId: e,
          bboxIntersectionCheck: f
        });
  ...
  highlight(t, e) {
    ...
    n && n.length < 1e3 && n.forEach((r) => {
      ...
      const a = st(o);
      a.objectId = t, a.disposeGeometryOnRemove = s instanceof wt, e.add(o);
    });
    const i = this._unbatchedEntities.get(t);
    i && i.length < 1e3 && i.forEach((r) => {
      const s = r.clone();
      this.copyHighlightMetadata(r, s), this.applyHighlightMaterial(s), st(s).objectId = t, e.add(s);
    });
  }
  /**
  ...
  applyHighlightMaterial(t) {
    if (this.hasMaterial(t)) {
      const e = Y.cloneMaterial(t.material);
      Y.setMaterialColor(e), t.material = e;
    }
  ...
  addLine(t, e) {
    const n = t.material, i = this.getMatchedLineBatches(t), r = new h.Vector3().setFromMatrixPosition(
      ...
      r,
      () => new Ot(
        M.INITIAL_LINE_VERTEX_CAPACITY,
        M.INITIAL_LINE_INDEX_CAPACITY,
        n
      )
    ), o = t.geometry.clone(), a = t.matrixWorld.clone();
    if (a.setPosition(0, 0, 0), !p.safeApplyMatrix4(
      o,
      a,
      2
    ))
  ...
  addMesh(t, e, n) {
    ...
    const r = this.getMatchedMeshBatches(t), s = new h.Vector3().setFromMatrixPosition(
      ...
      s,
      () => {
        const f = F(i).drawOrder ?? 0, d = new kt(
          M.INITIAL_MESH_VERTEX_CAPACITY,
          M.INITIAL_MESH_INDEX_CAPACITY,
          i
        );
        return d.renderOrder = f, d;
      }
    ), a = t.geometry.clone(), l = t.matrixWorld.clone();
    if (l.setPosition(0, 0, 0), !p.safeApplyMatrix4(
      a,
      l,
      3
    ))
      return a.dispose(), null;
  ...
  addPoint(t, e) {
    const n = t.material, i = new h.Vector3().setFromMatrixPosition(
      ...
      () => {
        const l = new Nt(
          M.INITIAL_POINT_VERTEX_CAPACITY,
          n
        );
        return l.visible = t.visible, l;
      }
    ), s = t.geometry.clone(), o = t.matrixWorld.clone();
    if (o.setPosition(0, 0, 0), !p.safeApplyMatrix4(
      s,
      o,
      2
    ))
  ...
  cloneUnbatchedObject(t) {
    ...
    const e = t.clone();
    if (t.updateMatrixWorld(!0), t.matrixWorld.decompose(A, yt, xt), e.position.copy(A), e.quaternion.copy(yt), e.scale.copy(xt), this.hasMaterial(t) && this.hasMaterial(e)) {
  ...
  finalizeUnbatchedLineClone(t) {
    ...
    e && (p.safeComputeBoundingBox(e), p.safeComputeBoundingSphere(e));
  }
  /**
   * Resolves drawable geometry from supported line/mesh/point object types.
   */
  getDrawableGeometry(t) {
    if (t instanceof H || t instanceof h.Mesh || t instanceof h.LineSegments || t instanceof h.Line || t instanceof h.Points)
      return t.geometry;
  }
  /**
  ...
  cloneUnbatchedSubtree(t) {
    const e = t.clone(!0);
    t.updateMatrixWorld(!0), t.matrixWorld.decompose(A, yt, xt), e.position.copy(A), e.quaternion.copy(yt), e.scale.copy(xt), e.updateMatrix(), e.updateMatrixWorld(!0);
    const n = B(t), i = B(e);
  ...
  cloneLineSegments2Geometry(t, e) {
    const n = t.geometry, i = n.getAttribute("instanceStart"), r = n.getAttribute("instanceEnd"), s = i.count, o = [];
    for (let l = 0; l < s; l++)
      A.fromBufferAttribute(i, l).applyMatrix4(e), $.fromBufferAttribute(r, l).applyMatrix4(e), !(!Number.isFinite(A.x) || !Number.isFinite(A.y) || !Number.isFinite(A.z) || !Number.isFinite($.x) || !Number.isFinite($.y) || !Number.isFinite($.z)) && o.push(
        A.x,
        A.y,
        A.z,
        $.x,
    ...
    if (o.length < 6)
      return null;
    const a = new U();
    return a.setPositions(new Float32Array(o)), n.hasAttribute("instanceColorStart") && (a.setAttribute(
      "instanceColorStart",
      n.getAttribute("instanceColorStart").clone()
    ), a.setAttribute(
      "instanceColorEnd",
      n.getAttribute("instanceColorEnd").clone()
    )), p.safeComputeBoundingBox(a), p.safeComputeBoundingSphere(a), a;
  }
  /**
  ...
  disposeHighlightObject(t) {
    ...
    this.hasGeometry(t) && st(t).disposeGeometryOnRemove && t.geometry.dispose();
  }
  /**
  ...
  unionUnbatchedObjectBounds(t, e, n) {
    ...
    if (i) {
      if (p.safeComputeBoundingBox(i), !i.boundingBox)
        return;
  ...
  isUnbatchedDrawableIntersecting(t, e) {
    return B(t).bboxIntersectionCheck ? this.isUnbatchedBboxIntersecting(t, e) : e.intersectObject(t, !0).length > 0;
  }
  /**
   * Tests ray intersection against the world-space bounds of one unbatched drawable.
   */
  isUnbatchedBboxIntersecting(t, e) {
    t.updateMatrixWorld(!0), nt.makeEmpty();
    const n = this.getDrawableGeometry(t);
    if (n) {
      if (p.safeComputeBoundingBox(n), !n.boundingBox)
        return !1;
      nt.copy(n.boundingBox).applyMatrix4(t.matrixWorld);
      ...
      return !1;
    return e.ray.intersectBox(nt, A) !== null;
  }
  /**
...
M.INITIAL_LINE_VERTEX_CAPACITY = 128, M.INITIAL_LINE_INDEX_CAPACITY = 256, M.INITIAL_MESH_VERTEX_CAPACITY = 128, M.INITIAL_MESH_INDEX_CAPACITY = 256, M.INITIAL_POINT_VERTEX_CAPACITY = 16;
let ae = M;
const A = /* @__PURE__ */ new h.Vector3(), $ = /* @__PURE__ */ new h.Vector3(), yt = /* @__PURE__ */ new h.Quaternion(), xt = /* @__PURE__ */ new h.Vector3(), nt = /* @__PURE__ */ new h.Box3(), Sn = /* @__PURE__ */ new h.Box3();
class Ce extends h.Object3D {
  constructor(t) {
...
class b extends Ce {
  ...
  set basePoint(t) {
    t == null ? this._basePoint = t : this._basePoint = this._basePoint ? this._basePoint.copy(t) : new Me(t);
  }
  /**
   * @inheritdoc
   */
  ...
  static flattenObject(t) {
    ...
    function o(a, l) {
      ...
      for (const g of u) {
        const f = V(a), d = V(g);
        !d.layerName && f.layerName && (d.layerName = f.layerName), g.children.length > 0 ? o(g, l) : (g.updateMatrixWorld(!0), g.visible = Be(g), e.push({
          object: g,
          relativeMatrix: l.clone().multiply(g.matrixWorld)
        })), a.remove(g);
      }
    }
  ...
  static disposeObject(t, e = !0) {
    e && t.removeFromParent(), (t instanceof h.Mesh || t instanceof h.Line || t instanceof h.Points) && t.geometry && t.geometry.dispose(), (t instanceof h.Mesh || t instanceof h.Line || t instanceof h.Points) && (Array.isArray(t.material) ? t.material : [t.material]).forEach((i) => {
      var r, s, o, a, l, u, g, f;
      i.dispose(), (r = i.map) == null || r.dispose(), (s = i.envMap) == null || s.dispose(), (o = i.lightMap) == null || o.dispose(), (a = i.bumpMap) == null || a.dispose(), (l = i.normalMap) == null || l.dispose(), (u = i.roughnessMap) == null || u.dispose(), (g = i.metalnessMap) == null || g.dispose(), (f = i.alphaMap) == null || f.dispose();
   ...
   */
  applyMatrix(t) {
    const e = we.createMatrix4(t);
    this.applyMatrix4(e), this.updateMatrixWorld(!0), this._wcsBbox.isEmpty() || this._wcsBbox.applyMatrix4(e);
  }
  /**
   * @inheritdoc
   */
  ...
  highlightObject(t) {
    if ("material" in t) {
      const e = t.material, n = V(t);
      if (n.originalMaterial == null) {
        const i = Y.cloneMaterial(e);
        Y.setMaterialColor(i), n.originalMaterial = e, t.material = i;
      }
...
class R extends b {
  constructor(t, e) {
    super(e), this._wcsChildBoxes = [], this._sourceEntities = [], t.forEach((r) => {
      if (Array.isArray(r)) {
        const s = new b(e);
        this.add(s), this.wcsBbox.union(s.wcsBbox);
      } else
        this.add(r), this.registerSourceEntities(r), this.wcsBbox.union(r.wcsBbox);
      this.storeBoxes(r);
    }), this.flatten();
    let n = !1;
  ...
  refreshWcsChildBoxesFromChildren() {
    this._wcsChildBoxes.length = 0, this.updateMatrixWorld(!0);
    const t = new h.Box3();
    for (const e of this._sourceEntities)
      this.appendSourceEntityWcsChildBox(e, t);
    this.children.forEach((e) => {
      e instanceof b && !this._sourceEntities.includes(e) && this.appendTreeEntityWcsChildBox(e, t);
   ...
   */
  addChild(t) {
    super.addChild(t), t.userData.layerName != null && t.userData.layerName !== "0" && (this._isOnTheSameLayer = !1), this.registerSourceEntities(t), this.storeBoxes(t), t.wcsBbox.isEmpty() || this.wcsBbox.union(t.wcsBbox), this.syncWcsBboxFromChildBoxes();
  }
  /**
   * @inheritdoc
   */
  applyMatrix(t) {
    const e = we.createMatrix4(t);
    this._wcsChildBoxes.forEach((n) => {
      R.isFiniteEntityBox(n) && this.applyMatrixToEntityBox(n, e);
   ...
   */
  copy(t, e) {
    return this._isOnTheSameLayer = t._isOnTheSameLayer, this._wcsChildBoxes = [], t.wcsChildBoxes.forEach((n) => this._wcsChildBoxes.push({ ...n })), this._sourceEntities = t._sourceEntities.map(
      (n) => n.fastDeepClone()
    ), super.copy(t, e);
  }
  /**
   ...
   */
  fastDeepClone() {
    const t = new R([], this.renderContext);
    return t.copy(this, !1), this.copyGeometry(this, t), t;
  }
  /**
   ...
   */
  dispose() {
    const t = new Set(this.children);
    for (const e of this._sourceEntities)
      t.has(e) || b.disposeObject(e, !1);
    this._sourceEntities.length = 0, super.dispose();
  }
  /**
  ...
  storeBoxes(t) {
    if (t instanceof R)
      t._wcsChildBoxes.forEach((e) => {
        R.isFiniteEntityBox(e) && this._wcsChildBoxes.push(e);
      });
    else if (t instanceof b) {
      if (t.wcsBbox.isEmpty())
        return;
      const e = {
      ...
      if (!R.isFiniteEntityBox(e))
        return;
      this._wcsChildBoxes.push(e);
    }
  }
  /**
   ...
   */
  registerSourceEntities(t) {
    if (t instanceof R) {
      t.getSourceEntities().forEach((e) => {
        this._sourceEntities.push(e);
      });
      return;
    }
    t instanceof b && this._sourceEntities.push(t);
  }
  /**
   ...
   */
  appendSourceEntityWcsChildBox(t, e) {
    if (t.wcsBbox.isEmpty())
      return;
    e.copy(t.wcsBbox), t.updateMatrixWorld(!0);
    const n = R.isWorldMatrixIdentity(this.matrixWorld) ? t.matrix : this.matrixWorld;
    e.applyMatrix4(n), !(!Number.isFinite(e.min.x) || !Number.isFinite(e.max.x)) && this._wcsChildBoxes.push({
      minX: e.min.x,
      minY: e.min.y,
      maxX: e.max.x,
      maxY: e.max.y,
   ...
   *   allocations during refresh.
   */
  appendTreeEntityWcsChildBox(t, e) {
    t.wcsBbox.isEmpty() || (t.updateMatrixWorld(!0), e.copy(t.wcsBbox), e.applyMatrix4(t.matrixWorld), !(!Number.isFinite(e.min.x) || !Number.isFinite(e.max.x)) && this._wcsChildBoxes.push({
      minX: e.min.x,
      minY: e.min.y,
      maxX: e.max.x,
      maxY: e.max.y,
   ...
   */
  static isWorldMatrixIdentity(t) {
    const e = new h.Matrix4();
    for (let n = 0; n < 16; ++n)
      if (Math.abs(t.elements[n] - e.elements[n]) > 1e-6)
        return !1;
    return !0;
  }
  /**
...
class Mn {
  ...
  getMeshBasicMaterial(t) {
    const e = Q.createTraitsForMText(
      t,
...
const D = class D {
   ...
   */
  async asyncRenderMText(t, e, n = dt()) {
    if (!this._renderer)
  ...
  async asyncRenderShape(t, e, n = dt()) {
    if (!this._renderer)
      throw new Error("AcTrMTextRenderer not initialized!");
  ...
  initialize(t) {
    ...
    if (e === "worker") {
      ...
      this._renderer = new te("worker", n);
    } else
      this._renderer = new te("main", n);
    if (this._renderMode && this._renderer.setDefaultMode(this._renderMode), this.applyFontUrl(), this.applyDefaultFonts(), this._styleManager) {
      const i = new Mn(this._styleManager);
  ...
  static resetInstance() {
    D.getInstance().dispose(), D._instance = null;
  }
...
function In(c, t, e, n = h.FrontSide) {
  const i = new h.Color(
  ...
  ), s = vn[(c.name || "LINEAR").trim().toUpperCase()] ?? 0;
  return An(
    {
      startColor: i.getHex(),
      endColor: r.getHex(),
...
function Ln(c, t, e, n, i = 0, r = h.FrontSide) {
  const s = Math.max(
    2,
...
const Zt = class Zt {
  ...
  getMaterial(t, e) {
    ...
    return this.keyToTraits[n] || (this.keyToTraits[n] = { ...tt(t), ...e }), this.cache[n] ? this.cache[n] : this.createMaterial(n, t, e);
  }
  /**
  ...
  updateLayerMaterial(t, e) {
    ...
    for (const i of Object.keys(this.cache)) {
      const r = this.cache[i], s = F(r);
      if (!(s.layer === t && Xe(s))) continue;
      ...
      const g = this.buildKey(u, u), f = r.id;
      r.dispose(), delete this.cache[i], delete this.keyToTraits[i];
      const d = this.createMaterial(
        g,
        u,
        u,
        l
      );
      this.keyToTraits[g] = u, n[f] = d;
    }
    return n;
  }
  /**
  ...
  changeForeground(t) {
    for (const e of Object.keys(this.cache)) {
      ...
      !(F(n).isForeground === !0) || !this.keyToTraits[e] || Y.setMaterialColor(n, new h.Color(t));
    }
  }
  /**
  ...
  changeBackground(t) {
    for (const e of Object.keys(this.cache)) {
      const n = this.cache[e];
      !(F(n).isBackgroundFill === !0) || !this.keyToTraits[e] || Y.setMaterialColor(n, new h.Color(t));
    }
  }
  /**
  ...
  applyInheritedLayerTraits(t, e, n) {
    ...
    i && e.color && (t.color = e.color.clone()), r && e.lineType && (t.lineType = tt(e.lineType)), s && e.lineWeight != null && (t.lineWeight = e.lineWeight), o && e.transparency && (t.transparency = tt(e.transparency));
  }
  /**
  ...
  resolveByLayerBindings(t, e) {
    var r;
    const n = e ? F(e) : void 0, i = ((r = t.transparency) == null ? void 0 : r.isByLayer) === !0;
    return {
      ...
      isByLayerLineWeight: (n == null ? void 0 : n.isByLayerLineWeight) ?? t.lineWeight === _t.ByLayer,
  ...
  createMaterial(t, e, n, i) {
    ...
    s && Y.setMaterialColor(
      r,
      new h.Color(
        Ut(this.options.currentBackgroundColor)
      )
    );
...
class zn extends X {
  ...
  createMaterialImpl(t, e) {
    ...
    return n.gradient ? o = this.createGradientShaderMaterial(
      ...
      e,
      r
    ) : !n.definitionLines || n.definitionLines.length < 1 ? o = this.createMeshBasicMaterial(s, r) : n.definitionLines.some((a) => !this.isValidDefinitionLine(a)) ? (T.warn(
  ...
  createHatchShaderMaterial(t, e, n, i) {
    ...
    let a = 2;
    r.definitionLines.forEach((d) => {
      a = Math.max(
        d.dashLengths.length,
        a
      );
    });
    let l = 0;
    const u = [], g = new h.Vector2();
    for (const d of r.definitionLines) {
      const m = new h.Vector2(
        ...
        d.offset.x,
        d.offset.y
      ).rotateAround(g, -d.angle);
      if (y.y === 0) {
        T.warn("offset.y is zero, skipping pattern line");
        continue;
      }
      const x = d.dashLengths.length;
      let _ = !0, S = 0;
      for (let w = 0; w < x; ++w) {
        const qt = d.dashLengths[w];
        qt > 0 && (_ = !1), S += Math.abs(qt);
      }
      const C = _ ? o : s, I = [];
      let O = 0;
      for (let w = 0; w < x; ++w)
        I[w] = d.dashLengths[w], I[w] === 0 && (I[w] = C * S), O += Math.abs(I[w]);
      for (let w = x; w < a; ++w)
        I[w] = 0;
      const Lt = {
        angle: d.angle,
  ...
  buildKey(t, e) {
    ...
    if (n.gradient) {
      const u = n.gradient, g = ce(e.gradientBounds);
      return [
        "gradient",
        t.layer,
        o,
    ...
    const l = n.definitionLines.map((u) => {
      if (!this.isValidDefinitionLine(u))
        return "invalid";
      const g = u.dashLengths.join(","), f = Number.isFinite(u.angle) ? u.angle : 0, d = u.base.x, m = u.base.y, y = u.offset.x, x = u.offset.y;
      return `${g}@${f},${d},${m},${y},${x}`;
    }).join("|");
    return [
      "hatch",
...
class Pn extends X {
  ...
  hasByLayerKeyTraits(t) {
    return super.hasByLayerKeyTraits(t) || t.lineWeight === _t.ByLayer;
  }
  resolveLineWidth(t) {
  ...
  updateResolution() {
    ...
    Object.values(this.cache).forEach((e) => {
      e instanceof bt && e.resolution.copy(t);
    });
  }
...
class Rn {
  constructor() {
    this.options = {
      ...
      showLineWeight: !1,
      currentBackgroundColor: Ie
    }, this.unsupportedTextStyles = {}, this.pointMgr = new Gn(this.options), this.lineMgr = new Pn(this.options), this.fillMgr = new zn(this.options);
  }
  /**
  ...
  set currentBackgroundColor(t) {
    this.options.currentBackgroundColor = t, this.changeBackground(t), this.repaintForegroundMaterials(Ut(t));
  }
  /**
...
const he = /* @__PURE__ */ new h.Vector2(0, 0);
class Dn extends Rt {
  constructor(t = new Rn(), e = Ue) {
    super(), this.styleManager = t, this.batchDrawPolicy = e;
  }
  /**
   * Refreshes background-dependent fields from the canvas background colour.
   */
  syncBackgroundColor(t) {
    this.backgroundIsDark = !Ae(t), this.foregroundOnDark = Te, this.foregroundOnLight = Le;
  }
}
class Fn extends b {
  constructor(t, e, n) {
   ...
   */
  generateUVs(t) {
    const e = t.attributes.position.array, n = new Float32Array(e.length / 3 * 2), i = Math.min(...e.filter((u, g) => g % 3 === 0)), r = Math.max(...e.filter((u, g) => g % 3 === 0)), s = Math.min(...e.filter((u, g) => g % 3 === 1)), o = Math.max(...e.filter((u, g) => g % 3 === 1)), a = r - i, l = o - s;
    for (let u = 0; u < e.length; u += 3) {
      const g = e[u], f = e[u + 1];
      n[u / 3 * 2] = (g - i) / a, n[u / 3 * 2 + 1] = (f - s) / l;
    }
...
class Vn extends b {
  constructor(t, e, n, i = !1) {
    ...
    if (r instanceof bt) {
      const f = new Float32Array((s - 1) * 6);
      for (let y = 0, x = 0; y < s - 1; y++) {
        const _ = t[y], S = t[y + 1];
        f[x++] = _.x - o.x, f[x++] = _.y - o.y, f[x++] = (_.z ?? 0) - o.z, f[x++] = S.x - o.x, f[x++] = S.y - o.y, f[x++] = (S.z ?? 0) - o.z;
      }
      const d = new U();
      d.setPositions(f), p.safeComputeBoundingBox(
        d
      ), p.safeComputeBoundingSphere(
        d
      ), this.geometry = d, this.setBoundingBox(
        d,
        o
      );
      const m = new H(d, r);
      m.position.set(o.x, o.y, o.z), B(m).styleMaterialId = r.id, this.add(m), this.finalizeLeafDrawables();
      return;
    }
    const a = new Float32Array(s * 3), l = s * 2 > 65535 ? new Uint32Array(s * 2) : new Uint16Array(s * 2);
    for (let f = 0, d = 0; f < s; f++) {
      const m = t[f];
      a[d++] = m.x - o.x, a[d++] = m.y - o.y, a[d++] = (m.z ?? 0) - o.z;
    }
    for (let f = 0, d = 0; f < s - 1; f++)
      l[d++] = f, l[d++] = f + 1;
    ...
    const g = new h.LineSegments(u, r);
    g.position.set(o.x, o.y, o.z), p.computeLineDistances(g), this.add(g), this.finalizeLeafDrawables();
  }
  resolveDrawMode() {
    return this.batchDrawPolicy.resolveDrawMode({
      anchor: Ht(this.wcsBbox)
    });
  }
  setBoundingBox(t, e) {
    const n = p.safeComputeBoundingBox(t);
  ...
  computeLocalOrigin(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const i = t[n];
      e.expandByPoint(On.set(i.x, i.y, i.z ?? 0));
    }
    return e.getCenter(new h.Vector3());
  }
}
const On = /* @__PURE__ */ new h.Vector3();
class kn extends b {
  constructor(t, e, n, i, r) {
    super(r);
    const s = this.styleManager.getLineMaterial(i), o = new h.Box3();
    for (let f = 0; f < t.length; f += e)
      o.expandByPoint(Nn.set(t[f], t[f + 1], t[f + 2] ?? 0));
    const a = o.getCenter(new h.Vector3());
    if (s instanceof bt) {
      const f = Math.floor(n.length / 2), d = new Float32Array(f * 6);
      for (let x = 0, _ = 0; x < f; x++) {
        const S = n[x * 2], C = n[x * 2 + 1], I = S * e, O = C * e;
        d[_++] = t[I] - a.x, d[_++] = t[I + 1] - a.y, d[_++] = (t[I + 2] ?? 0) - a.z, d[_++] = t[O] - a.x, d[_++] = t[O + 1] - a.y, d[_++] = (t[O + 2] ?? 0) - a.z;
      }
      const m = new U();
      m.setPositions(d), p.safeComputeBoundingBox(
        m
      ), p.safeComputeBoundingSphere(
        m
      ), this.setBoundingBox(
      ...
      const y = new H(m, s);
      y.position.set(a.x, a.y, a.z), B(y).styleMaterialId = s.id, this.add(y), this.finalizeLeafDrawables();
      return;
    }
    const l = new Float32Array(t.length);
    for (let f = 0; f < t.length; f += e)
      l[f] = t[f] - a.x, l[f + 1] = t[f + 1] - a.y, l[f + 2] = (t[f + 2] ?? 0) - a.z;
    const u = new h.BufferGeometry();
    u.setAttribute(
      "position",
      new h.BufferAttribute(l, e)
    ), u.setIndex(new h.BufferAttribute(n, 1)), this.setBoundingBox(u, a);
    const g = new h.LineSegments(u, s);
    g.position.set(a.x, a.y, a.z), p.computeLineDistances(g), this.add(g), this.finalizeLeafDrawables();
  }
  resolveDrawMode() {
    return this.batchDrawPolicy.resolveDrawMode({
      anchor: Ht(this.wcsBbox)
...
const Nn = /* @__PURE__ */ new h.Vector3(), le = /* @__PURE__ */ new h.Box3(), Et = /* @__PURE__ */ new h.Vector3();
class Wn extends b {
  constructor(t, e, n, i, r = !1) {
    super(i), this._text = t, this._style = { ...n }, this._entityTraits = v.snapshotEntityTraits(e), this._colorSettings = v.buildColorSettingsFromTraits(
      e,
  ...
  refreshTextMaterials() {
    this._colorSettings = v.buildColorSettingsFromTraits(
      {
        ...Q.createDefaultTraits(),
   ...
   */
  toPlanViewMTextData() {
    const t = this._text, e = t.position;
    return {
      ...t,
      position: {
        x: e.x,
  ...
  async syncDraw() {
    ...
    if (t)
      try {
        const e = this._style, n = this.toPlanViewMTextData();
...
`,
  ...
  async draw() {
    ...
    if (t)
      try {
        const e = this._style, n = this.toPlanViewMTextData(), i = await t.asyncRenderMText(
          n,
          e,
          this._colorSettings
        );
...
`,
  ...
  raycast(t, e) {
    var i;
    const n = e.length;
    (i = this._mtext) == null || i.raycast(t, e), !(e.length > n || this.wcsBbox.isEmpty()) && (le.copy(this.wcsBbox), t.ray.intersectBox(le, Et) && e.push({
      distance: t.ray.origin.distanceTo(Et),
      point: Et.clone(),
      object: this,
      face: null,
      faceIndex: void 0,
  ...
  computeGeometryBox() {
    ...
    return this.updateMatrixWorld(!0), this.traverse((n) => {
      ...
      const i = n.geometry, r = p.safeComputeBoundingBox(i);
  ...
  removeInvalidGeometryLeaves() {
    ...
    const t = [];
    this.traverse((n) => {
      this.hasGeometry(n) && (p.hasFinitePositions(n.geometry) || t.push(n));
    });
    for (const n of t)
...
const ue = /* @__PURE__ */ new h.Box3(), Pt = /* @__PURE__ */ new h.Vector3();
class Un extends b {
  constructor(t, e, n, i, r = !1) {
    super(i), this._shape = t, this._style = qe(t, n, i), this._entityTraits = v.snapshotEntityTraits(e), this._colorSettings = v.buildColorSettingsFromTraits(
      e,
      i.styleManager.currentBackgroundColor
    ), r || this.syncDraw();
  }
   ...
   */
  toRenderableShapeData() {
    const t = this._shape, { byName: e, byCode: n } = be(this._shape);
    return {
      ...t,
      name: e,
      shapeNumber: n
...
`,
  ...
  raycast(t, e) {
    var i;
    const n = e.length;
    (i = this._rendered) == null || i.raycast(t, e), !(e.length > n || this.wcsBbox.isEmpty()) && (ue.copy(this.wcsBbox), t.ray.intersectBox(ue, Pt) && e.push({
...
const de = /* @__PURE__ */ new h.Vector3();
class Hn extends b {
  constructor(t, e, n, i) {
    super(i), this._point = t;
    const r = N.instance.create(
      n.displayMode
    );
    this.isShowPoint = r.point != null;
    const s = r.point ?? new h.BufferGeometry().setFromPoints([de.set(0, 0, 0)]);
    this.unionWorldBoundingBox(s, t);
    const o = this.styleManager.getPointsMaterial(e), a = new h.Points(s, o);
    if (a.position.set(t.x, t.y, t.z ?? 0), B(a).bboxIntersectionCheck = !0, a.visible = this.isShowPoint, this.add(a), r.line) {
      const l = r.line;
      this.unionWorldBoundingBox(l, t);
      const u = this.styleManager.getLineMaterial(e, !0), g = new h.LineSegments(l, u);
      g.position.set(t.x, t.y, t.z ?? 0);
      const f = B(g);
      f.bboxIntersectionCheck = !0, f.isPoint = !0, f.position = { x: t.x, y: t.y, z: t.z }, this.add(g);
    }
...
class Xn extends b {
  constructor(t, e, n) {
    ...
    let a;
    if (o.length === 1 ? a = o[0] : o.length > 1 && (a = Ve(o) ?? void 0), a && jn(a)) {
      const l = p.safeComputeBoundingBox(a);
      if (!l) {
        T.warn("Skipped hatch fill with invalid geometry coordinates"), a.dispose();
        return;
      }
      ...
      }, g = this.styleManager.getFillMaterial(
        e,
        void 0,
        u
      ), f = new h.Mesh(a, g);
      this.add(f), this.finalizeLeafDrawables();
    } else s && T.warn("Failed to convert hatch boundaries!");
  }
  resolveDrawMode() {
  ...
  buildHatchGeometry(t, e, n) {
    ...
    for (const a of r) {
      ...
      const f = this.findIntersectHole(t, a[1]);
      f.forEach((m) => {
        let y = {
          segments: [],
          inverted: !1
        ...
        try {
          m.forEach((_, S) => {
            x = Math.min(t[_][0].relativeEps(), 1e-6);
            const C = new De(new Fe(x));
            if (S === 0)
              y = C.segments({
                regions: [o(t[_])],
                inverted: !1
              ...
              g = C.polygon(C.selectUnion(O)), g.regions.length > 0 ? g.regions.forEach((Tt) => {
                if (Tt.length === 0)
                  return;
                const Lt = Tt.map(
                  (w) => new h.Vector2(w[0], w[1])
                );
                u.holes.push(new h.Path(Lt));
              }) : T.warn("mergedHoles.regions is empty!");
            }
          });
        } catch (_) {
          T.warn(`Polybool error: ${_}, epsilon is ${x}`);
        }
      });
      const d = f.flat(2);
...
class fi {
  constructor(t) {
    this.events = {
      fontNotFound: new ge()
    }, this._renderer = t, this._context = new Dn();
    const e = t.getSize(new h.Vector2());
    this._context.styleManager.updateLineResolution(e.x, e.y), j.getInstance().overrideStyleManager(
      this._context.styleManager
    ), rt.instance.events.fontNotFound.addEventListener((n) => {
      this.events.fontNotFound.dispatch(n);
    }), this._subEntityTraits = Q.createDefaultTraits();
  }
  /**
   * @inheritdoc
   */
   ...
   */
  get context() {
    return this._context.syncBackgroundColor(
   ...
   */
  get missedFonts() {
    return rt.instance.missedFonts;
  }
  /**
   ...
   */
  area(t) {
    return new Xn(t, this._subEntityTraits, this._context);
  }
  /**
   * @inheritdoc
   */
   ...
   */
  image(t, e) {
    return new Fn(t, e, this._context);
  }
  /**
   * Clears all cached materials and releases its memory
   */
  dispose() {
    this._context.styleManager.dispose(), rt.instance.missedFonts = {};
  }
  linePoints(t) {
    return t.length < 2 ? this.createEntity() : new Vn(
      t,
      this._subEntityTraits,
      this._context,
      !1
...
class Yn {
  ...
  constructor(t, e, n) {
    ...
    this._camera = new $n(i), this._cameraControls = this.createCameraControls(), this._cameraControls.addEventListener("change", () => {
  ...
  pointToBox(t, e) {
    ...
    return new fe().setFromPoints([i, r]);
  }
  /**
...
export {
  Yn as AcTrBaseView,
  ae as AcTrBatchedGroup,
  Ot as AcTrBatchedLine,
  wt as AcTrBatchedLine2,
  kt as AcTrBatchedMesh,
  Nt as AcTrBatchedPoint,
  $n as AcTrCamera,
  b as AcTrEntity,
  gi as AcTrFontLoader,
  R as AcTrGroup,
  ui as AcTrHtmlTransientManager,
  En as AcTrLinePatternShaders,
  v as AcTrMTextColorUtil,
  j as AcTrMTextRenderer,
  Ce as AcTrObject,
  Dn as AcTrRenderContext,
  fi as AcTrRenderer,
  di as AcTrTransientManager,
  Wt as AcTrViewportView,
  me as RTE_REBASE_THRESHOLD,
  Ue as alwaysBatchDrawPolicy,
  si as alwaysUnbatchDrawPolicy,
  ai as asAcTrMaterial,
  ye as batchOriginOffsetDistance,
  We as canMergeIntoBatchOrigin,
  In as createGradientHatchShaderMaterial,
  An as createGradientHatchShaderMaterialFromUniforms,
  Ln as createHatchPatternShaderMaterial,
  oi as defaultBatchDrawPolicy,
  Ne as exceedsBatchOriginOffset,
  F as getMaterialMetadata,
  Xe as hasByLayerBinding,
  L as isBatchGeometryActive,
  W as isBatchGeometryVisible,
  hi as isHighlightCloneDrawable,
  ci as isHighlightOverlayDescendant,
  ke as isLargeWorldCoordinatePoint,
  Be as isObjectHierarchyVisible,
  ne as markHighlightOverlayGroup,
  Ht as resolveAnchorFromBox,
  ri as resolveAnchorFromPoints,
  xe as setMaterialMetadata
};
