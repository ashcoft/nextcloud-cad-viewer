 ...
 */
export declare enum DimensionTextMoveRule {
 ...
 */
export declare enum DimensionTextFit {
 ...
 */
export declare enum DimensionTextFill {
    /** No background */
    None = 0,
 ...
 */
export declare enum DimensionFractionFormat {
    Horizontal = 0,
    Diagonal = 1,
    /** For example, 1/2 */
    NotStacked = 2
 ...
 */
export declare enum DimensionAngularUnit {
    Decimal = 0,
