 ...
 * ```
 */
var AcDbViewTable = /** @class */ (function (_super) {
    __extends(AcDbViewTable, _super);
    /**
     ...
     * ```
     */
    function AcDbViewTable(db) {
        return _super.call(this, db) || this;
    }
    return AcDbViewTable;
}(AcDbSymbolTable));
export { AcDbViewTable };
//# sourceMappingURL=AcDbViewTable.js.map