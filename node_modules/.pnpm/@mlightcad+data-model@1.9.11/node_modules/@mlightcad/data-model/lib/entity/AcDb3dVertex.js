...
var AcDb3dVertex = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDb3dVertex.prototype, "dxfTypeName", {
        get: function () {
            return 'VERTEX';
        },
        enumerable: false,
    ...
    /** @inheritdoc */
    AcDb3dVertex.prototype.subMoveGripPointsAt = function (indices, offset) {
     ...
     */
    AcDb3dVertex.prototype.subGetOsnapPoints = function (osnapMode, _pickPoint, _lastPoint, snapPoints) {
     ...
     * @returns undefined
     */
    AcDb3dVertex.prototype.subWorldDraw = function (_renderer) {
        return undefined;
    };
    /**
     ...
     */
    AcDb3dVertex.prototype.dxfOutFields = function (filer) {
