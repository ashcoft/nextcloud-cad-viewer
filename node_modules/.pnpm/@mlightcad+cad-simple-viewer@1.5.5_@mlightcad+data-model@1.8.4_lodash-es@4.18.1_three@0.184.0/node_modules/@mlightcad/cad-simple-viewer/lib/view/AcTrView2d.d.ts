...
export declare class AcTrView2d extends AcEdBaseView {
     ...
     * @inheritdoc
     */
    search(box: AcGeBox2d | AcGeBox3d): AcEdSpatialQueryResultItemEx[];
    /**
     * @inheritdoc
     */
