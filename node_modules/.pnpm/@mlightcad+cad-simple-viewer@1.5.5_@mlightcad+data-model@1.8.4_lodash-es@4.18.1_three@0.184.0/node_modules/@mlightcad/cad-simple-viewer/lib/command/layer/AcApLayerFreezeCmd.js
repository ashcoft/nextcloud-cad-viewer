...
var AcApLayerFreezeCmd = /** @class */ (function (_super) {
     ...
     */
    AcApLayerFreezeCmd.prototype.notify = function (message, type) {
    ...
    AcApLayerFreezeCmd.prototype.freezeEntityLayer = function (context, objectId) {
        ...
        if (!layer) {
            this.notify("".concat(AcApI18n.t('jig.layfrz.layerNotFound'), ": ").concat(layerName), 'warning');
            return;
        }
        ...
        if (layer.isFrozen) {
            this.notify("".concat(AcApI18n.t('jig.layfrz.alreadyFrozen'), ": ").concat(layer.name), 'info');
            return;
        }
        ...
        this.notify("".concat(AcApI18n.t('jig.layfrz.frozen'), ": ").concat(layer.name), 'success');
    };
    /**
    ...
    AcApLayerFreezeCmd.prototype.runUndo = function (context) {
        ...
        if (!layer) {
            this.notify("".concat(AcApI18n.t('jig.layfrz.layerNotFound'), ": ").concat(history.layerName), 'warning');
            return;
        }
        this.setLayerFrozen(layer, history.wasFrozen);
        context.view.selectionSet.clear();
        this.notify("".concat(AcApI18n.t('jig.layfrz.restored'), ": ").concat(layer.name), 'success');
    };
