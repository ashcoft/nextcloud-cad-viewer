 ...
 */
var AcApFontUtil = /** @class */ (function () {
    function AcApFontUtil() {
    }
    /**
     * @inheritdoc FontManager.isFontLoaded
     */
    AcApFontUtil.isFontLoaded = function (fontName) {
        return FontManager.instance.isFontLoaded(fontName);
    };
    /**
     * @inheritdoc FontManager.getFontType
     */
    AcApFontUtil.getFontType = function (fontName) {
     ...
     */
    AcApFontUtil.getReplacementFontName = function (fontName) {
     ...
     */
    AcApFontUtil.getShxCodePoints = function (fontName) {
        var _a, _b;
        var font = FontManager.instance.getFontByName(fontName, false);
        if (!font || font.type !== 'shx')
            return [];
        var data = font.data;
        var keys = Object.keys((_b = (_a = data.content) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : {});
        return keys
     ...
     */
    AcApFontUtil.getLoadedShxFontData = function (fontName) {
        var font = FontManager.instance.getFontByName(fontName, false);
        if (!font || font.type !== 'shx')
            return undefined;
        return font.data;
     ...
     */
    AcApFontUtil.createShxParserFont = function (data) {
     ...
     */
    AcApFontUtil.findFontInfoByName = function (fontName) {
        var _a, _b;
        var list = (_b = (_a = AcApDocManager.instance) === null || _a === void 0 ? void 0 : _a.avaiableFonts) !== null && _b !== void 0 ? _b : [];
        var target = fontName.trim().toLowerCase();
        if (!target)
            return undefined;
        return list.find(function (info) {
            return info.name.some(function (n) { return n.trim().toLowerCase() === target; });
        });
    };
    /**
     ...
     */
    AcApFontUtil.getCatalogFontType = function (fontName) {
        var _a;
        return (_a = AcApFontUtil.findFontInfoByName(fontName)) === null || _a === void 0 ? void 0 : _a.type;
    };
    /**
     ...
     */
    AcApFontUtil.ensureDrawingFontLoaded = function (fontName) {
        return __awaiter(this, void 0, void 0, function () {
            var dm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dm = AcApDocManager.instance;
                        if (!dm)
                            return [2 /*return*/];
                        if (AcApFontUtil.isFontLoaded(fontName))
                            return [2 /*return*/];
                        return [4 /*yield*/, dm.loadFonts([fontName])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
export { AcApFontUtil };
//# sourceMappingURL=AcApFontUtil.js.map