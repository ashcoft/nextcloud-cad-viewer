...
var AcApLayoffCmd = /** @class */ (function (_super) {
    ...
    AcApLayoffCmd.prototype.turnOffEntityLayer = function (context, objectId) {
        ...
        if (!layer) {
            this.showMessage("".concat(AcApI18n.t('jig.layoff.layerNotFound'), ": ").concat(layerName), 'warning');
            return;
        }
        ...
        this.showMessage("".concat(AcApI18n.t('jig.layoff.turnedOff'), ": ").concat(layer.name), 'success');
    };
    /**
    ...
    AcApLayoffCmd.prototype.runUndo = function (context) {
        ...
        context.view.selectionSet.clear();
        this.showMessage("".concat(AcApI18n.t('jig.layoff.restored'), ": ").concat(layer.name), 'success');
    };
