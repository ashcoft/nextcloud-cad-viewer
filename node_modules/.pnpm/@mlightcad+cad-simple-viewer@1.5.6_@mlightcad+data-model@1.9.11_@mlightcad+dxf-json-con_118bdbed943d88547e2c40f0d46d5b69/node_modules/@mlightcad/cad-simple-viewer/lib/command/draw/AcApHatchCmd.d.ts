import { AcDbHatch, AcDbHatchStyle, AcDbObjectId, AcGeLoop2d } from '@mlightcad/data-model';
...
export declare class AcApHatchCmd extends AcEdCommand {
    ...
    private normalizeSysVarNumber;
    private normalizePositiveSysVarNumber;
    private sysVarRadiansToDegrees;
    private getSysVar;
    private getDatabaseSysVarSettings;
    private getActiveSettings;
    private setActiveSysVar;
    /**
     ...
     */
    protected normalizePatternName(value: string): string;
    /**
     ...
     */
    protected styleToKeyword(style: AcDbHatchStyle): "Outer" | "Ignore" | "Normal";
    /**
     ...
     */
    protected keywordToStyle(keyword: string): AcDbHatchStyle;
    /**
     ...
     */
    protected collectLoopsFromAllBoundaries(context: AcApContext): AcGeLoop2d[];
    /**
     ...
     */
    protected resolveLoopsForPickPoint(point: {
        x: number;
        y: number;
    }, loops: ReadonlyArray<AcGeLoop2d>): AcGeLoop2d[];
    /**
     ...
     */
    protected appendHatch(context: AcApContext, loops: ReadonlyArray<AcGeLoop2d>): boolean;
    /**
     ...
     */
    protected doSelectObjects(context: AcApContext): Promise<boolean>;
    /**
     ...
     */
    protected doPickPoints(context: AcApContext): Promise<boolean>;
    /**
