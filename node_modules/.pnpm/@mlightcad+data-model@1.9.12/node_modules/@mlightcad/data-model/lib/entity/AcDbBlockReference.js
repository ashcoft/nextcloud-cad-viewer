...
var AcDbBlockReference = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbBlockReference.prototype, "blockTransform", {
        ...
        get: function () {
            ...
            // ------------------------------------------------------------
            var mInsert = new AcGeMatrix3d().makeTranslation(this._position.x, this._position.y, this._position.z);
            // ------------------------------------------------------------
    ...
    AcDbBlockReference.prototype.subWorldDraw = function (renderer) {
        ...
        if (blockTableRecord != null) {
            ...
            var block = AcDbRenderingCache.instance.draw(renderer, blockTableRecord, this.resolvedColor, attribs_1, true, matrix, this._normal);
            return block;
        }
        else {
