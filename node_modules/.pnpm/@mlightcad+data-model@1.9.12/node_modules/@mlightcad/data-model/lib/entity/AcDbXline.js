...
import { AcGeBox3d, AcGeLine3d, AcGePoint3d, AcGeVector3d, offsetPointByDirectionInXY } from '@mlightcad/geometry-engine';
...
var AcDbXline = /** @class */ (function (_super) {
    ...
    AcDbXline.prototype.createOffsetCurve = function (offsetDist) {
        var offsetPoint = offsetPointByDirectionInXY(this.basePoint, this.unitDir, offsetDist);
        if (!offsetPoint)
            return null;
