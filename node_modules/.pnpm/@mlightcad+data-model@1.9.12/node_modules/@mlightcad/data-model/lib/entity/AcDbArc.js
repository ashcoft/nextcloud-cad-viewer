...
import { AcGeCircArc3d, AcGeMathUtil, AcGeMatrix3d, AcGeVector3d, getOcsAngle, getOcsReferenceVector, transformWcsPointToOcs } from '@mlightcad/geometry-engine';
...
var AcDbArc = /** @class */ (function (_super) {
    ...
    function AcDbArc(center, radius, startAngle, endAngle, normal) {
        ...
        var refVec = getOcsReferenceVector(normal);
    ...
    AcDbArc.prototype.dxfOutFields = function (filer) {
        ...
        var centerOcs = transformWcsPointToOcs(this.center, this.normal);
