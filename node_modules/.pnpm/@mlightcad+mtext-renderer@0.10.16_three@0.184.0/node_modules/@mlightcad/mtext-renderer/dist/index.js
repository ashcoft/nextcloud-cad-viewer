...
import { BufferGeometry as Qi, BufferAttribute as es, ShapePath as Va, ShapeUtils as qa, Shape as ts, LineCurve as pr, QuadraticBezierCurve as wn, CubicBezierCurve as Fn, EllipseCurve as kn } from "three";
class Tn {
  constructor() {
    this.listeners = [];
  }
...
class ja {
  constructor(e) {
    this.names = /* @__PURE__ */ new Set(), this.unsupportedChars = {}, this.encoding = e.encoding, e.alias.forEach((r) => this.names.add(r)), this.cache = new ns();
  }
  /**
...
class $a extends M.Shape {
  constructor() {
    super(...arguments), this.width = 0;
  }
}
const Nr = (t, e) => e.some((r) => t instanceof r);
let En, Ln;
function as() {
  return En || (En = [
    IDBDatabase,
...
const Gr = /* @__PURE__ */ new WeakMap(), dr = /* @__PURE__ */ new WeakMap(), cr = /* @__PURE__ */ new WeakMap();
function ss(t) {
...
function cs(t) {
  return is().includes(t) ? function(...e) {
    return t.apply(Wr(this), e), it(this.request);
  } : function(...e) {
    return it(t.apply(Wr(this), e));
  };
}
function us(t) {
  return typeof t == "function" ? cs(t) : (t instanceof IDBTransaction && os(t), Nr(t, as()) ? new Proxy(t, Hr) : t);
}
function it(t) {
  ...
  if (dr.has(t))
    return dr.get(t);
  const e = us(t);
  return e !== t && (dr.set(t, e), cr.set(e, t)), e;
}
const Wr = (t) => cr.get(t);
function hs(t, e, { blocked: r, upgrade: n, blocking: a, terminated: i } = {}) {
  const s = indexedDB.open(t, e), o = it(s);
  return n && s.addEventListener("upgradeneeded", (c) => {
    n(it(s.result), c.oldVersion, c.newVersion, it(s.transaction), c);
...
const ls = ["get", "getKey", "getAll", "getAllKeys", "count"], fs = ["put", "add", "delete", "clear"], gr = /* @__PURE__ */ new Map();
function An(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (gr.get(e))
    return gr.get(e);
  const r = e.replace(/FromIndex$/, ""), n = e !== r, a = fs.includes(r);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(r in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || ls.includes(r))
  )
    return;
...
Za((t) => ({
  ...t,
  get: (e, r, n) => An(e, r) || t.get(e, r, n),
  has: (e, r) => !!An(e, r) || t.has(e, r)
}));
const ps = ["continue", "continuePrimaryKey", "advance"], Bn = {}, zr = /* @__PURE__ */ new WeakMap(), Ka = /* @__PURE__ */ new WeakMap(), ds = {
  get(t, e) {
    if (!ps.includes(e))
      return t[e];
    let r = Bn[e];
    return r || (r = Bn[e] = function(...n) {
      zr.set(this, Ka.get(this)[e](...n));
    }), r;
  }
};
async function* gs(...t) {
  ...
  if (e instanceof IDBCursor || (e = await e.openCursor(...t)), !e)
    return;
  e = e;
  const r = new Proxy(e, ds);
  for (Ka.set(r, e), cr.set(r, Wr(e)); e; )
    yield r, e = await (zr.get(r) || e.continue()), zr.delete(r);
}
function Un(t, e) {
  return e === Symbol.asyncIterator && Nr(t, [IDBIndex, IDBObjectStore, IDBCursor]) || e === "iterate" && Nr(t, [IDBIndex, IDBObjectStore]);
}
Za((t) => ({
  ...t,
  get(e, r, n) {
    return Un(e, r) ? gs : t.get(e, r, n);
  },
  has(e, r) {
    return Un(e, r) || t.has(e, r);
  }
}));
const rt = {
  fonts: "fonts"
   ...
   */
  async set(e, r) {
    await (await this.getDatabase()).put(rt.fonts, { ...r, name: e });
  }
  /**
   ...
   */
  async get(e) {
    return await (await this.getDatabase()).get(rt.fonts, e);
  }
  /**
   ...
   */
  async delete(e) {
    await (await this.getDatabase()).delete(rt.fonts, e);
  }
  /**
   ...
   */
  async getAll() {
    return await (await this.getDatabase()).getAll(rt.fonts);
  }
  /**
   * Clears all fonts from the cache
   */
  async clear() {
    await (await this.getDatabase()).clear(rt.fonts);
  }
  /**
   ...
   */
  async destroy() {
    this.close(), await indexedDB.deleteDatabase(ye.DATABASE_NAME), ye._instance = void 0;
  }
  // Private methods for database management
  async getDatabase() {
    if (this.isClosing)
      throw new Error("Cannot perform operation while database is closing");
    return this.db ? this.db : (this.db = await hs(
      ye.DATABASE_NAME,
      ye.DATABASE_VERSION,
      {
        ...
        blocking() {
          console.warn("Database blocking newer version - closing connection"), ye.instance.close();
        }
      }
    ), this.db);
  }
...
ye.DATABASE_NAME = "mlightcad", ye.DATABASE_VERSION = vr[vr.length - 1].version;
let wt = ye;
...
String.prototype.codePointAt || function() {
  var t = function() {
    ...
    if (this == null)
      throw TypeError();
    var n = String(this), a = n.length, i = r ? Number(r) : 0;
    if (i != i && (i = 0), !(i < 0 || i >= a)) {
      var s = n.charCodeAt(i), o;
      return (
        // check if it’s the start of a surrogate pair
        s >= 55296 && s <= 56319 && // high surrogate
        a > i + 1 && (o = n.charCodeAt(i + 1), o >= 56320 && o <= 57343) ? (s - 55296) * 1024 + o - 56320 + 65536 : s
      );
    }
  };
...
function vs(t, e) {
  this.source = t, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = e, this.destLen = 0, this.ltree = new Tt(), this.dtree = new Tt();
}
var Qa = new Tt(), ei = new Tt(), tn = new Uint8Array(30), rn = new Uint16Array(30), ti = new Uint8Array(30), ri = new Uint16Array(30), ys = new Uint8Array([
  16,
  17,
  18,
  0,
  ...
  1,
  15
]), On = new Tt(), Ue = new Uint8Array(320);
function ni(t, e, r, n) {
  var a, i;
  for (a = 0; a < r; ++a)
    t[a] = 0;
...
function yr(t, e, r, n) {
  ...
  for (a = 0; a < n; ++a)
    t.table[e[r + a]]++;
  for (t.table[0] = 0, i = 0, a = 0; a < 16; ++a)
    Rn[a] = i, i += t.table[a];
  for (a = 0; a < n; ++a)
    e[r + a] && (t.trans[Rn[e[r + a]]++] = a);
}
function xs(t) {
...
function Vr(t, e) {
  ...
  do
    n = 2 * n + (i & 1), i >>>= 1, ++a, r += e.table[a], n -= e.table[a];
  while (n >= 0);
  return t.tag = i, t.bitcount -= a, e.trans[r + n];
}
function bs(t, e, r) {
  var n, a, i, s, o, c;
  for (n = Oe(t, 5, 257), a = Oe(t, 5, 1), i = Oe(t, 4, 4), s = 0; s < 19; ++s)
    Ue[s] = 0;
  for (s = 0; s < i; ++s) {
    var u = Oe(t, 3, 0);
    Ue[ys[s]] = u;
  }
  for (yr(On, Ue, 0, 19), o = 0; o < n + a; ) {
    var h = Vr(t, On);
    switch (h) {
      case 16:
        var d = Ue[o - 1];
...
function Mn(t, e, r) {
  for (; ; ) {
    ...
    if (n < 256)
      ...
      var a, i, s, o;
      for (n -= 257, a = Oe(t, tn[n], rn[n]), i = Vr(t, r), s = t.destLen - Oe(t, ti[i], ri[i]), o = s; o < s + a; ++o)
...
function Ss(t) {
  ...
  return t.bitcount = 0, en;
}
function ws(t, e) {
  var r = new vs(t, e), n, a, i;
  do {
    switch (n = xs(r), a = Oe(r, 2, 0), a) {
      case 0:
        i = Ss(r);
        break;
      case 1:
        ...
        break;
      case 2:
        bs(r, r.ltree, r.dtree), i = Mn(r, r.ltree, r.dtree);
        break;
      default:
        i = Ja;
    }
...
Qe.prototype.addPoint = function(t, e) {
...
Qe.prototype.addX = function(t) {
  this.addPoint(t, null);
};
Qe.prototype.addY = function(t) {
  this.addPoint(null, t);
};
Qe.prototype.addBezier = function(t, e, r, n, a, i, s, o) {
  var c = [t, e], u = [r, n], h = [a, i], d = [s, o];
  this.addPoint(t, e), this.addPoint(s, o);
  for (var l = 0; l <= 1; l++) {
    var g = 6 * c[l] - 12 * u[l] + 6 * h[l], x = -3 * c[l] + 9 * u[l] - 9 * h[l] + 3 * d[l], v = 3 * u[l] - 3 * c[l];
    if (x === 0) {
      if (g === 0)
        continue;
      var F = -v / g;
      0 < F && F < 1 && (l === 0 && this.addX(ut(c[l], u[l], h[l], d[l], F)), l === 1 && this.addY(ut(c[l], u[l], h[l], d[l], F)));
      continue;
    }
    var y = Math.pow(g, 2) - 4 * v * x;
    if (!(y < 0)) {
      var b = (-g + Math.sqrt(y)) / (2 * x);
      0 < b && b < 1 && (l === 0 && this.addX(ut(c[l], u[l], h[l], d[l], b)), l === 1 && this.addY(ut(c[l], u[l], h[l], d[l], b)));
      var w = (-g - Math.sqrt(y)) / (2 * x);
      0 < w && w < 1 && (l === 0 && this.addX(ut(c[l], u[l], h[l], d[l], w)), l === 1 && this.addY(ut(c[l], u[l], h[l], d[l], w)));
    }
  }
};
Qe.prototype.addQuad = function(t, e, r, n, a, i) {
...
he.prototype.moveTo = function(t, e) {
  this.commands.push({
    type: "M",
    x: t,
    y: e
...
he.prototype.lineTo = function(t, e) {
  this.commands.push({
    type: "L",
    x: t,
    y: e
...
he.prototype.curveTo = he.prototype.bezierCurveTo = function(t, e, r, n, a, i) {
  this.commands.push({
    type: "C",
    x1: t,
    y1: e,
...
he.prototype.quadTo = he.prototype.quadraticCurveTo = function(t, e, r, n) {
  this.commands.push({
    type: "Q",
    x1: t,
    y1: e,
...
he.prototype.close = he.prototype.closePath = function() {
  this.commands.push({
    type: "Z"
  });
};
he.prototype.extend = function(t) {
  if (t.commands)
    t = t.commands;
...
he.prototype.getBoundingBox = function() {
  for (var t = new Qe(), e = 0, r = 0, n = 0, a = 0, i = 0; i < this.commands.length; i++) {
    var s = this.commands[i];
    switch (s.type) {
      case "M":
        t.addPoint(s.x, s.y), e = n = s.x, r = a = s.y;
        break;
      case "L":
        t.addPoint(s.x, s.y), n = s.x, a = s.y;
        break;
      case "Q":
        t.addQuad(n, a, s.x1, s.y1, s.x, s.y), n = s.x, a = s.y;
        break;
      case "C":
        t.addBezier(n, a, s.x1, s.y1, s.x2, s.y2, s.x, s.y), n = s.x, a = s.y;
        break;
      case "Z":
        n = e, a = r;
        break;
...
he.prototype.toPathData = function(t) {
  t = t !== void 0 ? t : 2;
  function e(s) {
    return Math.round(s) === s ? "" + Math.round(s) : s.toFixed(t);
  }
  function r() {
    for (var s = arguments, o = "", c = 0; c < arguments.length; c += 1) {
      var u = s[c];
      u >= 0 && c > 0 && (o += " "), o += e(u);
    }
    return o;
...
he.prototype.toDOMElement = function(t) {
...
var P = { fail: ai, argument: In, assert: In }, Dn = 32768, _n = 2147483648, dt = {}, R = {}, N = {};
function Le(t) {
  return function() {
    return t;
  };
...
N.USHORT = Le(2);
R.SHORT = function(t) {
  return t >= Dn && (t = -(2 * Dn - t)), [t >> 8 & 255, t & 255];
};
N.SHORT = Le(2);
R.UINT24 = function(t) {
...
N.ULONG = Le(4);
R.LONG = function(t) {
  return t >= _n && (t = -(2 * _n - t)), [t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, t & 255];
};
N.LONG = Le(4);
R.FIXED = R.ULONG;
N.FIXED = N.ULONG;
...
R.REAL = function(t) {
  ...
  for (var a = "", i = 0, s = e.length; i < s; i += 1) {
    var o = e[i];
    o === "e" ? a += e[++i] === "-" ? "c" : "b" : o === "." ? a += "a" : o === "-" ? a += "e" : a += o;
  }
  a += a.length & 1 ? "f" : "ff";
  for (var c = [30], u = 0, h = a.length; u < h; u += 2)
    c.push(parseInt(a.substr(u, 2), 16));
  return c;
};
N.REAL = function(t) {
...
dt.UTF8 = function(t, e, r) {
  for (var n = [], a = r, i = 0; i < a; i++, e += 1)
    n[i] = t.getUint8(e);
  return String.fromCharCode.apply(null, n);
};
dt.UTF16 = function(t, e, r) {
  for (var n = [], a = r / 2, i = 0; i < a; i++, e += 2)
    n[i] = t.getUint16(e);
  return String.fromCharCode.apply(null, n);
};
R.UTF16 = function(t) {
...
dt.MACSTRING = function(t, e, r, n) {
  var a = qr[n];
  if (a !== void 0) {
    for (var i = "", s = 0; s < r; s++) {
      var o = t.getUint8(e + s);
      o <= 127 ? i += String.fromCharCode(o) : i += a[o & 127];
    }
    return i;
  }
};
var Ht = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), Wt, ks = function(t) {
  if (!Wt) {
    Wt = {};
    for (var e in qr)
      Wt[e] = new String(e);
...
function Es(t, e, r) {
  ...
  for (var o = e; o < i; ++o) {
    var c = t[o];
    r.push(c + 65536 >> 8 & 255, c + 256 & 255);
  }
  return i;
}
R.VARDELTAS = function(t) {
  for (var e = 0, r = []; e < t.length; ) {
    var n = t[e];
    n === 0 ? e = Ts(t, e, r) : n >= -128 && n <= 127 ? e = Cs(t, e, r) : e = Es(t, e, r);
  }
  return r;
};
R.INDEX = function(t) {
  ...
  if (n.length === 0)
    return [0, 0];
  for (var s = [], o = 1 + Math.floor(Math.log(e) / Math.log(2)) / 8 | 0, c = [void 0, R.BYTE, R.USHORT, R.UINT24, R.ULONG][o], u = 0; u < r.length; u += 1) {
    var h = c(r[u]);
...
R.DICT = function(t) {
  for (var e = [], r = Object.keys(t), n = r.length, a = 0; a < n; a += 1) {
    ...
    e = e.concat(R.OPERAND(s.value, s.type)), e = e.concat(R.OPERATOR(i));
  }
  return e;
};
N.DICT = function(t) {
...
R.OPERAND = function(t, e) {
  ...
  if (Array.isArray(e))
    for (var n = 0; n < e.length; n += 1)
      P.argument(t.length === e.length, "Not enough arguments given for type" + e), r = r.concat(R.OPERAND(t[n], e[n]));
  else if (e === "SID")
    r = r.concat(R.NUMBER(t));
  else if (e === "offset")
    r = r.concat(R.NUMBER32(t));
  else if (e === "number")
    r = r.concat(R.NUMBER(t));
  else if (e === "real")
    r = r.concat(R.REAL(t));
...
R.CHARSTRING = function(t) {
  ...
  for (var r = [], n = t.length, a = 0; a < n; a += 1) {
    var i = t[a];
    r = r.concat(R[i.type](i.value));
  }
  return zt && zt.set(t, r), r;
};
...
function Yr(t, e, r) {
  ...
  for (var i = 0; i < n; i++)
    a[i + 1] = { name: t + i, type: "TABLE", value: r(e[i], i) };
  return a;
}
function Et(t, e, r) {
  var n = e.length, a = [];
...
function tr(t) {
  t.format === 1 ? pe.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(Ct("glyph", t.glyphs))
  ) : t.format === 2 ? pe.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 2 }].concat(Et("rangeRecord", t.ranges, function(e) {
      return [
...
tr.prototype = Object.create(pe.prototype);
tr.prototype.constructor = tr;
function rr(t) {
  pe.call(
    this,
    "scriptListTable",
    Et("scriptRecord", t, function(e, r) {
      ...
      return P.assert(!!a, "Unable to write GSUB: script " + e.tag + " has no default language system."), [
        ...
        { name: "script" + r, type: "TABLE", value: new pe("scriptTable", [
        ...
        ].concat(Et("langSys", n.langSysRecords, function(i, s) {
          var o = i.langSys;
          return [
            { name: "langSysTag" + s, type: "TAG", value: i.tag },
            { name: "langSys" + s, type: "TABLE", value: new pe("langSys", [
              { name: "lookupOrder", type: "USHORT", value: 0 },
              { name: "reqFeatureIndex", type: "USHORT", value: o.reqFeatureIndex }
            ].concat(Ct("featureIndex", o.featureIndexes))) }
          ];
        }))) }
      ];
    })
...
rr.prototype = Object.create(pe.prototype);
rr.prototype.constructor = rr;
function nr(t) {
  pe.call(
    this,
    "featureListTable",
    Et("featureRecord", t, function(e, r) {
      var n = e.feature;
      return [
        { name: "featureTag" + r, type: "TAG", value: e.tag },
        { name: "feature" + r, type: "TABLE", value: new pe("featureTable", [
          { name: "featureParams", type: "USHORT", value: n.featureParams }
        ].concat(Ct("lookupListIndex", n.lookupListIndexes))) }
      ];
    })
  );
}
nr.prototype = Object.create(pe.prototype);
nr.prototype.constructor = nr;
function ar(t, e) {
  pe.call(this, "lookupListTable", Yr("lookup", t, function(r) {
    var n = e[r.lookupType];
    return P.assert(!!n, "Unable to write GSUB lookup type " + r.lookupType + " tables."), new pe("lookupTable", [
      { name: "lookupType", type: "USHORT", value: r.lookupType },
      { name: "lookupFlag", type: "USHORT", value: r.lookupFlag }
    ].concat(Yr("subtable", r.subtables, n)));
  }));
}
ar.prototype = Object.create(pe.prototype);
...
E.prototype.parseLongDateTime = function() {
  var t = nn(this.data, this.offset + this.relativeOffset + 4);
  return t -= 2082844800, this.relativeOffset += 8, t;
};
E.prototype.parseVersion = function(t) {
  var e = ir(this.data, this.offset + this.relativeOffset), r = ir(this.data, this.offset + this.relativeOffset + 2);
  return this.relativeOffset += 4, t === void 0 && (t = 4096), e + r / t / 10;
};
E.prototype.skip = function(t, e) {
  e === void 0 && (e = 1), this.relativeOffset += Rs[t] * e;
};
...
E.prototype.parseListOfLists = function(t) {
  for (var e = this.parseOffset16List(), r = e.length, n = this.relativeOffset, a = new Array(r), i = 0; i < r; i++) {
    ...
    if (this.relativeOffset = s, t) {
      for (var o = this.parseOffset16List(), c = new Array(o.length), u = 0; u < o.length; u++)
        this.relativeOffset = s + o[u], c[u] = t.call(this);
      a[i] = c;
    } else
...
E.prototype.parseScriptList = function() {
  return this.parsePointer(E.recordList({
    tag: E.tag,
    script: E.pointer({
      defaultLangSys: E.pointer(Nn),
      langSysRecords: E.recordList({
        tag: E.tag,
        langSys: E.pointer(Nn)
      })
    })
  })) || [];
};
...
function Is(t, e, r, n, a) {
  ...
  for (var s = new _.Parser(r, n + a + 14), o = new _.Parser(r, n + a + 16 + i * 2), c = new _.Parser(r, n + a + 16 + i * 4), u = new _.Parser(r, n + a + 16 + i * 6), h = n + a + 16 + i * 8, d = 0; d < i - 1; d += 1)
    for (var l = void 0, g = s.parseUShort(), x = o.parseUShort(), v = c.parseShort(), F = u.parseUShort(), y = x; y <= g; y += 1)
      F !== 0 ? (h = u.offset + u.relativeOffset - 2, h += F, h += (y - x) * 2, l = _.getUShort(r, h), l !== 0 && (l = l + v & 65535)) : l = y + v & 65535, t.glyphIndexMap[y] = l;
}
function Ds(t, e) {
  var r = {};
...
function Ns(t) {
  ...
  var i = new I.Table("cmap", a);
  for (i.segments = [], r = 0; r < t.length; r += 1) {
    for (var s = t.get(r), o = 0; o < s.unicodes.length; o += 1)
      _s(i, s.unicodes[o], r);
    i.segments = i.segments.sort(function(b, w) {
      return b.start - w.start;
    });
  }
  Ps(i);
  var c = i.segments.length, u = 0, h = [], d = [], l = [], g = [], x = [], v = [];
  for (r = 0; r < c; r += 1) {
    var F = i.segments[r];
...
oi.prototype.charToGlyphIndex = function(t) {
  var e = t.codePointAt(0), r = this.font.glyphs;
  if (r) {
    for (var n = 0; n < r.length; n += 1)
      for (var a = r.get(n), i = 0; i < a.unicodes.length; i += 1)
        if (a.unicodes[i] === e)
          return n;
  }
  return null;
...
ci.prototype.charToGlyphIndex = function(t) {
  return this.cmap.glyphIndexMap[t.codePointAt(0)] || 0;
};
function sr(t, e) {
  this.encoding = t, this.charset = e;
}
sr.prototype.charToGlyphIndex = function(t) {
  ...
  switch (t.version) {
    ...
    case 2:
      ...
      for (var e = 0; e < t.numberOfGlyphs; e++)
        t.glyphNameIndex[e] < nt.length ? this.names[e] = nt[t.glyphNameIndex[e]] : this.names[e] = t.names[t.glyphNameIndex[e] - nt.length];
      break;
    case 2.5:
      this.names = new Array(t.numberOfGlyphs);
      for (var r = 0; r < t.numberOfGlyphs; r++)
        this.names[r] = nt[r + t.glyphNameIndex[r]];
      break;
    case 3:
      this.names = [];
      break;
...
an.prototype.nameToGlyphIndex = function(t) {
  return this.names.indexOf(t);
};
an.prototype.glyphIndexToName = function(t) {
  return this.names[t];
};
function Ws(t) {
...
ke.prototype.bindConstructorValues = function(t) {
...
ke.prototype.addUnicode = function(t) {
  this.unicodes.length === 0 && (this.unicode = t), this.unicodes.push(t);
};
ke.prototype.getBoundingBox = function() {
  return this.path.getBoundingBox();
};
ke.prototype.getPath = function(t, e, r, n, a) {
  t = t !== void 0 ? t : 0, e = e !== void 0 ? e : 0, r = r !== void 0 ? r : 72;
  var i, s;
  n || (n = {});
  var o = n.xScale, c = n.yScale;
  if (n.hinting && a && a.hinting && (s = this.path && a.hinting.exec(this, r)), s)
    i = a.hinting.getCommands(s), t = Math.round(t), e = Math.round(e), o = c = 1;
  else {
...
ke.prototype.draw = function(t, e, r, n, a) {
...
ke.prototype.drawPoints = function(t, e, r, n) {
  function a(d, l, g, x) {
    ...
    for (var v = 0; v < d.length; v += 1)
      t.moveTo(l + d[v].x * x, g + d[v].y * x), t.arc(l + d[v].x * x, g + d[v].y * x, 2, 0, Math.PI * 2, !1);
    t.closePath(), t.fill();
  }
  e = e !== void 0 ? e : 0, r = r !== void 0 ? r : 0, n = n !== void 0 ? n : 24;
  for (var i = 1 / this.path.unitsPerEm * n, s = [], o = [], c = this.path, u = 0; u < c.commands.length; u += 1) {
    var h = c.commands[u];
    h.x !== void 0 && s.push({ x: h.x, y: -h.y }), h.x1 !== void 0 && o.push({ x: h.x1, y: -h.y1 }), h.x2 !== void 0 && o.push({ x: h.x2, y: -h.y2 });
  }
  t.fillStyle = "blue", a(s, e, r, i), t.fillStyle = "red", a(o, e, r, i);
};
ke.prototype.drawMetrics = function(t, e, r, n) {
  var a;
  e = e !== void 0 ? e : 0, r = r !== void 0 ? r : 0, n = n !== void 0 ? n : 24, a = 1 / this.path.unitsPerEm * n, t.lineWidth = 1, t.strokeStyle = "black", tt.line(t, e, -1e4, e, 1e4), tt.line(t, -1e4, r, 1e4, r);
  var i = this.xMin || 0, s = this.yMin || 0, o = this.xMax || 0, c = this.yMax || 0, u = this.advanceWidth || 0;
  t.strokeStyle = "blue", tt.line(t, e + i * a, -1e4, e + i * a, 1e4), tt.line(t, e + o * a, -1e4, e + o * a, 1e4), tt.line(t, -1e4, r + -s * a, 1e4, r + -s * a), tt.line(t, -1e4, r + -c * a, 1e4, r + -c * a), t.strokeStyle = "green", tt.line(t, e + u * a, -1e4, e + u * a, 1e4);
};
function Vt(t, e, r) {
...
function sn(t, e) {
  if (this.font = t, this.glyphs = {}, Array.isArray(e))
    for (var r = 0; r < e.length; r++) {
      var n = e[r];
      n.path.unitsPerEm = t.unitsPerEm, this.glyphs[r] = n;
    }
...
function Ys(t, e) {
  return new ke({ index: e, font: t });
}
function js(t, e, r, n, a, i) {
  return function() {
    var s = new ke({ index: e, font: t });
    return s.path = function() {
      r(s, n, a);
      var o = i(t.glyphs, s);
      return o.unitsPerEm = t.unitsPerEm, o;
    }, Vt(s, "xMin", "_xMin"), Vt(s, "xMax", "_xMax"), Vt(s, "yMin", "_yMin"), Vt(s, "yMax", "_yMax"), s;
  };
}
function $s(t, e, r, n) {
  return function() {
    var a = new ke({ index: e, font: t });
...
var De = { GlyphSet: sn, glyphLoader: Ys, ttfGlyphLoader: js, cffGlyphLoader: $s };
function ui(t, e) {
  if (t === e)
    return !0;
...
function Qs(t, e) {
  ...
  if (e >= 32 && e <= 246)
    return e - 139;
  if (e >= 247 && e <= 250)
    return r = t.parseByte(), (e - 247) * 256 + r + 108;
  if (e >= 251 && e <= 254)
...
function hi(t, e, r) {
  ...
  for (r = r !== void 0 ? r : t.length; n.relativeOffset < r; ) {
    var s = n.parseByte();
    s <= 21 ? (s === 12 && (s = 1200 + n.parseByte()), a.push([s, i]), i = []) : i.push(Qs(n, s));
  }
  return eo(a);
}
function Ft(t, e) {
  return e <= 390 ? e = Zt[e] : e = t[e - 391], e;
}
function li(t, e, r) {
  for (var n = {}, a, i = 0; i < e.length; i += 1) {
    var s = e[i];
    if (Array.isArray(s.type)) {
      var o = [];
      o.length = s.type.length;
      for (var c = 0; c < s.type.length; c++)
        a = t[s.op] !== void 0 ? t[s.op][c] : void 0, a === void 0 && (a = s.value !== void 0 && s.value[c] !== void 0 ? s.value[c] : null), s.type[c] === "SID" && (a = Ft(r, a)), o[c] = a;
      n[s.name] = o;
    } else
      a = t[s.op], a === void 0 && (a = s.value !== void 0 ? s.value : null), s.type === "SID" && (a = Ft(r, a)), n[s.name] = a;
  }
  return n;
}
function to(t, e) {
...
function Gn(t, e, r, n) {
  for (var a = [], i = 0; i < r.length; i += 1) {
    var s = new DataView(new Uint8Array(r[i]).buffer), o = ro(s, n);
    ...
    if (c !== 0 && u !== 0) {
      ...
      if (o._defaultWidthX = h.defaultWidthX, o._nominalWidthX = h.nominalWidthX, h.subrs !== 0) {
        ...
        o._subrs = l.objects, o._subrsBias = jr(o._subrs);
      }
      o._privateDict = h;
    }
    a.push(o);
...
function ao(t, e, r) {
  ...
  if (s === 0)
    ...
    n = 1;
    for (var h = 0; h < u; h += 1)
      for (var d = i.parseCard8(), l = i.parseCard8(), g = d; g <= d + l; g += 1)
        a[g] = n, n += 1;
  } else
...
function Hn(t, e, r) {
  var n, a, i, s, o = new he(), c = [], u = 0, h = !1, d = !1, l = 0, g = 0, x, v, F, y;
  if (t.isCIDFont) {
    var b = t.tables.cff.topDict._fdSelect[e.index], w = t.tables.cff.topDict._fdArray[b];
    x = w._subrs, v = w._subrsBias, F = w._defaultWidthX, y = w._nominalWidthX;
  } else
    x = t.tables.cff.topDict._subrs, v = t.tables.cff.topDict._subrsBias, F = t.tables.cff.topDict._defaultWidthX, y = t.tables.cff.topDict._nominalWidthX;
  var k = F;
  function C(O, H) {
  ...
  function B(O) {
    for (var H, z, W, le, ce, $, K, J, ae, ue, oe, fe, G = 0; G < O.length; ) {
      var q = O[G];
      switch (G += 1, q) {
        case 1:
          U();
        ...
        case 3:
          ...
          break;
        case 4:
          c.length > 1 && !h && (k = c.shift() + y, h = !0), g += c.pop(), C(l, g);
          break;
        case 5:
          for (; c.length > 0; )
            l += c.shift(), g += c.shift(), o.lineTo(l, g);
          break;
        case 6:
          for (; c.length > 0 && (l += c.shift(), o.lineTo(l, g), c.length !== 0); )
            g += c.shift(), o.lineTo(l, g);
          break;
        case 7:
          for (; c.length > 0 && (g += c.shift(), o.lineTo(l, g), c.length !== 0); )
            l += c.shift(), o.lineTo(l, g);
          break;
        case 8:
          for (; c.length > 0; )
            n = l + c.shift(), a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), l = i + c.shift(), g = s + c.shift(), o.curveTo(n, a, i, s, l, g);
          break;
        case 10:
          ce = c.pop() + v, $ = x[ce], $ && B($);
          break;
        ...
        case 12:
          switch (q = O[G], G += 1, q) {
            case 35:
              n = l + c.shift(), a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), K = i + c.shift(), J = s + c.shift(), ae = K + c.shift(), ue = J + c.shift(), oe = ae + c.shift(), fe = ue + c.shift(), l = oe + c.shift(), g = fe + c.shift(), c.shift(), o.curveTo(n, a, i, s, K, J), o.curveTo(ae, ue, oe, fe, l, g);
              break;
            case 34:
              n = l + c.shift(), a = g, i = n + c.shift(), s = a + c.shift(), K = i + c.shift(), J = s, ae = K + c.shift(), ue = s, oe = ae + c.shift(), fe = g, l = oe + c.shift(), o.curveTo(n, a, i, s, K, J), o.curveTo(ae, ue, oe, fe, l, g);
              break;
            case 36:
              n = l + c.shift(), a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), K = i + c.shift(), J = s, ae = K + c.shift(), ue = s, oe = ae + c.shift(), fe = ue + c.shift(), l = oe + c.shift(), o.curveTo(n, a, i, s, K, J), o.curveTo(ae, ue, oe, fe, l, g);
              break;
            case 37:
              n = l + c.shift(), a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), K = i + c.shift(), J = s + c.shift(), ae = K + c.shift(), ue = J + c.shift(), oe = ae + c.shift(), fe = ue + c.shift(), Math.abs(oe - l) > Math.abs(fe - g) ? l = oe + c.shift() : g = fe + c.shift(), o.curveTo(n, a, i, s, K, J), o.curveTo(ae, ue, oe, fe, l, g);
              break;
            default:
        ...
        case 20:
          ...
          break;
        case 21:
          c.length > 2 && !h && (k = c.shift() + y, h = !0), g += c.pop(), l += c.pop(), C(l, g);
          break;
        case 22:
          c.length > 1 && !h && (k = c.shift() + y, h = !0), l += c.pop(), C(l, g);
          break;
        case 23:
          U();
          break;
        ...
        case 26:
          for (c.length % 2 && (l += c.shift()); c.length > 0; )
            n = l, a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), l = i, g = s + c.shift(), o.curveTo(n, a, i, s, l, g);
          break;
        case 27:
          for (c.length % 2 && (g += c.shift()); c.length > 0; )
            n = l + c.shift(), a = g, i = n + c.shift(), s = a + c.shift(), l = i + c.shift(), g = s, o.curveTo(n, a, i, s, l, g);
          break;
        case 28:
          H = O[G], z = O[G + 1], c.push((H << 24 | z << 16) >> 16), G += 2;
          break;
        case 29:
          ce = c.pop() + t.gsubrsBias, $ = t.gsubrs[ce], $ && B($);
          break;
        case 30:
          for (; c.length > 0 && (n = l, a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), l = i + c.shift(), g = s + (c.length === 1 ? c.shift() : 0), o.curveTo(n, a, i, s, l, g), c.length !== 0); )
            n = l + c.shift(), a = g, i = n + c.shift(), s = a + c.shift(), g = s + c.shift(), l = i + (c.length === 1 ? c.shift() : 0), o.curveTo(n, a, i, s, l, g);
          break;
        case 31:
          for (; c.length > 0 && (n = l + c.shift(), a = g, i = n + c.shift(), s = a + c.shift(), g = s + c.shift(), l = i + (c.length === 1 ? c.shift() : 0), o.curveTo(n, a, i, s, l, g), c.length !== 0); )
            n = l, a = g + c.shift(), i = n + c.shift(), s = a + c.shift(), l = i + c.shift(), g = s + (c.length === 1 ? c.shift() : 0), o.curveTo(n, a, i, s, l, g);
          break;
        default:
          q < 32 ? console.log("Glyph " + e.index + ": unknown operator " + q) : q < 247 ? c.push(q - 139) : q < 251 ? (H = O[G], G += 1, c.push((q - 247) * 256 + H + 108)) : q < 255 ? (H = O[G], G += 1, c.push(-(q - 251) * 256 - H - 108)) : (H = O[G], z = O[G + 1], W = O[G + 2], le = O[G + 3], G += 4, c.push((H << 24 | z << 16 | W << 8 | le) / 65536));
      }
    }
  }
...
function so(t, e, r, n) {
  r.tables.cff = {};
  var a = to(t, e), i = qe(t, a.endOffset, _.bytesToString), s = qe(t, i.endOffset), o = qe(t, s.endOffset, _.bytesToString), c = qe(t, o.endOffset);
  r.gsubrs = c.objects, r.gsubrsBias = jr(r.gsubrs);
  var u = Gn(t, e, s.objects, o.objects);
  if (u.length !== 1)
  ...
  if (r.tables.cff.topDict = h, h._privateDict && (r.defaultWidthX = h._privateDict.defaultWidthX, r.nominalWidthX = h._privateDict.nominalWidthX), h.ros[0] !== void 0 && h.ros[1] !== void 0 && (r.isCIDFont = !0), r.isCIDFont) {
    ...
    d += e;
    var g = qe(t, d), x = Gn(t, e, g.objects, o.objects);
    h._fdArray = x, l += e, h._fdSelect = io(t, l, r.numGlyphs, x.length);
  }
  var v = e + h.private[1], F = di(t, v, h.private[0], o.objects);
  if (r.defaultWidthX = F.defaultWidthX, r.nominalWidthX = F.nominalWidthX, F.subrs !== 0) {
    var y = v + F.subrs, b = qe(t, y);
    r.subrs = b.objects, r.subrsBias = jr(r.subrs);
  } else
    r.subrs = [], r.subrsBias = 0;
  var w;
  n.lowMemory ? (w = Zs(t, e + h.charStrings), r.nGlyphs = w.offsets.length) : (w = qe(t, e + h.charStrings), r.nGlyphs = w.objects.length);
  var k = no(t, e + h.charset, r.nGlyphs, o.objects);
  if (h.encoding === 0 ? r.cffEncoding = new sr(Gs, k) : h.encoding === 1 ? r.cffEncoding = new sr(Hs, k) : r.cffEncoding = ao(t, e + h.encoding, k), r.encoding = r.encoding || r.cffEncoding, r.glyphs = new De.GlyphSet(r), n.lowMemory)
    r._push = function(B) {
      var O = Ks(B, w.offsets, t, e + h.charStrings);
      r.glyphs.push(B, De.cffGlyphLoader(r, B, Hn, O));
    };
  else
    for (var C = 0; C < r.nGlyphs; C += 1) {
      var U = w.objects[C];
      r.glyphs.push(C, De.cffGlyphLoader(r, C, Hn, U));
    }
}
function gi(t, e) {
  var r, n = Zt.indexOf(t);
  return n >= 0 && (r = n), n = e.indexOf(t), n >= 0 ? r = n + Zt.length : (r = Zt.length + e.length, e.push(t)), r;
}
function oo() {
...
function vi(t, e, r) {
  for (var n = {}, a = 0; a < t.length; a += 1) {
    ...
    s !== void 0 && !ui(s, i.value) && (i.type === "SID" && (s = gi(s, r)), n[i.op] = { name: i.name, type: i.type, value: s });
  }
  return n;
}
function Wn(t, e) {
  var r = new I.Record("Top DICT", [
    { name: "dict", type: "DICT", value: {} }
  ]);
  return r.dict = vi(fi, t, e), r;
}
function zn(t) {
...
function lo(t, e) {
  for (var r = new I.Record("Charsets", [
...
function fo(t) {
  ...
  for (var n = 0, a = 0, i = 0; i < r.commands.length; i += 1) {
    var s = void 0, o = void 0, c = r.commands[i];
    if (c.type === "Q") {
      var u = 0.3333333333333333, h = 2 / 3;
      c = {
        type: "C",
        x: c.x,
        y: c.y,
        x1: Math.round(u * n + h * c.x1),
        y1: Math.round(u * a + h * c.y1),
        x2: Math.round(u * c.x + h * c.x1),
        y2: Math.round(u * c.y + h * c.y1)
      };
    }
    if (c.type === "M")
      s = Math.round(c.x - n), o = Math.round(c.y - a), e.push({ name: "dx", type: "NUMBER", value: s }), e.push({ name: "dy", type: "NUMBER", value: o }), e.push({ name: "rmoveto", type: "OP", value: 21 }), n = Math.round(c.x), a = Math.round(c.y);
    else if (c.type === "L")
      ...
      var d = Math.round(c.x1 - n), l = Math.round(c.y1 - a), g = Math.round(c.x2 - c.x1), x = Math.round(c.y2 - c.y1);
      s = Math.round(c.x - c.x2), o = Math.round(c.y - c.y2), e.push({ name: "dx1", type: "NUMBER", value: d }), e.push({ name: "dy1", type: "NUMBER", value: l }), e.push({ name: "dx2", type: "NUMBER", value: g }), e.push({ name: "dy2", type: "NUMBER", value: x }), e.push({ name: "dx", type: "NUMBER", value: s }), e.push({ name: "dy", type: "NUMBER", value: o }), e.push({ name: "rrcurveto", type: "OP", value: 8 }), n = Math.round(c.x), a = Math.round(c.y);
    }
  }
...
function po(t) {
  for (var e = new I.Record("CharStrings INDEX", [
    ...
    var n = t.get(r), a = fo(n);
    e.charStrings.push({ name: n.name, type: "CHARSTRING", value: a });
  }
  return e;
}
function go(t, e) {
  var r = new I.Record("Private DICT", [
    { name: "dict", type: "DICT", value: {} }
  ]);
  return r.dict = vi(pi, t, e), r;
}
function vo(t, e) {
  for (var r = new I.Table("CFF ", [
  ...
  var u = [];
  r.header = oo(), r.nameIndex = co([e.postScriptName]);
  var h = Wn(a, u);
  r.topDictIndex = zn(h), r.globalSubrIndex = ho(), r.charsets = lo(s, u), r.charStringsIndex = po(t), r.privateDict = go(i, u), r.stringIndex = uo(u);
  var d = r.header.sizeOf() + r.nameIndex.sizeOf() + r.topDictIndex.sizeOf() + r.stringIndex.sizeOf() + r.globalSubrIndex.sizeOf();
  return a.charset = d, a.encoding = 0, a.charStrings = a.charset + r.charsets.sizeOf(), a.private[1] = a.charStrings + r.charStringsIndex.sizeOf(), h = Wn(a, u), r.topDictIndex = zn(h), r;
}
var yi = { parse: so, make: vo };
function yo(t, e) {
...
function mo(t) {
  ...
  return t.createdTimestamp && (r = t.createdTimestamp + 2082844800), new I.Table("head", [
...
var xi = { parse: xo, make: bo };
function So(t, e, r, n, a) {
...
function Fo(t, e, r, n, a, i, s) {
  s.lowMemory ? wo(t, e, r, n, a) : So(e, r, n, a, i);
}
function ko(t) {
  for (var e = new I.Table("hmtx", []), r = 0; r < t.length; r += 1) {
...
function Ro(t, e, r) {
  for (var n = {}, a = new _.Parser(t, e), i = a.parseUShort(), s = a.parseUShort(), o = a.offset + a.parseUShort(), c = 0; c < s; c++) {
    var u = a.parseUShort(), h = a.parseUShort(), d = a.parseUShort(), l = a.parseUShort(), g = Fi[l] || l, x = a.parseUShort(), v = a.parseUShort(), F = Bo(u, d, r), y = Ci(u, h, d);
    if (y !== void 0 && F !== void 0) {
      var b = void 0;
      if (y === $r ? b = dt.UTF16(t, o + v, x) : b = dt.MACSTRING(t, o + v, x, y), b) {
        var w = n[g];
        w === void 0 && (w = n[g] = {}), w[F] = b;
      }
    }
  }
...
function Io(t, e) {
  ...
  for (var s in t) {
    var o = i[s];
    if (o === void 0 && (o = s), r = parseInt(o), isNaN(r))
      throw new Error('Name table entry "' + s + '" does not exist, see nameTableNames for complete list.');
    a[r] = t[s], n.push(r);
  }
  for (var c = mr(ki), u = mr(Ti), h = [], d = [], l = 0; l < n.length; l++) {
    r = n[l];
    var g = a[r];
    for (var x in g) {
      var v = g[x], F = 1, y = c[x], b = Ao[y], w = Ci(F, b, y), k = R.MACSTRING(v, w);
      k === void 0 && (F = 0, y = e.indexOf(x), y < 0 && (y = e.length, e.push(x)), b = 4, k = R.UTF16(v));
      var C = qn(k, d);
      h.push(Vn(
        F,
        b,
  ...
  h.sort(function(W, le) {
    return W.platformID - le.platformID || W.encodingID - le.encodingID || W.languageID - le.languageID || W.nameID - le.nameID;
  });
  for (var H = new I.Table("name", [
    { name: "format", type: "USHORT", value: 0 },
    { name: "count", type: "USHORT", value: h.length },
    { name: "stringOffset", type: "USHORT", value: 6 + h.length * 12 }
  ]), z = 0; z < h.length; z++)
    H.fields.push({ name: "record_" + z, type: "RECORD", value: h[z] });
  return H.fields.push({ name: "strings", type: "LITERAL", value: d }), H;
}
var Ei = { parse: Ro, make: Io }, Zr = [
  { begin: 0, end: 127 },
  // Basic Latin
  { begin: 128, end: 255 },
  // Latin-1 Supplement
...
var Kr = { parse: _o, make: Po, unicodeRanges: Zr, getUnicodeRange: Do };
function No(t, e) {
  var r = {}, n = new _.Parser(t, e);
  switch (r.version = n.parseVersion(), r.italicAngle = n.parseFixed(), r.underlinePosition = n.parseShort(), r.underlineThickness = n.parseShort(), r.isFixedPitch = n.parseULong(), r.minMemType42 = n.parseULong(), r.maxMemType42 = n.parseULong(), r.minMemType1 = n.parseULong(), r.maxMemType1 = n.parseULong(), r.version) {
    ...
    case 2:
      ...
      for (var i = 0; i < r.numberOfGlyphs; i++)
        if (r.glyphNameIndex[i] >= nt.length) {
          var s = n.parseChar();
...
var Li = { parse: No, make: Go }, Te = new Array(9);
Te[1] = function() {
...
Te[5] = function() {
    ...
    return {
      ...
      ruleSets: this.parseListOfLists(function() {
        ...
        return {
          ...
          lookupRecords: this.parseRecordList(s, lt)
        };
      })
    };
  if (r === 2)
  ...
  if (r === 3) {
    ...
    return {
      ...
      lookupRecords: this.parseRecordList(a, lt)
    };
  }
...
vt[2] = function(e) {
  return P.assert(e.substFormat === 1, "Lookup type 2 substFormat must be 1."), new I.Table("substitutionTable", [
    { name: "substFormat", type: "USHORT", value: 1 },
    { name: "coverage", type: "TABLE", value: new I.Coverage(e.coverage) }
  ].concat(I.tableList("seqSet", e.sequences, function(r) {
    return new I.Table("sequenceSetTable", I.ushortList("sequence", r));
  })));
};
vt[3] = function(e) {
  return P.assert(e.substFormat === 1, "Lookup type 3 substFormat must be 1."), new I.Table("substitutionTable", [
    { name: "substFormat", type: "USHORT", value: 1 },
    { name: "coverage", type: "TABLE", value: new I.Coverage(e.coverage) }
  ].concat(I.tableList("altSet", e.alternateSets, function(r) {
    return new I.Table("alternateSetTable", I.ushortList("alternate", r));
  })));
};
vt[4] = function(e) {
  return P.assert(e.substFormat === 1, "Lookup type 4 substFormat must be 1."), new I.Table("substitutionTable", [
    { name: "substFormat", type: "USHORT", value: 1 },
    { name: "coverage", type: "TABLE", value: new I.Coverage(e.coverage) }
  ].concat(I.tableList("ligSet", e.ligatureSets, function(r) {
    return new I.Table("ligatureSetTable", I.tableList("ligature", r, function(n) {
      return new I.Table(
        "ligatureTable",
        [{ name: "ligGlyph", type: "USHORT", value: n.ligGlyph }].concat(I.ushortList("component", n.components, n.components.length + 1))
      );
    }));
  })));
};
vt[6] = function(e) {
  if (e.substFormat === 1) {
    var r = new I.Table("chainContextTable", [
      { name: "substFormat", type: "USHORT", value: e.substFormat },
      { name: "coverage", type: "TABLE", value: new I.Coverage(e.coverage) }
    ].concat(I.tableList("chainRuleSet", e.chainRuleSets, function(i) {
      return new I.Table("chainRuleSetTable", I.tableList("chainRule", i, function(s) {
        var o = I.ushortList("backtrackGlyph", s.backtrack, s.backtrack.length).concat(I.ushortList("inputGlyph", s.input, s.input.length + 1)).concat(I.ushortList("lookaheadGlyph", s.lookahead, s.lookahead.length)).concat(I.ushortList("substitution", [], s.lookupRecords.length));
        return s.lookupRecords.forEach(function(c, u) {
          o = o.concat({ name: "sequenceIndex" + u, type: "USHORT", value: c.sequenceIndex }).concat({ name: "lookupListIndex" + u, type: "USHORT", value: c.lookupListIndex });
    ...
    n.push({ name: "backtrackGlyphCount", type: "USHORT", value: e.backtrackCoverage.length }), e.backtrackCoverage.forEach(function(i, s) {
      n.push({ name: "backtrackCoverage" + s, type: "TABLE", value: new I.Coverage(i) });
    }), n.push({ name: "inputGlyphCount", type: "USHORT", value: e.inputCoverage.length }), e.inputCoverage.forEach(function(i, s) {
      n.push({ name: "inputCoverage" + s, type: "TABLE", value: new I.Coverage(i) });
    }), n.push({ name: "lookaheadGlyphCount", type: "USHORT", value: e.lookaheadCoverage.length }), e.lookaheadCoverage.forEach(function(i, s) {
      n.push({ name: "lookaheadCoverage" + s, type: "TABLE", value: new I.Coverage(i) });
    }), n.push({ name: "substitutionCount", type: "USHORT", value: e.lookupRecords.length }), e.lookupRecords.forEach(function(i, s) {
    ...
    var a = new I.Table("chainContextTable", n);
    return a;
  }
...
function Wo(t) {
  return new I.Table("GSUB", [
    ...
    { name: "scripts", type: "TABLE", value: new I.ScriptList(t.scripts) },
    { name: "features", type: "TABLE", value: new I.FeatureList(t.features) },
    { name: "lookups", type: "TABLE", value: new I.LookupList(t.lookups, vt) }
  ]);
}
var Ai = { parse: Ho, make: Wo };
function zo(t, e) {
  var r = new _.Parser(t, e), n = r.parseULong();
  P.argument(n === 1, "Unsupported META table version."), r.parseULong(), r.parseULong();
  for (var a = r.parseULong(), i = {}, s = 0; s < a; s++) {
    var o = r.parseTag(), c = r.parseULong(), u = r.parseULong(), h = dt.UTF8(t, e + c, u);
    i[o] = h;
  }
  return i;
}
function Vo(t) {
  var e = Object.keys(t).length, r = "", n = 16 + e * 12, a = new I.Table("meta", [
    { name: "version", type: "ULONG", value: 1 },
    { name: "flags", type: "ULONG", value: 0 },
  ...
  for (var i in t) {
    var s = r.length;
    r += t[i], a.fields.push({ name: "tag " + i, type: "TAG", value: i }), a.fields.push({ name: "offset " + i, type: "ULONG", value: n + s }), a.fields.push({ name: "length " + i, type: "ULONG", value: t[i].length });
  }
  return a.fields.push({ name: "stringPool", type: "CHARARRAY", value: r }), a;
}
var Bi = { parse: zo, make: Vo };
function Xn(t) {
...
function Ui(t) {
  ...
  var r = Math.pow(2, Xn(e.numTables));
  e.searchRange = 16 * r, e.entrySelector = Xn(r), e.rangeShift = e.numTables * 16 - e.searchRange;
  for (var n = [], a = [], i = e.sizeOf() + Yn().sizeOf() * e.numTables; i % 4 !== 0; )
    i += 1, a.push({ name: "padding", type: "BYTE", value: 0 });
  for (var s = 0; s < t.length; s += 1) {
    var o = t[s];
    P.argument(o.tableName.length === 4, "Table name" + o.tableName + " is invalid.");
    var c = o.sizeOf(), u = Yn(o.tableName, on(o.encode()), i, c);
...
function Xo(t) {
  for (var e = [], r = [], n = [], a = [], i = [], s = [], o = [], c, u = 0, h = 0, d = 0, l = 0, g = 0, x = 0; x < t.glyphs.length; x += 1) {
    var v = t.glyphs.get(x), F = v.unicode | 0;
    if (isNaN(v.advanceWidth))
      throw new Error("Glyph " + v.name + " (" + x + "): advanceWidth is not a number.");
    (c > F || c === void 0) && F > 0 && (c = F), u < F && (u = F);
    var y = Kr.getUnicodeRange(F);
    if (y < 32)
      h |= 1 << y;
    else if (y < 64)
      d |= 1 << y - 32;
    ...
    if (v.name !== ".notdef") {
      var b = v.getMetrics();
      e.push(b.xMin), r.push(b.yMin), n.push(b.xMax), a.push(b.yMax), s.push(b.leftSideBearing), o.push(b.rightSideBearing), i.push(v.advanceWidth);
    }
  }
  var w = {
    xMin: Math.min.apply(null, e),
  ...
  w.ascender = t.ascender, w.descender = t.descender;
  var k = mi.make({
    flags: 3,
    ...
    sTypoAscender: w.ascender,
    sTypoDescender: w.descender,
    sTypoLineGap: 0,
    usWinAscent: w.yMax,
    usWinDescent: Math.abs(w.yMin),
    ulCodePageRange1: 1,
    // FIXME: hard-code Latin 1 support for now
    sxHeight: jn(t, "xyvw", { yMax: Math.round(w.ascender / 2) }).yMax,
    sCapHeight: jn(t, "HIKLEFJMNTZBDPRAGOQSUVWXY", w).yMax,
    usDefaultChar: t.hasChar(" ") ? 32 : 0,
    // Use space as the default character, if available.
    usBreakChar: t.hasChar(" ") ? 32 : 0
    // Use space as the break character, if available.
  }, t.tables.os2)), O = bi.make(t.glyphs), H = si.make(t.glyphs), z = t.getEnglishName("fontFamily"), W = t.getEnglishName("fontSubfamily"), le = z + " " + W, ce = t.getEnglishName("postScriptName");
  ce || (ce = z.replace(/\s/g, "") + "-" + W);
  var $ = {};
  for (var K in t.names)
    $[K] = t.names[K];
  $.uniqueID || ($.uniqueID = { en: t.getEnglishName("manufacturer") + ":" + le }), $.postScriptName || ($.postScriptName = { en: ce }), $.preferredFamily || ($.preferredFamily = t.names.fontFamily), $.preferredSubfamily || ($.preferredSubfamily = t.names.fontSubfamily);
  var J = [], ae = Ei.make($, J), ue = J.length > 0 ? Si.make(J) : void 0, oe = Li.make(), fe = yi.make(t.glyphs, {
  ...
  }), G = t.metas && Object.keys(t.metas).length > 0 ? Bi.make(t.metas) : void 0, q = [k, C, U, B, ae, H, oe, fe, O];
  ue && q.push(ue), t.tables.gsub && q.push(Ai.make(t.tables.gsub)), G && q.push(G);
  for (var ct = Ui(q), Dt = ct.encode(), _t = on(Dt), mt = ct.fields, Pt = !1, We = 0; We < mt.length; We += 1)
    if (mt[We].name === "head table") {
      mt[We].value.checkSumAdjustment = 2981146554 - _t, Pt = !0;
      break;
    }
  if (!Pt)
...
var Yo = { make: Ui, fontToTable: Xo, computeCheckSum: on };
function xr(t, e) {
...
Bt.prototype = {
  ...
  getDefaultScriptName: function() {
    var t = this.getTable();
    if (t) {
      for (var e = !1, r = 0; r < t.scripts.length; r++) {
  ...
  getScriptTable: function(t, e) {
    ...
    if (r) {
      t = t || "DFLT";
      var n = r.scripts, a = xr(r.scripts, t);
      if (a >= 0)
        return n[a].script;
      if (e) {
        var i = {
  ...
  getFeatureTable: function(t, e, r, n) {
    var a = this.getLangSysTable(t, e, n);
    if (a) {
      for (var i, s = a.featureIndexes, o = this.font.tables[this.tableName].features, c = 0; c < s.length; c++)
        if (i = o[s[c]], i.tag === r)
          return i.feature;
      if (n) {
        var u = o.length;
   ...
   * @return {Object[]}
   */
  getLookupTables: function(t, e, r, n, a) {
    var i = this.getFeatureTable(t, e, r, a), s = [];
    if (i) {
      for (var o, c = i.lookupListIndexes, u = this.font.tables[this.tableName].lookups, h = 0; h < c.length; h++)
        o = u[c[h]], o.lookupType === n && s.push(o);
      if (s.length === 0 && a) {
        o = {
          lookupType: n,
          lookupFlag: 0,
  ...
  expandCoverage: function(t) {
    ...
    for (var e = [], r = t.ranges, n = 0; n < r.length; n++)
      for (var a = r[n], i = a.start, s = a.end, o = i; o <= s; o++)
        e.push(o);
    return e;
  }
};
...
Ut.prototype.getKerningValue = function(t, e, r) {
  for (var n = 0; n < t.length; n++)
    for (var a = t[n].subtables, i = 0; i < a.length; i++) {
      var s = a[i], o = this.getCoverageIndex(s.coverage, e);
      if (!(o < 0))
        switch (s.posFormat) {
          case 1:
            for (var c = s.pairSets[o], u = 0; u < c.length; u++) {
              var h = c[u];
              if (h.secondGlyph === r)
            ...
            break;
          case 2:
            var d = this.getGlyphClass(s.classDef1, e), l = this.getGlyphClass(s.classDef2, r), g = s.classRecords[d][l];
            return g.value1 && g.value1.xAdvance || 0;
        }
    }
  return 0;
};
Ut.prototype.getKerningTables = function(t, e) {
...
me.prototype.getSingle = function(t, e, r) {
  for (var n = [], a = this.getLookupTables(e, r, t, 1), i = 0; i < a.length; i++)
    for (var s = a[i].subtables, o = 0; o < s.length; o++) {
      ...
      if (c.substFormat === 1) {
        ...
        var g = c.substitute;
        for (h = 0; h < u.length; h++)
          n.push({ sub: u[h], by: g[h] });
      }
    }
  return n;
};
me.prototype.getMultiple = function(t, e, r) {
  for (var n = [], a = this.getLookupTables(e, r, t, 2), i = 0; i < a.length; i++)
    for (var s = a[i].subtables, o = 0; o < s.length; o++) {
      var c = s[o], u = this.expandCoverage(c.coverage), h = void 0;
      for (h = 0; h < u.length; h++) {
  ...
  for (var n = [], a = this.getLookupTables(e, r, t, 4), i = 0; i < a.length; i++)
    for (var s = a[i].subtables, o = 0; o < s.length; o++)
      for (var c = s[o], u = this.expandCoverage(c.coverage), h = c.ligatureSets, d = 0; d < u.length; d++)
        for (var l = u[d], g = h[d], x = 0; x < g.length; x++) {
          var v = g[x];
          n.push({
...
me.prototype.addSingle = function(t, e, r, n) {
  var a = this.getLookupTables(r, n, t, 1, !0)[0], i = cn(a, 2, {
...
me.prototype.addAlternate = function(t, e, r, n) {
  var a = this.getLookupTables(r, n, t, 3, !0)[0], i = cn(a, 1, {
...
me.prototype.addLigature = function(t, e, r, n) {
  var a = this.getLookupTables(r, n, t, 4, !0)[0], i = a.subtables[0];
  i || (i = {
  ...
  if (u >= 0) {
    for (var h = i.ligatureSets[u], d = 0; d < h.length; d++)
      if (jo(h[d].components, o))
        return;
    h.push(c);
  } else
    u = -1 - u, i.coverage.glyphs.splice(u, 0, s), i.ligatureSets.splice(u, 0, [c]);
};
me.prototype.getFeature = function(t, e, r) {
  if (/ss\d\d/.test(t))
...
me.prototype.add = function(t, e, r, n) {
  if (/ss\d\d/.test(t))
...
function Oi(t, e, r) {
  ...
  if (t.numberOfContours > 0) {
    for (var s = t.endPointIndices = [], o = 0; o < t.numberOfContours; o += 1)
      s.push(n.parseUShort());
    t.instructionLength = n.parseUShort(), t.instructions = [];
    for (var c = 0; c < t.instructionLength; c += 1)
      t.instructions.push(n.parseByte());
    var u = s[s.length - 1] + 1;
    a = [];
    for (var h = 0; h < u; h += 1)
    ...
    if (P.argument(a.length === u, "Bad flags."), s.length > 0) {
      ...
      if (u > 0) {
        ...
        for (var F = 0, y = 0; y < u; y += 1)
          i = a[y], x = g[y], x.x = Kn(n, i, F, 2, 16), F = x.x;
        for (var b = 0, w = 0; w < u; w += 1)
          i = a[w], x = g[w], x.y = Kn(n, i, b, 4, 32), b = x.y;
      }
      t.points = g;
    } else
      t.points = [];
    ...
    if (a & 256) {
      t.instructionLength = n.parseUShort(), t.instructions = [];
      for (var U = 0; U < t.instructionLength; U += 1)
        t.instructions.push(n.parseByte());
    }
  }
}
function br(t, e) {
  for (var r = [], n = 0; n < t.length; n += 1) {
    var a = t[n], i = {
      ...
      y: e.scale10 * a.x + e.yScale * a.y + e.dy,
      onCurve: a.onCurve,
...
function Ri(t) {
  ...
  for (var r = Ko(t), n = 0; n < r.length; ++n) {
    ...
    if (s.onCurve)
      ...
      var c = { x: (s.x + o.x) * 0.5, y: (s.y + o.y) * 0.5 };
      e.moveTo(c.x, c.y);
    }
    for (var u = 0; u < a.length; ++u)
      if (i = s, s = o, o = a[(u + 1) % a.length], s.onCurve)
        e.lineTo(s.x, s.y);
      else {
        var h = o;
        i.onCurve || ((s.x + i.x) * 0.5, (s.y + i.y) * 0.5), o.onCurve || (h = { x: (s.x + o.x) * 0.5, y: (s.y + o.y) * 0.5 }), e.quadraticCurveTo(s.x, s.y, h.x, h.y);
      }
    e.closePath();
  }
  return e;
    ...
    for (var r = 0; r < e.components.length; r += 1) {
      ...
      if (a.getPath(), a.points) {
        ...
        if (n.matchedPoints === void 0)
          ...
          var s = e.points[n.matchedPoints[0]], o = a.points[n.matchedPoints[1]], c = {
            xScale: n.xScale,
            scale01: n.scale01,
            scale10: n.scale10,
            yScale: n.yScale,
          ...
          o = br([o], c)[0], c.dx = s.x - o.x, c.dy = s.y - o.y, i = br(a.points, c);
        }
...
function Jo(t, e, r, n) {
  for (var a = new De.GlyphSet(n), i = 0; i < r.length - 1; i += 1) {
    var s = r[i], o = r[i + 1];
    s !== o ? a.push(i, De.ttfGlyphLoader(n, i, Oi, t, e + s, Mi)) : a.push(i, De.glyphLoader(n, i));
  }
  return a;
}
function Qo(t, e, r, n) {
...
function ec(t, e, r, n, a) {
  return a.lowMemory ? Qo(t, e, r, n) : Jo(t, e, r, n);
}
var Ii = { getPath: Ri, parse: ec }, Di, st, _i, Jr;
function Pi(t) {
  this.font = t, this.getCommands = function(e) {
    return Ii.getPath(e).commands;
...
var Gi = function(t) {
  ...
  interpolate: function(t, e, r, n) {
    var a, i, s, o, c, u, h;
    if (!n || n === this) {
      if (a = t.xo - e.xo, i = t.xo - r.xo, c = e.x - e.xo, u = r.x - r.xo, s = Math.abs(a), o = Math.abs(i), h = s + o, h === 0) {
        t.x = t.xo + (c + u) / 2;
        return;
      }
      t.x = t.xo + (c * o + u * s) / h;
    ...
    if (a = n.distance(t, e, !0, !0), i = n.distance(t, r, !0, !0), c = n.distance(e, e, !1, !0), u = n.distance(r, r, !1, !0), s = Math.abs(a), o = Math.abs(i), h = s + o, h === 0) {
      Me.setRelative(t, t, (c + u) / 2, n, !0);
      return;
    }
    Me.setRelative(t, t, (c * o + u * s) / h, n, !0);
  },
  ...
  setRelative: function(t, e, r, n, a) {
    if (!n || n === this) {
      t.x = (a ? e.xo : e.x) + r;
      return;
    }
    var i = a ? e.xo : e.x, s = a ? e.yo : e.y, o = i + r * n.x, c = s + r * n.y;
    t.x = o + (t.y - c) / n.normalSlope;
  },
  ...
  interpolate: function(t, e, r, n) {
    var a, i, s, o, c, u, h;
    if (!n || n === this) {
      if (a = t.yo - e.yo, i = t.yo - r.yo, c = e.y - e.yo, u = r.y - r.yo, s = Math.abs(a), o = Math.abs(i), h = s + o, h === 0) {
        t.y = t.yo + (c + u) / 2;
        return;
      }
      t.y = t.yo + (c * o + u * s) / h;
    ...
    if (a = n.distance(t, e, !0, !0), i = n.distance(t, r, !0, !0), c = n.distance(e, e, !1, !0), u = n.distance(r, r, !1, !0), s = Math.abs(a), o = Math.abs(i), h = s + o, h === 0) {
      Ge.setRelative(t, t, (c + u) / 2, n, !0);
      return;
    }
    Ge.setRelative(t, t, (c * o + u * s) / h, n, !0);
  },
  // Slope of line normal to this.
  normalSlope: 0,
  // Sets the point 'p' relative to point 'rp'
...
Ot.prototype.distance = function(t, e, r, n) {
  return this.x * Me.distance(t, e, r, n) + this.y * Ge.distance(t, e, r, n);
};
Ot.prototype.interpolate = function(t, e, r, n) {
  var a, i, s, o, c, u, h;
...
Ot.prototype.setRelative = function(t, e, r, n, a) {
  n = n || this;
...
Ot.prototype.touch = function(t) {
  t.xTouched = !0, t.yTouched = !0;
};
function Rt(t, e) {
  var r = Math.sqrt(t * t + e * e);
  return t /= r, e /= r, t === 1 && e === 0 ? Me : t === 0 && e === 1 ? Ge : new Ot(t, e);
}
function He(t, e, r, n) {
...
function je(t, e) {
  switch (this.env = t, this.stack = [], this.prog = e, t) {
    ...
    case "prep":
      this.fv = this.pv = this.dpv = Me, this.round = Ni;
  }
}
Pi.prototype.exec = function(t, e) {
  if (typeof e != "number")
  ...
  if (!(this._errorState > 2)) {
    ...
    if (!n || n.ppem !== e) {
      ...
      if (!a) {
        je.prototype = sc, a = this._fpgmState = new je("fpgm", r.tables.fpgm), a.funcs = [], a.font = r, exports.DEBUG && (console.log("---EXEC FPGM---"), a.step = -1);
        try {
          st(a);
        } catch (u) {
      ...
      je.prototype = a, n = this._prepState = new je("prep", r.tables.prep), n.ppem = e;
      var i = r.tables.cvt;
      if (i)
...
_i = function(t, e) {
  ...
  if (je.prototype = e, !a)
    o = new je("glyf", t.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), o.step = -1), Jr(t, o, r, n), s = o.gZone;
  else {
    var c = e.font;
    s = [], i = [];
    for (var u = 0; u < a.length; u++) {
      var h = a[u], d = c.glyphs.get(h.glyphIndex);
      o = new je("glyf", d.instructions), exports.DEBUG && (console.log("---EXEC COMP " + u + "---"), o.step = -1), Jr(d, o, r, n);
      for (var l = Math.round(h.dx * r), g = Math.round(h.dy * n), x = o.gZone, v = o.contours, F = 0; F < x.length; F++) {
        var y = x[F];
        y.xTouched = y.yTouched = !1, y.xo = y.x = y.x + l, y.yo = y.y = y.y + g;
      }
      var b = s.length;
      s.push.apply(s, x);
    ...
    t.instructions && !o.inhibitGridFit && (o = new je("glyf", t.instructions), o.gZone = o.z0 = o.z1 = o.z2 = s, o.contours = i, s.push(
      new He(0, 0),
      new He(Math.round(t.advanceWidth * r), 0)
    ), exports.DEBUG && (console.log("---EXEC COMPOSITE---"), o.step = -1), st(o), s.length -= 2);
  }
  return s;
};
Jr = function(t, e, r, n) {
  ...
  if (!e.inhibitGridFit) {
    if (exports.DEBUG) {
      ...
      for (var g = 0; g < i; g++)
        console.log(g, s[g].x, s[g].y);
    }
    if (s.push(
      new He(0, 0),
      new He(Math.round(t.advanceWidth * r), 0)
    ), st(e), s.length -= 2, exports.DEBUG) {
...
st = function(t) {
  ...
  if (e) {
    ...
    for (t.ip = 0; t.ip < r; t.ip++) {
      if (exports.DEBUG && t.step++, n = Di[e[t.ip]], !n)
        throw new Error(
...
function ta(t, e) {
  ...
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.pv = e.dpv = Rt(o, c);
}
function ra(t, e) {
  var r = e.stack, n = r.pop(), a = r.pop(), i = e.z2[n], s = e.z1[a];
  exports.DEBUG && console.log("SFVTL[" + t + "]", n, a);
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.fv = Rt(o, c);
}
function oc(t) {
  var e = t.stack, r = e.pop(), n = e.pop();
  exports.DEBUG && console.log(t.step, "SPVFS[]", r, n), t.pv = t.dpv = Rt(n, r);
}
function cc(t) {
  var e = t.stack, r = e.pop(), n = e.pop();
  exports.DEBUG && console.log(t.step, "SPVFS[]", r, n), t.fv = Rt(n, r);
}
function uc(t) {
...
function fc(t) {
  var e = t.stack, r = e.pop(), n = e.pop(), a = e.pop(), i = e.pop(), s = e.pop(), o = t.z0, c = t.z1, u = o[r], h = o[n], d = c[a], l = c[i], g = t.z2[s];
  exports.DEBUG && console.log("ISECT[], ", r, n, a, i, s);
  var x = u.x, v = u.y, F = h.x, y = h.y, b = d.x, w = d.y, k = l.x, C = l.y, U = (x - F) * (w - C) - (v - y) * (b - k), B = x * y - v * F, O = b * C - w * k;
  g.x = (B * (b - k) - O * (x - F)) / U, g.y = (B * (w - C) - O * (v - y)) / U;
}
function pc(t) {
...
function xc(t) {
  ...
  switch (exports.DEBUG && console.log(t.step, "SZPS[]", e), t.zp0 = t.zp1 = t.zp2 = e, e) {
    case 0:
      t.tZone || ur(t), t.z0 = t.z1 = t.z2 = t.tZone;
      break;
    case 1:
...
function Sc(t) {
  exports.DEBUG && console.log(t.step, "RTG[]"), t.round = Ni;
}
function wc(t) {
  exports.DEBUG && console.log(t.step, "RTHG[]"), t.round = nc;
}
function Fc(t) {
  var e = t.stack.pop();
...
function kc(t) {
  exports.DEBUG && console.log(t.step, "ELSE[]"), Hi(t, !1);
}
function Tc(t) {
  var e = t.stack.pop();
...
function Uc(t) {
  ...
  t.prog = t.funcs[r];
  for (var s = 0; s < n; s++)
    st(t), exports.DEBUG && console.log(
      ++t.step,
...
function Oc(t) {
  ...
  var r = t.ip, n = t.prog;
  t.prog = t.funcs[e], st(t), t.ip = r, t.prog = n, exports.DEBUG && console.log(++t.step, "returning from", e);
}
function Rc(t) {
...
function Ic(t) {
  ...
  for (exports.DEBUG && console.log(t.step, "FDEF[]", a); r[++n] !== 45; )
    ;
  t.ip = n, t.funcs[a] = r.slice(i + 1, n);
}
function na(t, e) {
  var r = e.stack.pop(), n = e.z0[r], a = e.fv, i = e.pv;
  exports.DEBUG && console.log(e.step, "MDAP[" + t + "]", r);
  var s = i.distance(n, Lt);
  t && (s = e.round(s)), a.setRelative(n, Lt, s, i), a.touch(n), e.rp0 = e.rp1 = r;
}
function aa(t, e) {
  var r = e.z2, n = r.length - 2, a, i, s;
  exports.DEBUG && console.log(e.step, "IUP[" + t.axis + "]");
  for (var o = 0; o < n; o++)
    a = r[o], !t.touched(a) && (i = a.prevTouched(t), i !== a && (s = a.nextTouched(t), i === s && t.setRelative(a, a, t.distance(i, i, !1, !0), t, !0), t.interpolate(a, i, s, t)));
}
function ia(t, e) {
...
function sa(t, e) {
  var r = e.stack, n = t ? e.rp1 : e.rp2, a = (t ? e.z0 : e.z1)[n], i = e.fv, s = e.pv, o = r.pop(), c = e.z2[e.contours[o]], u = c;
  exports.DEBUG && console.log(e.step, "SHC[" + t + "]", o);
  var h = s.distance(a, a, !1, !0);
  do
    u !== a && i.setRelative(u, u, h, s), u = u.nextPointOnContour;
  while (u !== c);
}
function oa(t, e) {
  var r = e.stack, n = t ? e.rp1 : e.rp2, a = (t ? e.z0 : e.z1)[n], i = e.fv, s = e.pv, o = r.pop();
...
function Pc(t) {
  for (var e = t.stack, r = t.rp0, n = t.z0[r], a = t.loop, i = t.fv, s = t.pv, o = t.z1; a--; ) {
    ...
    exports.DEBUG && console.log(
      t.step,
      (t.loop > 1 ? "loop " + (t.loop - a) + ": " : "") + "ALIGNRP[]",
      c
    ), i.setRelative(u, n, 0, s), i.touch(u);
  }
  t.loop = 1;
}
function Nc(t) {
  exports.DEBUG && console.log(t.step, "RTDG[]"), t.round = rc;
}
function ua(t, e) {
  ...
  var u = o.distance(i, Lt);
  t && (Math.abs(u - c) < e.cvCutIn && (u = c), u = e.round(u)), s.setRelative(i, Lt, u, o), e.zp0 === 0 && (i.xo = i.x, i.yo = i.y), s.touch(i), e.rp0 = e.rp1 = a;
}
function Gc(t) {
...
function ha(t, e) {
  ...
  exports.DEBUG && console.log(e.step, "GC[" + t + "]", n), r.push(e.dpv.distance(a, Lt, t, !1) * 64);
}
function la(t, e) {
...
function ru(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "IF[]", e), e || (Hi(t, !0), exports.DEBUG && console.log(t.step, "EIF[]"));
}
function nu(t) {
...
function wr(t, e) {
  ...
  for (var h = 0; h < n; h++) {
    var d = r.pop(), l = r.pop(), g = o + ((l & 240) >> 4);
    if (g === s) {
      var x = (l & 15) - 8;
...
function Fr(t, e) {
  var r = e.stack, n = r.pop(), a = e.ppem, i = e.deltaBase + (t - 1) * 16, s = e.deltaShift;
...
function mu(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "SROUND[]", e), t.round = Gi;
  var r;
  switch (e & 192) {
    case 0:
      r = 0.5;
...
function xu(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "S45ROUND[]", e), t.round = Gi;
  var r;
  switch (e & 192) {
    case 0:
      r = Math.sqrt(2) / 2;
...
function bu(t) {
  exports.DEBUG && console.log(t.step, "ROFF[]"), t.round = tc;
}
function Su(t) {
  exports.DEBUG && console.log(t.step, "RUTG[]"), t.round = ac;
}
function wu(t) {
  exports.DEBUG && console.log(t.step, "RDTG[]"), t.round = ic;
}
function Fu(t) {
  var e = t.stack.pop();
...
function fa(t, e) {
  ...
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.dpv = Rt(o, c);
}
function ku(t) {
...
function D(t, e, r, n, a, i) {
  var s = i.stack, o = t && s.pop(), c = s.pop(), u = i.rp0, h = i.z0[u], d = i.z1[c], l = i.minDis, g = i.fv, x = i.dpv, v, F, y, b;
  F = v = x.distance(d, h, !0, !0), y = F >= 0 ? 1 : -1, F = Math.abs(F), t && (b = i.cvt[o], n && Math.abs(F - b) < i.cvCutIn && (F = b)), r && F < l && (F = l), n && (F = i.round(F)), g.setRelative(d, h, y * F, x), g.touch(d), exports.DEBUG && console.log(
    i.step,
...
Di = [
  ...
  Ve.bind(void 0, 8),
  /* 0xC0 */
  D.bind(void 0, 0, 0, 0, 0, 0),
  /* 0xC1 */
  D.bind(void 0, 0, 0, 0, 0, 1),
  /* 0xC2 */
  D.bind(void 0, 0, 0, 0, 0, 2),
  /* 0xC3 */
  D.bind(void 0, 0, 0, 0, 0, 3),
  /* 0xC4 */
  D.bind(void 0, 0, 0, 0, 1, 0),
  /* 0xC5 */
  D.bind(void 0, 0, 0, 0, 1, 1),
  /* 0xC6 */
  D.bind(void 0, 0, 0, 0, 1, 2),
  /* 0xC7 */
  D.bind(void 0, 0, 0, 0, 1, 3),
  /* 0xC8 */
  D.bind(void 0, 0, 0, 1, 0, 0),
  /* 0xC9 */
  D.bind(void 0, 0, 0, 1, 0, 1),
  /* 0xCA */
  D.bind(void 0, 0, 0, 1, 0, 2),
  /* 0xCB */
  D.bind(void 0, 0, 0, 1, 0, 3),
  /* 0xCC */
  D.bind(void 0, 0, 0, 1, 1, 0),
  /* 0xCD */
  D.bind(void 0, 0, 0, 1, 1, 1),
  /* 0xCE */
  D.bind(void 0, 0, 0, 1, 1, 2),
  /* 0xCF */
  D.bind(void 0, 0, 0, 1, 1, 3),
  /* 0xD0 */
  D.bind(void 0, 0, 1, 0, 0, 0),
  /* 0xD1 */
  D.bind(void 0, 0, 1, 0, 0, 1),
  /* 0xD2 */
  D.bind(void 0, 0, 1, 0, 0, 2),
  /* 0xD3 */
  D.bind(void 0, 0, 1, 0, 0, 3),
  /* 0xD4 */
  D.bind(void 0, 0, 1, 0, 1, 0),
  /* 0xD5 */
  D.bind(void 0, 0, 1, 0, 1, 1),
  /* 0xD6 */
  D.bind(void 0, 0, 1, 0, 1, 2),
  /* 0xD7 */
  D.bind(void 0, 0, 1, 0, 1, 3),
  /* 0xD8 */
  D.bind(void 0, 0, 1, 1, 0, 0),
  /* 0xD9 */
  D.bind(void 0, 0, 1, 1, 0, 1),
  /* 0xDA */
  D.bind(void 0, 0, 1, 1, 0, 2),
  /* 0xDB */
  D.bind(void 0, 0, 1, 1, 0, 3),
  /* 0xDC */
  D.bind(void 0, 0, 1, 1, 1, 0),
  /* 0xDD */
  D.bind(void 0, 0, 1, 1, 1, 1),
  /* 0xDE */
  D.bind(void 0, 0, 1, 1, 1, 2),
  /* 0xDF */
  D.bind(void 0, 0, 1, 1, 1, 3),
  /* 0xE0 */
  D.bind(void 0, 1, 0, 0, 0, 0),
  /* 0xE1 */
  D.bind(void 0, 1, 0, 0, 0, 1),
  /* 0xE2 */
  D.bind(void 0, 1, 0, 0, 0, 2),
  /* 0xE3 */
  D.bind(void 0, 1, 0, 0, 0, 3),
  /* 0xE4 */
  D.bind(void 0, 1, 0, 0, 1, 0),
  /* 0xE5 */
  D.bind(void 0, 1, 0, 0, 1, 1),
  /* 0xE6 */
  D.bind(void 0, 1, 0, 0, 1, 2),
  /* 0xE7 */
  D.bind(void 0, 1, 0, 0, 1, 3),
  /* 0xE8 */
  D.bind(void 0, 1, 0, 1, 0, 0),
  /* 0xE9 */
  D.bind(void 0, 1, 0, 1, 0, 1),
  /* 0xEA */
  D.bind(void 0, 1, 0, 1, 0, 2),
  /* 0xEB */
  D.bind(void 0, 1, 0, 1, 0, 3),
  /* 0xEC */
  D.bind(void 0, 1, 0, 1, 1, 0),
  /* 0xED */
  D.bind(void 0, 1, 0, 1, 1, 1),
  /* 0xEE */
  D.bind(void 0, 1, 0, 1, 1, 2),
  /* 0xEF */
  D.bind(void 0, 1, 0, 1, 1, 3),
  /* 0xF0 */
  D.bind(void 0, 1, 1, 0, 0, 0),
  /* 0xF1 */
  D.bind(void 0, 1, 1, 0, 0, 1),
  /* 0xF2 */
  D.bind(void 0, 1, 1, 0, 0, 2),
  /* 0xF3 */
  D.bind(void 0, 1, 1, 0, 0, 3),
  /* 0xF4 */
  D.bind(void 0, 1, 1, 0, 1, 0),
  /* 0xF5 */
  D.bind(void 0, 1, 1, 0, 1, 1),
  /* 0xF6 */
  D.bind(void 0, 1, 1, 0, 1, 2),
  /* 0xF7 */
  D.bind(void 0, 1, 1, 0, 1, 3),
  /* 0xF8 */
  D.bind(void 0, 1, 1, 1, 0, 0),
  /* 0xF9 */
  D.bind(void 0, 1, 1, 1, 0, 1),
  /* 0xFA */
  D.bind(void 0, 1, 1, 1, 0, 2),
  /* 0xFB */
  D.bind(void 0, 1, 1, 1, 0, 3),
  /* 0xFC */
  D.bind(void 0, 1, 1, 1, 1, 0),
  /* 0xFD */
  D.bind(void 0, 1, 1, 1, 1, 1),
  /* 0xFE */
  D.bind(void 0, 1, 1, 1, 1, 2),
  /* 0xFF */
  D.bind(void 0, 1, 1, 1, 1, 3)
];
function yt(t) {
...
function Uu(t) {
  ...
  r.forEach(function(a) {
    ...
    var i = t[a];
    typeof i == "function" && e.events[a].subscribe(i);
  });
  var n = [
    "insertToken",
    "removeToken",
  ...
  n.forEach(function(a) {
    e.events[a].subscribe(
      e.updateContextsRanges
    );
  });
}
function ne(t) {
  this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], Uu.call(this, t);
}
yt.prototype.setState = function(t, e) {
  return this.state[t] = e, this.activeState = { key: t, value: this.state[t] }, this.activeState;
};
yt.prototype.getState = function(t) {
  return this.state[t] || null;
};
ne.prototype.inboundIndex = function(t) {
  return t >= 0 && t < this.tokens.length;
};
ne.prototype.composeRUD = function(t) {
  var e = this, r = !0, n = t.map(function(i) {
    return e[i[0]].apply(e, i.slice(1).concat(r));
  }), a = function(i) {
...
ne.prototype.replaceRange = function(t, e, r, n) {
  ...
  if (!isNaN(t) && this.inboundIndex(t) && a) {
    ...
    return n || this.dispatch("replaceToken", [t, e, r]), [i, r];
  } else
    return { FAIL: "replaceRange: invalid tokens or startIndex." };
};
ne.prototype.replaceToken = function(t, e, r) {
  if (!isNaN(t) && this.inboundIndex(t) && e instanceof yt) {
    var n = this.tokens.splice(t, 1, e);
    return r || this.dispatch("replaceToken", [t, e]), [n[0], e];
  } else
    return { FAIL: "replaceToken: invalid token or index." };
};
ne.prototype.removeRange = function(t, e, r) {
  e = isNaN(e) ? this.tokens.length : e;
  var n = this.tokens.splice(t, e);
  return r || this.dispatch("removeRange", [n, t, e]), n;
};
ne.prototype.removeToken = function(t, e) {
  if (!isNaN(t) && this.inboundIndex(t)) {
    var r = this.tokens.splice(t, 1);
    return e || this.dispatch("removeToken", [r, t]), r;
  } else
    return { FAIL: "removeToken: invalid token index." };
};
ne.prototype.insertToken = function(t, e, r) {
  var n = t.every(
    function(a) {
      return a instanceof yt;
    }
  );
  return n ? (this.tokens.splice.apply(
    this.tokens,
    [e, 0].concat(t)
  ), r || this.dispatch("insertToken", [t, e]), t) : { FAIL: "insertToken: invalid token(s)." };
};
ne.prototype.registerModifier = function(t, e, r) {
  this.events.newToken.subscribe(function(n, a) {
    var i = [n, a], s = e === null || e.apply(this, i) === !0, o = [n, a];
    if (s) {
...
Ce.prototype.setCurrentIndex = function(t) {
...
ne.prototype.rangeToText = function(t) {
  if (t instanceof un)
...
ne.prototype.getContext = function(t) {
  var e = this.registeredContexts[t];
  return e || null;
};
ne.prototype.on = function(t, e) {
  var r = this.events[t];
  return r ? r.subscribe(e) : null;
};
ne.prototype.dispatch = function(t, e) {
  var r = this, n = this.events[t];
  n instanceof hr && n.subscribers.forEach(function(a) {
    a.apply(r, e || []);
  });
};
ne.prototype.registerContextChecker = function(t, e, r) {
  ...
  return this.registeredContexts[t] = n, this.contextCheckers.push(n), n;
};
ne.prototype.getRangeTokens = function(t) {
  var e = t.startIndex + t.endOffset;
  return [].concat(
    this.tokens.slice(t.startIndex, e)
  );
};
ne.prototype.getContextRanges = function(t) {
  var e = this.getContext(t);
  return e ? e.ranges : { FAIL: "context checker '" + t + "' is not registered." };
};
ne.prototype.resetContextsRanges = function() {
...
ne.prototype.updateContextsRanges = function() {
...
ne.prototype.setEndOffset = function(t, e) {
  var r = this.getContext(e).openRange.startIndex, n = new un(r, t, e), a = this.getContext(e).ranges;
  return n.rangeId = e + "." + a.length, a.push(n), this.getContext(e).openRange = null, n;
};
ne.prototype.runContextCheck = function(t) {
  var e = this, r = t.index;
  this.contextCheckers.forEach(function(n) {
    var a = n.contextName, i = e.getContext(a).openRange;
    if (!i && n.checkStart(t) && (i = new un(r, null, a), e.getContext(a).openRange = i, e.dispatch("contextStart", [a, r])), i && n.checkEnd(t)) {
      var s = r - i.startIndex + 1, o = e.setEndOffset(s, a);
      e.dispatch("contextEnd", [a, o]);
    }
  });
};
ne.prototype.tokenize = function(t) {
  this.tokens = [], this.resetContextsRanges();
  var e = Array.from(t);
  this.dispatch("start");
  for (var r = 0; r < e.length; r++) {
    var n = e[r], a = new Ce(e, r);
...
function Mt(t, e) {
  ...
  switch (e.format) {
    ...
    case 2:
      for (var r = e.ranges, n = 0; n < r.length; n++) {
        var a = r[n];
...
function Iu(t, e) {
  ...
  if (t.lookahead.length < e.lookaheadCoverage.length)
    return [];
  for (var i = t.lookahead.slice(a); i.length && Je(i[0].char); )
    i.shift();
  var s = new Ce(i, 0), o = kr(
    e.lookaheadCoverage,
    s
  ...
  if (d)
    for (var g = 0; g < e.lookupRecords.length; g++)
      for (var x = e.lookupRecords[g], v = x.lookupListIndex, F = this.getLookupByIndex(v), y = 0; y < F.subtables.length; y++) {
        var b = F.subtables[y], w = this.getLookupMethod(F, b), k = this.getSubstitutionType(F, b);
        if (k === "12")
...
function Du(t, e) {
  var r = t.current, n = Mt(r, e.coverage);
  if (n === -1)
    return null;
  for (var a, i = e.ligatureSets[n], s = 0; s < i.length; s++) {
    a = i[s];
    for (var o = 0; o < a.components.length; o++) {
      var c = t.lookahead[o], u = a.components[o];
      if (c !== u)
        break;
...
xe.prototype.getDefaultScriptFeaturesIndexes = function() {
...
xe.prototype.getScriptFeaturesIndexes = function(t) {
  ...
  for (var r = this.font.tables.gsub.scripts, n = 0; n < r.length; n++) {
    var a = r[n];
    if (a.tag === t && a.script.defaultLangSys)
    ...
    if (i)
      for (var s = 0; s < i.length; s++) {
        ...
        if (o.tag === t) {
          var c = o.langSys;
          return c.featureIndexes;
        }
      }
  }
  return this.getDefaultScriptFeaturesIndexes();
};
xe.prototype.mapTagsToFeatures = function(t, e) {
  for (var r = {}, n = 0; n < t.length; n++) {
    var a = t[n].tag, i = t[n].feature;
    r[a] = i;
  }
  this.features[e].tags = r;
};
xe.prototype.getScriptFeatures = function(t) {
  var e = this.features[t];
  if (this.features.hasOwnProperty(t))
    return e;
...
xe.prototype.getSubstitutionType = function(t, e) {
  var r = t.lookupType.toString(), n = e.substFormat.toString();
  return r + n;
};
xe.prototype.getLookupMethod = function(t, e) {
  var r = this, n = this.getSubstitutionType(t, e);
  switch (n) {
    case "11":
      return function(a) {
        return Ru.apply(
    ...
    default:
      throw new Error(
        "lookupType: " + t.lookupType + " - substFormat: " + e.substFormat + " is not yet supported"
      );
  }
};
xe.prototype.lookupFeature = function(t) {
  var e = t.contextParams, r = e.index, n = this.getFeature({
    tag: t.tag,
    script: t.script
  });
  if (!n)
    return new Error(
      "font '" + this.font.names.fullName.en + "' doesn't support feature '" + t.tag + "' for script '" + t.script + "'."
    );
  for (var a = this.getFeatureLookups(n), i = [].concat(e.context), s = 0; s < a.length; s++)
    for (var o = a[s], c = this.getLookupSubtables(o), u = 0; u < c.length; u++) {
      var h = c[u], d = this.getSubstitutionType(o, h), l = this.getLookupMethod(o, h), g = void 0;
      switch (d) {
        case "11":
          g = l(e.current), g && i.splice(r, 1, new at({
            id: 11,
            tag: t.tag,
            substitution: g
          }));
        ...
        case "12":
          ...
          break;
        case "63":
          g = l(e), Array.isArray(g) && g.length && i.splice(r, 1, new at({
            id: 63,
            tag: t.tag,
            substitution: g
          }));
      ...
      e = new Ce(i, r), !(Array.isArray(g) && !g.length) && (g = null);
    }
  return i.length ? i : null;
};
xe.prototype.supports = function(t) {
  if (!t.script)
    return !1;
  ...
  if (!t.tag)
    return e;
  var r = this.features[t.script].some(function(n) {
    return n.tag === t.tag;
  });
  return e && r;
};
xe.prototype.getLookupSubtables = function(t) {
  return t.subtables || null;
};
xe.prototype.getLookupByIndex = function(t) {
  var e = this.font.tables.gsub.lookups;
  return e[t] || null;
};
xe.prototype.getFeatureLookups = function(t) {
  return t.lookupListIndexes.map(this.getLookupByIndex.bind(this));
};
xe.prototype.getFeature = function(e) {
  if (!this.font)
...
function Pu(t) {
  ...
  return (
    // ? arabic first char
    r === null && Ke(e) || // ? arabic char preceded with a non arabic char
    !Ke(r) && Ke(e)
  );
}
function Nu(t) {
...
function hn(t, e, r) {
  t instanceof at && pa[t.id] && pa[t.id](t, e, r);
}
function ju(t) {
  for (var e = [].concat(t.backtrack), r = e.length - 1; r >= 0; r--) {
    var n = e[r], a = Wi(n), i = Je(n);
    if (!a && !i)
      return !0;
    if (a)
      return !1;
    ...
    a.forEach(function(o, c) {
      if (!Je(o.char)) {
        ...
        if (n.indexOf(h) !== -1) {
          ...
          d.forEach(function(l, g) {
            l instanceof at && (hn(l, a, g), i.context[g] = l.substitution);
          });
        }
      }
    });
...
function Ku(t) {
  var e = this, r = "arab", n = this.tokenizer.getRangeTokens(t), a = da(n);
...
function Ju(t) {
  ...
  return (
    // ? latin first char
    r === null && Kt(e) || // ? latin char preceded with a non latin char
    !Kt(r) && Kt(e)
  );
}
function Qu(t) {
...
function th(t) {
  var e = this, r = "latn", n = this.tokenizer.getRangeTokens(t), a = ga(n);
  a.context.forEach(function(i, s) {
    a.setCurrentIndex(s);
    var o = e.query.lookupFeature({
      tag: "liga",
...
function Ae(t) {
  this.baseDir = t || "ltr", this.tokenizer = new ne(), this.featuresTags = {};
}
Ae.prototype.setText = function(t) {
  this.text = t;
};
Ae.prototype.contextChecks = {
  latinWordCheck: eh,
  arabicWordCheck: Gu,
  arabicSentenceCheck: zu
};
function Tr(t) {
...
function rh() {
  return Tr.call(this, "latinWord"), Tr.call(this, "arabicWord"), Tr.call(this, "arabicSentence"), this.tokenizer.tokenize(this.text);
}
function nh() {
  var t = this, e = this.tokenizer.getContextRanges("arabicSentence");
  e.forEach(function(r) {
    var n = t.tokenizer.getRangeTokens(r);
    t.tokenizer.replaceRange(
      r.startIndex,
      r.endOffset,
      n.reverse()
    );
...
Ae.prototype.registerFeatures = function(t, e) {
...
Ae.prototype.applyFeatures = function(t, e) {
  if (!t)
    throw new Error(
      "No valid font was provided to apply features"
    );
  this.query || (this.query = new xe(t));
  for (var r = 0; r < e.length; r++) {
    var n = e[r];
    this.query.supports({ script: n.script }) && this.registerFeatures(n.script, n.tags);
  }
};
Ae.prototype.registerModifier = function(t, e, r) {
...
Ae.prototype.checkContextReady = function(t) {
  return !!this.tokenizer.getContext(t);
};
Ae.prototype.applyFeaturesToContexts = function() {
  this.checkContextReady("arabicWord") && (ah.call(this), ih.call(this)), this.checkContextReady("latinWord") && sh.call(this), this.checkContextReady("arabicSentence") && nh.call(this);
};
Ae.prototype.processText = function(t) {
  (!this.text || this.text !== t) && (this.setText(t), rh.call(this), this.applyFeaturesToContexts());
};
Ae.prototype.getBidiText = function(t) {
  return this.processText(t), this.tokenizer.getText();
};
Ae.prototype.getTextGlyphs = function(t) {
  this.processText(t);
  for (var e = [], r = 0; r < this.tokenizer.tokens.length; r++) {
    var n = this.tokenizer.tokens[r];
    if (!n.state.deleted) {
      var a = n.activeState.value;
      e.push(Array.isArray(a) ? a[0] : a);
    }
  }
  return e;
};
function j(t) {
  t = t || {}, t.tables = t.tables || {}, t.empty || (xt(t.familyName, "When creating a new Font object, familyName is required."), xt(t.styleName, "When creating a new Font object, styleName is required."), xt(t.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), xt(t.ascender, "When creating a new Font object, ascender is required."), xt(t.descender <= 0, "When creating a new Font object, negative descender value is required."), this.names = {
  ...
  })), this.supported = !0, this.glyphs = new De.GlyphSet(this, t.glyphs || []), this.encoding = new oi(this), this.position = new Ut(this), this.substitution = new me(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
    get: function() {
      if (this._hinting)
        return this._hinting;
      if (this.outlinesFormat === "truetype")
        return this._hinting = new Pi(this);
    }
  });
}
...
j.prototype.stringToGlyphs = function(t, e) {
  ...
  for (var s = n.getTextGlyphs(t), o = s.length, c = new Array(o), u = this.glyphs.get(0), h = 0; h < o; h += 1)
...
j.prototype.download = function(t) {
  ...
  if ($o())
    if (window.URL = window.URL || window.webkitURL, window.URL) {
      ...
      o.initEvent("click", !0, !1), s.dispatchEvent(o);
    } else
      console.warn("Font file could not be downloaded. Try using a different browser.");
  else {
    var c = require("fs"), u = Zo(n);
    c.writeFileSync(t, u);
  }
};
...
function lh(t, e) {
  ...
  for (var n = 0; n < t.axes.length; n++)
    r.fields = r.fields.concat(oh(n, t.axes[n], e));
  for (var a = 0; a < t.instances.length; a++)
    r.fields = r.fields.concat(uh(a, t.instances[a], t.axes, e));
  return r;
}
function fh(t, e, r) {
  ...
  for (var s = n.parseUShort(), o = n.parseUShort(), c = n.parseUShort(), u = n.parseUShort(), h = [], d = 0; d < s; d++)
    h.push(ch(t, e + i + d * o, r));
  for (var l = [], g = e + i + s * o, x = 0; x < c; x++)
    l.push(hh(t, g + x * u, h, r));
  return { axes: h, instances: l };
}
var ph = { make: lh, parse: fh }, dh = function() {
  return {
    coverage: this.parsePointer(E.coverage),
  ...
  return this.parseList(E.pointer(gh));
}, yh = function() {
  return {
    coverage: this.parsePointer(E.coverage),
    ligGlyphs: this.parseList(E.pointer(vh))
  };
}, mh = function() {
...
function xh(t, e) {
  ...
  var a = {
    ...
    attachList: r.parsePointer(dh),
    ligCaretList: r.parsePointer(yh),
    markAttachClassDef: r.parsePointer(E.classDef)
  };
  return n >= 1.2 && (a.markGlyphSets = r.parsePointer(mh)), a;
}
var bh = { parse: xh }, Ee = new Array(10);
Ee[1] = function() {
  var e = this.offset + this.relativeOffset, r = this.parseUShort();
  if (r === 1)
    return {
...
function Fh(t) {
  return new I.Table("GPOS", [
    ...
    { name: "scripts", type: "TABLE", value: new I.ScriptList(t.scripts) },
    { name: "features", type: "TABLE", value: new I.FeatureList(t.features) },
    { name: "lookups", type: "TABLE", value: new I.LookupList(t.lookups, wh) }
  ]);
}
var kh = { parse: Sh, make: Fh };
function Th(t) {
  var e = {};
  t.skip("uShort");
  var r = t.parseUShort();
  ...
  t.skip("uShort", 3);
  for (var a = 0; a < n; a += 1) {
    var i = t.parseUShort(), s = t.parseUShort(), o = t.parseShort();
    e[i + "," + s] = o;
  }
  return e;
}
function Ch(t) {
  ...
  t.skip("uShort");
  var r = t.parseULong();
  r > 1 && console.warn("Only the first kern subtable is supported."), t.skip("uLong");
  var n = t.parseUShort(), a = n & 255;
  if (t.skip("uShort"), a === 0) {
    var i = t.parseUShort();
    t.skip("uShort", 3);
    for (var s = 0; s < i; s += 1) {
      var o = t.parseUShort(), c = t.parseUShort(), u = t.parseShort();
      e[o + "," + c] = u;
    }
  }
  return e;
...
function ie(t, e) {
  if (e.compression === "WOFF") {
    ...
    if (Fs(r, n), n.byteLength !== e.length)
...
function Oh(t, e) {
  ...
  if (c === "\0\0\0" || c === "true" || c === "typ1")
    a.outlinesFormat = "truetype", s = _.getUShort(i, 4), o = va(i, s);
  else if (c === "OTTO")
    a.outlinesFormat = "cff", s = _.getUShort(i, 4), o = va(i, s);
  else if (c === "wOFF") {
    var u = _.getTag(i, 4);
    if (u === "\0\0\0")
    ...
    s = _.getUShort(i, 12), o = Uh(i, s);
  } else
    throw new Error("Unsupported OpenType signature " + c);
  for (var h, d, l, g, x, v, F, y, b, w, k, C, U = 0; U < s; U += 1) {
    var B = o[U], O = void 0;
    switch (B.tag) {
      case "cmap":
        O = ie(i, B), a.tables.cmap = si.parse(O.data, O.offset), a.encoding = new ci(a.tables.cmap);
        break;
      case "cvt ":
      ...
      case "fpgm":
        ...
        break;
      case "head":
        O = ie(i, B), a.tables.head = mi.parse(O.data, O.offset), a.unitsPerEm = a.tables.head.unitsPerEm, r = a.tables.head.indexToLocFormat;
        break;
      case "hhea":
        O = ie(i, B), a.tables.hhea = xi.parse(O.data, O.offset), a.ascender = a.tables.hhea.ascender, a.descender = a.tables.hhea.descender, a.numberOfHMetrics = a.tables.hhea.numberOfHMetrics;
        break;
      case "hmtx":
        F = B;
        break;
      case "ltag":
        O = ie(i, B), n = Si.parse(O.data, O.offset);
        break;
      case "maxp":
        O = ie(i, B), a.tables.maxp = wi.parse(O.data, O.offset), a.numGlyphs = a.tables.maxp.numGlyphs;
        break;
      case "name":
        w = B;
        break;
      case "OS/2":
        O = ie(i, B), a.tables.os2 = Kr.parse(O.data, O.offset);
        break;
      case "post":
        O = ie(i, B), a.tables.post = Li.parse(O.data, O.offset), a.glyphNames = new an(a.tables.post);
        break;
      case "prep":
        O = ie(i, B), C = new _.Parser(O.data, O.offset), a.tables.prep = C.parseByteList(B.length);
        break;
      case "glyf":
        l = B;
        break;
  ...
  var H = ie(i, w);
  if (a.tables.name = Ei.parse(H.data, H.offset, n), a.names = a.tables.name, l && b) {
    var z = r === 0, W = ie(i, b), le = Bh.parse(W.data, W.offset, a.numGlyphs, z), ce = ie(i, l);
    a.glyphs = Ii.parse(ce.data, ce.offset, le, a, e);
  } else if (h) {
    var $ = ie(i, h);
    yi.parse($.data, $.offset, a, e);
  } else
    throw new Error("Font doesn't contain TrueType or CFF outlines.");
  var K = ie(i, F);
  if (bi.parse(a, K.data, K.offset, a.numberOfHMetrics, a.numGlyphs, a.glyphs, e), Vs(a, e), y) {
    var J = ie(i, y);
    a.kerningPairs = Lh.parse(J.data, J.offset);
  } else
    a.kerningPairs = {};
  if (g) {
    var ae = ie(i, g);
    a.tables.gdef = bh.parse(ae.data, ae.offset);
  }
  if (x) {
    var ue = ie(i, x);
    a.tables.gpos = kh.parse(ue.data, ue.offset), a.position.init();
  }
  if (v) {
    var oe = ie(i, v);
    a.tables.gsub = Ai.parse(oe.data, oe.offset);
  }
  if (d) {
    var fe = ie(i, d);
    a.tables.fvar = ph.parse(fe.data, fe.offset, a.names);
  }
  if (k) {
    var G = ie(i, k);
...
function ya(t, e = !1) {
  const r = t[0].index !== null, n = new Set(Object.keys(t[0].attributes)), a = new Set(Object.keys(t[0].morphAttributes)), i = {}, s = {}, o = t[0].morphTargetsRelative, c = new Qi();
  let u = 0;
  for (let h = 0; h < t.length; ++h) {
    ...
    for (const g in d.attributes) {
      ...
      i[g] === void 0 && (i[g] = []), i[g].push(d.attributes[g]), l++;
    }
    if (l !== n.size)
    ...
    for (const g in d.morphAttributes) {
      ...
      s[g] === void 0 && (s[g] = []), s[g].push(d.morphAttributes[g]);
    }
    if (e) {
      let g;
      if (r)
...
function Rh(t, e = 1e-4) {
  ...
  for (let b = 0; b < i; b++) {
    ...
    if (k in r)
      ...
      for (let C = 0, U = o.length; C < U; C++) {
        const B = o[C], O = t.getAttribute(B), H = t.morphAttributes[B], z = O.itemSize, W = c[B], le = u[B];
        for (let ce = 0; ce < z; ce++) {
          const $ = d[ce], K = l[ce];
          if (W[K](s, O[$](w)), H)
            for (let J = 0, ae = H.length; J < ae; J++)
              le[J][K](s, H[J][$](w));
        }
      }
      r[k] = s, h.push(s), s++;
  ...
  for (const b in t.attributes) {
    const w = c[b];
    if (y.setAttribute(b, new w.constructor(
      w.array.slice(0, s * w.itemSize),
      w.itemSize,
      w.normalized
    )), b in u)
      for (let k = 0; k < u[b].length; k++) {
        const C = u[b][k];
        y.morphAttributes[b][k] = new C.constructor(
...
class xa extends $a {
  ...
  toGeometry() {
    ...
    if (e == null) {
      ...
      return e = new M.ShapeGeometry(r, 4), e.hasAttribute("uv") && e.deleteAttribute("uv"), e.hasAttribute("normal") && e.deleteAttribute("normal"), Rh(e, 1e-6);
    }
    return e;
  }
  /**
...
function Dh(t, e, r, n, a) {
  ...
  if (i.o) {
    ...
    for (let F = 0, y = v.length; F < y; )
      switch (v[F++]) {
        case "m":
          o = v[F++] * e + r, c = v[F++] * e + n, s.moveTo(o, c);
          break;
        case "l":
          o = v[F++] * e + r, c = v[F++] * e + n, s.lineTo(o, c);
          break;
        case "q":
          u = v[F++] * e + r, h = v[F++] * e + n, d = v[F++] * e + r, l = v[F++] * e + n, s.quadraticCurveTo(d, l, u, h);
          break;
        case "b":
          u = v[F++] * e + r, h = v[F++] * e + n, d = v[F++] * e + r, l = v[F++] * e + n, g = v[F++] * e + r, x = v[F++] * e + n, s.bezierCurveTo(d, l, g, x, u, h);
          break;
      }
  }
...
class _h extends Mh {
   ...
   */
  generateShapes(e, r = 100, n = "ltr") {
    const a = [];
    return Ph(e, r, this.data, n).forEach((s) => {
      a.push(...qh(s));
    }), a;
  }
}
function Ph(t, e, r, n = "ltr") {
  const a = Array.from(t), i = e / r.resolution, s = (r.boundingBox.yMax - r.boundingBox.yMin + r.underlineThickness) * i, o = [];
  let c = 0, u = 0;
  (n === "rtl" || n === "tb") && a.reverse();
  for (const h of a)
    if (h === `
`)
      c = 0, u -= s;
    else {
      const d = Nh(h, i, c, u, r);
      if (!d) continue;
      n === "tb" ? (c = 0, u += r.ascender * i) : c += d.offsetX, o.push(d.path);
    }
  return o;
}
function Nh(t, e, r, n, a) {
  const i = a.glyphs[t] || a.glyphs["?"];
  if (!i) {
    console.error(
      `THREE.Font: character "${t}" does not exist in font family ${a.familyName}.`
    );
    return;
  }
  const s = new Va();
    ...
    for (; c < o.length; ) {
      ...
      switch (u) {
        ...
        case "q":
          ...
          break;
        case "b":
          l = parseFloat(o[c++]) * e + r, g = parseFloat(o[c++]) * e + n, x = parseFloat(o[c++]) * e + r, v = parseFloat(o[c++]) * e + n, F = parseFloat(o[c++]) * e + r, y = parseFloat(o[c++]) * e + n, s.bezierCurveTo(x, v, F, y, l, g);
          break;
      }
    }
  }
...
function Hh(t) {
  ...
  for (let n = 0; n < e; n++) {
    let a = null, i = 1 / 0;
    for (let s = 0; s < e; s++)
      if (n !== s && t[n].every((o) => Gh(o, t[s]))) {
        const o = Math.abs(qa.area(t[s]));
        o < i && (i = o, a = s);
      }
    r[n] = a;
  }
...
function zh(t) {
  return t.map((e, r) => e === null ? r : -1).filter((e) => e >= 0);
}
function Vh(t) {
  const e = [];
  for (let r = t.length - 1; r >= 0; r--) {
    const n = t[r];
    if (n instanceof pr)
      e.push(new pr(n.v2.clone(), n.v1.clone()));
    else if (n instanceof wn)
      e.push(
        new wn(n.v2.clone(), n.v1.clone(), n.v0.clone())
      );
    ...
    else if (typeof n.getPoints == "function") {
      const a = n.getPoints(8);
      for (let i = a.length - 1; i > 0; i--)
        e.push(new pr(a[i].clone(), a[i - 1].clone()));
    }
  }
  return e;
}
function ba(t, e) {
  const r = qa.area(t.getPoints(32)) > 0, n = e === r ? t.curves.slice() : Vh(t.curves), a = new ts();
  return a.curves.push(...n), a;
}
function qh(t, e = 32) {
  const r = t.subPaths;
  if (!r || r.length === 0) return [];
  const n = r.map((g) => g.getPoints(e)), a = Hh(n), i = Wh(a), s = zh(a), o = r.length, c = Array(o).fill(-1), u = Array(o).fill(-1);
  for (const g of s) {
    const x = [{ idx: g, d: 0 }];
    for (; x.length; ) {
      const v = x.pop();
      c[v.idx] = v.d, u[v.idx] = g;
      for (const F of i[v.idx]) x.push({ idx: F, d: v.d + 1 });
    }
  }
...
class Yh extends ja {
   ...
   */
  constructor(e) {
    super(e), this.type = "mesh", this.glyphCache = new Xh(512);
    const r = e.data;
   ...
   */
  parseMeshFont(e) {
    const r = Oh(e), n = Math.round, a = r.charToGlyph("A"), i = a ? r.unitsPerEm / (a.yMax || r.unitsPerEm) : 1, s = {
      glyphs: {},
      // Lazy loaded later
   ...
   */
  getCodeShape(e, r) {
    return this.getCharShape(String.fromCodePoint(e), r);
  }
  /**
...
class ge {
  ...
  readBytes(e = 1) {
    ...
    const r = new Uint8Array(this.data.buffer, this.position, e);
  ...
  readUint16(e = !0) {
    ...
    const r = this.data.getUint16(this.position, e);
...
var ve = /* @__PURE__ */ ((t) => (t.SHAPES = "shapes", t.BIGFONT = "bigfont", t.UNIFONT = "unifont", t))(ve || {});
class jh {
  parse(e) {
    const r = this.parseHeader(e).split(" "), n = r[1].toLocaleLowerCase();
    if (!Object.values(ve).includes(n))
  ...
  parseHeader(e) {
    let r = "", n = 0;
    for (; e.currentPosition < e.length - 2 && n < 1024; ) {
      const a = e.readUint8();
      if (a === 13) {
        const i = e.currentPosition, s = e.readUint8(), o = e.readUint8();
        if (s === 10 && o === 26)
          break;
        e.setPosition(i), r += String.fromCharCode(a);
      } else
...
class Zh {
  parse(e) {
    try {
      ...
      const n = [];
      for (let s = 0; s < r; s++) {
        const o = e.readUint16(), c = e.readUint16();
        c > 0 && n.push({ code: o, length: c });
      }
      const a = {};
      for (const s of n)
        try {
      ...
      if (0 in a) {
        ...
        try {
          ...
          let c = s.findIndex((u) => $h.includes(u));
      ...
      return console.error("Error parsing shape font:", r), {
        data: {},
...
class Kh {
  parse(e) {
    try {
      e.readInt16();
      const r = e.readInt16(), n = e.readInt16();
      if (r <= 0)
        throw new Error("Invalid character count in font file");
      e.skip(n * 4);
      const a = [];
      for (let o = 0; o < r; o++) {
        const c = e.readUint16(), u = e.readUint16(), h = e.readUint32();
        (c !== 0 || u !== 0 || h !== 0) && a.push({ code: c, length: u, offset: h });
      }
      const i = {};
      for (const o of a)
        try {
      ...
      return console.error("Error parsing big font:", r), {
        data: {},
        info: "Failed to parse font file",
        baseUp: 8,
        baseDown: 2,
  ...
  utf8ArrayToStr(e) {
    ...
    for (; n < e.length; ) {
      ...
      switch (a >> 4) {
        ...
        case 13: {
          const i = e[n++];
          r += String.fromCharCode((a & 31) << 6 | i & 63);
          break;
        }
        case 14: {
          const i = e[n++], s = e[n++];
          r += String.fromCharCode(
            (a & 15) << 12 | (i & 63) << 6 | (s & 63) << 0
          );
          break;
        }
      }
...
class Jh {
  parse(e) {
    try {
      ...
      if (r <= 0)
        throw new Error("Invalid character count in font file");
      const n = e.readInt16(), a = e.readBytes(n), i = {
        data: {},
        info: "",
        baseUp: 8,
        baseDown: 2,
      ...
      try {
        ...
        let c = o.indexOf("\0");
        c >= 0 && (i.info = o.substring(0, c), c + 3 < a.length && (i.baseUp = a[c + 1], i.baseDown = a[c + 2], i.height = i.baseUp + i.baseDown, i.width = i.height, i.orientation = a[c + 3] === 0 ? "horizontal" : "vertical"));
      } catch {
      ...
      for (let o = 0; o < r - 1; o++)
        try {
          const c = e.readUint16(), u = e.readUint16();
          if (u > 0) {
      ...
      return console.error("Error parsing unifont:", r), {
        data: {},
        info: "Failed to parse font file",
        baseUp: 8,
        baseDown: 2,
...
class re {
   ...
   */
  divideScalars(e, r) {
    return e !== 0 && (this.x /= e), r !== 0 && (this.y /= r), this;
  }
  /**
...
class At {
  ...
  constructor(e) {
    if (e.start && e.end && e.bulge !== void 0) {
      ...
      const r = this.end.clone().subtract(this.start), n = r.length();
      if (Math.abs(this.bulge) * n / 2 === 0) {
        this.radius = 0, this.center = this.start.clone(), this.startAngle = Math.atan2(r.y, r.x), this.endAngle = this.startAngle;
        return;
      }
      ...
      this.center = e.center.clone(), this.radius = e.radius, this.isClockwise = e.isClockwise, this.startAngle = e.startOctant * Sa;
      const r = (e.octantCount === 0 ? 8 : e.octantCount) * Sa;
  ...
  tessellate(e = Math.PI / 18) {
    ...
    const r = [this.start.clone()], n = Math.abs(this.endAngle - this.startAngle), a = Math.max(1, Math.floor(n / e));
    for (let i = 1; i < a; i++) {
...
class kt {
  ...
  get bbox() {
    ...
    return this.polylines.forEach((i) => {
      i.forEach((s) => {
        e = Math.min(e, s.x), r = Math.max(r, s.x), n = Math.min(n, s.y), a = Math.max(a, s.y);
      });
    }), this._bbox = { minX: e, minY: n, maxX: r, maxY: a }, this._bbox;
  }
  /**
  ...
  offset(e, r = !0) {
    ...
    return r ? new kt(
      ...
      this.polylines.map((i) => i.map((s) => s.clone().add(e)))
    ) : ((a = this.lastPoint) == null || a.add(e), this.polylines.forEach((i) => i.forEach((s) => s.add(e))), this._bbox && (this._bbox.maxX += e.x, this._bbox.minX += e.x, this._bbox.maxY += e.y, this._bbox.minY += e.y), this);
  }
  /**
  ...
  toSVG(e = {}) {
    ...
    let i, s;
    if (a) {
      const o = this.bbox, c = 0.2, u = o.maxX - o.minX, h = o.maxY - o.minY, d = u === 0 ? h : u, l = h === 0 ? u : h, g = o.minX - d * c, x = o.maxX + d * c, v = o.minY - l * c, F = o.maxY + l * c;
      s = this.polylines.map((y) => {
        let b = "";
        return y.forEach((w, k) => {
          const C = w.x, U = -w.y;
          b += k === 0 ? `M ${C} ${U} ` : `L ${C} ${U} `;
        }), `<path d="${b}" stroke="${n}" stroke-width="${r}" fill="none"/>`;
      }).join(""), i = `${g} ${-F} ${x - g} ${F - v}`;
    } else
...
class tl {
   ...
   */
  getCharShape(e, r) {
    const n = r / this.fontData.content.height;
    return this.parseAndScale(e, { factor: n });
  }
  /**
  ...
  parseAndScale(e, r) {
    ...
    if (this.shapeCache.has(e))
      n = this.shapeCache.get(e);
    else {
      const a = this.fontData.content.data;
      if (a[e]) {
        const i = a[e];
        n = this.parseShape(i), this.shapeData.set(e, n), this.shapeCache.set(e, n);
      }
    }
    if (n) {
      if (r.factor !== void 0)
        return this.scaleShapeByFactor(n, r.factor);
      if (r.height !== void 0) {
        const a = r.width ?? r.height;
        return this.scaleShapeByHeightAndWidth(n, r.height, a);
      } else
        return n;
    }
  }
   ...
   */
  scaleShapeByFactor(e, r) {
    var n;
    return new kt(
      (n = e.lastPoint) == null ? void 0 : n.clone().multiply(r),
      e.polylines.map((a) => a.map((i) => i.clone().multiply(r)))
    );
  }
  /**
   ...
   * @returns The scaled shape
   */
  scaleShapeByHeightAndWidth(e, r, n) {
    var a;
  ...
  parseShape(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const a = e[n];
      a <= 15 ? n = this.handleSpecialCommand(a, e, n, r) : this.handleVectorCommand(a, r);
    }
    return new kt(r.currentPoint, r.polylines);
  }
  /**
   ...
   */
  handleSpecialCommand(e, r, n, a) {
    let i = n;
    switch (e) {
      case 0:
        a.currentPolyline = [], a.isPenDown = !1;
        break;
      case 1:
        a.isPenDown = !0, a.currentPolyline.push(a.currentPoint.clone());
        break;
      case 2:
        a.isPenDown = !1, a.currentPolyline.length > 1 && a.polylines.push(a.currentPolyline.slice()), a.currentPolyline = [];
        break;
      case 3:
        i++, a.scale /= r[i];
        break;
      ...
      case 5:
        ...
        a.sp.push(a.currentPoint.clone());
        break;
      case 6:
        a.currentPoint = a.sp.pop() ?? a.currentPoint;
        break;
      case 7:
        i = this.handleSubshapeCommand(r, i, a);
        break;
      case 8:
        i = this.handleXYDisplacement(r, i, a);
        break;
      case 9:
        i = this.handleMultipleXYDisplacements(r, i, a);
        break;
      case 10:
        i = this.handleOctantArc(r, i, a);
        break;
      case 11:
        i = this.handleFractionalArc(r, i, a);
        break;
      case 12:
        i = this.handleBulgeArc(r, i, a);
        break;
      case 13:
        i = this.handleMultipleBulgeArcs(r, i, a);
        break;
      case 14:
        i = this.skipCode(r, ++i);
        break;
  ...
  handleVectorCommand(e, r) {
    const n = (e & 240) >> 4, a = e & 15, i = this.getVectorForDirection(a);
    r.currentPoint.add(i.multiply(n * r.scale)), r.isPenDown && r.currentPolyline.push(r.currentPoint.clone());
  }
  /**
  ...
  handleSubshapeCommand(e, r, n) {
    let a = r, i = 0, s, o = n.scale * this.fontData.content.height, c = o;
    const u = n.currentPoint.clone();
    switch (n.currentPolyline.length > 1 && (n.polylines.push(n.currentPolyline.slice()), n.currentPolyline = []), this.fontData.header.fontType) {
      case ve.SHAPES:
        ...
        break;
      case ve.BIGFONT:
        a++, i = e[a], i === 0 && (a++, i = e[a++] << 8 | e[a++], u.x = ge.byteToSByte(e[a++]) * n.scale, u.y = ge.byteToSByte(e[a++]) * n.scale, this.fontData.content.isExtended && (c = e[a++] * n.scale), o = e[a] * n.scale);
        break;
      case ve.UNIFONT:
        a++, i = e[a++] << 8 | e[a++];
        break;
    }
    return i !== 0 && (s = this.getScaledSubshapeAtInsertPoint(i, c, o, u), s && n.polylines.push(...s.polylines.slice())), n.currentPolyline = [], a;
  }
  ...
  handleOctantArc(e, r, n) {
    var a;
    let i = r;
    const s = e[++i] * n.scale, o = ge.byteToSByte(e[++i]), c = (o & 112) >> 4;
    let u = o & 7;
    const h = o < 0, d = Math.PI / 4 * c, l = n.currentPoint.clone().subtract(new re(Math.cos(d) * s, Math.sin(d) * s)), g = At.fromOctant(l, s, c, u, h);
    if (n.isPenDown) {
  ...
  handleFractionalArc(e, r, n) {
    ...
    h < 0 && (v = -v, x = -x, F = -1);
    let y = g * d, b = y + x;
    y += g * i / 256 * F, b += g * s / 256 * F;
    const w = n.currentPoint.clone().subtract(new re(u * Math.cos(y), u * Math.sin(y)));
    if (n.currentPoint = w.clone().add(new re(u * Math.cos(b), u * Math.sin(b))), n.isPenDown) {
      let k = y;
      const C = [];
      if (C.push(
      ...
      C.push(w.clone().add(new re(u * Math.cos(b), u * Math.sin(b)))), n.currentPolyline.push(...C);
    }
    return a;
  }
      ...
      case 7:
        switch (this.fontData.header.fontType) {
          case ve.SHAPES:
            ...
            break;
          case ve.BIGFONT:
            r++, e[r] === 0 && (r += this.fontData.content.isExtended ? 6 : 5);
            break;
          case ve.UNIFONT:
            r += 2;
            break;
  ...
  getScaledSubshapeAtInsertPoint(e, r, n, a) {
    let i = this.shapeCache.get(e);
    if (!i) {
   ...
   */
  handleArcSegment(e, r, n, a, i, s) {
    r.x *= a, r.y *= a, n < -127 && (n = -127);
    const o = e.clone();
    if (i)
      if (n === 0)
        s.push(o.clone().add(r));
      else {
        const c = o.clone().add(r), u = At.fromBulge(o, c, n / 127).tessellate();
        s.push(...u.slice(1));
      }
    return o.add(r), o;
  }
...
class rl {
  ...
  constructor(e) {
    if (e instanceof ArrayBuffer) {
      const r = new ge(e), n = new jh().parse(r), a = Qh.createParser(n.fontType).parse(r);
      this.fontData = {
        header: n,
        content: a
      };
      ...
      this.fontData = e;
    this.shapeParser = new tl(this.fontData);
  }
  /**
   * Return true if this font contains glyph of the specified character. Otherwise, return false.
   * @param char - The character to check
   ...
   */
  getCharShape(e, r) {
    let n = this.shapeParser.getCharShape(e, r);
    return n && this.fontData.header.fontType === ve.BIGFONT && (n = n.normalizeToOrigin()), n;
  }
  /**
...
var Vi = { exports: {} }, fn = {}, lr = {};
lr.byteLength = ol;
lr.toByteArray = ul;
lr.fromByteArray = fl;
var Re = [], be = [], il = typeof Uint8Array < "u" ? Uint8Array : Array, Cr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var ht = 0, sl = Cr.length; ht < sl; ++ht)
  Re[ht] = Cr[ht], be[Cr.charCodeAt(ht)] = ht;
be[45] = 62;
be[95] = 63;
function qi(t) {
  var e = t.length;
...
function ul(t) {
  var e, r = qi(t), n = r[0], a = r[1], i = new il(cl(t, n, a)), s = 0, o = a > 0 ? n - 4 : n, c;
  for (c = 0; c < o; c += 4)
    e = be[t.charCodeAt(c)] << 18 | be[t.charCodeAt(c + 1)] << 12 | be[t.charCodeAt(c + 2)] << 6 | be[t.charCodeAt(c + 3)], i[s++] = e >> 16 & 255, i[s++] = e >> 8 & 255, i[s++] = e & 255;
  return a === 2 && (e = be[t.charCodeAt(c)] << 2 | be[t.charCodeAt(c + 1)] >> 4, i[s++] = e & 255), a === 1 && (e = be[t.charCodeAt(c)] << 10 | be[t.charCodeAt(c + 1)] << 4 | be[t.charCodeAt(c + 2)] >> 2, i[s++] = e >> 8 & 255, i[s++] = e & 255), i;
}
function hl(t) {
...
function ll(t, e, r) {
  for (var n, a = [], i = e; i < r; i += 3)
    n = (t[i] << 16 & 16711680) + (t[i + 1] << 8 & 65280) + (t[i + 2] & 255), a.push(hl(n));
  return a.join("");
}
function fl(t) {
  for (var e, r = t.length, n = r % 3, a = [], i = 16383, s = 0, o = r - n; s < o; s += i)
    a.push(ll(t, s, s + i > o ? o : s + i));
...
pn.read = function(t, e, r, n, a) {
  var i, s, o = a * 8 - n - 1, c = (1 << o) - 1, u = c >> 1, h = -7, d = r ? a - 1 : 0, l = r ? -1 : 1, g = t[e + d];
  for (d += l, i = g & (1 << -h) - 1, g >>= -h, h += o; h > 0; i = i * 256 + t[e + d], d += l, h -= 8)
    ;
...
pn.write = function(t, e, r, n, a, i) {
  var s, o, c, u = i * 8 - a - 1, h = (1 << u) - 1, d = h >> 1, l = a === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : i - 1, x = n ? 1 : -1, v = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (o = isNaN(e) ? 1 : 0, s = h) : (s = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -s)) < 1 && (s--, c *= 2), s + d >= 1 ? e += l / c : e += l * Math.pow(2, 1 - d), e * c >= 2 && (s++, c /= 2), s + d >= h ? (o = 0, s = h) : s + d >= 1 ? (o = (e * c - 1) * Math.pow(2, a), s = s + d) : (o = e * Math.pow(2, d - 1) * Math.pow(2, a), s = 0)); a >= 8; t[r + g] = o & 255, g += x, o /= 256, a -= 8)
    ;
 ...
 */
(function(t) {
  var e = lr, r = pn, n = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  t.Buffer = o, t.SlowBuffer = b, t.INSPECT_MAX_BYTES = 50;
  var a = 2147483647;
  ...
  function h(m, f, p) {
    return u(m), m <= 0 ? s(m) : f !== void 0 ? typeof p == "string" ? s(m).fill(f, p) : s(m).fill(f) : s(m);
  }
  o.alloc = function(m, f, p) {
    return h(m, f, p);
  };
  function d(m) {
  ...
  function l(m, f) {
    ...
    var p = w(m, f) | 0, S = s(p), T = S.write(m, f);
    return T !== p && (S = S.slice(0, T)), S;
  }
  function g(m) {
    for (var f = m.length < 0 ? 0 : y(m.length) | 0, p = s(f), S = 0; S < f; S += 1)
      p[S] = m[S] & 255;
    return p;
  }
  function x(m) {
  ...
  function v(m, f, p) {
    ...
    if (m.byteLength < f + (p || 0))
      throw new RangeError('"length" is outside of buffer bounds');
    var S;
    return f === void 0 && p === void 0 ? S = new Uint8Array(m) : p === void 0 ? S = new Uint8Array(m, f) : S = new Uint8Array(m, f, p), Object.setPrototypeOf(S, o.prototype), S;
  }
  function F(m) {
    if (o.isBuffer(m)) {
      var f = y(m.length) | 0, p = s(f);
      return p.length === 0 || m.copy(p, 0, 0, f), p;
    }
    if (m.length !== void 0)
      return typeof m.length != "number" || fr(m.length) ? s(0) : g(m);
  ...
  }, o.compare = function(f, p) {
    if (Be(f, Uint8Array) && (f = o.from(f, f.offset, f.byteLength)), Be(p, Uint8Array) && (p = o.from(p, p.offset, p.byteLength)), !o.isBuffer(f) || !o.isBuffer(p))
      throw new TypeError(
        'The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array'
      );
    if (f === p) return 0;
    for (var S = f.length, T = p.length, L = 0, A = Math.min(S, T); L < A; ++L)
      if (f[L] !== p[L]) {
        S = f[L], T = p[L];
        break;
      }
  ...
  function w(m, f) {
    ...
    var p = m.length, S = arguments.length > 2 && arguments[2] === !0;
    if (!S && p === 0) return 0;
    for (var T = !1; ; )
      switch (f) {
        case "ascii":
  ...
  o.prototype.swap16 = function() {
    ...
    var f = "", p = t.INSPECT_MAX_BYTES;
    return f = this.toString("hex", 0, p).replace(/(.{2})/g, "$1 ").trim(), this.length > p && (f += " ... "), "<Buffer " + f + ">";
  }, n && (o.prototype[n] = o.prototype.inspect), o.prototype.compare = function(f, p, S, T, L) {
    ...
    if (p === void 0 && (p = 0), S === void 0 && (S = f ? f.length : 0), T === void 0 && (T = 0), L === void 0 && (L = this.length), p < 0 || S > f.length || T < 0 || L > this.length)
    ...
    if (p >= S)
      return 1;
    if (p >>>= 0, S >>>= 0, T >>>= 0, L >>>= 0, this === f) return 0;
    for (var A = L - T, V = S - p, Y = Math.min(A, V), Q = this.slice(T, L), de = f.slice(p, S), te = 0; te < Y; ++te)
      if (Q[te] !== de[te]) {
        A = Q[te], V = de[te];
        break;
      }
  ...
  function U(m, f, p, S, T) {
    if (m.length === 0) return -1;
    if (typeof p == "string" ? (S = p, p = 0) : p > 2147483647 ? p = 2147483647 : p < -2147483648 && (p = -2147483648), p = +p, fr(p) && (p = T ? 0 : m.length - 1), p < 0 && (p = m.length + p), p >= m.length) {
      if (T) return -1;
      p = m.length - 1;
    } else if (p < 0)
      if (T) p = 0;
    ...
    if (typeof f == "string" && (f = o.from(f, S)), o.isBuffer(f))
      return f.length === 0 ? -1 : B(m, f, p, S, T);
    if (typeof f == "number")
      return f = f & 255, typeof Uint8Array.prototype.indexOf == "function" ? T ? Uint8Array.prototype.indexOf.call(m, f, p) : Uint8Array.prototype.lastIndexOf.call(m, f, p) : B(m, [f], p, S, T);
    throw new TypeError("val must be string, number or Buffer");
  }
  function B(m, f, p, S, T) {
    ...
    function Y(bn, Sn) {
      return L === 1 ? bn[Sn] : bn.readUInt16BE(Sn * L);
    }
    var Q;
    if (T) {
      var de = -1;
      for (Q = p; Q < A; Q++)
        if (Y(m, Q) === Y(f, de === -1 ? 0 : Q - de)) {
          if (de === -1 && (de = Q), Q - de + 1 === V) return de * L;
        } else
          de !== -1 && (Q -= Q - de), de = -1;
    } else
      for (p + V > A && (p = A - V), Q = p; Q >= 0; Q--) {
        for (var te = !0, Gt = 0; Gt < V; Gt++)
          if (Y(m, Q + Gt) !== Y(f, Gt)) {
            te = !1;
            break;
          }
  ...
  o.prototype.includes = function(f, p, S) {
    return this.indexOf(f, p, S) !== -1;
  }, o.prototype.indexOf = function(f, p, S) {
    return U(this, f, p, S, !0);
  }, o.prototype.lastIndexOf = function(f, p, S) {
    return U(this, f, p, S, !1);
  };
  function O(m, f, p, S) {
    p = Number(p) || 0;
    var T = m.length - p;
  ...
  function H(m, f, p, S) {
    return Nt(We(f, m.length - p), m, p, S);
  }
  function z(m, f, p, S) {
    return Nt(Zi(f), m, p, S);
  }
  function W(m, f, p, S) {
    return Nt(xn(f), m, p, S);
  }
  function le(m, f, p, S) {
    return Nt(Ki(f, m.length - p), m, p, S);
  }
  o.prototype.write = function(f, p, S, T) {
    if (p === void 0)
      T = "utf8", S = this.length, p = 0;
    else if (S === void 0 && typeof p == "string")
      T = p, S = this.length, p = 0;
    else if (isFinite(p))
      p = p >>> 0, isFinite(S) ? (S = S >>> 0, T === void 0 && (T = "utf8")) : (T = S, S = void 0);
    else
      throw new Error(
        "Buffer.write(string, encoding, offset[, length]) is no longer supported"
      );
    var L = this.length - p;
    if ((S === void 0 || S > L) && (S = L), f.length > 0 && (S < 0 || p < 0) || p > this.length)
  ...
  function ce(m, f, p) {
    return f === 0 && p === m.length ? e.fromByteArray(m) : e.fromByteArray(m.slice(f, p));
  }
  function $(m, f, p) {
      ...
      if (T + V <= p) {
        ...
        switch (V) {
          ...
          case 2:
            ...
            break;
          case 3:
            Y = m[T + 1], Q = m[T + 2], (Y & 192) === 128 && (Q & 192) === 128 && (te = (L & 15) << 12 | (Y & 63) << 6 | Q & 63, te > 2047 && (te < 55296 || te > 57343) && (A = te));
            break;
          case 4:
            Y = m[T + 1], Q = m[T + 2], de = m[T + 3], (Y & 192) === 128 && (Q & 192) === 128 && (de & 192) === 128 && (te = (L & 15) << 18 | (Y & 63) << 12 | (Q & 63) << 6 | de & 63, te > 65535 && te < 1114112 && (A = te));
        }
      }
  ...
  function fe(m, f, p) {
    for (var S = m.slice(f, p), T = "", L = 0; L < S.length - 1; L += 2)
      T += String.fromCharCode(S[L] + S[L + 1] * 256);
    return T;
  }
  o.prototype.slice = function(f, p) {
    var S = this.length;
    f = ~~f, p = p === void 0 ? S : ~~p, f < 0 ? (f += S, f < 0 && (f = 0)) : f > S && (f = S), p < 0 ? (p += S, p < 0 && (p = 0)) : p > S && (p = S), p < f && (p = f);
    var T = this.subarray(f, p);
    return Object.setPrototypeOf(T, o.prototype), T;
  };
  function G(m, f, p) {
    if (m % 1 !== 0 || m < 0) throw new RangeError("offset is not uint");
    if (m + f > p) throw new RangeError("Trying to access beyond buffer length");
  }
  o.prototype.readUintLE = o.prototype.readUIntLE = function(f, p, S) {
    f = f >>> 0, p = p >>> 0, S || G(f, p, this.length);
    for (var T = this[f], L = 1, A = 0; ++A < p && (L *= 256); )
      T += this[f + A] * L;
    return T;
  }, o.prototype.readUintBE = o.prototype.readUIntBE = function(f, p, S) {
    f = f >>> 0, p = p >>> 0, S || G(f, p, this.length);
    for (var T = this[f + --p], L = 1; p > 0 && (L *= 256); )
      T += this[f + --p] * L;
    return T;
  }, o.prototype.readUint8 = o.prototype.readUInt8 = function(f, p) {
    return f = f >>> 0, p || G(f, 1, this.length), this[f];
  }, o.prototype.readUint16LE = o.prototype.readUInt16LE = function(f, p) {
    return f = f >>> 0, p || G(f, 2, this.length), this[f] | this[f + 1] << 8;
  }, o.prototype.readUint16BE = o.prototype.readUInt16BE = function(f, p) {
    return f = f >>> 0, p || G(f, 2, this.length), this[f] << 8 | this[f + 1];
  }, o.prototype.readUint32LE = o.prototype.readUInt32LE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), (this[f] | this[f + 1] << 8 | this[f + 2] << 16) + this[f + 3] * 16777216;
  }, o.prototype.readUint32BE = o.prototype.readUInt32BE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), this[f] * 16777216 + (this[f + 1] << 16 | this[f + 2] << 8 | this[f + 3]);
  }, o.prototype.readIntLE = function(f, p, S) {
    f = f >>> 0, p = p >>> 0, S || G(f, p, this.length);
    for (var T = this[f], L = 1, A = 0; ++A < p && (L *= 256); )
      T += this[f + A] * L;
    return L *= 128, T >= L && (T -= Math.pow(2, 8 * p)), T;
  }, o.prototype.readIntBE = function(f, p, S) {
    f = f >>> 0, p = p >>> 0, S || G(f, p, this.length);
    for (var T = p, L = 1, A = this[f + --T]; T > 0 && (L *= 256); )
      A += this[f + --T] * L;
    return L *= 128, A >= L && (A -= Math.pow(2, 8 * p)), A;
  }, o.prototype.readInt8 = function(f, p) {
    return f = f >>> 0, p || G(f, 1, this.length), this[f] & 128 ? (255 - this[f] + 1) * -1 : this[f];
  }, o.prototype.readInt16LE = function(f, p) {
    f = f >>> 0, p || G(f, 2, this.length);
    var S = this[f] | this[f + 1] << 8;
    return S & 32768 ? S | 4294901760 : S;
  }, o.prototype.readInt16BE = function(f, p) {
    f = f >>> 0, p || G(f, 2, this.length);
    var S = this[f + 1] | this[f] << 8;
    return S & 32768 ? S | 4294901760 : S;
  }, o.prototype.readInt32LE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), this[f] | this[f + 1] << 8 | this[f + 2] << 16 | this[f + 3] << 24;
  }, o.prototype.readInt32BE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), this[f] << 24 | this[f + 1] << 16 | this[f + 2] << 8 | this[f + 3];
  }, o.prototype.readFloatLE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), r.read(this, f, !0, 23, 4);
  }, o.prototype.readFloatBE = function(f, p) {
    return f = f >>> 0, p || G(f, 4, this.length), r.read(this, f, !1, 23, 4);
  }, o.prototype.readDoubleLE = function(f, p) {
    return f = f >>> 0, p || G(f, 8, this.length), r.read(this, f, !0, 52, 8);
  }, o.prototype.readDoubleBE = function(f, p) {
    return f = f >>> 0, p || G(f, 8, this.length), r.read(this, f, !1, 52, 8);
  };
  function q(m, f, p, S, T, L) {
    ...
    if (p + S > m.length) throw new RangeError("Index out of range");
  }
  o.prototype.writeUintLE = o.prototype.writeUIntLE = function(f, p, S, T) {
    if (f = +f, p = p >>> 0, S = S >>> 0, !T) {
      var L = Math.pow(2, 8 * S) - 1;
      q(this, f, p, S, L, 0);
    }
    var A = 1, V = 0;
    for (this[p] = f & 255; ++V < S && (A *= 256); )
      this[p + V] = f / A & 255;
    return p + S;
  }, o.prototype.writeUintBE = o.prototype.writeUIntBE = function(f, p, S, T) {
    if (f = +f, p = p >>> 0, S = S >>> 0, !T) {
      var L = Math.pow(2, 8 * S) - 1;
      q(this, f, p, S, L, 0);
    }
    var A = S - 1, V = 1;
    for (this[p + A] = f & 255; --A >= 0 && (V *= 256); )
      this[p + A] = f / V & 255;
    return p + S;
  }, o.prototype.writeUint8 = o.prototype.writeUInt8 = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 1, 255, 0), this[p] = f & 255, p + 1;
  }, o.prototype.writeUint16LE = o.prototype.writeUInt16LE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 2, 65535, 0), this[p] = f & 255, this[p + 1] = f >>> 8, p + 2;
  }, o.prototype.writeUint16BE = o.prototype.writeUInt16BE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 2, 65535, 0), this[p] = f >>> 8, this[p + 1] = f & 255, p + 2;
  }, o.prototype.writeUint32LE = o.prototype.writeUInt32LE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 4, 4294967295, 0), this[p + 3] = f >>> 24, this[p + 2] = f >>> 16, this[p + 1] = f >>> 8, this[p] = f & 255, p + 4;
  }, o.prototype.writeUint32BE = o.prototype.writeUInt32BE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 4, 4294967295, 0), this[p] = f >>> 24, this[p + 1] = f >>> 16, this[p + 2] = f >>> 8, this[p + 3] = f & 255, p + 4;
  }, o.prototype.writeIntLE = function(f, p, S, T) {
    if (f = +f, p = p >>> 0, !T) {
      var L = Math.pow(2, 8 * S - 1);
      q(this, f, p, S, L - 1, -L);
    }
    var A = 0, V = 1, Y = 0;
    for (this[p] = f & 255; ++A < S && (V *= 256); )
      f < 0 && Y === 0 && this[p + A - 1] !== 0 && (Y = 1), this[p + A] = (f / V >> 0) - Y & 255;
    return p + S;
  }, o.prototype.writeIntBE = function(f, p, S, T) {
    if (f = +f, p = p >>> 0, !T) {
      var L = Math.pow(2, 8 * S - 1);
      q(this, f, p, S, L - 1, -L);
    }
    ...
    for (this[p + A] = f & 255; --A >= 0 && (V *= 256); )
      f < 0 && Y === 0 && this[p + A + 1] !== 0 && (Y = 1), this[p + A] = (f / V >> 0) - Y & 255;
    return p + S;
  }, o.prototype.writeInt8 = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 1, 127, -128), f < 0 && (f = 255 + f + 1), this[p] = f & 255, p + 1;
  }, o.prototype.writeInt16LE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 2, 32767, -32768), this[p] = f & 255, this[p + 1] = f >>> 8, p + 2;
  }, o.prototype.writeInt16BE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 2, 32767, -32768), this[p] = f >>> 8, this[p + 1] = f & 255, p + 2;
  }, o.prototype.writeInt32LE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 4, 2147483647, -2147483648), this[p] = f & 255, this[p + 1] = f >>> 8, this[p + 2] = f >>> 16, this[p + 3] = f >>> 24, p + 4;
  }, o.prototype.writeInt32BE = function(f, p, S) {
    return f = +f, p = p >>> 0, S || q(this, f, p, 4, 2147483647, -2147483648), f < 0 && (f = 4294967295 + f + 1), this[p] = f >>> 24, this[p + 1] = f >>> 16, this[p + 2] = f >>> 8, this[p + 3] = f & 255, p + 4;
  };
  function ct(m, f, p, S, T, L) {
    if (p + S > m.length) throw new RangeError("Index out of range");
    if (p < 0) throw new RangeError("Index out of range");
  }
  function Dt(m, f, p, S, T) {
    return f = +f, p = p >>> 0, T || ct(m, f, p, 4), r.write(m, f, p, S, 23, 4), p + 4;
  }
  o.prototype.writeFloatLE = function(f, p, S) {
    return Dt(this, f, p, !0, S);
  }, o.prototype.writeFloatBE = function(f, p, S) {
    return Dt(this, f, p, !1, S);
  };
  function _t(m, f, p, S, T) {
    return f = +f, p = p >>> 0, T || ct(m, f, p, 8), r.write(m, f, p, S, 52, 8), p + 8;
  }
  o.prototype.writeDoubleLE = function(f, p, S) {
    return _t(this, f, p, !0, S);
  }, o.prototype.writeDoubleBE = function(f, p, S) {
    return _t(this, f, p, !1, S);
  }, o.prototype.copy = function(f, p, S, T) {
    if (!o.isBuffer(f)) throw new TypeError("argument should be a Buffer");
    if (S || (S = 0), !T && T !== 0 && (T = this.length), p >= f.length && (p = f.length), p || (p = 0), T > 0 && T < S && (T = S), T === S || f.length === 0 || this.length === 0) return 0;
    if (p < 0)
      throw new RangeError("targetStart out of bounds");
    if (S < 0 || S >= this.length) throw new RangeError("Index out of range");
    if (T < 0) throw new RangeError("sourceEnd out of bounds");
    T > this.length && (T = this.length), f.length - p < T - S && (T = f.length - p + S);
    var L = T - S;
    return this === f && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(p, S, T) : Uint8Array.prototype.set.call(
      f,
      this.subarray(S, T),
      p
    ), L;
  }, o.prototype.fill = function(f, p, S, T) {
    if (typeof f == "string") {
      if (typeof p == "string" ? (T = p, p = 0, S = this.length) : typeof S == "string" && (T = S, S = this.length), T !== void 0 && typeof T != "string")
  ...
  function Pt(m) {
    if (m = m.split("=")[0], m = m.trim().replace(mt, ""), m.length < 2) return "";
    for (; m.length % 4 !== 0; )
      m = m + "=";
    return m;
  }
  function We(m, f) {
    f = f || 1 / 0;
    for (var p, S = m.length, T = null, L = [], A = 0; A < S; ++A) {
      if (p = m.charCodeAt(A), p > 55295 && p < 57344) {
        if (!T) {
          if (p > 56319) {
  ...
  function Zi(m) {
    for (var f = [], p = 0; p < m.length; ++p)
      f.push(m.charCodeAt(p) & 255);
    return f;
  }
  function Ki(m, f) {
    for (var p, S, T, L = [], A = 0; A < m.length && !((f -= 2) < 0); ++A)
      p = m.charCodeAt(A), S = p >> 8, T = p % 256, L.push(T), L.push(S);
    return L;
  }
  function xn(m) {
    return e.toByteArray(Pt(m));
  }
  function Nt(m, f, p, S) {
    for (var T = 0; T < S && !(T + p >= f.length || T >= m.length); ++T)
      f[T + p] = m[T];
    return T;
  }
  function Be(m, f) {
  ...
  var Ji = function() {
    for (var m = "0123456789abcdef", f = new Array(256), p = 0; p < 16; ++p)
      for (var S = p * 16, T = 0; T < 16; ++T)
        f[S + T] = m[p] + m[T];
    return f;
  }();
})(fn);
var Jt = fn, ft = Jt.Buffer, Se = {}, we;
for (we in Jt)
  Jt.hasOwnProperty(we) && (we === "SlowBuffer" || we === "Buffer" || (Se[we] = Jt[we]));
var pt = Se.Buffer = {};
for (we in ft)
  ft.hasOwnProperty(we) && (we === "allocUnsafe" || we === "allocUnsafeSlow" || (pt[we] = ft[we]));
Se.Buffer.prototype = ft.prototype;
(!pt.from || pt.from === Uint8Array.from) && (pt.from = function(t, e, r) {
  if (typeof t == "number")
...
pt.alloc || (pt.alloc = function(t, e, r) {
  if (typeof t != "number")
...
gn.prototype.write = function(t) {
  return this.addBOM && (t = Xi + t, this.addBOM = !1), this.encoder.write(t);
};
gn.prototype.end = function() {
...
vn.prototype.write = function(t) {
  var e = this.decoder.write(t);
  return this.pass || !e || (e[0] === Xi && (e = e.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), e;
};
vn.prototype.end = function() {
  return this.decoder.end();
};
var pl = typeof Object.hasOwn > "u" ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
function dl(t, e) {
  for (var r in e)
    pl(e, r) && (t[r] = e[r]);
}
var Yi = dl, Er = {}, Lr = {}, Xt = { exports: {} };
...
function gl() {
  return wa || (wa = 1, function(t, e) {
    ...
    i.prototype = Object.create(n.prototype), a(n, i), i.from = function(s, o, c) {
      if (typeof s == "number")
        throw new TypeError("Argument must not be a number");
      return n(s, o, c);
    }, i.alloc = function(s, o, c) {
      if (typeof s != "number")
...
function vl() {
  if (Fa) return Lr;
  Fa = 1;
  var t = gl().Buffer, e = t.isEncoding || function(y) {
  ...
  function n(y) {
    var b = r(y);
    if (typeof b != "string" && (t.isEncoding === e || !e(y))) throw new Error("Unknown encoding: " + y);
    return b || y;
  }
  Lr.StringDecoder = a;
  function a(y) {
    ...
    switch (this.encoding) {
      case "utf16le":
        this.text = d, this.end = l, b = 4;
        break;
      case "utf8":
        this.fillLast = c, b = 4;
        break;
      case "base64":
        this.text = g, this.end = x, b = 3;
        break;
      default:
  ...
  a.prototype.write = function(y) {
    ...
    if (this.lastNeed) {
      ...
      w = 0;
    return w < y.length ? b ? b + this.text(y, w) : this.text(y, w) : b || "";
  ...
  function s(y, b, w) {
    ...
    if (k < w) return 0;
    var C = i(b[k]);
    return C >= 0 ? (C > 0 && (y.lastNeed = C - 1), C) : --k < w || C === -2 ? 0 : (C = i(b[k]), C >= 0 ? (C > 0 && (y.lastNeed = C - 2), C) : --k < w || C === -2 ? 0 : (C = i(b[k]), C >= 0 ? (C > 0 && (C === 2 ? C = 0 : y.lastNeed = C - 3), C) : 0));
  }
  function o(y, b, w) {
    if ((b[0] & 192) !== 128)
      return y.lastNeed = 0, "�";
  ...
  function c(y) {
    var b = this.lastTotal - this.lastNeed, w = o(this, y);
  ...
  function u(y, b) {
    ...
    return y.copy(this.lastChar, 0, k), y.toString("utf8", b, k);
  }
  function h(y) {
  ...
  function l(y) {
    ...
    if (this.lastNeed) {
      ...
      return b + this.lastChar.toString("utf16le", 0, w);
    }
    return b;
  }
  function g(y, b) {
    var w = (y.length - b) % 3;
    return w === 0 ? y.toString("base64", b) : (this.lastNeed = 3 - w, this.lastTotal = 3, w === 1 ? this.lastChar[0] = y[y.length - 1] : (this.lastChar[0] = y[y.length - 2], this.lastChar[1] = y[y.length - 1]), y.toString("base64", b, y.length - w));
  }
  function x(y) {
    var b = y && y.length ? this.write(y) : "";
...
function yl() {
  ...
  var r = vl().StringDecoder;
  function n(u, h) {
    this.decoder = new r(h.enc);
  }
  n.prototype.write = function(u) {
    return t.isBuffer(u) || (u = t.from(u)), this.decoder.write(u);
  ...
  i.prototype.write = function(u) {
    u = this.prevStr + u;
    var h = u.length - u.length % 4;
    return this.prevStr = u.slice(h), u = u.slice(0, h), t.from(u, "base64");
  ...
  o.prototype.write = function(u) {
    for (var h = this.acc, d = this.contBytes, l = this.accBytes, g = "", x = 0; x < u.length; x++) {
      var v = u[x];
      (v & 192) !== 128 ? (d > 0 && (g += this.defaultCharUnicode, d = 0), v < 128 ? g += String.fromCharCode(v) : v < 224 ? (h = v & 31, d = 1, l = 1) : v < 240 ? (h = v & 15, d = 2, l = 1) : g += this.defaultCharUnicode) : d > 0 ? (h = h << 6 | v & 63, d--, l++, d === 0 && (l === 2 && h < 128 && h > 0 ? g += this.defaultCharUnicode : l === 3 && h < 2048 ? g += this.defaultCharUnicode : g += String.fromCharCode(h))) : g += this.defaultCharUnicode;
    }
    return this.acc = h, this.contBytes = d, this.accBytes = l, g;
  ...
  return c.prototype.write = function(u) {
    if (this.highSurrogate && (u = this.highSurrogate + u, this.highSurrogate = ""), u.length > 0) {
      var h = u.charCodeAt(u.length - 1);
      h >= 55296 && h < 56320 && (this.highSurrogate = u[u.length - 1], u = u.slice(0, u.length - 1));
    }
    return t.from(u, this.enc);
...
function ml() {
  ...
  _e.utf32le = { type: "_utf32", isLE: !0 }, _e.utf32be = { type: "_utf32", isLE: !1 }, _e.ucs4le = "utf32le", _e.ucs4be = "utf32be", e.prototype.encoder = r, e.prototype.decoder = n;
  function r(u, h) {
    this.isLE = h.isLE, this.highSurrogate = 0;
  }
  r.prototype.write = function(u) {
    for (var h = t.from(u, "ucs2"), d = t.alloc(h.length * 2), l = this.isLE ? d.writeUInt32LE : d.writeUInt32BE, g = 0, x = 0; x < h.length; x += 2) {
      var v = h.readUInt16LE(x), F = v >= 55296 && v < 56320, y = v >= 56320 && v < 57344;
      if (this.highSurrogate)
        if (F || !y)
          l.call(d, this.highSurrogate, g), g += 4;
        else {
          var b = (this.highSurrogate - 55296 << 10 | v - 56320) + 65536;
          l.call(d, b, g), g += 4, this.highSurrogate = 0;
          continue;
        }
      F ? this.highSurrogate = v : (l.call(d, v, g), g += 4, this.highSurrogate = 0);
    }
  ...
  function n(u, h) {
    this.isLE = h.isLE, this.badChar = h.iconv.defaultCharUnicode.charCodeAt(0), this.overflow = [];
  }
  n.prototype.write = function(u) {
    if (u.length === 0)
      return "";
    var h = 0, d = 0, l = t.alloc(u.length + 4), g = 0, x = this.isLE, v = this.overflow, F = this.badChar;
    if (v.length > 0) {
      for (; h < u.length && v.length < 4; h++)
        v.push(u[h]);
      v.length === 4 && (x ? d = v[h] | v[h + 1] << 8 | v[h + 2] << 16 | v[h + 3] << 24 : d = v[h + 3] | v[h + 2] << 8 | v[h + 1] << 16 | v[h] << 24, v.length = 0, g = a(l, g, d, F));
    }
    for (; h < u.length - 3; h += 4)
      x ? d = u[h] | u[h + 1] << 8 | u[h + 2] << 16 | u[h + 3] << 24 : d = u[h + 3] | u[h + 2] << 8 | u[h + 1] << 16 | u[h] << 24, g = a(l, g, d, F);
    for (; h < u.length; h++)
      v.push(u[h]);
  ...
  }, _e.utf32 = i, _e.ucs4 = "utf32";
  function i(u, h) {
    this.iconv = h;
  }
  i.prototype.encoder = s, i.prototype.decoder = o;
  function s(u, h) {
    u = u || {}, u.addBOM === void 0 && (u.addBOM = !0), this.encoder = h.iconv.getEncoder(u.defaultEncoding || "utf-32le", u);
  }
  s.prototype.write = function(u) {
  ...
  function o(u, h) {
    this.decoder = null, this.initialBufs = [], this.initialBufsLen = 0, this.options = u || {}, this.iconv = h.iconv;
  }
  o.prototype.write = function(u) {
    if (!this.decoder) {
  ...
  function c(u, h) {
    var d = [], l = 0, g = 0, x = 0, v = 0, F = 0;
    e:
      for (var y = 0; y < u.length; y++)
        for (var b = u[y], w = 0; w < b.length; w++)
          if (d.push(b[w]), d.length === 4) {
            if (l === 0) {
            ...
            if ((d[0] !== 0 || d[1] > 16) && x++, (d[3] !== 0 || d[2] > 16) && g++, d[0] === 0 && d[1] === 0 && (d[2] !== 0 || d[3] !== 0) && F++, (d[0] !== 0 || d[1] !== 0) && d[2] === 0 && d[3] === 0 && v++, d.length = 0, l++, l >= 100)
              break e;
          }
    return F - x > v - g ? "utf-32be" : F - x < v - g ? "utf-32le" : h || "utf-32le";
  }
  return _e;
}
var Yt = {}, Ca;
function xl() {
  ...
  a.prototype.encoder = i, a.prototype.decoder = s;
  function i(c, u) {
    c = c || {}, c.addBOM === void 0 && (c.addBOM = !0), this.encoder = u.iconv.getEncoder("utf-16le", c);
  }
  ...
  function o(c, u) {
    ...
    e:
      for (var x = 0; x < c.length; x++)
        for (var v = c[x], F = 0; F < v.length; F++)
          if (h.push(v[F]), h.length === 2) {
            if (d === 0) {
              if (h[0] === 255 && h[1] === 254) return "utf-16le";
              if (h[0] === 254 && h[1] === 255) return "utf-16be";
            }
            if (h[0] === 0 && h[1] !== 0 && g++, h[0] !== 0 && h[1] === 0 && l++, h.length = 0, d++, d >= 100)
              break e;
          }
...
function bl() {
  ...
  n.prototype.write = function(v) {
    return t.from(v.replace(r, (function(F) {
  ...
  a.prototype.write = function(v) {
    for (var F = "", y = 0, b = this.inBase64, w = this.base64Accum, k = 0; k < v.length; k++)
      if (!b)
        v[k] == c && (F += this.iconv.decode(v.slice(y, k), "ascii"), y = k + 1, b = !0);
      else if (!s[v[k]]) {
        if (k == y && v[k] == u)
          F += "+";
        else {
          var C = w + this.iconv.decode(v.slice(y, k), "ascii");
          F += this.iconv.decode(t.from(C, "base64"), "utf16-be");
        }
        v[k] != u && k--, y = k + 1, b = !1, w = "";
      }
    if (!b)
      F += this.iconv.decode(v.slice(y), "ascii");
    else {
      var C = w + this.iconv.decode(v.slice(y), "ascii"), U = C.length - C.length % 8;
      w = C.slice(U), C = C.slice(0, U), F += this.iconv.decode(t.from(C, "base64"), "utf16-be");
    }
    return this.inBase64 = b, this.base64Accum = w, F;
  }, a.prototype.end = function() {
    var v = "";
  ...
  d.prototype.encoder = l, d.prototype.decoder = g, d.prototype.bomAware = !0;
  function l(v, F) {
    this.iconv = F.iconv, this.inBase64 = !1, this.base64Accum = t.alloc(6), this.base64AccumIdx = 0;
  }
  l.prototype.write = function(v) {
    for (var F = this.inBase64, y = this.base64Accum, b = this.base64AccumIdx, w = t.alloc(v.length * 5 + 10), k = 0, C = 0; C < v.length; C++) {
      var U = v.charCodeAt(C);
      U >= 32 && U <= 126 ? (F && (b > 0 && (k += w.write(y.slice(0, b).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), k), b = 0), w[k++] = u, F = !1), F || (w[k++] = U, U === h && (w[k++] = u))) : (F || (w[k++] = h, F = !0), F && (y[b++] = U >> 8, y[b++] = U & 255, b == y.length && (k += w.write(y.toString("base64").replace(/\//g, ","), k), b = 0)));
    }
    return this.inBase64 = F, this.base64AccumIdx = b, w.slice(0, k);
  }, l.prototype.end = function() {
    var v = t.alloc(10), F = 0;
    return this.inBase64 && (this.base64AccumIdx > 0 && (F += v.write(this.base64Accum.slice(0, this.base64AccumIdx).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), F), this.base64AccumIdx = 0), v[F++] = u, this.inBase64 = !1), v.slice(0, F);
  };
  function g(v, F) {
    this.iconv = F.iconv, this.inBase64 = !1, this.base64Accum = "";
  }
  ...
  return x[44] = !0, g.prototype.write = function(v) {
    for (var F = "", y = 0, b = this.inBase64, w = this.base64Accum, k = 0; k < v.length; k++)
      if (!b)
        v[k] == h && (F += this.iconv.decode(v.slice(y, k), "ascii"), y = k + 1, b = !0);
      else if (!x[v[k]]) {
        if (k == y && v[k] == u)
          F += "&";
        else {
...
function Sl() {
  ...
  function e(a, i) {
    ...
    this.decodeBuf = t.from(a.chars, "ucs2");
    for (var c = t.alloc(65536, i.defaultCharSingleByte.charCodeAt(0)), o = 0; o < a.chars.length; o++)
      c[a.chars.charCodeAt(o)] = o;
    this.encodeBuf = c;
  }
  ...
  r.prototype.write = function(a) {
    for (var i = t.alloc(a.length), s = 0; s < a.length; s++)
      i[s] = this.encodeBuf[a.charCodeAt(s)];
    return i;
  }, r.prototype.end = function() {
  };
  function n(a, i) {
  ...
  return n.prototype.write = function(a) {
    for (var i = this.decodeBuf, s = t.alloc(a.length * 2), o = 0, c = 0, u = 0; u < a.length; u++)
      o = a[u] * 2, c = u * 2, s[c] = i[o], s[c + 1] = i[o + 1];
...
function kl() {
  ...
  function c(l, g) {
    ...
    if (typeof l.gb18030 == "function") {
      ...
      this.decodeTables.push(i.slice(0));
      for (var b = this.decodeTables[0], v = 129; v <= 254; v++)
        for (var w = this.decodeTables[a - b[v]], k = 48; k <= 57; k++) {
          if (w[k] === e)
            w[k] = a - F;
          else if (w[k] > a)
          ...
          for (var C = this.decodeTables[a - w[k]], U = 129; U <= 254; U++) {
            ...
            for (var B = this.decodeTables[a - C[U]], O = 48; O <= 57; O++)
              B[O] === e && (B[O] = r);
          }
        }
    }
    ...
    if (l.encodeSkipVals)
      for (var v = 0; v < l.encodeSkipVals.length; v++) {
        var z = l.encodeSkipVals[v];
        if (typeof z == "number")
          H[z] = !0;
        else
          for (var k = z.from; k <= z.to; k++)
            H[k] = !0;
      }
    if (this._fillEncodeTable(0, 0, H), l.encodeAdd)
      for (var W in l.encodeAdd)
        Object.prototype.hasOwnProperty.call(l.encodeAdd, W) && this._setEncodeChar(W.charCodeAt(0), l.encodeAdd[W]);
  ...
  c.prototype.encoder = u, c.prototype.decoder = h, c.prototype._getDecodeTrieNode = function(l) {
      ...
      if (typeof F == "string")
        for (var y = 0; y < F.length; ) {
          ...
          if (b >= 55296 && b < 56320) {
            ...
            if (w >= 56320 && w < 57344)
              x[g++] = 65536 + (b - 55296) * 1024 + (w - 56320);
            else
              throw new Error("Incorrect surrogate pair in " + this.encodingName + " at chunk " + l[0]);
          } else if (b > 4080 && b <= 4095) {
            for (var k = 4095 - b + 2, C = [], U = 0; U < k; U++)
              C.push(F.charCodeAt(y++));
            x[g++] = n - this.decodeTableSeq.length, this.decodeTableSeq.push(C);
          } else
            x[g++] = b;
        }
      else if (typeof F == "number")
        for (var B = x[g - 1] + 1, y = 0; y < F; y++)
          x[g++] = B++;
      else
        throw new Error("Incorrect type '" + typeof F + "' given in " + this.encodingName + " at chunk " + l[0]);
    }
    if (g > 255)
  ...
  }, c.prototype._setEncodeChar = function(l, g) {
    ...
    var x = l[0], v = this._getEncodeBucket(x), F = x & 255, y;
    v[F] <= n ? y = this.encodeTableSeq[n - v[F]] : (y = {}, v[F] !== e && (y[s] = v[F]), v[F] = n - this.encodeTableSeq.length, this.encodeTableSeq.push(y));
    for (var b = 1; b < l.length - 1; b++) {
      var w = y[x];
      typeof w == "object" ? y = w : (y = y[x] = {}, w !== void 0 && (y[s] = w));
    }
    x = l[l.length - 1], y[x] = g;
  }, c.prototype._fillEncodeTable = function(l, g, x) {
    for (var v = this.decodeTables[l], F = !1, y = {}, b = 0; b < 256; b++) {
      var w = v[b], k = g + b;
      if (!x[k])
        if (w >= 0)
          ...
          if (!y[C]) {
            var U = k << 8 >>> 0;
            this._fillEncodeTable(C, U, x) ? F = !0 : y[C] = !0;
          }
  ...
  u.prototype.write = function(l) {
    for (var g = t.alloc(l.length * (this.gb18030 ? 4 : 3)), x = this.leadSurrogate, v = this.seqObj, F = -1, y = 0, b = 0; ; ) {
      if (F === -1) {
        if (y == l.length) break;
      ...
      if (v !== void 0 && w != e) {
        ...
        if (typeof C == "object") {
          v = C;
          continue;
        } else typeof C == "number" ? k = C : C == null && (C = v[s], C !== void 0 && (k = C, F = w));
        v = void 0;
      } else if (w >= 0) {
        var U = this.encodeTable[w >> 8];
        if (U !== void 0 && (k = U[w & 255]), k <= n) {
        ...
        if (k == e && this.gb18030) {
          ...
          if (B != -1) {
            ...
            g[b++] = 129 + Math.floor(k / 12600), k = k % 12600, g[b++] = 48 + Math.floor(k / 1260), k = k % 1260, g[b++] = 129 + Math.floor(k / 10), k = k % 10, g[b++] = 48 + k;
            continue;
          }
        }
      }
      k === e && (k = this.defaultCharSingleByte), k < 256 ? g[b++] = k : k < 65536 ? (g[b++] = k >> 8, g[b++] = k & 255) : k < 16777216 ? (g[b++] = k >> 16, g[b++] = k >> 8 & 255, g[b++] = k & 255) : (g[b++] = k >>> 24, g[b++] = k >>> 16 & 255, g[b++] = k >>> 8 & 255, g[b++] = k & 255);
    }
    return this.seqObj = v, this.leadSurrogate = x, g.slice(0, b);
  }, u.prototype.end = function() {
    if (!(this.leadSurrogate === -1 && this.seqObj === void 0)) {
      var l = t.alloc(10), g = 0;
      if (this.seqObj) {
        var x = this.seqObj[s];
        x !== void 0 && (x < 256 ? l[g++] = x : (l[g++] = x >> 8, l[g++] = x & 255)), this.seqObj = void 0;
      }
  ...
  h.prototype.write = function(l) {
    for (var g = t.alloc(l.length * 2), x = this.nodeIdx, v = this.prevBytes, F = this.prevBytes.length, y = -this.prevBytes.length, b, w = 0, k = 0; w < l.length; w++) {
      var C = w >= 0 ? l[w] : v[w + F], b = this.decodeTables[x][C];
      if (!(b >= 0)) if (b === e)
        ...
        if (w >= 3)
          ...
          var U = (v[w - 3 + F] - 129) * 12600 + ((w - 2 >= 0 ? l[w - 2] : v[w - 2 + F]) - 48) * 1260 + ((w - 1 >= 0 ? l[w - 1] : v[w - 1 + F]) - 129) * 10 + (C - 48);
        var B = d(this.gb18030.gbChars, U);
        b = this.gb18030.uChars[B] + U - this.gb18030.gbChars[B];
      } else if (b <= a) {
        x = a - b;
        continue;
      } else if (b <= n) {
        for (var O = this.decodeTableSeq[n - b], H = 0; H < O.length - 1; H++)
          b = O[H], g[k++] = b & 255, g[k++] = b >> 8;
        b = O[O.length - 1];
      } else
        throw new Error("iconv-lite internal error: invalid decoding table value " + b + " at " + x + "/" + C);
      if (b >= 65536) {
        b -= 65536;
        var z = 55296 | b >> 10;
        g[k++] = z & 255, g[k++] = z >> 8, b = 56320 | b & 1023;
      }
      g[k++] = b & 255, g[k++] = b >> 8, x = 0, y = w + 1;
    }
    return this.nodeIdx = x, this.prevBytes = y >= 0 ? Array.prototype.slice.call(l, y) : v.slice(y + F).concat(Array.prototype.slice.call(l)), g.slice(0, k).toString("ucs2");
  }, h.prototype.end = function() {
    for (var l = ""; this.prevBytes.length > 0; ) {
      l += this.defaultCharUnicode;
      var g = this.prevBytes.slice(1);
      this.prevBytes = [], this.nodeIdx = 0, g.length > 0 && (l += this.write(g));
    }
...
function Ml() {
  ...
  return Dr = function(e) {
    ...
    n.prototype = Object.create(r.prototype, {
      constructor: { value: n }
    }), n.prototype._transform = function(i, s, o) {
      if (typeof i != "string")
    ...
    function a(i, s) {
      this.conv = i, s = s || {}, s.encoding = this.encoding = "utf8", r.call(this, s);
    }
    return a.prototype = Object.create(r.prototype, {
      constructor: { value: a }
    }), a.prototype._transform = function(i, s, o) {
      ...
      try {
        var s = this.conv.end();
        s && s.length && this.push(s, this.encoding), i();
      } catch (o) {
        i(o);
      }
    }, a.prototype.collect = function(i) {
      var s = "";
      return this.on("error", i), this.on("data", function(o) {
        s += o;
      }), this.on("end", function() {
...
const Il = {}, Dl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Il
}, Symbol.toStringTag, { value: "Module" })), _l = /* @__PURE__ */ al(Dl);
(function(t) {
  var e = et.Buffer, r = dn, n = Yi, a = t.exports;
  ...
  }, a._canonicalizeEncoding = function(s) {
    return ("" + s).toLowerCase().replace(/:\d{4}$|[^0-9a-z]/g, "");
  }, a.getEncoder = function(o, c) {
    var u = a.getCodec(o), h = new u.encoder(c, u);
    return u.bomAware && c && c.addBOM && (h = new r.PrependBOM(h, c)), h;
  }, a.getDecoder = function(o, c) {
    var u = a.getCodec(o), h = new u.decoder(c, u);
...
class yn extends $a {
   ...
   */
  constructor(e, r, n, a) {
    super(), this.fontSize = r, this.shape = n, this.font = a, this.code = e, this.width = this.resolveAdvanceWidth(n);
  }
  /**
  ...
  resolveAdvanceWidth(e) {
    var a;
    const r = this.calcWidth(), n = ((a = e.lastPoint) == null ? void 0 : a.x) ?? 0;
    if (this.font.data.header.fontType === ve.BIGFONT) {
      const { width: i, height: s } = this.font.data.content, o = s > 0 ? i / s * this.fontSize : 0;
      return Math.max(r, n, o);
    }
    return n > 0 ? n : r;
  }
  calcWidth() {
  ...
  toGeometry() {
    ...
    if (e == null) {
      ...
      let i = 0;
      e = new M.BufferGeometry();
      for (let s = 0; s < r.length; s++) {
        const o = r[s];
        for (let c = 0; c < o.length; c++) {
          const u = o[c];
          n.push(u.x, u.y, 0), c === o.length - 1 || a.push(i, i + 1), i++;
        }
      }
      e.setAttribute(
        "position",
        new M.Float32BufferAttribute(n, 3)
      ), e.setIndex(a);
    }
    return e;
  }
...
class Gl extends ja {
  constructor(e) {
    super(e), this.type = "shx", this.font = new rl(e.data), this.data = this.font.fontData;
  }
  /**
   * Return true if this font contains glyph of the specified character. Otherwise, return false.
   * @param char - The character to check
   ...
   */
  getSpaceAdvance(e) {
    const r = this.getCharShape(" ", e);
    return r ? r.width : e * 0.5;
  }
  generateShapes(e, r) {
    const n = [];
    let a = 0;
    for (let i = 0; i < e.length; i++) {
      const s = e[i];
      if (s === " ") {
        a += this.getSpaceAdvance(r);
        continue;
      }
      const o = this.getCharShape(s, r);
      if (!o) {
        a += this.getSpaceAdvance(r), this.addUnsupportedChar(s);
        continue;
      }
   ...
   */
  getCharShape(e, r) {
    return this.getCodeShape(this.getCode(e), r);
  }
  /**
   ...
   */
  getCodeShape(e, r) {
    const n = this.font.getCharShape(e, r);
    return n ? new yn(e, r, n, this) : void 0;
  }
  /**
   * For an unsupported char, use "？" as a replacement.
   */
  getNotFoundTextShape(e) {
    const r = this.font.fontData.header.fontType === ve.BIGFONT ? "？" : "?";
    return this.getCharShape(r, e);
  }
  /**
   ...
   */
  getCode(e) {
    if (this.font.fontData.header.fontType === ve.BIGFONT && this.encoding) {
      const n = Nl.encode(e[0], this.encoding);
...
class Ie {
  constructor() {
    this.fontMapping = {}, this.loadedFontMap = /* @__PURE__ */ new Map(), this.unsupportedChars = {}, this.missedFonts = {}, this.enableFontCache = !0, this.defaultFont = "simkai", this.events = {
      ...
      fontLoaded: new Tn()
    }, this.loader = new M.FileLoader(), this.loader.setResponseType("arraybuffer"), this.fileNames = [], this.fontLoader = new Hl();
  }
  /**
  ...
  async loadFonts(e) {
    ...
    for (let a = 0; a < e.length; a++)
      r.push(this.loadFont(e[a]));
    const n = [];
    return await Promise.allSettled(r).then((a) => {
      a.forEach((i, s) => {
        const o = i.status === "fulfilled", c = e[s].url, u = Cn(c.toLowerCase());
        n.push({
          fontName: u,
          url: c,
   ...
   */
  getCharShape(e, r, n) {
    let a = this.getFontByName(r);
    return a || (a = this.getFontByChar(e)), a == null ? void 0 : a.getCharShape(e, n);
  }
  /**
  ...
  async loadFont(e) {
    ...
    if (this.isFontLoaded(n.name))
      return;
    const i = await wt.instance.get(a);
    if (i) {
      const s = $e.instance.createFont(i);
      this.loadedFontMap.set(a, s);
    } else {
      const s = await this.loader.loadAsync(e.url);
      n.data = s;
      const o = $e.instance.createFont(n);
      o && (e.name.forEach((c) => o.names.add(c)), this.loadedFontMap.set(a, o), this.enableFontCache && await wt.instance.set(a, n));
    }
  ...
  fontInfoToFontData(e) {
    const r = Cn(e.file).toLowerCase(), n = ["ttf", "otf", "woff"].includes(e.type) ? "mesh" : e.type;
    return {
      name: r,
      alias: e.name,
      type: n,
  ...
  async getAllFontsFromCache() {
    if (this.loadedFontMap.size !== 0)
      return;
    const e = await wt.instance.getAll();
    for (const r of e) {
      const { name: n } = r;
      if (this.fileNames && !this.fileNames.includes(n))
        continue;
      const a = $e.instance.createFont(r);
...
class Hl {
  ...
  async load(e) {
    ...
    const r = [], n = [];
    e.forEach((s) => {
      const o = s.toLowerCase(), c = this._avaiableFontMap.get(o);
      c && (Ie.instance.isFontLoaded(o) && r.push({
        fontName: o,
        url: c.url,
        status: "Success"
      }), n.push(c));
    });
    const a = await Ie.instance.loadFonts(n), i = {};
...
function cf(t) {
  const e = t >> 16 & 255, r = t >> 8 & 255, n = t & 255;
  return [e, r, n];
}
function _a(t) {
...
function ql(t) {
  return t === null ? null : `#${ji(t).toString(16).padStart(6, "0")}`;
}
function Xl(t) {
  if (!t)
    return null;
  ...
  if (/^[0-9a-f]{6}$/.test(e))
    return `#${e}`;
  if (/^#[0-9a-f]{3}$/.test(e)) {
    const r = e[1], n = e[2], a = e[3];
    return `#${r}${r}${n}${n}${a}${a}`;
  }
  if (/^[0-9a-f]{3}$/.test(e)) {
    const r = e[0], n = e[1], a = e[2];
    return `#${r}${r}${n}${n}${a}${a}`;
  }
  return null;
}
function Yl(t) {
  ...
  const r = Xl(e);
  if (r)
    return ji(Number.parseInt(r.slice(1), 16));
  const n = e.match(/^rgba?\((.*)\)$/);
  if (!n)
    return null;
  const a = n[1].replace(/\s*\/\s*/g, " ").split(/[,\s]+/).map((u) => u.trim()).filter(Boolean);
  if (a.length < 3)
    return null;
  const i = (u) => {
    if (u.endsWith("%")) {
...
class Zl {
   ...
   */
  constructor(e, r, n = {}) {
    this.continueStroke = !1, this.inStackContext = !1, this.scanner = new _r(e);
    const a = r ?? new It();
    this.ctxStack = new $l(a), this.yieldPropertyCommands = n.yieldPropertyCommands ?? !1, this.resetParagraphParameters = n.resetParagraphParameters ?? !1, this.mifDecoder = n.mifDecoder ?? this.decodeMultiByteChar.bind(this), this.mifCodeLength = n.mifCodeLength ?? "auto";
  }
  /**
  ...
  decodeMultiByteChar(e) {
    try {
      if (e.length === 5) {
        ...
        ]), a = new TextDecoder("gbk").decode(r);
        if (a !== "▯")
          return a;
        const s = new TextDecoder("big5").decode(r);
        if (s !== "▯")
          return s;
      }
      return "▯";
  ...
  extractMifCode(e) {
    ...
    if (e === "auto") {
      ...
      if (i)
        return i;
      const s = (n = this.scanner.tail.match(/^[0-9A-Fa-f]{4}/)) == null ? void 0 : n[0];
      return s || null;
    } else
   ...
   */
  parseStacking() {
    const e = new _r(this.extractExpression(!0));
    let r = "", n = "", a = "";
    const i = () => {
      let c = e.peek(), u = !1;
      return c.charCodeAt(0) < 32 && (c = " "), c === "\\" && (u = !0, e.consume(1), c = e.peek()), e.consume(1), [c, u];
    }, s = () => {
      let c = "";
      for (; e.hasData; ) {
        const [u, h] = i();
    ...
    return [r, a] = s(), a && (n = o(a === "^")), r === "" && n.includes("I/") ? [Z.STACK, [" ", " ", "/"]] : a === "^" ? [Z.STACK, [r, n, "^"]] : [Z.STACK, [r, n, a]];
  }
  /**
   ...
   */
  parseAlign(e) {
    const r = this.scanner.get();
    "012".includes(r) ? e.align = parseInt(r) : e.align = Ze.BOTTOM, this.consumeOptionalTerminator();
  }
  /**
   ...
   */
  parseHeight(e) {
    const r = this.extractFloatExpression(!0);
    if (r)
      try {
        r.endsWith("x") ? e.capHeight = {
          value: parseFloat(r.slice(0, -1)),
          isRelative: !0
        } : e.capHeight = {
          value: parseFloat(r),
          isRelative: !1
  ...
  parseCharTracking(e) {
    ...
    if (r)
      try {
        r.endsWith("x") ? e.charTrackingFactor = {
          value: Math.abs(parseFloat(r.slice(0, -1))),
          isRelative: !0
        } : e.charTrackingFactor = {
          value: Math.abs(parseFloat(r)),
          isRelative: !1
        };
      } catch {
        this.scanner.consume(-r.length);
  ...
  parseFloatValueOrFactor(e) {
    ...
    if (r)
      if (r.endsWith("x")) {
        const n = parseFloat(r.slice(0, -1));
        e *= n;
      } else
        e = parseFloat(r);
    return e;
   ...
   */
  parseOblique(e) {
    const r = this.extractFloatExpression(!1);
    r && (e.oblique = parseFloat(r)), this.consumeOptionalTerminator();
  }
  /**
   ...
   */
  parseAciColor(e) {
    const r = this.extractIntExpression();
    if (r) {
      const n = parseInt(r);
      n < 257 && (e.color.aci = n);
    }
  ...
  extractFloatExpression(e = !1) {
    const r = e ? /^[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:[eE][+-]?\d+)?x?/ : /^[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:[eE][+-]?\d+)?/, n = this.scanner.tail.match(r);
    if (n) {
      const a = n[0];
  ...
  extractIntExpression() {
    ...
    if (e) {
      const r = e[0];
      return this.scanner.consume(r.length), r;
    }
    return "";
  }
  /**
  ...
  extractExpression(e = !1) {
    const r = this.scanner.find(";", e);
    if (r < 0) {
      const s = this.scanner.tail;
      return this.scanner.consume(s.length), s;
    }
    const a = this.scanner.peek(r - this.scanner.currentIndex - 1) === "\\", i = this.scanner.tail.slice(0, r - this.scanner.currentIndex + (a ? 1 : 0));
  ...
  parseFontProperties(e) {
    const r = this.extractExpression().split("|");
    if (r.length > 0 && r[0]) {
      const n = r[0];
      let a = "Regular", i = 400;
      for (const s of r.slice(1))
        s.startsWith("b1") ? i = 700 : s === "i" || s.startsWith("i1") ? a = "Italic" : (s === "i0" || s.startsWith("i0")) && (a = "Regular");
      e.fontFace = {
        family: n,
        style: a,
        weight: i
  ...
  parseParagraphProperties(e) {
    const r = new _r(this.extractExpression());
    let n = e.paragraph.indent, a = e.paragraph.left, i = e.paragraph.right, s = e.paragraph.align, o = [];
    const c = () => {
      const u = r.tail.match(/^[+-]?\d+(?:\.\d*)?(?:[eE][+-]?\d+)?/);
      if (u) {
        const h = parseFloat(u[0]);
        for (r.consume(u[0].length); r.peek() === ","; )
          r.consume(1);
        return h;
      }
      return 0;
      ...
      for (; this.scanner.hasData; ) {
        ...
        if (c.charCodeAt(0) < 32) {
          if (this.scanner.consume(1), c === "	")
            return [Z.TABULATOR, null];
          if (c === `
`)
            return [Z.NEW_PARAGRAPH, null];
          c = " ";
        }
        if (c === "\\")
        ...
        if (c === "%" && this.scanner.peek(1) === "%") {
          const h = this.scanner.peek(2).toLowerCase(), d = Wl[h];
          if (d) {
            this.scanner.consume(3), s += d;
            continue;
          } else {
            const l = [h, this.scanner.peek(3), this.scanner.peek(4)];
            if (l.every((g) => g >= "0" && g <= "9")) {
              const g = Number.parseInt(l.join(""), 10);
              this.scanner.consume(5), s += String.fromCharCode(g);
            } else
        ...
        if (c === " ")
          return s ? (this.scanner.consume(1), n = r, [e, s]) : (this.scanner.consume(1), [r, null]);
        if (!o) {
          if (c === "{") {
            if (s)
              return [e, s];
        ...
        this.scanner.consume(1), c.charCodeAt(0) >= 32 && (s += c);
      }
      return s ? [e, s] : [Z.NONE, null];
    };
    for (; ; ) {
      const [s, o] = i.call(this);
      if (s) {
        if (yield new Pr(s, this.ctxStack.current.copy(), o), s === Z.NEW_PARAGRAPH && this.resetParagraphParameters) {
          const c = this.ctxStack.current, u = a(c);
          this.yieldPropertyCommands && Object.keys(u).length > 0 && (yield new Pr(Z.PROPERTIES_CHANGED, c.copy(), {
            command: void 0,
            changes: { paragraph: u },
            depth: this.ctxStack.depth
          }));
        }
        n && (yield new Pr(n, this.ctxStack.current.copy(), null), n = null);
      } else
        break;
    }
  }
...
class _r {
   ...
   */
  peek(e = 0) {
    const r = this._index + e;
    return r >= this.textLen || r < 0 ? "" : this.text[r];
  }
  /**
...
class gt {
  ...
  get rgb() {
    if (this._rgbValue === null)
      return null;
    const e = this._rgbValue >> 16 & 255, r = this._rgbValue >> 8 & 255, n = this._rgbValue & 255;
    return [e, r, n];
  }
  /**
  ...
  set rgb(e) {
    if (e) {
      const [r, n, a] = e;
      this._rgbValue = (r & 255) << 16 | (n & 255) << 8 | a & 255, this._aci = null;
    } else
      this._rgbValue = null;
  }
  /**
   ...
   */
  toCssColor() {
    return this._rgbValue !== null ? ql(this._rgbValue) : null;
  }
  /**
...
class It {
  constructor() {
    this._stroke = 0, this.continueStroke = !1, this.color = new gt(), this.align = Ze.BOTTOM, this.fontFace = { family: "", style: "Regular", weight: 400 }, this._capHeight = { value: 1, isRelative: !1 }, this._widthFactor = { value: 1, isRelative: !1 }, this._charTrackingFactor = { value: 1, isRelative: !1 }, this.oblique = 0, this.paragraph = {
      indent: 0,
      left: 0,
      right: 0,
      align: ee.DEFAULT,
   ...
   */
  get underline() {
    return !!(this._stroke & Xe.UNDERLINE);
  }
  /**
   ...
   */
  set underline(e) {
    this._setStrokeState(Xe.UNDERLINE, e);
  }
  /**
   * Get whether text has strike-through
   */
  get strikeThrough() {
    return !!(this._stroke & Xe.STRIKE_THROUGH);
  }
  /**
   ...
   */
  set strikeThrough(e) {
    this._setStrokeState(Xe.STRIKE_THROUGH, e);
  }
  /**
   * Get whether text has overline
   */
  get overline() {
    return !!(this._stroke & Xe.OVERLINE);
  }
  /**
   ...
   */
  set overline(e) {
    this._setStrokeState(Xe.OVERLINE, e);
  }
  /**
   ...
   */
  _setStrokeState(e, r = !0) {
    r ? this._stroke |= e : this._stroke &= ~e;
  }
  /**
...
function Qt(t) {
  ...
  return r === 0 ? jt(t.byBlockColor) : r === 256 ? jt(t.byLayerColor) : r != null ? Ya(r) : e.rgbValue !== null ? jt(e.rgbValue) : jt(t.byLayerColor);
}
function Pa(t, e, r) {
  const n = new gt();
  return r && e === t.byLayerColor ? n.aci = 256 : n.rgbValue = e, {
...
const Kl = 1.666666, $t = 0.3;
var Ye = /* @__PURE__ */ ((t) => (t[t.LEFT_TO_RIGHT = 1] = "LEFT_TO_RIGHT", t[t.RIGHT_TO_LEFT = 2] = "RIGHT_TO_LEFT", t[t.TOP_TO_BOTTOM = 3] = "TOP_TO_BOTTOM", t[t.BOTTOM_TO_TOP = 4] = "BOTTOM_TO_TOP", t[t.BY_STYLE = 5] = "BY_STYLE", t))(Ye || {}), X = /* @__PURE__ */ ((t) => (t[t.TopLeft = 1] = "TopLeft", t[t.TopCenter = 2] = "TopCenter", t[t.TopRight = 3] = "TopRight", t[t.MiddleLeft = 4] = "MiddleLeft", t[t.MiddleCenter = 5] = "MiddleCenter", t[t.MiddleRight = 6] = "MiddleRight", t[t.BottomLeft = 7] = "BottomLeft", t[t.BottomCenter = 8] = "BottomCenter", t[t.BottomRight = 9] = "BottomRight", t[t.BaselineLeft = 10] = "BaselineLeft", t[t.BaselineCenter = 11] = "BaselineCenter", t[t.BaselineRight = 12] = "BaselineRight", t))(X || {}), se = /* @__PURE__ */ ((t) => (t.CHAR = "CHAR", t.STACK = "STACK", t))(se || {});
const er = "", ot = () => ({
...
function Qr(t, e, r) {
  const n = [];
  if (t.filter((l) => l.char !== er).forEach((l) => {
    const g = Jl(
    ...
    return n;
  const a = (l) => l.type === se.CHAR && l.char.trim().length === 0, i = (l) => l.type === se.CHAR && l.char.trim().length > 0, s = n.findIndex(i);
  if (s < 0) return n;
  let o = -1;
  ...
  const d = new M.Box3().copy(h[0].box);
...
function Na(t) {
  ...
  return !Number.isFinite(e) || !Number.isFinite(r) || e <= 0 || r <= 0 || e >= r * Ql ? e : tf(t.text, r);
}
...
class mn extends It {
   ...
   */
  getColorAsHex() {
    return this.color.isRgb && this.color.rgbValue !== null ? this.color.rgbValue : this.color.isAci && this.color.aci !== null ? Ya(this.color.aci) : 16777215;
  }
  /**
...
class nf {
  ...
  get currentLineHeight() {
    const e = this.defaultLineSpaceFactor * this.currentFontSize * Kl, r = this.currentMaxFontSize > 0 ? this.currentMaxFontSize : this.currentFontSize;
    return e + r;
  }
  /**
   ...
   */
  startNewParagraph(e, r, n, a, i) {
    this.recordVisualLineBreak(n, a), this.processGeometries(
      e,
      r,
      n,
      a,
  ...
  processText(e) {
    ...
    for (const o of e)
      ...
      } else if (o.type === Z.SPACE)
        this.processBlank(a, i);
      else if (o.type === Z.PROPERTIES_CHANGED) {
    ...
    return r.length > 0 || n.length > 0 ? this.processGeometries(
      ...
      i,
      s
    ), this.processLastLine(), this.captureCurrentLineAdvance(), this.recordCurrentLineLayout(), s.userData.lineLayouts = this._lineLayouts.map((o, c) => ({
      ...o,
      breakIndex: c < this._lineLayouts.length - 1 ? this._lineBreakIndices[c] : void 0
    })), s.userData.logicalAdvanceWidth = this._maxLineAdvance, s;
  }
  ...
  processWord(e, r, n, a, i) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      c ? this.currentHorizontalAlignment == ee.DISTRIBUTED ? s += c.width * this.currentWidthFactor : s += c.width * this.currentWordSpace * this.currentWidthFactor : s += this.currentBlankAdvance;
    }
  ...
  processStack(e, r, n, a, i) {
    const [s, o, c] = e, u = this._hOffset, h = this._vOffset, d = this._currentContext.charTrackingFactor.value, l = this.currentFontSize, g = this._currentContext.fontSizeScaleFactor;
    ...
    const F = Math.max(x, v), y = (F - x) / 2, b = (F - v) / 2;
    if (c === "^") {
      if (this._currentContext.fontSizeScaleFactor = g * 0.7, this.calcuateLineParams(), s && !o) {
        ...
        r.push(...w), n.push(...k), a.push(...C), i.push(...U), this._hOffset = u + x;
      } else if (!s && o) {
        const w = [], k = [], C = [], U = [];
        this._hOffset = u, this._vOffset = this.convertTopAlignedVOffset(
          h - l * 0.6,
      ...
      const B = [], O = [], H = [], z = [];
      this._hOffset = u + b, this._vOffset = this.convertTopAlignedVOffset(
      ...
      if (r.push(...B), n.push(...O), a.push(...H), i.push(...z), c === "/" || c === "#") {
        const W = new M.BufferGeometry(), le = new Float32Array([
          u,
          h - this.currentFontSize * 0.8 + this.defaultFontSize * $t,
          0,
          u + F,
          h - this.currentFontSize * 0.8 + this.defaultFontSize * $t,
          0
        ...
        ), W.setIndex(null), W.userData = { isDecoration: !0 }, n.push(W);
      }
      this._hOffset = u + F;
    }
  ...
  recordStackDivider(e, r, n, a, i) {
    ...
    const s = r - this.currentFontSize * 0.8 + this.defaultFontSize * $t, o = new M.Box3(
      new M.Vector3(e, s, 0),
   ...
   */
  convertTopAlignedVOffset(e, r) {
    return e - r + this.defaultFontSize + this.defaultFontSize * $t;
  }
  processBlank(e, r) {
  ...
  recordVisualLineBreak(e, r) {
    const n = this._processedCharCount + this.countFinalCharBoxes(
      e ?? [],
      r ?? [],
      se.CHAR
    );
    this._lineBreakIndices.push(n);
  }
  recordCurrentLineLayout() {
    const e = this.flowDirection == Ye.BOTTOM_TO_TOP ? this._vOffset : this._vOffset - this.defaultFontSize, r = this.currentLineHeight;
    this._lineLayouts.push({
      y: e + r / 2,
      height: r
    });
  }
  processChar(e, r, n, a, i) {
    const s = this.getCharShape(e);
    if (!s) {
      this.processBlank(a, i);
      return;
    }
    ...
    let h = 0;
    if (u) {
      const b = u * Math.PI / 180, w = new M.Matrix4();
      w.set(
        1,
        Math.tan(b),
        0,
        ...
        0,
        1
      ), o.applyMatrix4(w), h = Math.tan(b) * c;
    }
    const d = this.fontManager.getFontType(this.currentFont);
    this._currentContext.bold && d === "mesh" && o.scale(1.06, 1.06, 1), this.hOffset > (this.maxLineWidth || 1 / 0) && (this.recordVisualLineBreak(a, i), this.advanceToNextLine(!1));
    const l = this.hOffset, g = this.flowDirection == Ye.BOTTOM_TO_TOP ? this.vOffset : this.vOffset - this.currentLayoutFontSize, x = s.width * this.currentWidthFactor;
    o.translate(l, g, 0);
    const v = s.width * this.currentWidthFactor + h * this.currentWidthFactor;
    if (this.currentHorizontalAlignment == ee.DISTRIBUTED ? this._hOffset += v : this._hOffset += s.width * this.currentWordSpace * this.currentWidthFactor + h * this.currentWidthFactor, r.push(o), this._lineHasRenderableChar = !0, this._options.collectCharBoxes !== !1) {
    ...
    const F = c * 0.05, y = 1e-3;
    if (this._currentContext.underline) {
      const b = new M.BufferGeometry(), w = g - F;
      b.setAttribute(
        "position",
    ...
    if (this._currentContext.overline) {
      const b = new M.BufferGeometry(), w = g + c + F;
      b.setAttribute(
        "position",
        new M.BufferAttribute(
          new Float32Array([
    ...
    if (this._currentContext.strikeThrough) {
      const b = new M.BufferGeometry(), w = g + c / 2 - c * 0.2;
      b.setAttribute(
        "position",
        new M.BufferAttribute(
          new Float32Array([
  ...
  advanceToNextLine(e = !0) {
    e && this.recordVisualLineBreak(), this.captureCurrentLineAdvance(), this.recordCurrentLineLayout(), this._hOffset = 0, this._lineHasRenderableChar ? this._pendingEmptyLineFontSizeAdjust = void 0 : this._pendingEmptyLineFontSizeAdjust = this.currentFontSize, this.flowDirection == Ye.BOTTOM_TO_TOP ? this._vOffset += this.currentLineHeight : this._vOffset -= this.currentLineHeight, this._lineCount++, this.processAlignment(), this._currentLineObjects = [], this._lineCount == 2 ? this._totalHeight = this.currentMaxFontSize : this._totalHeight = this._totalHeight + this.currentLineHeight, this._maxFontSize = 0, this._lineHasRenderableChar = !1;
  }
  ...
  applyPendingEmptyLineYAdjust() {
    ...
    e !== 0 && (this.flowDirection == Ye.BOTTOM_TO_TOP ? this._vOffset += e : this._vOffset -= e), this._pendingEmptyLineFontSizeAdjust = void 0;
  }
  ...
  processAlignment() {
    ...
    const n = r, a = n.getSize(rf), i = (s, o) => {
      ...
      if (c && c.length > 0) {
        const d = new M.Vector3(o, 0, 0);
        c.forEach((l) => {
          var g;
          return (g = l.box) == null ? void 0 : g.translate(d);
        });
      }
    };
    switch (this.currentHorizontalAlignment) {
      case ee.LEFT:
      case ee.JUSTIFIED: {
        const s = Number.isFinite(this.maxLineWidth) ? this._currentLeftMargin - n.min.x : this._currentLeftMargin, o = /* @__PURE__ */ new Set();
        e.forEach((c) => {
      ...
      case ee.DISTRIBUTED: {
        ...
        e.forEach((c, u) => {
          ...
          c.geometry.translate(h, 0, 0), o.has(c.owner) || (i(c.owner, h), o.add(c.owner));
        });
        break;
      }
    }
  ...
  calculateBlankWidthForFont(e, r) {
    const n = this.fontManager.getCharShape(" ", e, r);
    return n && n.width > 0 ? n.width : this.fontManager.getFontType(e) === "shx" ? r * 0.5 : r * 0.3;
  }
  /**
  ...
  toThreeObject(e, r, n, a, i) {
    const s = new M.Group(), o = this.getMaterialColorSettings(), c = this.styleManager.getMeshBasicMaterial(
      o
    ), u = this.styleManager.getLineBasicMaterial(
      o
    ), h = this._options.collectCharBoxes !== !1, d = e.filter((g) => g instanceof M.ShapeGeometry);
    if (d.length > 0) {
      const g = d.length > 1 ? ya(d) : d[0], x = new M.Mesh(g, c);
      x.userData.bboxIntersectionCheck = !0, x.userData.charBoxType = i, h && n.length > 0 && (x.userData.layout = { chars: n.slice() }), s.add(x);
    }
    const l = [
      ...r,
      ...e.filter((g) => !(g instanceof M.ShapeGeometry))
    ];
    if (l.length > 0) {
      const g = l.length > 1 ? ya(l) : l[0], x = new M.LineSegments(g, u);
...
const St = /* @__PURE__ */ new M.Vector3(), Pe = /* @__PURE__ */ new M.Vector3(), Ne = /* @__PURE__ */ new M.Vector3(), Ga = /* @__PURE__ */ new M.Vector3(1, 0, 0);
class or extends M.Object3D {
  /**
  ...
  constructor(e, r, n, a, i = ot()) {
    super(), this._style = r, this._styleManager = n, this._fontManager = a, this._colorSettings = {
      ...
      layer: i.layer,
      color: i.color.copy()
    }, this._box = new M.Box3(), this._layoutData = void 0, this._mtextData = e, this._fontsInStyleLoaded = !1;
  }
  /**
   ...
   */
  async asyncDraw() {
    const e = Array.from(or.getFonts(this._mtextData.text || "", !0));
   ...
   */
  raycast(e, r) {
    this.createLayoutData().chars.forEach((a) => {
      if (a.box && e.ray.intersectBox(a.box, St)) {
        const i = e.ray.origin.distanceTo(St);
        r.push({
          distance: i,
          point: St.clone(),
          object: this,
  ...
  loadMText(e, r) {
    ...
    const s = new M.Box3().setFromObject(n);
    if (!Number.isFinite(i)) {
      const x = (g = n.userData) == null ? void 0 : g.logicalAdvanceWidth, v = typeof x == "number" && x > 0 ? x : s.max.x - s.min.x;
      i = Number.isFinite(v) && v > 0 ? v : 0;
    }
    ...
    const u = (x) => {
      ...
      const v = new M.Vector3(c.x, c.y, 0), F = (y) => {
        var b;
        (b = y.box) == null || b.translate(v), y.children && y.children.length > 0 && y.children.forEach(F);
      };
      x.forEach(F);
    }, h = (x) => {
    ...
    n.traverse((x) => {
      var v, F, y;
      "geometry" in x && x.geometry.translate(c.x, c.y, 0), u(
        (F = (v = x.userData) == null ? void 0 : v.layout) == null ? void 0 : F.chars
      ), h(
        (y = x.userData) == null ? void 0 : y.lineLayouts
      ), x.layers.enableAll();
    });
    let d = e.rotation || 0;
    if (e.directionVector) {
      const x = e.directionVector, v = new M.Vector3(x.x, x.y, x.z), F = v.clone().cross(Ga), y = Ga.angleTo(v);
      d = F.z > 0 ? -y : y;
    }
    const l = e.position;
    return n.position.set((l == null ? void 0 : l.x) ?? 0, (l == null ? void 0 : l.y) ?? 0, (l == null ? void 0 : l.z) ?? 0), n.quaternion.setFromAxisAngle(new M.Vector3(0, 0, 1), d), n.scale.set(1, 1, 1), n.updateMatrix(), n.updateMatrixWorld(!0), n;
  }
  /**
  ...
  createMTextGroup(e, r) {
    ...
    const n = Na(e) || 0, a = Number.isFinite(n) && n > 0;
    let i = ee.LEFT;
    a && e.attachmentPoint && ([
      X.TopLeft,
      X.MiddleLeft,
    ...
    e.attachmentPoint && ([
      ...
      X.TopCenter,
      X.TopRight
    ].includes(e.attachmentPoint) ? s = Ze.TOP : [
      X.MiddleLeft,
      X.MiddleCenter,
      X.MiddleRight
    ...
    l.fontFace.family = r.font, l.capHeight = {
      value: o,
      isRelative: !1
    }, l.widthFactor = {
      value: c,
  ...
  measureAnchorMetrics(e, r, n, a, i) {
    ...
    e.traverse((v) => {
      var y;
      const F = (y = v.userData) == null ? void 0 : y.lineLayouts;
      !F || F.length === 0 || F.forEach((b) => {
        const w = b.y - b.height / 2, k = b.y + b.height / 2;
    ...
    let l = 0, g = 0;
    i == Ye.BOTTOM_TO_TOP ? (l = a.isEmpty() ? 0 : a.min.y, g = l + u) : (g = a.isEmpty() ? 0 : a.max.y, l = g - u);
    const x = s.hasLine ? s.baselineY : l;
    return { minX: h, maxX: d, minY: l, maxY: g, baselineY: x };
  }
  /**
  ...
  getLayout(e, r, n) {
    ...
    if (i && i.length > 0 && i.forEach((l) => {
      St.set(0, l.y, 0).applyMatrix4(e.matrixWorld), Pe.set(0, l.y - l.height / 2, 0).applyMatrix4(e.matrixWorld), Ne.set(0, l.y + l.height / 2, 0).applyMatrix4(e.matrixWorld), n.push({
        y: St.y,
        height: Math.abs(Ne.y - Pe.y),
        breakIndex: l.breakIndex
      });
    }), a && a.length > 0) {
      const l = (h = e.userData) == null ? void 0 : h.charBoxType, g = Qr(
        a,
        e.matrixWorld,
        l
      );
  ...
  updateBoxFromObject(e, r) {
    ...
    if (e instanceof M.Line || e instanceof M.Mesh) {
      const g = e.geometry;
      if (!((l = g.userData) != null && l.isDecoration)) {
        g.boundingBox === null && g.computeBoundingBox();
        const x = new M.Box3().copy(g.boundingBox);
        x.applyMatrix4(e.matrixWorld), this.box.union(x);
      }
    }
    const s = e.children;
    for (let g = 0, x = s.length; g < x; g++)
      this.updateBoxFromObject(s[g], r);
  }
  /**
  ...
  disposeThreeObject(e) {
    e.traverse((r) => {
      if (r.geometry && typeof r.geometry.dispose == "function")
        try {
          r.geometry.dispose();
        } catch {
        }
      if (r.material) {
        const n = (a) => {
          if (a && typeof a.dispose == "function")
            try {
              a.dispose();
            } catch {
            }
        };
        Array.isArray(r.material) ? r.material.forEach(n) : n(r.material);
      }
    });
  }
  /**
...
class $i {
  ...
  getMeshBasicMaterial(e) {
    ...
    if (!this.meshBasicMaterials[r]) {
      const n = Qt(e);
      this.meshBasicMaterials[r] = new M.MeshBasicMaterial({
        color: n
      });
    }
    return this.meshBasicMaterials[r];
  }
  getLineBasicMaterial(e) {
    const r = this.buildKey(e);
    if (!this.lineBasicMaterials[r]) {
      const n = Qt(e);
      this.lineBasicMaterials[r] = new M.LineBasicMaterial({
        color: n
      });
    }
    return this.lineBasicMaterials[r];
  }
  /**
   ...
   */
  buildKey(e) {
    const r = e.color.aci === 256, n = Qt(e);
    return r && e.layer ? `layer_${e.layer}_${n}` : `entity_${n}`;
  }
}
const Ha = /* @__PURE__ */ new M.Vector3(), Wa = /* @__PURE__ */ new M.Vector3(), za = /* @__PURE__ */ new M.Vector3();
class af {
  constructor(e = {}) {
    ...
    ), this.defaultStyleManager = new $i();
  ...
  async ensureInitialized() {
    this.isInitialized || (await this.loadFonts([Ie.instance.defaultFont]), this.isInitialized = !0);
  }
  /**
   * Handles messages coming from any worker.
   */
  handleWorkerMessage(e, r) {
    const { id: n, success: a, data: i, error: s } = e, o = this.pendingRequests.get(n);
    o ? (this.pendingRequests.delete(n), this.inFlightPerWorker[r] = Math.max(
      0,
      this.inFlightPerWorker[r] - 1
    ), a ? o.resolve(i) : o.reject(new Error(s || "Unknown worker error"))) : console.warn(`No pending request found for worker response id=${n}`);
  }
  /**
  ...
  attachWorkerHandlers(e, r) {
    e.onmessage = (n) => {
      this.handleWorkerMessage(n.data, r);
    }, e.onerror = (n) => {
      console.error(`Worker ${r} error:`, n);
      const a = [];
      this.pendingRequests.forEach((i, s) => {
        i.workerIndex === r && a.push(s);
      }), a.forEach((i) => {
        const s = this.pendingRequests.get(i);
        s && (s.reject(new Error("Worker error occurred")), this.pendingRequests.delete(i));
      }), this.inFlightPerWorker[r] = 0;
    };
  }
  pickLeastLoadedWorker() {
    let e = 0, r = this.inFlightPerWorker[0] ?? 0;
    for (let n = 1; n < this.inFlightPerWorker.length; n++) {
      const a = this.inFlightPerWorker[n] ?? 0;
      a < r && (r = a, e = n);
    }
    return e;
  }
  sendMessageToAllWorkers(e) {
    return Promise.all(
      this.workers.map(
        (r, n) => this.sendMessageToOneWorker(e, n)
      )
    );
  }
  sendMessageToOneWorker(e, r) {
    const n = r ?? this.pickLeastLoadedWorker(), a = this.workers[n];
    return new Promise((i, s) => {
      ...
      this.pendingRequests.set(o, {
        ...
        reject: s,
        workerIndex: n
      }), this.inFlightPerWorker[n] = (this.inFlightPerWorker[n] ?? 0) + 1, a.postMessage(c), setTimeout(() => {
        this.pendingRequests.get(o) && (this.pendingRequests.delete(o), this.inFlightPerWorker[n] = Math.max(
          0,
      ...
      this.workers.map(
        (e, r) => new Promise((n, a) => {
          ...
          this.pendingRequests.set(i, {
            ...
            reject: a,
            workerIndex: r
          }), this.inFlightPerWorker[r] = (this.inFlightPerWorker[r] ?? 0) + 1, e.postMessage({ type: "getAvailableFonts", id: i }), setTimeout(() => {
            this.pendingRequests.get(i) && (this.pendingRequests.delete(i), this.inFlightPerWorker[r] = Math.max(
              0,
              this.inFlightPerWorker[r] - 1
   ...
   */
  async asyncRenderMText(e, r, n = ot()) {
    await this.ensureInitialized();
    const a = await this.sendMessageToOneWorker({
      type: "render",
      data: { mtextContent: e, textStyle: r, colorSettings: n }
    });
    return this.reconstructMText(a, n);
  }
  /**
   * Render MText synchronously.
   * Notes: It isn't supported yet.
   */
  syncRenderMText(e, r, n = ot()) {
    throw new Error(
  ...
  async loadFonts(e) {
    ...
    const r = await this.sendMessageToAllWorkers({
      type: "loadFonts",
      data: { fonts: e }
    }), n = /* @__PURE__ */ new Set();
    return r.forEach((a) => {
      var i;
      return (i = a == null ? void 0 : a.loaded) == null ? void 0 : i.forEach((s) => n.add(s));
    }), { loaded: Array.from(n) };
  }
  async getAvailableFonts() {
  ...
  reconstructMText(e, r) {
    const n = r.color.aci === 256, a = new M.Group();
    e.children.forEach((s) => {
      ...
      if (Object.keys(s.geometry.attributes).forEach((h) => {
        ...
        if (s.geometry.index.componentType === "uint32") {
          ...
          o.setIndex(new M.Uint32BufferAttribute(d, 1));
        } else {
          ...
          o.setIndex(new M.Uint16BufferAttribute(d, 1));
        }
      let c;
      if (s.type === "mesh") {
        const h = Pa(
        ...
        c = this.defaultStyleManager.getMeshBasicMaterial({
          ...h
        }), s.material.transparent !== void 0 && (c.transparent = s.material.transparent), s.material.opacity !== void 0 && (c.opacity = s.material.opacity), s.material.side !== void 0 && (c.side = s.material.side);
      } else {
        const h = Pa(
          r,
          s.material.color,
        ...
        c = this.defaultStyleManager.getLineBasicMaterial({
          ...h
      ...
      let u;
      s.type === "mesh" ? u = new M.Mesh(o, c) : u = new M.LineSegments(
        o,
        c
        ...
        s.rotation.z,
        s.rotation.w
      ), u.scale.set(s.scale.x, s.scale.y, s.scale.z), s.charBoxType && (u.userData.charBoxType = s.charBoxType), s.lineLayouts && s.lineLayouts.length > 0 && (u.userData.lineLayouts = s.lineLayouts.map((h) => ({
        y: h.y,
        height: h.height,
    ...
    return i.createLayoutData = () => {
      var c;
      const s = (c = a.userData) == null ? void 0 : c.layoutCache;
      if (s)
        return s;
      const o = { lines: [], chars: [] };
      return a.updateWorldMatrix(!0, !0), this.collectLayout(a, o.chars, o.lines), a.userData.layoutCache = o, o;
    }, i;
  }
  deserializeCharBoxes(e) {
    return e.map((r) => ({
      ...
      char: r.char,
      box: new M.Box3(
        new M.Vector3(r.box.min.x, r.box.min.y, r.box.min.z),
        new M.Vector3(r.box.max.x, r.box.max.y, r.box.max.z)
      ),
  ...
  collectLayout(e, r, n) {
    ...
    const a = (c = (o = e.userData) == null ? void 0 : o.layout) == null ? void 0 : c.chars, i = (u = e.userData) == null ? void 0 : u.lineLayouts;
    if (i && i.length > 0 && i.forEach((l) => {
      Ha.set(0, l.y, 0).applyMatrix4(e.matrixWorld), Wa.set(0, l.y - l.height / 2, 0).applyMatrix4(e.matrixWorld), za.set(0, l.y + l.height / 2, 0).applyMatrix4(e.matrixWorld), n.push({
        y: Ha.y,
        height: Math.abs(za.y - Wa.y),
        breakIndex: l.breakIndex
      });
    }), a && a.length > 0) {
      const l = (h = e.userData) == null ? void 0 : h.charBoxType, g = Qr(
   ...
   */
  terminate() {
    this.workers.forEach((e) => e.terminate()), this.workers = [], this.inFlightPerWorker = [], this.readyPromise = null, this.pendingRequests.forEach(({ reject: e }) => {
...
class sf {
  constructor() {
    this.fontManager = Ie.instance, this.defaultStyleManager = new $i(), this.isInitialized = !1;
  }
  /**
   * Used to manage materials used by texts
   */
...
class lf {
  ...
  constructor(e = "main", r = {}) {
    this.defaultMode = e, this.mainThreadRenderer = new sf(), this.webWorkerRenderer = new af(r), this.renderer = this.mainThreadRenderer, e === "worker" && (this.renderer = this.webWorkerRenderer);
  }
  /**
   ...
   */
  setStyleManager(e) {
    this.mainThreadRenderer.styleManager = e, this.webWorkerRenderer.styleManager = e;
  }
  /**
   ...
   */
  async asyncRenderMText(e, r, n = ot(), a) {
...
export {
  ja as BaseFont,
  $a as BaseTextShape,
  ef as CJK_MTEXT_CHAR_WIDTH_HEIGHT_RATIO,
  se as CharBoxType,
  Hl as DefaultFontLoader,
  Tn as EventManager,
  $e as FontFactory,
  Ie as FontManager,
  Kl as LINE_SPACING_SCALE_FACTOR,
  Ql as MIN_REASONABLE_MTEXT_WIDTH_HEIGHT_RATIO,
  or as MText,
  ...
  er as STACK_DIVIDER_CHAR,
  $t as STACK_VERTICAL_SHIFT_FACTOR,
  rl as ShxParserFont,
  _r as TextScanner,
  Z as TokenType,
  lf as UnifiedRenderer,
  af as WebWorkerRenderer,
  Pa as buildWorkerMaterialColorSettings,
  ot as createDefaultColorSettings,
  uf as escapeDxfLineEndings,
  tf as estimateMTextWrapWidth,
  Ya as getColorByIndex,
  jl as getFonts,
  hf as hasInlineFormattingCodes,
  cf as int2rgb,
  Qt as resolveMTextColor,
  Na as resolveMTextWrapWidth,
  Vl as rgb2int
};
