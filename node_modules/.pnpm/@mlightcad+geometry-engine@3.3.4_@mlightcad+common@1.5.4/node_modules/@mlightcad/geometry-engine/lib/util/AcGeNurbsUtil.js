 ...
 */
export function evaluateNurbsDerivatives(u, degree, knots, controlPoints, weights) {
    var n = controlPoints.length - 1;
    var p = degree;
    ...
    if (Math.abs(w) < 1e-10) {
        var point_1 = evaluateNurbsPoint(u, degree, knots, controlPoints, weights);
 ...
 */
export function signedPlanarCurvature(deriv1, deriv2) {
    var dx = deriv1[0];
    var dy = deriv1[1];
    var ddx = deriv2[0];
    var ddy = deriv2[1];
