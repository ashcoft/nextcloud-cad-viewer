...
class Ka {
  constructor(e) {
    this.names = /* @__PURE__ */ new Set(), this.unsupportedChars = {}, this.encoding = e.encoding, e.alias.forEach((r) => this.names.add(r)), this.cache = new ss();
  }
  /**
...
const Wr = (t, e) => e.some((r) => t instanceof r);
let Un, On;
function os() {
  return Un || (Un = [
    IDBDatabase,
...
const Vr = /* @__PURE__ */ new WeakMap(), gr = /* @__PURE__ */ new WeakMap(), ur = /* @__PURE__ */ new WeakMap();
function us(t) {
...
function ls(t) {
  return cs().includes(t) ? function(...e) {
    return t.apply(Xr(this), e), st(this.request);
  } : function(...e) {
    return st(t.apply(Xr(this), e));
  };
}
function fs(t) {
  return typeof t == "function" ? ls(t) : (t instanceof IDBTransaction && hs(t), Wr(t, os()) ? new Proxy(t, qr) : t);
}
function st(t) {
  ...
  if (gr.has(t))
    return gr.get(t);
  const e = fs(t);
  return e !== t && (gr.set(t, e), ur.set(e, t)), e;
}
const Xr = (t) => ur.get(t);
function ps(t, e, { blocked: r, upgrade: n, blocking: a, terminated: i } = {}) {
  const s = indexedDB.open(t, e), o = st(s);
  return n && s.addEventListener("upgradeneeded", (c) => {
    n(st(s.result), c.oldVersion, c.newVersion, st(s.transaction), c);
...
const ds = ["get", "getKey", "getAll", "getAllKeys", "count"], gs = ["put", "add", "delete", "clear"], vr = /* @__PURE__ */ new Map();
function Rn(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (vr.get(e))
    return vr.get(e);
  const r = e.replace(/FromIndex$/, ""), n = e !== r, a = gs.includes(r);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(r in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || ds.includes(r))
  )
    return;
...
Ja((t) => ({
  ...t,
  get: (e, r, n) => Rn(e, r) || t.get(e, r, n),
  has: (e, r) => !!Rn(e, r) || t.has(e, r)
}));
const vs = ["continue", "continuePrimaryKey", "advance"], Mn = {}, Yr = /* @__PURE__ */ new WeakMap(), ei = /* @__PURE__ */ new WeakMap(), ys = {
  get(t, e) {
    if (!vs.includes(e))
      return t[e];
    let r = Mn[e];
    return r || (r = Mn[e] = function(...n) {
      Yr.set(this, ei.get(this)[e](...n));
    }), r;
  }
};
async function* ms(...t) {
  ...
  if (e instanceof IDBCursor || (e = await e.openCursor(...t)), !e)
    return;
  e = e;
  const r = new Proxy(e, ys);
  for (ei.set(r, e), ur.set(r, Xr(e)); e; )
    yield r, e = await (Yr.get(r) || e.continue()), Yr.delete(r);
}
function In(t, e) {
  return e === Symbol.asyncIterator && Wr(t, [IDBIndex, IDBObjectStore, IDBCursor]) || e === "iterate" && Wr(t, [IDBIndex, IDBObjectStore]);
}
Ja((t) => ({
  ...t,
  get(e, r, n) {
    return In(e, r) ? ms : t.get(e, r, n);
  },
  has(e, r) {
    return In(e, r) || t.has(e, r);
  }
}));
const nt = {
  fonts: "fonts"
   ...
   */
  async set(e, r) {
    await (await this.getDatabase()).put(nt.fonts, { ...r, name: e });
  }
  /**
  ...
  async getDatabase() {
    ...
    return this.db ? this.db : (this.db = await ps(
      ye.DATABASE_NAME,
      ye.DATABASE_VERSION,
      {
...
ye.DATABASE_NAME = "mlightcad", ye.DATABASE_VERSION = yr[yr.length - 1].version;
let Ft = ye;
...
function xs(t, e) {
  this.source = t, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = e, this.destLen = 0, this.ltree = new Ct(), this.dtree = new Ct();
}
var ri = new Ct(), ni = new Ct(), sn = new Uint8Array(30), on = new Uint16Array(30), ai = new Uint8Array(30), ii = new Uint16Array(30), bs = new Uint8Array([
  16,
  17,
  18,
  0,
  ...
  1,
  15
]), Dn = new Ct(), Ue = new Uint8Array(320);
function si(t, e, r, n) {
  var a, i;
  for (a = 0; a < r; ++a)
    t[a] = 0;
...
function Pn(t, e, r) {
  for (; ; ) {
    ...
    if (n < 256)
      ...
      var a, i, s, o;
      for (n -= 257, a = Oe(t, sn[n], on[n]), i = jr(t, r), s = t.destLen - Oe(t, ai[i], ii[i]), o = s; o < s + a; ++o)
...
function ks(t) {
  ...
  return t.bitcount = 0, an;
}
function Ts(t, e) {
  var r = new xs(t, e), n, a, i;
  do {
    switch (n = ws(r), a = Oe(r, 2, 0), a) {
      case 0:
        i = ks(r);
        break;
      case 1:
        ...
        break;
      case 2:
        Fs(r, r.ltree, r.dtree), i = Pn(r, r.ltree, r.dtree);
        break;
      default:
        i = ti;
    }
...
Je.prototype.addBezier = function(t, e, r, n, a, i, s, o) {
  var c = [t, e], u = [r, n], h = [a, i], g = [s, o];
  this.addPoint(t, e), this.addPoint(s, o);
  for (var l = 0; l <= 1; l++) {
    var p = 6 * c[l] - 12 * u[l] + 6 * h[l], x = -3 * c[l] + 9 * u[l] - 9 * h[l] + 3 * g[l], v = 3 * u[l] - 3 * c[l];
    if (x === 0) {
      if (p === 0)
        continue;
      var F = -v / p;
      0 < F && F < 1 && (l === 0 && this.addX(ht(c[l], u[l], h[l], g[l], F)), l === 1 && this.addY(ht(c[l], u[l], h[l], g[l], F)));
      continue;
    }
    var m = Math.pow(p, 2) - 4 * v * x;
    if (!(m < 0)) {
      var S = (-p + Math.sqrt(m)) / (2 * x);
      0 < S && S < 1 && (l === 0 && this.addX(ht(c[l], u[l], h[l], g[l], S)), l === 1 && this.addY(ht(c[l], u[l], h[l], g[l], S)));
      var w = (-p - Math.sqrt(m)) / (2 * x);
      0 < w && w < 1 && (l === 0 && this.addX(ht(c[l], u[l], h[l], g[l], w)), l === 1 && this.addY(ht(c[l], u[l], h[l], g[l], w)));
    }
  }
};
...
var zt = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), Wt, Es = function(t) {
  if (!Wt) {
    Wt = {};
    for (var e in $r)
      Wt[e] = new String(e);
...
M.TABLE = function(t) {
  ...
  for (var h = 0; h < n.length; h += 1) {
    var g = a[h], l = e.length;
    P.argument(l < 65536, "Table " + t.tableName + " too big."), e[g] = l >> 8, e[g + 1] = l & 255, e = e.concat(n[h]);
  }
  return e;
};
N.TABLE = function(t) {
...
function rr(t) {
  t.format === 1 ? pe.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(Et("glyph", t.glyphs))
  ) : t.format === 2 ? pe.call(
    this,
    "coverageTable",
    [{ name: "coverageFormat", type: "USHORT", value: 2 }].concat(Lt("rangeRecord", t.ranges, function(e) {
      return [
...
function nr(t) {
  pe.call(
    this,
    "scriptListTable",
    Lt("scriptRecord", t, function(e, r) {
      ...
      return P.assert(!!a, "Unable to write GSUB: script " + e.tag + " has no default language system."), [
        ...
        { name: "script" + r, type: "TABLE", value: new pe("scriptTable", [
          ...
          ].concat(Et("featureIndex", a.featureIndexes))) }
        ].concat(Lt("langSys", n.langSysRecords, function(i, s) {
          var o = i.langSys;
          return [
            ...
            ].concat(Et("featureIndex", o.featureIndexes))) }
          ];
        }))) }
      ];
    })
...
function ar(t) {
  pe.call(
    this,
    "featureListTable",
    Lt("featureRecord", t, function(e, r) {
      var n = e.feature;
      return [
        ...
        ].concat(Et("lookupListIndex", n.lookupListIndexes))) }
      ];
    })
  );
}
...
function ir(t, e) {
  pe.call(this, "lookupListTable", Kr("lookup", t, function(r) {
    ...
    ].concat(Kr("subtable", r.subtables, n)));
  }));
}
ir.prototype = Object.create(pe.prototype);
...
E.prototype.parseLongDateTime = function() {
  var t = cn(this.data, this.offset + this.relativeOffset + 4);
  return t -= 2082844800, this.relativeOffset += 8, t;
};
E.prototype.parseVersion = function(t) {
  var e = sr(this.data, this.offset + this.relativeOffset), r = sr(this.data, this.offset + this.relativeOffset + 2);
  return this.relativeOffset += 4, t === void 0 && (t = 4096), e + r / t / 10;
};
E.prototype.skip = function(t, e) {
  e === void 0 && (e = 1), this.relativeOffset += Ds[t] * e;
};
...
E.prototype.parseScriptList = function() {
  return this.parsePointer(E.recordList({
    tag: E.tag,
    script: E.pointer({
      defaultLangSys: E.pointer(Wn),
      langSysRecords: E.recordList({
        tag: E.tag,
        langSys: E.pointer(Wn)
      })
    })
  })) || [];
};
...
function Ps(t, e, r, n, a) {
  ...
  for (var s = new _.Parser(r, n + a + 14), o = new _.Parser(r, n + a + 16 + i * 2), c = new _.Parser(r, n + a + 16 + i * 4), u = new _.Parser(r, n + a + 16 + i * 6), h = n + a + 16 + i * 8, g = 0; g < i - 1; g += 1)
    for (var l = void 0, p = s.parseUShort(), x = o.parseUShort(), v = c.parseShort(), F = u.parseUShort(), m = x; m <= p; m += 1)
      F !== 0 ? (h = u.offset + u.relativeOffset - 2, h += F, h += (m - x) * 2, l = _.getUShort(r, h), l !== 0 && (l = l + v & 65535)) : l = m + v & 65535, t.glyphIndexMap[m] = l;
}
function Ns(t, e) {
  var r = {};
...
function zs(t) {
  ...
  Hs(i);
  var c = i.segments.length, u = 0, h = [], g = [], l = [], p = [], x = [], v = [];
  for (r = 0; r < c; r += 1) {
    var F = i.segments[r];
...
hi.prototype.charToGlyphIndex = function(t) {
...
li.prototype.charToGlyphIndex = function(t) {
  return this.cmap.glyphIndexMap[t.codePointAt(0)] || 0;
};
function or(t, e) {
  this.encoding = t, this.charset = e;
}
or.prototype.charToGlyphIndex = function(t) {
  ...
  switch (t.version) {
    ...
    case 2:
      ...
      for (var e = 0; e < t.numberOfGlyphs; e++)
        t.glyphNameIndex[e] < at.length ? this.names[e] = at[t.glyphNameIndex[e]] : this.names[e] = t.names[t.glyphNameIndex[e] - at.length];
      break;
    case 2.5:
      this.names = new Array(t.numberOfGlyphs);
      for (var r = 0; r < t.numberOfGlyphs; r++)
        this.names[r] = at[r + t.glyphNameIndex[r]];
      break;
    case 3:
      this.names = [];
      break;
...
un.prototype.nameToGlyphIndex = function(t) {
  return this.names.indexOf(t);
};
un.prototype.glyphIndexToName = function(t) {
  return this.names[t];
};
function qs(t) {
...
ke.prototype.bindConstructorValues = function(t) {
  this.index = t.index || 0, this.name = t.name || null, this.unicode = t.unicode || void 0, this.unicodes = t.unicodes || t.unicode !== void 0 ? [t.unicode] : [], "xMin" in t && (this.xMin = t.xMin), "yMin" in t && (this.yMin = t.yMin), "xMax" in t && (this.xMax = t.xMax), "yMax" in t && (this.yMax = t.yMax), "advanceWidth" in t && (this.advanceWidth = t.advanceWidth), Object.defineProperty(this, "path", $s(this, t.path));
};
...
ke.prototype.getPath = function(t, e, r, n, a) {
  ...
  for (var h = new he(), g = 0; g < i.length; g += 1) {
    var l = i[g];
...
ke.prototype.drawPoints = function(t, e, r, n) {
  function a(g, l, p, x) {
    ...
    for (var v = 0; v < g.length; v += 1)
      t.moveTo(l + g[v].x * x, p + g[v].y * x), t.arc(l + g[v].x * x, p + g[v].y * x, 2, 0, Math.PI * 2, !1);
    t.closePath(), t.fill();
  }
...
function Ks(t, e, r, n, a, i) {
  return function() {
    ...
    }, qt(s, "xMin", "_xMin"), qt(s, "xMax", "_xMax"), qt(s, "yMin", "_yMin"), qt(s, "yMax", "_yMax"), s;
  };
}
function Qs(t, e, r, n) {
  return function() {
...
var De = { GlyphSet: hn, glyphLoader: Zs, ttfGlyphLoader: Ks, cffGlyphLoader: Qs };
function fi(t, e) {
  if (t === e)
    return !0;
...
function qe(t, e, r) {
  ...
  if (i !== 0) {
    ...
    o = e + 2;
  for (var g = 0; g < n.length - 1; g += 1) {
    var l = _.getBytes(t, s + n[g], s + n[g + 1]);
    r && (l = r(l)), a.push(l);
  }
...
function pi(t, e, r) {
  ...
  for (r = r !== void 0 ? r : t.length; n.relativeOffset < r; ) {
    var s = n.parseByte();
    s <= 21 ? (s === 12 && (s = 1200 + n.parseByte()), a.push([s, i]), i = []) : i.push(ro(n, s));
  }
  return no(a);
}
function kt(t, e) {
  return e <= 390 ? e = Kt[e] : e = t[e - 391], e;
}
function di(t, e, r) {
  for (var n = {}, a, i = 0; i < e.length; i += 1) {
    ...
    if (Array.isArray(s.type)) {
      ...
      for (var c = 0; c < s.type.length; c++)
        a = t[s.op] !== void 0 ? t[s.op][c] : void 0, a === void 0 && (a = s.value !== void 0 && s.value[c] !== void 0 ? s.value[c] : null), s.type[c] === "SID" && (a = kt(r, a)), o[c] = a;
      n[s.name] = o;
    } else
      a = t[s.op], a === void 0 && (a = s.value !== void 0 ? s.value : null), s.type === "SID" && (a = kt(r, a)), n[s.name] = a;
  }
  return n;
}
function ao(t, e) {
...
function Vn(t, e, r, n) {
  for (var a = [], i = 0; i < r.length; i += 1) {
    var s = new DataView(new Uint8Array(r[i]).buffer), o = io(s, n);
...
function oo(t, e, r) {
  ...
  if (s === 0)
    ...
    n = 1;
    for (var h = 0; h < u; h += 1)
      for (var g = i.parseCard8(), l = i.parseCard8(), p = g; p <= g + l; p += 1)
        a[p] = n, n += 1;
  } else
...
function qn(t, e, r) {
  var n, a, i, s, o = new he(), c = [], u = 0, h = !1, g = !1, l = 0, p = 0, x, v, F, m;
  if (t.isCIDFont) {
    var S = t.tables.cff.topDict._fdSelect[e.index], w = t.tables.cff.topDict._fdArray[S];
    x = w._subrs, v = w._subrsBias, F = w._defaultWidthX, m = w._nominalWidthX;
  } else
    x = t.tables.cff.topDict._subrs, v = t.tables.cff.topDict._subrsBias, F = t.tables.cff.topDict._defaultWidthX, m = t.tables.cff.topDict._nominalWidthX;
  var k = F;
  function C(O, H) {
    g && o.closePath(), o.moveTo(O, H), g = !0;
  }
  function U() {
    var O;
    ...
    for (var H, W, z, le, ce, $, K, Q, ae, ue, oe, fe, G = 0; G < O.length; ) {
      ...
      switch (G += 1, q) {
        ...
        case 3:
          ...
          break;
        case 4:
          c.length > 1 && !h && (k = c.shift() + m, h = !0), p += c.pop(), C(l, p);
          break;
        case 5:
          for (; c.length > 0; )
        ...
        case 12:
          ...
          break;
        case 14:
          c.length > 0 && !h && (k = c.shift() + m, h = !0), g && (o.closePath(), g = !1);
          break;
        case 18:
          U();
          break;
        ...
        case 20:
          ...
          break;
        case 21:
          c.length > 2 && !h && (k = c.shift() + m, h = !0), p += c.pop(), l += c.pop(), C(l, p);
          break;
        case 22:
          c.length > 1 && !h && (k = c.shift() + m, h = !0), l += c.pop(), C(l, p);
          break;
        case 23:
          U();
          break;
...
function co(t, e, r, n) {
  ...
  if (o === 0)
    ...
    for (var g, l = 0; l < u; l++) {
      if (i = s.parseCard8(), g = s.parseCard16(), i >= n)
        throw new Error("CFF table CID Font FDSelect has bad FD index value " + i + " (FD count " + n + ")");
      if (g > r)
        throw new Error("CFF Table CID Font FDSelect format 3 range has bad GID " + g);
      for (; h < g; h++)
        a.push(i);
      h = g;
    }
    if (g !== r)
      throw new Error("CFF Table CID Font FDSelect format 3 range has bad final GID " + g);
  } else
...
function uo(t, e, r, n) {
  r.tables.cff = {};
  var a = ao(t, e), i = qe(t, a.endOffset, _.bytesToString), s = qe(t, i.endOffset), o = qe(t, s.endOffset, _.bytesToString), c = qe(t, o.endOffset);
  r.gsubrs = c.objects, r.gsubrsBias = Qr(r.gsubrs);
  var u = Vn(t, e, s.objects, o.objects);
  if (u.length !== 1)
  ...
  if (r.tables.cff.topDict = h, h._privateDict && (r.defaultWidthX = h._privateDict.defaultWidthX, r.nominalWidthX = h._privateDict.nominalWidthX), h.ros[0] !== void 0 && h.ros[1] !== void 0 && (r.isCIDFont = !0), r.isCIDFont) {
    var g = h.fdArray, l = h.fdSelect;
    if (g === 0 || l === 0)
      throw new Error("Font is marked as a CID font, but FDArray and/or FDSelect information is missing");
    g += e;
    var p = qe(t, g), x = Vn(t, e, p.objects, o.objects);
    h._fdArray = x, l += e, h._fdSelect = co(t, l, r.numGlyphs, x.length);
  }
  var v = e + h.private[1], F = yi(t, v, h.private[0], o.objects);
  if (r.defaultWidthX = F.defaultWidthX, r.nominalWidthX = F.nominalWidthX, F.subrs !== 0) {
    var m = v + F.subrs, S = qe(t, m);
    r.subrs = S.objects, r.subrsBias = Qr(r.subrs);
  } else
    r.subrs = [], r.subrsBias = 0;
  var w;
  n.lowMemory ? (w = Js(t, e + h.charStrings), r.nGlyphs = w.offsets.length) : (w = qe(t, e + h.charStrings), r.nGlyphs = w.objects.length);
  var k = so(t, e + h.charset, r.nGlyphs, o.objects);
  if (h.encoding === 0 ? r.cffEncoding = new or(Ws, k) : h.encoding === 1 ? r.cffEncoding = new or(Vs, k) : r.cffEncoding = oo(t, e + h.encoding, k), r.encoding = r.encoding || r.cffEncoding, r.glyphs = new De.GlyphSet(r), n.lowMemory)
    r._push = function(B) {
      var O = eo(B, w.offsets, t, e + h.charStrings);
      r.glyphs.push(B, De.cffGlyphLoader(r, B, qn, O));
    };
  else
    for (var C = 0; C < r.nGlyphs; C += 1) {
      var U = w.objects[C];
      r.glyphs.push(C, De.cffGlyphLoader(r, C, qn, U));
    }
}
function mi(t, e) {
  var r, n = Kt.indexOf(t);
  return n >= 0 && (r = n), n = e.indexOf(t), n >= 0 ? r = n + Kt.length : (r = Kt.length + e.length, e.push(t)), r;
}
function ho() {
...
function xi(t, e, r) {
  for (var n = {}, a = 0; a < t.length; a += 1) {
    ...
    s !== void 0 && !fi(s, i.value) && (i.type === "SID" && (s = mi(s, r)), n[i.op] = { name: i.name, type: i.type, value: s });
  }
  return n;
}
function Xn(t, e) {
...
function vo(t) {
  ...
  for (var n = 0, a = 0, i = 0; i < r.commands.length; i += 1) {
    ...
    if (c.type === "M")
      ...
      var g = Math.round(c.x1 - n), l = Math.round(c.y1 - a), p = Math.round(c.x2 - c.x1), x = Math.round(c.y2 - c.y1);
      s = Math.round(c.x - c.x2), o = Math.round(c.y - c.y2), e.push({ name: "dx1", type: "NUMBER", value: g }), e.push({ name: "dy1", type: "NUMBER", value: l }), e.push({ name: "dx2", type: "NUMBER", value: p }), e.push({ name: "dy2", type: "NUMBER", value: x }), e.push({ name: "dx", type: "NUMBER", value: s }), e.push({ name: "dy", type: "NUMBER", value: o }), e.push({ name: "rrcurveto", type: "OP", value: 8 }), n = Math.round(c.x), a = Math.round(c.y);
    }
  }
...
function xo(t, e) {
  ...
  var g = r.header.sizeOf() + r.nameIndex.sizeOf() + r.topDictIndex.sizeOf() + r.stringIndex.sizeOf() + r.globalSubrIndex.sizeOf();
  return a.charset = g, a.encoding = 0, a.charStrings = a.charset + r.charsets.sizeOf(), a.private[1] = a.charStrings + r.charStringsIndex.sizeOf(), h = Xn(a, u), r.topDictIndex = Yn(h), r;
}
...
function Co(t, e, r, n, a, i, s) {
  s.lowMemory ? To(t, e, r, n, a) : ko(e, r, n, a, i);
}
function Eo(t) {
...
function Do(t, e, r) {
  for (var n = {}, a = new _.Parser(t, e), i = a.parseUShort(), s = a.parseUShort(), o = a.offset + a.parseUShort(), c = 0; c < s; c++) {
    var u = a.parseUShort(), h = a.parseUShort(), g = a.parseUShort(), l = a.parseUShort(), p = Ci[l] || l, x = a.parseUShort(), v = a.parseUShort(), F = Ro(u, g, r), m = Ai(u, h, g);
    if (m !== void 0 && F !== void 0) {
      var S = void 0;
      if (m === Jr ? S = gt.UTF16(t, o + v, x) : S = gt.MACSTRING(t, o + v, x, m), S) {
        var w = n[p];
        w === void 0 && (w = n[p] = {}), w[F] = S;
      }
    }
  }
...
function Po(t, e) {
  ...
  for (var c = xr(Ei), u = xr(Li), h = [], g = [], l = 0; l < n.length; l++) {
    r = n[l];
    var p = a[r];
    for (var x in p) {
      var v = p[x], F = 1, m = c[x], S = Oo[m], w = Ai(F, S, m), k = M.MACSTRING(v, w);
      k === void 0 && (F = 0, m = e.indexOf(x), m < 0 && (m = e.length, e.push(x)), S = 4, k = M.UTF16(v));
      var C = $n(k, g);
      h.push(jn(
        F,
        S,
  ...
  h.sort(function(z, le) {
    return z.platformID - le.platformID || z.encodingID - le.encodingID || z.languageID - le.languageID || z.nameID - le.nameID;
  });
  ...
  return H.fields.push({ name: "strings", type: "LITERAL", value: g }), H;
}
...
var tn = { parse: Go, make: Ho, unicodeRanges: en, getUnicodeRange: No };
function zo(t, e) {
  var r = {}, n = new _.Parser(t, e);
  switch (r.version = n.parseVersion(), r.italicAngle = n.parseFixed(), r.underlinePosition = n.parseShort(), r.underlineThickness = n.parseShort(), r.isFixedPitch = n.parseULong(), r.minMemType42 = n.parseULong(), r.maxMemType42 = n.parseULong(), r.minMemType1 = n.parseULong(), r.maxMemType1 = n.parseULong(), r.version) {
    ...
    case 2:
      ...
      for (var i = 0; i < r.numberOfGlyphs; i++)
        if (r.glyphNameIndex[i] >= at.length) {
          var s = n.parseChar();
...
var Ui = { parse: zo, make: Wo }, Te = new Array(9);
Te[1] = function() {
...
Te[5] = function() {
    ...
    return {
      ...
      ruleSets: this.parseListOfLists(function() {
        ...
        return {
          ...
          lookupRecords: this.parseRecordList(s, ft)
        };
      })
    };
  if (r === 2)
  ...
  if (r === 3) {
    ...
    return {
      ...
      lookupRecords: this.parseRecordList(a, ft)
    };
  }
...
function qo(t) {
  return new I.Table("GSUB", [
    ...
    { name: "lookups", type: "TABLE", value: new I.LookupList(t.lookups, yt) }
  ]);
}
var Oi = { parse: Vo, make: qo };
function Xo(t, e) {
  var r = new _.Parser(t, e), n = r.parseULong();
  P.argument(n === 1, "Unsupported META table version."), r.parseULong(), r.parseULong();
  for (var a = r.parseULong(), i = {}, s = 0; s < a; s++) {
    var o = r.parseTag(), c = r.parseULong(), u = r.parseULong(), h = gt.UTF8(t, e + c, u);
    i[o] = h;
  }
  return i;
}
...
function Mi(t) {
  ...
  var r = Math.pow(2, Zn(e.numTables));
  e.searchRange = 16 * r, e.entrySelector = Zn(r), e.rangeShift = e.numTables * 16 - e.searchRange;
  for (var n = [], a = [], i = e.sizeOf() + Kn().sizeOf() * e.numTables; i % 4 !== 0; )
    i += 1, a.push({ name: "padding", type: "BYTE", value: 0 });
  for (var s = 0; s < t.length; s += 1) {
    var o = t[s];
    P.argument(o.tableName.length === 4, "Table name" + o.tableName + " is invalid.");
    var c = o.sizeOf(), u = Kn(o.tableName, ln(o.encode()), i, c);
  ...
  return n.sort(function(h, g) {
    return h.value.tag > g.value.tag ? 1 : -1;
...
function $o(t) {
  for (var e = [], r = [], n = [], a = [], i = [], s = [], o = [], c, u = 0, h = 0, g = 0, l = 0, p = 0, x = 0; x < t.glyphs.length; x += 1) {
    ...
    if (v.name !== ".notdef") {
      var S = v.getMetrics();
      e.push(S.xMin), r.push(S.yMin), n.push(S.xMax), a.push(S.yMax), s.push(S.leftSideBearing), o.push(S.rightSideBearing), i.push(v.advanceWidth);
    }
  }
  var w = {
    xMin: Math.min.apply(null, e),
  ...
  var k = Si.make({
  ...
  }), U = Ti.make(t.glyphs.length), B = tn.make(Object.assign({
    ...
    sxHeight: Qn(t, "xyvw", { yMax: Math.round(w.ascender / 2) }).yMax,
    sCapHeight: Qn(t, "HIKLEFJMNTZBDPRAGOQSUVWXY", w).yMax,
    usDefaultChar: t.hasChar(" ") ? 32 : 0,
    // Use space as the default character, if available.
    usBreakChar: t.hasChar(" ") ? 32 : 0
    // Use space as the break character, if available.
  }, t.tables.os2)), O = Fi.make(t.glyphs), H = ui.make(t.glyphs), W = t.getEnglishName("fontFamily"), z = t.getEnglishName("fontSubfamily"), le = W + " " + z, ce = t.getEnglishName("postScriptName");
  ce || (ce = W.replace(/\s/g, "") + "-" + z);
  var $ = {};
  ...
  var Q = [], ae = Bi.make($, Q), ue = Q.length > 0 ? ki.make(Q) : void 0, oe = Ui.make(), fe = bi.make(t.glyphs, {
  ...
  }), G = t.metas && Object.keys(t.metas).length > 0 ? Ri.make(t.metas) : void 0, q = [k, C, U, B, ae, H, oe, fe, O];
  ue && q.push(ue), t.tables.gsub && q.push(Oi.make(t.tables.gsub)), G && q.push(G);
  for (var ut = Mi(q), _t = ut.encode(), Pt = ln(_t), xt = ut.fields, Nt = !1, ze = 0; ze < xt.length; ze += 1)
    if (xt[ze].name === "head table") {
      xt[ze].value.checkSumAdjustment = 2981146554 - Pt, Nt = !0;
      break;
    }
  if (!Nt)
...
var Zo = { make: Mi, fontToTable: $o, computeCheckSum: ln };
function br(t, e) {
...
Ut.prototype = {
  ...
  getScriptTable: function(t, e) {
    ...
    if (r) {
      t = t || "DFLT";
      var n = r.scripts, a = br(r.scripts, t);
      if (a >= 0)
        return n[a].script;
      if (e) {
        var i = {
...
Ot.prototype.getKerningValue = function(t, e, r) {
      ...
      if (!(o < 0))
        switch (s.posFormat) {
          case 1:
            ...
            break;
          case 2:
            var g = this.getGlyphClass(s.classDef1, e), l = this.getGlyphClass(s.classDef2, r), p = s.classRecords[g][l];
            return p.value1 && p.value1.xAdvance || 0;
        }
    }
  return 0;
};
Ot.prototype.getKerningTables = function(t, e) {
...
me.prototype.getAlternates = function(t, e, r) {
  for (var n = [], a = this.getLookupTables(e, r, t, 3), i = 0; i < a.length; i++)
    for (var s = a[i].subtables, o = 0; o < s.length; o++)
      for (var c = s[o], u = this.expandCoverage(c.coverage), h = c.alternateSets, g = 0; g < u.length; g++)
        n.push({ sub: u[g], by: h[g] });
  return n;
};
me.prototype.getLigatures = function(t, e, r) {
  for (var n = [], a = this.getLookupTables(e, r, t, 4), i = 0; i < a.length; i++)
    for (var s = a[i].subtables, o = 0; o < s.length; o++)
      for (var c = s[o], u = this.expandCoverage(c.coverage), h = c.ligatureSets, g = 0; g < u.length; g++)
        for (var l = u[g], p = h[g], x = 0; x < p.length; x++) {
          var v = p[x];
          n.push({
...
me.prototype.addSingle = function(t, e, r, n) {
  var a = this.getLookupTables(r, n, t, 1, !0)[0], i = fn(a, 2, {
...
me.prototype.addMultiple = function(t, e, r, n) {
  ...
  var a = this.getLookupTables(r, n, t, 2, !0)[0], i = fn(a, 1, {
...
me.prototype.addAlternate = function(t, e, r, n) {
  var a = this.getLookupTables(r, n, t, 3, !0)[0], i = fn(a, 1, {
...
me.prototype.addLigature = function(t, e, r, n) {
  ...
  if (u >= 0) {
    for (var h = i.ligatureSets[u], g = 0; g < h.length; g++)
      if (Ko(h[g].components, o))
        return;
    h.push(c);
  } else
  ...
  if (t.numberOfContours > 0) {
    ...
    for (var h = 0; h < u; h += 1)
      if (i = n.parseByte(), a.push(i), (i & 8) > 0)
        for (var g = n.parseByte(), l = 0; l < g; l += 1)
          a.push(i), h += 1;
    if (P.argument(a.length === u, "Bad flags."), s.length > 0) {
      ...
      if (u > 0) {
        ...
        for (var F = 0, m = 0; m < u; m += 1)
          i = a[m], x = p[m], x.x = ta(n, i, F, 2, 16), F = x.x;
        for (var S = 0, w = 0; w < u; w += 1)
          i = a[w], x = p[w], x.y = ta(n, i, S, 4, 32), S = x.y;
      }
      t.points = p;
    } else
      t.points = [];
...
function Di(t) {
  ...
  if (!t)
    return e;
  for (var r = ec(t), n = 0; n < r.length; ++n) {
    ...
    for (var r = 0; r < e.components.length; r += 1) {
      ...
      if (a.getPath(), a.points) {
        ...
        if (n.matchedPoints === void 0)
          ...
          o = Sr([o], c)[0], c.dx = s.x - o.x, c.dy = s.y - o.y, i = Sr(a.points, c);
        }
...
function tc(t, e, r, n) {
  for (var a = new De.GlyphSet(n), i = 0; i < r.length - 1; i += 1) {
    var s = r[i], o = r[i + 1];
    s !== o ? a.push(i, De.ttfGlyphLoader(n, i, Ii, t, e + s, _i)) : a.push(i, De.glyphLoader(n, i));
  }
  return a;
}
function rc(t, e, r, n) {
...
function nc(t, e, r, n, a) {
  return a.lowMemory ? rc(t, e, r, n) : tc(t, e, r, n);
}
var Pi = { getPath: Di, parse: nc }, Ni, ot, Gi, rn;
function Hi(t) {
  this.font = t, this.getCommands = function(e) {
    return Pi.getPath(e).commands;
...
Rt.prototype.distance = function(t, e, r, n) {
  return this.x * Me.distance(t, e, r, n) + this.y * Ge.distance(t, e, r, n);
};
Rt.prototype.interpolate = function(t, e, r, n) {
  var a, i, s, o, c, u, h;
...
Rt.prototype.setRelative = function(t, e, r, n, a) {
  n = n || this;
  var i = a ? e.xo : e.x, s = a ? e.yo : e.y, o = i + r * n.x, c = s + r * n.y, u = n.normalSlope, h = this.slope, g = t.x, l = t.y;
  t.x = (h * g - u * o + c - l) / (h - u), t.y = h * (t.x - g) + l;
};
...
function Mt(t, e) {
  ...
  return t /= r, e /= r, t === 1 && e === 0 ? Me : t === 0 && e === 1 ? Ge : new Rt(t, e);
}
function He(t, e, r, n) {
...
var At = Object.freeze(new He(0, 0)), uc = {
  cvCutIn: 17 / 16,
...
function je(t, e) {
  switch (this.env = t, this.stack = [], this.prog = e, t) {
    ...
    case "prep":
      this.fv = this.pv = this.dpv = Me, this.round = zi;
  }
}
Hi.prototype.exec = function(t, e) {
  if (typeof e != "number")
  ...
  if (!(this._errorState > 2)) {
    ...
    if (!n || n.ppem !== e) {
      ...
      if (!a) {
        je.prototype = uc, a = this._fpgmState = new je("fpgm", r.tables.fpgm), a.funcs = [], a.font = r, exports.DEBUG && (console.log("---EXEC FPGM---"), a.step = -1);
        try {
          ot(a);
        } catch (u) {
...
Gi = function(t, e) {
  ...
  if (je.prototype = e, !a)
    o = new je("glyf", t.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), o.step = -1), rn(t, o, r, n), s = o.gZone;
  else {
    var c = e.font;
    s = [], i = [];
    for (var u = 0; u < a.length; u++) {
      var h = a[u], g = c.glyphs.get(h.glyphIndex);
      o = new je("glyf", g.instructions), exports.DEBUG && (console.log("---EXEC COMP " + u + "---"), o.step = -1), rn(g, o, r, n);
      for (var l = Math.round(h.dx * r), p = Math.round(h.dy * n), x = o.gZone, v = o.contours, F = 0; F < x.length; F++) {
        var m = x[F];
        m.xTouched = m.yTouched = !1, m.xo = m.x = m.x + l, m.yo = m.y = m.y + p;
      }
      var S = s.length;
      s.push.apply(s, x);
    ...
    ), exports.DEBUG && (console.log("---EXEC COMPOSITE---"), o.step = -1), ot(o), s.length -= 2);
  }
  return s;
};
rn = function(t, e, r, n) {
  ...
  for (var h, g, l = 0; l < i; l++)
    c = s[l], h || (h = c, o.push(l)), c.lastPointOfContour ? (c.nextPointOnContour = h, h.prevPointOnContour = c, h = void 0) : (g = s[l + 1], c.nextPointOnContour = g, g.prevPointOnContour = c);
  if (!e.inhibitGridFit) {
    if (exports.DEBUG) {
...
ot = function(t) {
  ...
  if (e) {
    ...
    for (t.ip = 0; t.ip < r; t.ip++) {
      if (exports.DEBUG && t.step++, n = Ni[e[t.ip]], !n)
        throw new Error(
...
function ia(t, e) {
  ...
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.pv = e.dpv = Mt(o, c);
}
function sa(t, e) {
  var r = e.stack, n = r.pop(), a = r.pop(), i = e.z2[n], s = e.z1[a];
  exports.DEBUG && console.log("SFVTL[" + t + "]", n, a);
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.fv = Mt(o, c);
}
function hc(t) {
  var e = t.stack, r = e.pop(), n = e.pop();
  exports.DEBUG && console.log(t.step, "SPVFS[]", r, n), t.pv = t.dpv = Mt(n, r);
}
function lc(t) {
  var e = t.stack, r = e.pop(), n = e.pop();
  exports.DEBUG && console.log(t.step, "SPVFS[]", r, n), t.fv = Mt(n, r);
}
function fc(t) {
...
function gc(t) {
  var e = t.stack, r = e.pop(), n = e.pop(), a = e.pop(), i = e.pop(), s = e.pop(), o = t.z0, c = t.z1, u = o[r], h = o[n], g = c[a], l = c[i], p = t.z2[s];
  exports.DEBUG && console.log("ISECT[], ", r, n, a, i, s);
  var x = u.x, v = u.y, F = h.x, m = h.y, S = g.x, w = g.y, k = l.x, C = l.y, U = (x - F) * (w - C) - (v - m) * (S - k), B = x * m - v * F, O = S * C - w * k;
  p.x = (B * (S - k) - O * (x - F)) / U, p.y = (B * (w - C) - O * (v - m)) / U;
}
function vc(t) {
...
function wc(t) {
  ...
  switch (exports.DEBUG && console.log(t.step, "SZPS[]", e), t.zp0 = t.zp1 = t.zp2 = e, e) {
    case 0:
      t.tZone || hr(t), t.z0 = t.z1 = t.z2 = t.tZone;
      break;
    case 1:
...
function kc(t) {
  exports.DEBUG && console.log(t.step, "RTG[]"), t.round = zi;
}
function Tc(t) {
  exports.DEBUG && console.log(t.step, "RTHG[]"), t.round = sc;
}
function Cc(t) {
  var e = t.stack.pop();
...
function Ec(t) {
  exports.DEBUG && console.log(t.step, "ELSE[]"), Vi(t, !1);
}
function Lc(t) {
  var e = t.stack.pop();
...
function Mc(t) {
  ...
  t.prog = t.funcs[r];
  for (var s = 0; s < n; s++)
    ot(t), exports.DEBUG && console.log(
      ++t.step,
...
function Ic(t) {
  ...
  var r = t.ip, n = t.prog;
  t.prog = t.funcs[e], ot(t), t.ip = r, t.prog = n, exports.DEBUG && console.log(++t.step, "returning from", e);
}
function Dc(t) {
...
function oa(t, e) {
  ...
  var s = i.distance(n, At);
  t && (s = e.round(s)), a.setRelative(n, At, s, i), a.touch(n), e.rp0 = e.rp1 = r;
}
function ca(t, e) {
...
function ua(t, e) {
  for (var r = e.stack, n = t ? e.rp1 : e.rp2, a = (t ? e.z0 : e.z1)[n], i = e.fv, s = e.pv, o = e.loop, c = e.z2; o--; ) {
    var u = r.pop(), h = c[u], g = s.distance(a, a, !1, !0);
    i.setRelative(h, h, g, s), i.touch(h), exports.DEBUG && console.log(
      e.step,
...
function la(t, e) {
  ...
  for (var u, h = s.distance(a, a, !1, !0), g = c.length - 2, l = 0; l < g; l++)
...
function Gc(t) {
  for (var e = t.stack, r = t.rp1, n = t.rp2, a = t.loop, i = t.z0[r], s = t.z1[n], o = t.fv, c = t.dpv, u = t.z2; a--; ) {
    ...
    exports.DEBUG && console.log(
      ...
      "<->",
      n
    ), o.interpolate(g, i, s, c), o.touch(g);
  }
  t.loop = 1;
}
function fa(t, e) {
...
function zc(t) {
  exports.DEBUG && console.log(t.step, "RTDG[]"), t.round = ic;
}
function pa(t, e) {
  ...
  var u = o.distance(i, At);
  t && (Math.abs(u - c) < e.cvCutIn && (u = c), u = e.round(u)), s.setRelative(i, At, u, o), e.zp0 === 0 && (i.xo = i.x, i.yo = i.y), s.touch(i), e.rp0 = e.rp1 = a;
}
function Wc(t) {
...
function da(t, e) {
  ...
  exports.DEBUG && console.log(e.step, "GC[" + t + "]", n), r.push(e.dpv.distance(a, At, t, !1) * 64);
}
function ga(t, e) {
...
function iu(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "IF[]", e), e || (Vi(t, !0), exports.DEBUG && console.log(t.step, "EIF[]"));
}
function su(t) {
...
function Fr(t, e) {
  ...
  for (var h = 0; h < n; h++) {
    var g = r.pop(), l = r.pop(), p = o + ((l & 240) >> 4);
    if (p === s) {
      var x = (l & 15) - 8;
      x >= 0 && x++, exports.DEBUG && console.log(e.step, "DELTAPFIX", g, "by", x * c);
      var v = u[g];
...
function Su(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "SROUND[]", e), t.round = Wi;
  var r;
  switch (e & 192) {
    case 0:
      r = 0.5;
...
function wu(t) {
  var e = t.stack.pop();
  exports.DEBUG && console.log(t.step, "S45ROUND[]", e), t.round = Wi;
  var r;
  switch (e & 192) {
    case 0:
      r = Math.sqrt(2) / 2;
...
function Fu(t) {
  exports.DEBUG && console.log(t.step, "ROFF[]"), t.round = ac;
}
function ku(t) {
  exports.DEBUG && console.log(t.step, "RUTG[]"), t.round = oc;
}
function Tu(t) {
  exports.DEBUG && console.log(t.step, "RDTG[]"), t.round = cc;
}
function Cu(t) {
  var e = t.stack.pop();
...
function va(t, e) {
  ...
  var o, c;
  t ? (o = i.y - s.y, c = s.x - i.x) : (o = s.x - i.x, c = s.y - i.y), e.dpv = Mt(o, c);
}
function Eu(t) {
...
function D(t, e, r, n, a, i) {
  var s = i.stack, o = t && s.pop(), c = s.pop(), u = i.rp0, h = i.z0[u], g = i.z1[c], l = i.minDis, p = i.fv, x = i.dpv, v, F, m, S;
  F = v = x.distance(g, h, !0, !0), m = F >= 0 ? 1 : -1, F = Math.abs(F), t && (S = i.cvt[o], n && Math.abs(F - S) < i.cvCutIn && (F = S)), r && F < l && (F = l), n && (F = i.round(F)), p.setRelative(g, h, m * F, x), p.touch(g), exports.DEBUG && console.log(
    i.step,
...
mt.prototype.getState = function(t) {
...
ne.prototype.replaceToken = function(t, e, r) {
  if (!isNaN(t) && this.inboundIndex(t) && e instanceof mt) {
...
ne.prototype.dispatch = function(t, e) {
  ...
  n instanceof lr && n.subscribers.forEach(function(a) {
    a.apply(r, e || []);
  });
};
...
ne.prototype.setEndOffset = function(t, e) {
  var r = this.getContext(e).openRange.startIndex, n = new pn(r, t, e), a = this.getContext(e).ranges;
...
ne.prototype.runContextCheck = function(t) {
  ...
  this.contextCheckers.forEach(function(n) {
    ...
    if (!i && n.checkStart(t) && (i = new pn(r, null, a), e.getContext(a).openRange = i, e.dispatch("contextStart", [a, r])), i && n.checkEnd(t)) {
...
function Pu(t, e) {
  ...
  if (t.lookahead.length < e.lookaheadCoverage.length)
    return [];
  for (var i = t.lookahead.slice(a); i.length && Qe(i[0].char); )
    i.shift();
  var s = new Ce(i, 0), o = Tr(
    e.lookaheadCoverage,
    s
  ), c = [].concat(t.backtrack);
  for (c.reverse(); c.length && Qe(c[0].char); )
    c.shift();
  ...
  var u = new Ce(c, 0), h = Tr(
    e.backtrackCoverage,
    u
  ), g = n.length === e.inputCoverage.length && o.length === e.lookaheadCoverage.length && h.length === e.backtrackCoverage.length, l = [];
  if (g)
    for (var p = 0; p < e.lookupRecords.length; p++)
      for (var x = e.lookupRecords[p], v = x.lookupListIndex, F = this.getLookupByIndex(v), m = 0; m < F.subtables.length; m++) {
        var S = F.subtables[m], w = this.getLookupMethod(F, S), k = this.getSubstitutionType(F, S);
        if (k === "12")
...
function Nu(t, e) {
  var r = t.current, n = It(r, e.coverage);
  if (n === -1)
    return null;
...
xe.prototype.lookupFeature = function(t) {
  ...
  for (var a = this.getFeatureLookups(n), i = [].concat(e.context), s = 0; s < a.length; s++)
    for (var o = a[s], c = this.getLookupSubtables(o), u = 0; u < c.length; u++) {
      var h = c[u], g = this.getSubstitutionType(o, h), l = this.getLookupMethod(o, h), p = void 0;
      switch (g) {
        case "11":
...
function dn(t, e, r) {
  t instanceof it && ya[t.id] && ya[t.id](t, e, r);
}
function Ku(t) {
  for (var e = [].concat(t.backtrack), r = e.length - 1; r >= 0; r--) {
    var n = e[r], a = qi(n), i = Qe(n);
    if (!a && !i)
      return !0;
    if (a)
      return !1;
  ...
  if (a.length !== 1) {
    ...
    a.forEach(function(o, c) {
      if (!Qe(o.char)) {
        ...
        if (n.indexOf(h) !== -1) {
          var g = e.query.lookupFeature({
            tag: h,
            script: r,
            contextParams: i
          });
          if (g instanceof Error)
            return console.info(g.message);
          g.forEach(function(l, p) {
...
function eh(t) {
  var e = this, r = "arab", n = this.tokenizer.getRangeTokens(t), a = ma(n);
...
function th(t) {
  ...
  return (
    // ? latin first char
    r === null && Qt(e) || // ? latin char preceded with a non latin char
    !Qt(r) && Qt(e)
  );
}
function rh(t) {
...
function ah(t) {
  var e = this, r = "latn", n = this.tokenizer.getRangeTokens(t), a = xa(n);
  a.context.forEach(function(i, s) {
    a.setCurrentIndex(s);
    var o = e.query.lookupFeature({
      tag: "liga",
...
function ih() {
  return Cr.call(this, "latinWord"), Cr.call(this, "arabicWord"), Cr.call(this, "arabicSentence"), this.tokenizer.tokenize(this.text);
}
function sh() {
...
Ae.prototype.applyFeaturesToContexts = function() {
  this.checkContextReady("arabicWord") && (oh.call(this), ch.call(this)), this.checkContextReady("latinWord") && uh.call(this), this.checkContextReady("arabicSentence") && sh.call(this);
};
Ae.prototype.processText = function(t) {
  (!this.text || this.text !== t) && (this.setText(t), ih.call(this), this.applyFeaturesToContexts());
};
...
function j(t) {
  t = t || {}, t.tables = t.tables || {}, t.empty || (bt(t.familyName, "When creating a new Font object, familyName is required."), bt(t.styleName, "When creating a new Font object, styleName is required."), bt(t.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), bt(t.ascender, "When creating a new Font object, ascender is required."), bt(t.descender <= 0, "When creating a new Font object, negative descender value is required."), this.names = {
  ...
  })), this.supported = !0, this.glyphs = new De.GlyphSet(this, t.glyphs || []), this.encoding = new hi(this), this.position = new Ot(this), this.substitution = new me(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
    get: function() {
      if (this._hinting)
        return this._hinting;
      if (this.outlinesFormat === "truetype")
        return this._hinting = new Hi(this);
    }
  });
}
...
j.prototype.stringToGlyphs = function(t, e) {
  var r = this, n = new Ae(), a = function(g) {
    return r.charToGlyphIndex(g.char);
  };
...
j.prototype.forEachGlyph = function(t, e, r, n, a, i) {
  ...
  for (var h = 0; h < o.length; h += 1) {
    var g = o[h];
    if (i.call(this, g, e, r, n, a), g.advanceWidth && (e += g.advanceWidth * s), a.kerning && h < o.length - 1) {
      var l = c ? this.position.getKerningValue(c, g.index, o[h + 1].index) : this.getKerningValue(g, o[h + 1]);
      e += l * s;
    }
...
function dh(t, e) {
  ...
  for (var n = 0; n < t.axes.length; n++)
    r.fields = r.fields.concat(hh(n, t.axes[n], e));
  for (var a = 0; a < t.instances.length; a++)
    r.fields = r.fields.concat(fh(a, t.instances[a], t.axes, e));
  return r;
}
function gh(t, e, r) {
  ...
  n.skip("uShort", 1);
  for (var s = n.parseUShort(), o = n.parseUShort(), c = n.parseUShort(), u = n.parseUShort(), h = [], g = 0; g < s; g++)
    h.push(lh(t, e + i + g * o, r));
...
var vh = { make: dh, parse: gh }, yh = function() {
  ...
  return this.parseList(E.pointer(mh));
}, bh = function() {
  return {
    coverage: this.parsePointer(E.coverage),
    ligGlyphs: this.parseList(E.pointer(xh))
  };
}, Sh = function() {
...
function wh(t, e) {
  ...
  var a = {
    ...
    attachList: r.parsePointer(yh),
    ligCaretList: r.parsePointer(bh),
    markAttachClassDef: r.parsePointer(E.classDef)
  };
  return n >= 1.2 && (a.markGlyphSets = r.parsePointer(Sh)), a;
}
var Fh = { parse: wh }, Ee = new Array(10);
Ee[1] = function() {
  var e = this.offset + this.relativeOffset, r = this.parseUShort();
  if (r === 1)
    return {
...
function Ch(t) {
  return new I.Table("GPOS", [
    ...
    { name: "scripts", type: "TABLE", value: new I.ScriptList(t.scripts) },
    { name: "features", type: "TABLE", value: new I.FeatureList(t.features) },
    { name: "lookups", type: "TABLE", value: new I.LookupList(t.lookups, Th) }
  ]);
}
var Eh = { parse: kh, make: Ch };
function Lh(t) {
  var e = {};
  t.skip("uShort");
  var r = t.parseUShort();
...
function ie(t, e) {
  if (e.compression === "WOFF") {
    ...
    if (Cs(r, n), n.byteLength !== e.length)
...
function Ih(t, e) {
  ...
  if (c === "\0\0\0" || c === "true" || c === "typ1")
    a.outlinesFormat = "truetype", s = _.getUShort(i, 4), o = ba(i, s);
  else if (c === "OTTO")
    a.outlinesFormat = "cff", s = _.getUShort(i, 4), o = ba(i, s);
  else if (c === "wOFF") {
    var u = _.getTag(i, 4);
    if (u === "\0\0\0")
  ...
  for (var h, g, l, p, x, v, F, m, S, w, k, C, U = 0; U < s; U += 1) {
    var B = o[U], O = void 0;
    switch (B.tag) {
      case "cmap":
        O = ie(i, B), a.tables.cmap = ui.parse(O.data, O.offset), a.encoding = new li(a.tables.cmap);
        break;
      case "cvt ":
      ...
      case "fpgm":
        ...
        break;
      case "head":
        O = ie(i, B), a.tables.head = Si.parse(O.data, O.offset), a.unitsPerEm = a.tables.head.unitsPerEm, r = a.tables.head.indexToLocFormat;
        break;
      case "hhea":
      ...
      case "ltag":
        ...
        break;
      case "maxp":
        O = ie(i, B), a.tables.maxp = Ti.parse(O.data, O.offset), a.numGlyphs = a.tables.maxp.numGlyphs;
        break;
      case "name":
        w = B;
        break;
      case "OS/2":
        O = ie(i, B), a.tables.os2 = tn.parse(O.data, O.offset);
        break;
      case "post":
        O = ie(i, B), a.tables.post = Ui.parse(O.data, O.offset), a.glyphNames = new un(a.tables.post);
        break;
      case "prep":
  ...
  var H = ie(i, w);
  if (a.tables.name = Bi.parse(H.data, H.offset, n), a.names = a.tables.name, l && S) {
    var W = r === 0, z = ie(i, S), le = Rh.parse(z.data, z.offset, a.numGlyphs, W), ce = ie(i, l);
    a.glyphs = Pi.parse(ce.data, ce.offset, le, a, e);
  } else if (h) {
    var $ = ie(i, h);
  ...
  if (x) {
    var ue = ie(i, x);
    a.tables.gpos = Eh.parse(ue.data, ue.offset), a.position.init();
  }
  if (v) {
    var oe = ie(i, v);
  ...
  if (k) {
    var G = ie(i, k);
    a.tables.meta = Ri.parse(G.data, G.offset), a.metas = a.tables.meta;
  }
  return a;
}
function Sa(t, e = !1) {
  ...
  for (let h = 0; h < t.length; ++h) {
    ...
    for (const p in g.attributes) {
      ...
      i[p] === void 0 && (i[p] = []), i[p].push(g.attributes[p]), l++;
    }
    if (l !== n.size)
    ...
    for (const p in g.morphAttributes) {
      if (!a.has(p))
      ...
      s[p] === void 0 && (s[p] = []), s[p].push(g.morphAttributes[p]);
    }
    if (e) {
      let p;
      if (r)
...
function wa(t) {
  ...
  const s = new e(i), o = new ns(s, r, n);
  let c = 0;
  for (let u = 0; u < t.length; ++u) {
    const h = t[u];
...
function Dh(t, e = 1e-4) {
  e = Math.max(e, Number.EPSILON);
  const r = {}, n = t.getIndex(), a = t.getAttribute("position"), i = n ? n.count : a.count;
  let s = 0;
  const o = Object.keys(t.attributes), c = {}, u = {}, h = [], g = ["getX", "getY", "getZ", "getW"], l = ["setX", "setY", "setZ", "setW"];
  for (let S = 0, w = o.length; S < w; S++) {
    const k = o[S], C = t.attributes[k];
  ...
  const p = e * 0.5, x = Math.log10(1 / e), v = Math.pow(10, x), F = p * v;
  for (let S = 0; S < i; S++) {
  ...
  for (const S in t.attributes) {
    const w = c[S];
    if (m.setAttribute(S, new w.constructor(
      ...
      for (let k = 0; k < u[S].length; k++) {
        const C = u[S][k];
        m.morphAttributes[S][k] = new C.constructor(
...
`)
      ...
      const g = Nh(h, a, o, c, r);
      o += g.offsetX, s.push(g.path);
    }
  }
  return s;
}
    ...
    for (let F = 0, m = v.length; F < m; )
      switch (v[F++]) {
        ...
        case "l":
          ...
          break;
        case "q":
          u = v[F++] * e + r, h = v[F++] * e + n, g = v[F++] * e + r, l = v[F++] * e + n, s.quadraticCurveTo(g, l, u, h);
          break;
        case "b":
          u = v[F++] * e + r, h = v[F++] * e + n, g = v[F++] * e + r, l = v[F++] * e + n, p = v[F++] * e + r, x = v[F++] * e + n, s.bezierCurveTo(g, l, p, x, u, h);
          break;
      }
  }
...
class Gh extends _h {
  ...
  generateShapes(e, r = 100, n = "ltr") {
    const a = [];
    return Hh(e, r, this.data, n).forEach((s) => {
      a.push(...jh(s));
    }), a;
  }
}
function Hh(t, e, r, n = "ltr") {
...
`)
      ...
      const g = zh(h, i, c, u, r);
      if (!g) continue;
      n === "tb" ? (c = 0, u += r.ascender * i) : c += g.offsetX, o.push(g.path);
    }
  return o;
}
function zh(t, e, r, n, a) {
  ...
  if (i.o) {
    ...
    for (; c < o.length; ) {
      ...
      switch (u) {
        case "m":
          h = parseFloat(o[c++]) * e + r, g = parseFloat(o[c++]) * e + n, s.moveTo(h, g);
          break;
        case "l":
          h = parseFloat(o[c++]) * e + r, g = parseFloat(o[c++]) * e + n, s.lineTo(h, g);
          break;
        case "q":
          l = parseFloat(o[c++]) * e + r, p = parseFloat(o[c++]) * e + n, x = parseFloat(o[c++]) * e + r, v = parseFloat(o[c++]) * e + n, s.quadraticCurveTo(x, v, l, p);
          break;
        case "b":
          l = parseFloat(o[c++]) * e + r, p = parseFloat(o[c++]) * e + n, x = parseFloat(o[c++]) * e + r, v = parseFloat(o[c++]) * e + n, F = parseFloat(o[c++]) * e + r, m = parseFloat(o[c++]) * e + n, s.bezierCurveTo(x, v, F, m, l, p);
          break;
      }
    }
  }
...
function Wh(t, e) {
  ...
  for (let s = 0, o = i - 1; s < i; o = s++) {
    const c = e[s].x, u = e[s].y, h = e[o].x, g = e[o].y;
    u > a != g > a && n < (h - c) * (a - u) / (g - u) + c && (r = !r);
  }
  return r;
}
function Vh(t) {
  ...
  for (let n = 0; n < e; n++) {
    let a = null, i = 1 / 0;
    for (let s = 0; s < e; s++)
      if (n !== s && t[n].every((o) => Wh(o, t[s]))) {
        const o = Math.abs(ja.area(t[s]));
        o < i && (i = o, a = s);
      }
    r[n] = a;
  }
...
function Yh(t) {
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    const n = t[r];
    if (n instanceof dr)
      e.push(new dr(n.v2.clone(), n.v1.clone()));
    else if (n instanceof Cn)
      e.push(
        new Cn(n.v2.clone(), n.v1.clone(), n.v0.clone())
      );
      ...
      for (let i = a.length - 1; i > 0; i--)
        e.push(new dr(a[i].clone(), a[i - 1].clone()));
    }
  }
  return e;
}
function ka(t, e) {
  const r = ja.area(t.getPoints(32)) > 0, n = e === r ? t.curves.slice() : Yh(t.curves), a = new as();
...
function jh(t, e = 32) {
  ...
  const h = [], g = /* @__PURE__ */ new Set();
  function l(p) {
    const x = ka(r[p], !0);
    g.add(p);
    for (const v of i[p])
      if (!g.has(v) && c[v] === c[p] + 1) {
        const F = ka(r[v], !1);
        x.holes.push(F), g.add(v);
      }
    h.push(x);
  }
...
class Zh extends Ka {
   ...
   */
  constructor(e) {
    super(e), this.type = "mesh", this.glyphCache = new $h(512);
    const r = e.data;
   ...
   */
  parseMeshFont(e) {
    const r = Ih(e), n = Math.round, a = r.charToGlyph("A"), i = a ? r.unitsPerEm / (a.yMax || r.unitsPerEm) : 1, s = {
      glyphs: {},
      // Lazy loaded later
    ...
    try {
      ...
      if (0 in a) {
        ...
        try {
          ...
          let c = s.findIndex((u) => Qh.includes(u));
        ...
        try {
          ...
          if (u > 0) {
            ...
            if (h.length === u) {
              const g = h.indexOf(0);
              let l = 0;
              g >= 0 && g < h.length && (l = g + 1), l < h.length && (s[c] = h.subarray(l));
            }
          }
        } catch {
...
class Tt {
  ...
  toSVG(e = {}) {
    ...
    let i, s;
    if (a) {
      const o = this.bbox, c = 0.2, u = o.maxX - o.minX, h = o.maxY - o.minY, g = u === 0 ? h : u, l = h === 0 ? u : h, p = o.minX - g * c, x = o.maxX + g * c, v = o.minY - l * c, F = o.maxY + l * c;
...
class al {
  ...
  parseShape(e) {
    ...
    return new Tt(r.currentPoint, r.polylines);
  }
  /**
  ...
  handleOctantArc(e, r, n) {
    ...
    let u = o & 7;
    const h = o < 0, g = Math.PI / 4 * c, l = n.currentPoint.clone().subtract(new re(Math.cos(g) * s, Math.sin(g) * s)), p = Bt.fromOctant(l, s, c, u, h);
    if (n.isPenDown) {
  ...
  handleFractionalArc(e, r, n) {
    let a = r;
    const i = e[++a], s = e[++a], o = e[++a], c = e[++a], u = (o * 255 + c) * n.scale, h = ge.byteToSByte(e[++a]), g = (h & 112) >> 4;
    let l = h & 7;
    l === 0 && (l = 8), s !== 0 && l--;
    const p = Math.PI / 4;
    let x = p * l, v = nl, F = 1;
    h < 0 && (v = -v, x = -x, F = -1);
    let m = p * g, S = m + x;
    m += p * i / 256 * F, S += p * s / 256 * F;
    const w = n.currentPoint.clone().subtract(new re(u * Math.cos(m), u * Math.sin(m)));
    if (n.currentPoint = w.clone().add(new re(u * Math.cos(S), u * Math.sin(S))), n.isPenDown) {
      let k = m;
      const C = [];
      if (C.push(
      ...
      C.push(w.clone().add(new re(u * Math.cos(S), u * Math.sin(S)))), n.currentPolyline.push(...C);
    }
    return a;
  }
  ...
  handleArcSegment(e, r, n, a, i, s) {
    ...
    if (i)
      if (n === 0)
        ...
        const c = o.clone().add(r), u = Bt.fromBulge(o, c, n / 127).tessellate();
        s.push(...u.slice(1));
      }
    return o.add(r), o;
  }
...
class il {
  ...
  constructor(e) {
    if (e instanceof ArrayBuffer) {
      const r = new ge(e), n = new Kh().parse(r), a = rl.createParser(n.fontType).parse(r);
      this.fontData = {
        header: n,
        content: a
      };
      ...
      this.fontData = e;
    this.shapeParser = new al(this.fontData);
  }
  /**
   * Return true if this font contains glyph of the specified character. Otherwise, return false.
   * @param char - The character to check
...
var Yi = { exports: {} }, vn = {}, fr = {};
fr.byteLength = hl;
fr.toByteArray = fl;
fr.fromByteArray = gl;
var Re = [], be = [], cl = typeof Uint8Array < "u" ? Uint8Array : Array, Er = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var lt = 0, ul = Er.length; lt < ul; ++lt)
  Re[lt] = Er[lt], be[Er.charCodeAt(lt)] = lt;
be[45] = 62;
be[95] = 63;
function ji(t) {
  var e = t.length;
...
function fl(t) {
  var e, r = ji(t), n = r[0], a = r[1], i = new cl(ll(t, n, a)), s = 0, o = a > 0 ? n - 4 : n, c;
  for (c = 0; c < o; c += 4)
...
function dl(t, e, r) {
  for (var n, a = [], i = e; i < r; i += 3)
    n = (t[i] << 16 & 16711680) + (t[i + 1] << 8 & 65280) + (t[i + 2] & 255), a.push(pl(n));
  return a.join("");
}
function gl(t) {
  for (var e, r = t.length, n = r % 3, a = [], i = 16383, s = 0, o = r - n; s < o; s += i)
    a.push(dl(t, s, s + i > o ? o : s + i));
...
yn.read = function(t, e, r, n, a) {
  var i, s, o = a * 8 - n - 1, c = (1 << o) - 1, u = c >> 1, h = -7, g = r ? a - 1 : 0, l = r ? -1 : 1, p = t[e + g];
  for (g += l, i = p & (1 << -h) - 1, p >>= -h, h += o; h > 0; i = i * 256 + t[e + g], g += l, h -= 8)
    ;
  for (s = i & (1 << -h) - 1, i >>= -h, h += n; h > 0; s = s * 256 + t[e + g], g += l, h -= 8)
    ;
  if (i === 0)
    i = 1 - u;
  else {
...
yn.write = function(t, e, r, n, a, i) {
  var s, o, c, u = i * 8 - a - 1, h = (1 << u) - 1, g = h >> 1, l = a === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : i - 1, x = n ? 1 : -1, v = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (o = isNaN(e) ? 1 : 0, s = h) : (s = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -s)) < 1 && (s--, c *= 2), s + g >= 1 ? e += l / c : e += l * Math.pow(2, 1 - g), e * c >= 2 && (s++, c /= 2), s + g >= h ? (o = 0, s = h) : s + g >= 1 ? (o = (e * c - 1) * Math.pow(2, a), s = s + g) : (o = e * Math.pow(2, g - 1) * Math.pow(2, a), s = 0)); a >= 8; t[r + p] = o & 255, p += x, o /= 256, a -= 8)
    ;
 ...
 */
(function(t) {
  var e = fr, r = yn, n = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  ...
  function l(y, f) {
    ...
    var d = w(y, f) | 0, b = s(d), T = b.write(y, f);
    return T !== d && (b = b.slice(0, T)), b;
  }
  function p(y) {
    for (var f = y.length < 0 ? 0 : m(y.length) | 0, d = s(f), b = 0; b < f; b += 1)
      d[b] = y[b] & 255;
    return d;
  }
  function x(y) {
  ...
  function v(y, f, d) {
    ...
    var b;
    return f === void 0 && d === void 0 ? b = new Uint8Array(y) : d === void 0 ? b = new Uint8Array(y, f) : b = new Uint8Array(y, f, d), Object.setPrototypeOf(b, o.prototype), b;
  }
  function F(y) {
    if (o.isBuffer(y)) {
    ...
    if (y.length !== void 0)
      return typeof y.length != "number" || pr(y.length) ? s(0) : p(y);
  ...
  o.isBuffer = function(f) {
    ...
    if (f === d) return 0;
    for (var b = f.length, T = d.length, L = 0, A = Math.min(b, T); L < A; ++L)
      if (f[L] !== d[L]) {
        b = f[L], T = d[L];
        break;
      }
  ...
  function w(y, f) {
    ...
    var d = y.length, b = arguments.length > 2 && arguments[2] === !0;
    if (!b && d === 0) return 0;
    for (var T = !1; ; )
      switch (f) {
        case "ascii":
  ...
  o.prototype.swap16 = function() {
  ...
  }, n && (o.prototype[n] = o.prototype.inspect), o.prototype.compare = function(f, d, b, T, L) {
    ...
    if (d === void 0 && (d = 0), b === void 0 && (b = f ? f.length : 0), T === void 0 && (T = 0), L === void 0 && (L = this.length), d < 0 || b > f.length || T < 0 || L > this.length)
    ...
    if (d >= b)
      return 1;
    if (d >>>= 0, b >>>= 0, T >>>= 0, L >>>= 0, this === f) return 0;
    for (var A = L - T, V = b - d, Y = Math.min(A, V), J = this.slice(T, L), de = f.slice(d, b), te = 0; te < Y; ++te)
      if (J[te] !== de[te]) {
        A = J[te], V = de[te];
        break;
      }
  ...
  function U(y, f, d, b, T) {
    if (y.length === 0) return -1;
    if (typeof d == "string" ? (b = d, d = 0) : d > 2147483647 ? d = 2147483647 : d < -2147483648 && (d = -2147483648), d = +d, pr(d) && (d = T ? 0 : y.length - 1), d < 0 && (d = y.length + d), d >= y.length) {
      if (T) return -1;
      d = y.length - 1;
    } else if (d < 0)
      if (T) d = 0;
      else return -1;
    if (typeof f == "string" && (f = o.from(f, b)), o.isBuffer(f))
      return f.length === 0 ? -1 : B(y, f, d, b, T);
    if (typeof f == "number")
      return f = f & 255, typeof Uint8Array.prototype.indexOf == "function" ? T ? Uint8Array.prototype.indexOf.call(y, f, d) : Uint8Array.prototype.lastIndexOf.call(y, f, d) : B(y, [f], d, b, T);
    throw new TypeError("val must be string, number or Buffer");
  }
  function B(y, f, d, b, T) {
  ...
  o.prototype.includes = function(f, d, b) {
    return this.indexOf(f, d, b) !== -1;
  }, o.prototype.indexOf = function(f, d, b) {
    return U(this, f, d, b, !0);
  }, o.prototype.lastIndexOf = function(f, d, b) {
    return U(this, f, d, b, !1);
  };
  function O(y, f, d, b) {
    d = Number(d) || 0;
    var T = y.length - d;
  ...
  function H(y, f, d, b) {
    return Gt(ze(f, y.length - d), y, d, b);
  }
  function W(y, f, d, b) {
    return Gt(Ji(f), y, d, b);
  }
  function z(y, f, d, b) {
    return Gt(Fn(f), y, d, b);
  }
  function le(y, f, d, b) {
    return Gt(es(f, y.length - d), y, d, b);
  }
  o.prototype.write = function(f, d, b, T) {
    if (d === void 0)
    ...
    var L = this.length - d;
    if ((b === void 0 || b > L) && (b = L), f.length > 0 && (b < 0 || d < 0) || d > this.length)
  ...
  function $(y, f, d) {
    ...
    for (var b = [], T = f; T < d; ) {
      ...
      A === null ? (A = 65533, V = 1) : A > 65535 && (A -= 65536, b.push(A >>> 10 & 1023 | 55296), A = 56320 | A & 1023), b.push(A), T += V;
    }
    return Q(b);
  }
  var K = 4096;
  ...
  function fe(y, f, d) {
    for (var b = y.slice(f, d), T = "", L = 0; L < b.length - 1; L += 2)
      T += String.fromCharCode(b[L] + b[L + 1] * 256);
    return T;
  }
  ...
  o.prototype.readUintLE = o.prototype.readUIntLE = function(f, d, b) {
    f = f >>> 0, d = d >>> 0, b || G(f, d, this.length);
    for (var T = this[f], L = 1, A = 0; ++A < d && (L *= 256); )
      T += this[f + A] * L;
    return T;
  }, o.prototype.readUintBE = o.prototype.readUIntBE = function(f, d, b) {
    f = f >>> 0, d = d >>> 0, b || G(f, d, this.length);
  ...
  }, o.prototype.readIntLE = function(f, d, b) {
    f = f >>> 0, d = d >>> 0, b || G(f, d, this.length);
    for (var T = this[f], L = 1, A = 0; ++A < d && (L *= 256); )
      T += this[f + A] * L;
    return L *= 128, T >= L && (T -= Math.pow(2, 8 * d)), T;
  }, o.prototype.readIntBE = function(f, d, b) {
    f = f >>> 0, d = d >>> 0, b || G(f, d, this.length);
  ...
  function q(y, f, d, b, T, L) {
    ...
    if (d + b > y.length) throw new RangeError("Index out of range");
  }
  o.prototype.writeUintLE = o.prototype.writeUIntLE = function(f, d, b, T) {
    if (f = +f, d = d >>> 0, b = b >>> 0, !T) {
      var L = Math.pow(2, 8 * b) - 1;
      q(this, f, d, b, L, 0);
    }
    var A = 1, V = 0;
    for (this[d] = f & 255; ++V < b && (A *= 256); )
      this[d + V] = f / A & 255;
    return d + b;
  }, o.prototype.writeUintBE = o.prototype.writeUIntBE = function(f, d, b, T) {
    if (f = +f, d = d >>> 0, b = b >>> 0, !T) {
      var L = Math.pow(2, 8 * b) - 1;
      q(this, f, d, b, L, 0);
    }
    ...
    for (this[d + A] = f & 255; --A >= 0 && (V *= 256); )
      this[d + A] = f / V & 255;
    return d + b;
  }, o.prototype.writeUint8 = o.prototype.writeUInt8 = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 1, 255, 0), this[d] = f & 255, d + 1;
  }, o.prototype.writeUint16LE = o.prototype.writeUInt16LE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 2, 65535, 0), this[d] = f & 255, this[d + 1] = f >>> 8, d + 2;
  }, o.prototype.writeUint16BE = o.prototype.writeUInt16BE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 2, 65535, 0), this[d] = f >>> 8, this[d + 1] = f & 255, d + 2;
  }, o.prototype.writeUint32LE = o.prototype.writeUInt32LE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 4, 4294967295, 0), this[d + 3] = f >>> 24, this[d + 2] = f >>> 16, this[d + 1] = f >>> 8, this[d] = f & 255, d + 4;
  }, o.prototype.writeUint32BE = o.prototype.writeUInt32BE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 4, 4294967295, 0), this[d] = f >>> 24, this[d + 1] = f >>> 16, this[d + 2] = f >>> 8, this[d + 3] = f & 255, d + 4;
  }, o.prototype.writeIntLE = function(f, d, b, T) {
    if (f = +f, d = d >>> 0, !T) {
      var L = Math.pow(2, 8 * b - 1);
      q(this, f, d, b, L - 1, -L);
    }
    var A = 0, V = 1, Y = 0;
    for (this[d] = f & 255; ++A < b && (V *= 256); )
      f < 0 && Y === 0 && this[d + A - 1] !== 0 && (Y = 1), this[d + A] = (f / V >> 0) - Y & 255;
    return d + b;
  }, o.prototype.writeIntBE = function(f, d, b, T) {
    if (f = +f, d = d >>> 0, !T) {
      var L = Math.pow(2, 8 * b - 1);
      q(this, f, d, b, L - 1, -L);
    }
    ...
    for (this[d + A] = f & 255; --A >= 0 && (V *= 256); )
      f < 0 && Y === 0 && this[d + A + 1] !== 0 && (Y = 1), this[d + A] = (f / V >> 0) - Y & 255;
    return d + b;
  }, o.prototype.writeInt8 = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 1, 127, -128), f < 0 && (f = 255 + f + 1), this[d] = f & 255, d + 1;
  }, o.prototype.writeInt16LE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 2, 32767, -32768), this[d] = f & 255, this[d + 1] = f >>> 8, d + 2;
  }, o.prototype.writeInt16BE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 2, 32767, -32768), this[d] = f >>> 8, this[d + 1] = f & 255, d + 2;
  }, o.prototype.writeInt32LE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 4, 2147483647, -2147483648), this[d] = f & 255, this[d + 1] = f >>> 8, this[d + 2] = f >>> 16, this[d + 3] = f >>> 24, d + 4;
  }, o.prototype.writeInt32BE = function(f, d, b) {
    return f = +f, d = d >>> 0, b || q(this, f, d, 4, 2147483647, -2147483648), f < 0 && (f = 4294967295 + f + 1), this[d] = f >>> 24, this[d + 1] = f >>> 16, this[d + 2] = f >>> 8, this[d + 3] = f & 255, d + 4;
  };
  function ut(y, f, d, b, T, L) {
    if (d + b > y.length) throw new RangeError("Index out of range");
    if (d < 0) throw new RangeError("Index out of range");
  }
  function _t(y, f, d, b, T) {
    return f = +f, d = d >>> 0, T || ut(y, f, d, 4), r.write(y, f, d, b, 23, 4), d + 4;
  }
  o.prototype.writeFloatLE = function(f, d, b) {
    return _t(this, f, d, !0, b);
  }, o.prototype.writeFloatBE = function(f, d, b) {
    return _t(this, f, d, !1, b);
  };
  function Pt(y, f, d, b, T) {
    return f = +f, d = d >>> 0, T || ut(y, f, d, 8), r.write(y, f, d, b, 52, 8), d + 8;
  }
  o.prototype.writeDoubleLE = function(f, d, b) {
    return Pt(this, f, d, !0, b);
  }, o.prototype.writeDoubleBE = function(f, d, b) {
    return Pt(this, f, d, !1, b);
  }, o.prototype.copy = function(f, d, b, T) {
    ...
    var L = T - b;
    return this === f && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(d, b, T) : Uint8Array.prototype.set.call(
      f,
      this.subarray(b, T),
      d
    ), L;
  }, o.prototype.fill = function(f, d, b, T) {
    if (typeof f == "string") {
  ...
  function Nt(y) {
    if (y = y.split("=")[0], y = y.trim().replace(xt, ""), y.length < 2) return "";
    for (; y.length % 4 !== 0; )
      y = y + "=";
    return y;
  }
  function ze(y, f) {
    f = f || 1 / 0;
    for (var d, b = y.length, T = null, L = [], A = 0; A < b; ++A) {
  ...
  function es(y, f) {
    for (var d, b, T, L = [], A = 0; A < y.length && !((f -= 2) < 0); ++A)
      d = y.charCodeAt(A), b = d >> 8, T = d % 256, L.push(T), L.push(b);
    return L;
  }
  function Fn(y) {
  ...
  function Gt(y, f, d, b) {
    for (var T = 0; T < b && !(T + d >= f.length || T >= y.length); ++T)
      f[T + d] = y[T];
    return T;
  }
  function Be(y, f) {
...
var dt = Se.Buffer = {};
for (we in pt)
  pt.hasOwnProperty(we) && (we === "allocUnsafe" || we === "allocUnsafeSlow" || (dt[we] = pt[we]));
Se.Buffer.prototype = pt.prototype;
(!dt.from || dt.from === Uint8Array.from) && (dt.from = function(t, e, r) {
  if (typeof t == "number")
...
dt.alloc || (dt.alloc = function(t, e, r) {
  if (typeof t != "number")
...
bn.prototype.write = function(t) {
  ...
  return this.pass || !e || (e[0] === $i && (e = e.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), e;
};
bn.prototype.end = function() {
  return this.decoder.end();
};
var vl = typeof Object.hasOwn > "u" ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
function yl(t, e) {
  for (var r in e)
    vl(e, r) && (t[r] = e[r]);
}
var Zi = yl, Lr = {}, Ar = {}, Yt = { exports: {} };
...
function xl() {
  if (Ea) return Ar;
  Ea = 1;
  var t = ml().Buffer, e = t.isEncoding || function(m) {
  ...
  function n(m) {
    var S = r(m);
    if (typeof S != "string" && (t.isEncoding === e || !e(m))) throw new Error("Unknown encoding: " + m);
    return S || m;
  }
  Ar.StringDecoder = a;
  function a(m) {
    ...
    switch (this.encoding) {
      case "utf16le":
        this.text = g, this.end = l, S = 4;
        break;
      case "utf8":
        this.fillLast = c, S = 4;
        break;
      case "base64":
        this.text = p, this.end = x, S = 3;
        break;
      default:
  ...
  a.prototype.write = function(m) {
    ...
    var S, w;
    if (this.lastNeed) {
      if (S = this.fillLast(m), S === void 0) return "";
      w = this.lastNeed, this.lastNeed = 0;
    } else
      w = 0;
    return w < m.length ? S ? S + this.text(m, w) : this.text(m, w) : S || "";
  }, a.prototype.end = h, a.prototype.text = u, a.prototype.fillLast = function(m) {
  ...
  function s(m, S, w) {
    ...
    if (k < w) return 0;
    var C = i(S[k]);
    return C >= 0 ? (C > 0 && (m.lastNeed = C - 1), C) : --k < w || C === -2 ? 0 : (C = i(S[k]), C >= 0 ? (C > 0 && (m.lastNeed = C - 2), C) : --k < w || C === -2 ? 0 : (C = i(S[k]), C >= 0 ? (C > 0 && (C === 2 ? C = 0 : m.lastNeed = C - 3), C) : 0));
  }
  function o(m, S, w) {
    if ((S[0] & 192) !== 128)
      return m.lastNeed = 0, "�";
    if (m.lastNeed > 1 && S.length > 1) {
      if ((S[1] & 192) !== 128)
        return m.lastNeed = 1, "�";
      if (m.lastNeed > 2 && S.length > 2 && (S[2] & 192) !== 128)
        return m.lastNeed = 2, "�";
    }
  }
  function c(m) {
    var S = this.lastTotal - this.lastNeed, w = o(this, m);
    if (w !== void 0) return w;
    if (this.lastNeed <= m.length)
      return m.copy(this.lastChar, S, 0, this.lastNeed), this.lastChar.toString(this.encoding, 0, this.lastTotal);
    m.copy(this.lastChar, S, 0, m.length), this.lastNeed -= m.length;
  }
  function u(m, S) {
    var w = s(this, m, S);
    if (!this.lastNeed) return m.toString("utf8", S);
    this.lastTotal = w;
    var k = m.length - (w - this.lastNeed);
    return m.copy(this.lastChar, 0, k), m.toString("utf8", S, k);
  }
  function h(m) {
    var S = m && m.length ? this.write(m) : "";
    return this.lastNeed ? S + "�" : S;
  }
  function g(m, S) {
    if ((m.length - S) % 2 === 0) {
      var w = m.toString("utf16le", S);
      if (w) {
        var k = w.charCodeAt(w.length - 1);
        if (k >= 55296 && k <= 56319)
          return this.lastNeed = 2, this.lastTotal = 4, this.lastChar[0] = m[m.length - 2], this.lastChar[1] = m[m.length - 1], w.slice(0, -1);
      }
      return w;
    }
    return this.lastNeed = 1, this.lastTotal = 2, this.lastChar[0] = m[m.length - 1], m.toString("utf16le", S, m.length - 1);
  }
  function l(m) {
    var S = m && m.length ? this.write(m) : "";
    if (this.lastNeed) {
  ...
  function p(m, S) {
    var w = (m.length - S) % 3;
    return w === 0 ? m.toString("base64", S) : (this.lastNeed = 3 - w, this.lastTotal = 3, w === 1 ? this.lastChar[0] = m[m.length - 1] : (this.lastChar[0] = m[m.length - 2], this.lastChar[1] = m[m.length - 1]), m.toString("base64", S, m.length - w));
  }
  function x(m) {
    var S = m && m.length ? this.write(m) : "";
...
function bl() {
  ...
  s.prototype.write = function(u) {
    for (var h = t.alloc(u.length * 3), g = 0, l = 0; l < u.length; l++) {
      var p = u.charCodeAt(l);
      p < 128 ? h[g++] = p : p < 2048 ? (h[g++] = 192 + (p >>> 6), h[g++] = 128 + (p & 63)) : (h[g++] = 224 + (p >>> 12), h[g++] = 128 + (p >>> 6 & 63), h[g++] = 128 + (p & 63));
    }
    return h.slice(0, g);
  ...
  o.prototype.write = function(u) {
    for (var h = this.acc, g = this.contBytes, l = this.accBytes, p = "", x = 0; x < u.length; x++) {
      var v = u[x];
      (v & 192) !== 128 ? (g > 0 && (p += this.defaultCharUnicode, g = 0), v < 128 ? p += String.fromCharCode(v) : v < 224 ? (h = v & 31, g = 1, l = 1) : v < 240 ? (h = v & 15, g = 2, l = 1) : p += this.defaultCharUnicode) : g > 0 ? (h = h << 6 | v & 63, g--, l++, g === 0 && (l === 2 && h < 128 && h > 0 ? p += this.defaultCharUnicode : l === 3 && h < 2048 ? p += this.defaultCharUnicode : p += String.fromCharCode(h))) : p += this.defaultCharUnicode;
    }
    return this.acc = h, this.contBytes = g, this.accBytes = l, p;
...
function Sl() {
  ...
  r.prototype.write = function(u) {
    for (var h = t.from(u, "ucs2"), g = t.alloc(h.length * 2), l = this.isLE ? g.writeUInt32LE : g.writeUInt32BE, p = 0, x = 0; x < h.length; x += 2) {
      var v = h.readUInt16LE(x), F = v >= 55296 && v < 56320, m = v >= 56320 && v < 57344;
      if (this.highSurrogate)
        if (F || !m)
          l.call(g, this.highSurrogate, p), p += 4;
        else {
          var S = (this.highSurrogate - 55296 << 10 | v - 56320) + 65536;
          l.call(g, S, p), p += 4, this.highSurrogate = 0;
          continue;
        }
      F ? this.highSurrogate = v : (l.call(g, v, p), p += 4, this.highSurrogate = 0);
    }
    return p < g.length && (g = g.slice(0, p)), g;
  ...
  n.prototype.write = function(u) {
    if (u.length === 0)
      return "";
    var h = 0, g = 0, l = t.alloc(u.length + 4), p = 0, x = this.isLE, v = this.overflow, F = this.badChar;
    if (v.length > 0) {
      for (; h < u.length && v.length < 4; h++)
        v.push(u[h]);
      v.length === 4 && (x ? g = v[h] | v[h + 1] << 8 | v[h + 2] << 16 | v[h + 3] << 24 : g = v[h + 3] | v[h + 2] << 8 | v[h + 1] << 16 | v[h] << 24, v.length = 0, p = a(l, p, g, F));
    }
    for (; h < u.length - 3; h += 4)
      x ? g = u[h] | u[h + 1] << 8 | u[h + 2] << 16 | u[h + 3] << 24 : g = u[h + 3] | u[h + 2] << 8 | u[h + 1] << 16 | u[h] << 24, p = a(l, p, g, F);
    for (; h < u.length; h++)
      v.push(u[h]);
    return l.slice(0, p).toString("ucs2");
  };
  function a(u, h, g, l) {
    if ((g < 0 || g > 1114111) && (g = l), g >= 65536) {
      g -= 65536;
      var p = 55296 | g >> 10;
      u[h++] = p & 255, u[h++] = p >> 8;
      var g = 56320 | g & 1023;
    }
    return u[h++] = g & 255, u[h++] = g >> 8, h;
  }
  n.prototype.end = function() {
  ...
  o.prototype.write = function(u) {
    if (!this.decoder) {
      ...
      for (var g = "", l = 0; l < this.initialBufs.length; l++)
        g += this.decoder.write(this.initialBufs[l]);
    ...
    if (!this.decoder) {
      ...
      for (var h = "", g = 0; g < this.initialBufs.length; g++)
        h += this.decoder.write(this.initialBufs[g]);
  ...
  function c(u, h) {
    var g = [], l = 0, p = 0, x = 0, v = 0, F = 0;
    e:
      for (var m = 0; m < u.length; m++)
        for (var S = u[m], w = 0; w < S.length; w++)
          if (g.push(S[w]), g.length === 4) {
            if (l === 0) {
            ...
            if ((g[0] !== 0 || g[1] > 16) && x++, (g[3] !== 0 || g[2] > 16) && p++, g[0] === 0 && g[1] === 0 && (g[2] !== 0 || g[3] !== 0) && F++, (g[0] !== 0 || g[1] !== 0) && g[2] === 0 && g[3] === 0 && v++, g.length = 0, l++, l >= 100)
              break e;
          }
    return F - x > v - p ? "utf-32be" : F - x < v - p ? "utf-32le" : h || "utf-32le";
  }
  return _e;
}
var jt = {}, Ba;
function wl() {
  ...
  n.prototype.write = function(c) {
    if (c.length == 0)
      return "";
    var u = t.alloc(c.length + 1), h = 0, g = 0;
    for (this.overflowByte !== -1 && (u[0] = c[0], u[1] = this.overflowByte, h = 1, g = 2); h < c.length - 1; h += 2, g += 2)
      u[g] = c[h + 1], u[g + 1] = c[h];
    return this.overflowByte = h == c.length - 1 ? c[c.length - 1] : -1, u.slice(0, g).toString("ucs2");
  }, n.prototype.end = function() {
    this.overflowByte = -1;
  }, jt.utf16 = a;
  function a(c, u) {
  ...
  s.prototype.write = function(c) {
    ...
    if (!this.decoder) {
      ...
      return g && (u += g), this.initialBufs.length = this.initialBufsLen = 0, u;
    }
    return this.decoder.end();
  };
  function o(c, u) {
      ...
      for (var x = 0; x < c.length; x++)
        for (var v = c[x], F = 0; F < v.length; F++)
          if (h.push(v[F]), h.length === 2) {
            ...
            if (h[0] === 0 && h[1] !== 0 && p++, h[0] !== 0 && h[1] === 0 && l++, h.length = 0, g++, g >= 100)
              break e;
          }
...
function Fl() {
  ...
  a.prototype.write = function(v) {
    for (var F = "", m = 0, S = this.inBase64, w = this.base64Accum, k = 0; k < v.length; k++)
      if (!S)
        v[k] == c && (F += this.iconv.decode(v.slice(m, k), "ascii"), m = k + 1, S = !0);
      else if (!s[v[k]]) {
        if (k == m && v[k] == u)
          F += "+";
        else {
    ...
    if (!S)
      F += this.iconv.decode(v.slice(m), "ascii");
    else {
  ...
  g.prototype.encoder = l, g.prototype.decoder = p, g.prototype.bomAware = !0;
  function l(v, F) {
    this.iconv = F.iconv, this.inBase64 = !1, this.base64Accum = t.alloc(6), this.base64AccumIdx = 0;
  }
  l.prototype.write = function(v) {
    for (var F = this.inBase64, m = this.base64Accum, S = this.base64AccumIdx, w = t.alloc(v.length * 5 + 10), k = 0, C = 0; C < v.length; C++) {
      var U = v.charCodeAt(C);
      U >= 32 && U <= 126 ? (F && (S > 0 && (k += w.write(m.slice(0, S).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), k), S = 0), w[k++] = u, F = !1), F || (w[k++] = U, U === h && (w[k++] = u))) : (F || (w[k++] = h, F = !0), F && (m[S++] = U >> 8, m[S++] = U & 255, S == m.length && (k += w.write(m.toString("base64").replace(/\//g, ","), k), S = 0)));
    }
  ...
  return x[44] = !0, p.prototype.write = function(v) {
    for (var F = "", m = 0, S = this.inBase64, w = this.base64Accum, k = 0; k < v.length; k++)
      if (!S)
        v[k] == h && (F += this.iconv.decode(v.slice(m, k), "ascii"), m = k + 1, S = !0);
      else if (!x[v[k]]) {
        if (k == m && v[k] == u)
          F += "&";
        else {
...
function El() {
  ...
  function c(l, p) {
    ...
    if (typeof l.gb18030 == "function") {
      ...
      this.decodeTables.push(i.slice(0));
      for (var S = this.decodeTables[0], v = 129; v <= 254; v++)
        for (var w = this.decodeTables[a - S[v]], k = 48; k <= 57; k++) {
          if (w[k] === e)
            w[k] = a - F;
          else if (w[k] > a)
  ...
  c.prototype.encoder = u, c.prototype.decoder = h, c.prototype._getDecodeTrieNode = function(l) {
    ...
    var x = l[0], v = this._getEncodeBucket(x), F = x & 255, m;
    v[F] <= n ? m = this.encodeTableSeq[n - v[F]] : (m = {}, v[F] !== e && (m[s] = v[F]), v[F] = n - this.encodeTableSeq.length, this.encodeTableSeq.push(m));
    for (var S = 1; S < l.length - 1; S++) {
      var w = m[x];
      typeof w == "object" ? m = w : (m = m[x] = {}, w !== void 0 && (m[s] = w));
    }
    x = l[l.length - 1], m[x] = p;
  }, c.prototype._fillEncodeTable = function(l, p, x) {
    for (var v = this.decodeTables[l], F = !1, m = {}, S = 0; S < 256; S++) {
      var w = v[S], k = p + S;
      if (!x[k])
        if (w >= 0)
          ...
          if (!m[C]) {
            var U = k << 8 >>> 0;
            this._fillEncodeTable(C, U, x) ? F = !0 : m[C] = !0;
          }
  ...
  u.prototype.write = function(l) {
    for (var p = t.alloc(l.length * (this.gb18030 ? 4 : 3)), x = this.leadSurrogate, v = this.seqObj, F = -1, m = 0, S = 0; ; ) {
      if (F === -1) {
        if (m == l.length) break;
      ...
      if (v !== void 0 && w != e) {
        ...
        if (k == e && this.gb18030) {
          var B = g(this.gb18030.uChars, w);
          if (B != -1) {
            var k = this.gb18030.gbChars[B] + (w - this.gb18030.uChars[B]);
            p[S++] = 129 + Math.floor(k / 12600), k = k % 12600, p[S++] = 48 + Math.floor(k / 1260), k = k % 1260, p[S++] = 129 + Math.floor(k / 10), k = k % 10, p[S++] = 48 + k;
            continue;
          }
        }
      }
      k === e && (k = this.defaultCharSingleByte), k < 256 ? p[S++] = k : k < 65536 ? (p[S++] = k >> 8, p[S++] = k & 255) : k < 16777216 ? (p[S++] = k >> 16, p[S++] = k >> 8 & 255, p[S++] = k & 255) : (p[S++] = k >>> 24, p[S++] = k >>> 16 & 255, p[S++] = k >>> 8 & 255, p[S++] = k & 255);
    }
    return this.seqObj = v, this.leadSurrogate = x, p.slice(0, S);
  ...
  h.prototype.write = function(l) {
    for (var p = t.alloc(l.length * 2), x = this.nodeIdx, v = this.prevBytes, F = this.prevBytes.length, m = -this.prevBytes.length, S, w = 0, k = 0; w < l.length; w++) {
      var C = w >= 0 ? l[w] : v[w + F], S = this.decodeTables[x][C];
      if (!(S >= 0)) if (S === e)
        S = this.defaultCharUnicode.charCodeAt(0), w = m;
      else if (S === r) {
        if (w >= 3)
        ...
        var B = g(this.gb18030.gbChars, U);
        S = this.gb18030.uChars[B] + U - this.gb18030.gbChars[B];
      } else if (S <= a) {
        x = a - S;
        continue;
      } else if (S <= n) {
        for (var O = this.decodeTableSeq[n - S], H = 0; H < O.length - 1; H++)
          S = O[H], p[k++] = S & 255, p[k++] = S >> 8;
        S = O[O.length - 1];
      } else
        throw new Error("iconv-lite internal error: invalid decoding table value " + S + " at " + x + "/" + C);
      if (S >= 65536) {
        S -= 65536;
        var W = 55296 | S >> 10;
        p[k++] = W & 255, p[k++] = W >> 8, S = 56320 | S & 1023;
      }
      p[k++] = S & 255, p[k++] = S >> 8, x = 0, m = w + 1;
    }
    return this.nodeIdx = x, this.prevBytes = m >= 0 ? Array.prototype.slice.call(l, m) : v.slice(m + F).concat(Array.prototype.slice.call(l)), p.slice(0, k).toString("ucs2");
...
const Pl = {}, Nl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Pl
}, Symbol.toStringTag, { value: "Module" })), Gl = /* @__PURE__ */ ol(Nl);
(function(t) {
  ...
  a.encodings = null, a.defaultCharUnicode = "�", a.defaultCharSingleByte = "?", a.encode = function(o, c, u) {
    o = "" + (o || "");
    var h = a.getEncoder(c, u), g = h.write(o), l = h.end();
    return l && l.length > 0 ? e.concat([g, l]) : g;
    ...
    var h = a.getDecoder(c, u), g = h.write(o), l = h.end();
    return l ? g + l : g;
    ...
    for (var u = a._canonicalizeEncoding(o), h = {}; ; ) {
      ...
      switch (typeof l) {
        ...
        case "object":
          ...
          break;
        case "function":
          return h.encodingName || (h.encodingName = u), g = new l(h, a), a._codecDataCache[h.encodingName] = g, g;
        default:
    ...
    if (!a.supportsStreams) {
      var c = _l()(o);
      a.IconvLiteEncoderStream = c.IconvLiteEncoderStream, a.IconvLiteDecoderStream = c.IconvLiteDecoderStream, a.encodeStream = function(h, g) {
        return new a.IconvLiteEncoderStream(a.getEncoder(h, g), g);
      }, a.decodeStream = function(h, g) {
        return new a.IconvLiteDecoderStream(a.getDecoder(h, g), g);
      }, a.supportsStreams = !0;
    }
  };
  var i;
...
class Wl extends Ka {
  constructor(e) {
    super(e), this.type = "shx", this.font = new il(e.data), this.data = this.font.fontData;
  }
  /**
   * Return true if this font contains glyph of the specified character. Otherwise, return false.
   * @param char - The character to check
   ...
   */
  getScaleFactor() {
    const { height: e, baseUp: r } = this.data.content;
    return r > 0 && e > 0 ? e / r : 1;
  }
  /**
   * Gets the shape data for a specific character at a given size.
  ...
  getCodeShape(e, r) {
    ...
    return n ? new Sn(e, r, n, this) : void 0;
  }
  /**
  ...
  getCode(e) {
    if (this.font.fontData.header.fontType === ve.BIGFONT && this.encoding) {
      const n = zl.encode(e[0], this.encoding);
...
class Ie {
  ...
  async loadFont(e) {
    ...
    if (this.isFontLoaded(n.name))
      return;
    const i = await Ft.instance.get(a);
    if (i) {
      ...
      o && (e.name.forEach((c) => o.names.add(c)), this.loadedFontMap.set(a, o), this.enableFontCache && await Ft.instance.set(a, n));
    }
  ...
  async getAllFontsFromCache() {
    if (this.loadedFontMap.size !== 0)
      return;
    const e = await Ft.instance.getAll();
    for (const r of e) {
      const { name: n } = r;
...
function Kl(t) {
  ...
  const i = (u) => {
    if (u.endsWith("%")) {
      const g = Number.parseFloat(u.slice(0, -1));
      return Ha(g / 100 * 255);
    }
...
class ef {
   ...
   */
  parseStacking() {
    const e = new Pr(this.extractExpression(!0));
    let r = "", n = "", a = "";
    const i = () => {
      let c = e.peek(), u = !1;
  ...
  parseParagraphProperties(e) {
    const r = new Pr(this.extractExpression());
...
`)
          ...
          if ("\\{}".includes(this.scanner.peek(1)))
            ...
            switch (h) {
              ...
              case "S": {
                ...
                const g = this.parseStacking();
                return this.inStackContext = !1, g;
              }
              case "m":
              case "M":
                if (this.scanner.peek() === "+") {
                  this.scanner.consume(1);
                  const g = this.extractMifCode(this.mifCodeLength);
                  if (g) {
                    this.scanner.consume(g.length);
                    const l = this.mifDecoder(g);
                    return s ? [e, s] : [e, l];
                  }
                  this.scanner.consume(-1);
                }
              ...
              case "U":
                if (this.scanner.peek() === "+") {
                  this.scanner.consume(1);
                  const g = this.scanner.tail.match(/^[0-9A-Fa-f]{4,8}/);
                  if (g) {
                    const l = g[0];
              ...
              default:
                if (h)
                  try {
                    const g = this.parseProperties(h);
                    if (this.yieldPropertyCommands && g)
                      return [Z.PROPERTIES_CHANGED, g];
                    continue;
                  } catch {
                    const g = this.scanner.tail.slice(u, this.scanner.currentIndex);
                    s += g;
                  }
            }
            continue;
        ...
        if (c === "%" && this.scanner.peek(1) === "%") {
          const h = this.scanner.peek(2).toLowerCase(), g = Xl[h];
          if (g) {
            this.scanner.consume(3), s += g;
            continue;
          } else {
        ...
        if (!o) {
          if (c === "{") {
            ...
            if (this.scanner.consume(1), this.yieldPropertyCommands) {
              ...
              this.popCtx();
              const g = this.getPropertyChanges(h, this.ctxStack.current);
              if (Object.keys(g).length > 0)
                return [
                  Z.PROPERTIES_CHANGED,
                  { command: void 0, changes: g, depth: this.ctxStack.depth }
                ];
            } else
              this.popCtx();
            continue;
        ...
        if (!this.inStackContext && c === "^") {
          ...
          if (h) {
            ...
            if (this.scanner.consume(2), g === 32)
              s += "^";
            else {
              if (g === 73)
    ...
    for (; ; ) {
      ...
      if (s) {
        if (yield new Nr(s, this.ctxStack.current.copy(), o), s === Z.NEW_PARAGRAPH && this.resetParagraphParameters) {
          const c = this.ctxStack.current, u = a(c);
          this.yieldPropertyCommands && Object.keys(u).length > 0 && (yield new Nr(Z.PROPERTIES_CHANGED, c.copy(), {
            command: void 0,
            changes: { paragraph: u },
            depth: this.ctxStack.depth
          }));
        }
        n && (yield new Nr(n, this.ctxStack.current.copy(), null), n = null);
      } else
        break;
    }
  }
...
class Dt {
  constructor() {
    this._stroke = 0, this.continueStroke = !1, this.color = new vt(), this.align = Ze.BOTTOM, this.fontFace = { family: "", style: "Regular", weight: 400 }, this._capHeight = { value: 1, isRelative: !1 }, this._widthFactor = { value: 1, isRelative: !1 }, this._charTrackingFactor = { value: 1, isRelative: !1 }, this.oblique = 0, this.paragraph = {
      indent: 0,
      left: 0,
      right: 0,
      align: ee.DEFAULT,
...
function nn(t, e, r) {
  ...
  const g = new R.Box3().copy(h[0].box);
  return h.slice(1).forEach((l) => g.union(l.box)), [
    ...c,
    {
      type: se.STACK,
      char: "",
...
class nf {
  ...
  processText(e) {
    ...
    return r.length > 0 || n.length > 0 ? this.processGeometries(
      ...
      i,
      s
    ), this.processLastLine(), this.recordCurrentLineLayout(), s.userData.lineLayouts = this._lineLayouts.map((o, c) => ({
      ...o,
  ...
  processStack(e, r, n, a, i) {
    const [s, o, c] = e, u = this._hOffset, h = this._vOffset, g = this._currentContext.charTrackingFactor.value, l = this.currentFontSize, p = this._currentContext.fontSizeScaleFactor;
    ...
    const F = Math.max(x, v), m = (F - x) / 2, S = (F - v) / 2;
    if (c === "^") {
      ...
      const B = [], O = [], H = [], W = [];
      this._hOffset = u + S, this._vOffset = this.convertTopAlignedVOffset(
  ...
  convertTopAlignedVOffset(e, r) {
    return e - r + this.defaultFontSize + this.defaultFontSize * Zt;
  }
  processBlank(e, r) {
  ...
  processChar(e, r, n, a, i) {
    ...
    let h = 0;
    if (u) {
      const S = u * Math.PI / 180, w = new R.Matrix4();
      w.set(
        1,
        Math.tan(S),
        0,
        ...
        0,
        1
      ), o.applyMatrix4(w), h = Math.tan(S) * c;
    }
    const g = this.fontManager.getFontType(this.currentFont);
    this._currentContext.bold && g === "mesh" && o.scale(1.06, 1.06, 1), this.hOffset > (this.maxLineWidth || 1 / 0) && (this.recordVisualLineBreak(a, i), this.advanceToNextLine(!1));
    const l = this.hOffset, p = this.flowDirection == Ye.BOTTOM_TO_TOP ? this.vOffset : this.vOffset - this.currentLayoutFontSize, x = s.width * this.currentWidthFactor;
    o.translate(l, p, 0);
    ...
    if (this.currentHorizontalAlignment == ee.DISTRIBUTED ? this._hOffset += v : this._hOffset += s.width * this.currentWordSpace * this.currentWidthFactor + h * this.currentWidthFactor, r.push(o), this._lineHasRenderableChar = !0, this._options.collectCharBoxes !== !1) {
      ...
      const S = new R.Box3().copy(o.boundingBox);
    ...
    const F = c * 0.05, m = 1e-3;
    if (this._currentContext.underline) {
      const S = new R.BufferGeometry(), w = p - F;
      S.setAttribute(
        "position",
    ...
    if (this._currentContext.overline) {
      const S = new R.BufferGeometry(), w = p + c + F;
      S.setAttribute(
        "position",
        new R.BufferAttribute(
          new Float32Array([
    ...
    if (this._currentContext.strikeThrough) {
      const S = new R.BufferGeometry(), w = p + c / 2 - c * 0.2;
      S.setAttribute(
        "position",
        new R.BufferAttribute(
          new Float32Array([
  ...
  countFinalCharBoxes(e, r, n) {
    ...
    if (n !== se.STACK)
      return a.length;
    const i = (g) => g.type === se.CHAR && g.char.trim().length === 0, s = (g) => g.type === se.CHAR && g.char.trim().length > 0, o = a.findIndex(s);
  ...
  processAlignment() {
    ...
    const n = r, a = n.getSize(rf), i = (s, o) => {
      ...
      if (c && c.length > 0) {
        const g = new R.Vector3(o, 0, 0);
        c.forEach((l) => {
          var p;
          return (p = l.box) == null ? void 0 : p.translate(g);
        });
      }
    };
  ...
  toThreeObject(e, r, n, a, i) {
    const s = new R.Group(), o = this.getMaterialColorSettings(), c = this.styleManager.getMeshBasicMaterial(
      ...
      o
    ), h = this._options.collectCharBoxes !== !1, g = e.filter((p) => p instanceof R.ShapeGeometry);
    if (g.length > 0) {
      const p = g.length > 1 ? Sa(g) : g[0], x = new R.Mesh(p, c);
...
class cr extends R.Object3D {
   ...
   */
  async asyncDraw() {
    const e = Array.from(cr.getFonts(this._mtextData.text || "", !0));
  ...
  raycast(e, r) {
    this.createLayoutData().chars.forEach((a) => {
      if (a.box && e.ray.intersectBox(a.box, wt)) {
        const i = e.ray.origin.distanceTo(wt);
        r.push({
          distance: i,
          point: wt.clone(),
          object: this,
  ...
  loadMText(e, r) {
    ...
    const u = (p) => {
      ...
      const x = new R.Vector3(c.x, c.y, 0), v = (F) => {
        var m;
        (m = F.box) == null || m.translate(x), F.children && F.children.length > 0 && F.children.forEach(v);
      };
      p.forEach(v);
    }, h = (p) => {
    ...
    n.traverse((p) => {
      ...
      "geometry" in p && p.geometry.translate(c.x, c.y, 0), u(
        ...
        (F = p.userData) == null ? void 0 : F.lineLayouts
      ), p.layers.enableAll();
    });
    let g = e.rotation || 0;
    if (e.directionVector) {
      const p = e.directionVector, x = new R.Vector3(p.x, p.y, p.z), v = x.clone().cross(Wa), F = Wa.angleTo(x);
      g = v.z > 0 ? -F : F;
    }
    n.matrix.compose(rt, Hr, Gr);
    const l = e.position ? rt.clone().sub(e.position) : rt;
    return zr.makeTranslation(-l.x, -l.y, 0), za.makeRotationZ(g), n.matrix.multiply(zr), n.matrix.multiply(za), n.matrix.multiply(zr.invert()), n.matrix.decompose(n.position, n.quaternion, n.scale), n;
  }
  /**
  ...
  createMTextGroup(e, r) {
    ...
    const o = e.height || r.fixedTextHeight || 0, c = e.widthFactor || r.widthFactor || 1, u = e.lineSpaceFactor || 0.3, h = e.drawingDirection ?? Ye.LEFT_TO_RIGHT, g = {
      fontSize: o,
      widthFactor: c,
      lineSpaceFactor: u,
  ...
  measureAnchorMetrics(e, r, n, a, i) {
    ...
    e.traverse((v) => {
      var m;
      const F = (m = v.userData) == null ? void 0 : m.lineLayouts;
      !F || F.length === 0 || F.forEach((S) => {
        const w = S.y - S.height / 2, k = S.y + S.height / 2;
    ...
    let h = 0, g = Number.isFinite(r) && r > 0 ? r : 0;
    g <= h && !a.isEmpty() && (h = a.min.x, g = a.max.x);
    let l = 0, p = 0;
    i == Ye.BOTTOM_TO_TOP ? (l = a.isEmpty() ? 0 : a.min.y, p = l + u) : (p = a.isEmpty() ? 0 : a.max.y, l = p - u);
    const x = s.hasLine ? s.baselineY : l;
    return { minX: h, maxX: g, minY: l, maxY: p, baselineY: x };
  }
  /**
  ...
  getLayout(e, r, n) {
    ...
    if (i && i.length > 0 && i.forEach((l) => {
      wt.set(0, l.y, 0).applyMatrix4(e.matrixWorld), Pe.set(0, l.y - l.height / 2, 0).applyMatrix4(e.matrixWorld), Ne.set(0, l.y + l.height / 2, 0).applyMatrix4(e.matrixWorld), n.push({
        y: wt.y,
    ...
    if (e instanceof R.Line || e instanceof R.Mesh) {
      const l = e.geometry;
      if (!((g = l.userData) != null && g.isDecoration)) {
  ...
  updateBoxFromObject(e, r) {
    ...
    if (i && i.length > 0) {
      const p = (g = e.userData) == null ? void 0 : g.charBoxType;
      nn(
        i,
        e.matrixWorld,
        p
...
class Qi {
   ...
   */
  buildKey(e) {
    const r = e.color.aci === 256, n = er(e);
...
class af {
  constructor(e = {}) {
    ...
    ), this.defaultStyleManager = new Qi();
   ...
   */
  async asyncRenderMText(e, r, n = ct()) {
  ...
  reconstructMText(e, r) {
    ...
    e.children.forEach((s) => {
      ...
      if (Object.keys(s.geometry.attributes).forEach((h) => {
        const g = s.geometry.attributes[h], l = new Float32Array(
          g.arrayBuffer,
          g.byteOffset,
          g.length
        ...
        if (s.geometry.index.componentType === "uint32") {
          ...
          o.setIndex(new R.Uint32BufferAttribute(g, 1));
        } else {
          ...
          o.setIndex(new R.Uint16BufferAttribute(g, 1));
        }
      let c;
      if (s.type === "mesh") {
        const h = this.buildMaterialColorSettings(
          r,
          s.material.color,
          n
        );
  ...
  buildMaterialColorSettings(e, r, n) {
    const a = new vt();
    return n && r === e.byLayerColor ? a.aci = 256 : e.color.isAci && e.color.aci !== null ? a.aci = e.color.aci : a.rgbValue = r, {
  ...
  collectLayout(e, r, n) {
    ...
    const a = (c = (o = e.userData) == null ? void 0 : o.layout) == null ? void 0 : c.chars, i = (u = e.userData) == null ? void 0 : u.lineLayouts;
    if (i && i.length > 0 && i.forEach((l) => {
      Va.set(0, l.y, 0).applyMatrix4(e.matrixWorld), qa.set(0, l.y - l.height / 2, 0).applyMatrix4(e.matrixWorld), Xa.set(0, l.y + l.height / 2, 0).applyMatrix4(e.matrixWorld), n.push({
        y: Va.y,
        height: Math.abs(Xa.y - qa.y),
        breakIndex: l.breakIndex
      });
    }), a && a.length > 0) {
      const l = (h = e.userData) == null ? void 0 : h.charBoxType, p = nn(
...
class sf {
  constructor() {
    this.fontManager = Ie.instance, this.defaultStyleManager = new Qi(), this.isInitialized = !1;
  }
  /**
   * Used to manage materials used by texts
   */
...
class lf {
   ...
   */
  async asyncRenderMText(e, r, n = ct(), a) {
