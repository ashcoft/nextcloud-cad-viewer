...
var AcApDocManager = /** @class */ (function () {
    ...
    AcApDocManager.prototype.executeCommandString = function (cmdStr) {
        return __awaiter(this, void 0, void 0, function () {
            var lines, _a, cmdName, scriptInputs, documentMode, cmd, loaded;
            var _this = this;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, cmd.trigger(this.context).finally(function () {
     ...
     */
    AcApDocManager.prototype.showBusyIndicator = function () {
     ...
     */
    AcApDocManager.prototype.resetOpenFileProgress = function () {
        this._openFileProgressPeak = 0;
     ...
     */
    AcApDocManager.prototype.normalizeOpenFileProgress = function (data) {
        var stage = data.stage;
        if (stage !== this._openFileProgressStage) {
            if (this._openFileProgressStage === 'FETCH_FILE' &&
                stage === 'CONVERSION') {
                this._openFileProgressPeak = 0;
            }
            this._openFileProgressStage = stage;
        }
        this._openFileProgressPeak = Math.max(this._openFileProgressPeak, data.percentage);
        return __assign(__assign({}, data), { percentage: this._openFileProgressPeak });
    };
    /**
