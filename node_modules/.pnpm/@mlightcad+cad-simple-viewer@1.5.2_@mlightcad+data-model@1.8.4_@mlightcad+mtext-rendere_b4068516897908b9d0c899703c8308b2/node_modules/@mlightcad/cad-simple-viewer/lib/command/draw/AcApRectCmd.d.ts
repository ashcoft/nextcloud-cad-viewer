...
export declare class AcApRectJig extends AcEdPreviewJig<AcGePoint2dLike> {
     ...
     */
    constructor(view: AcEdBaseView, start: AcGePoint2dLike, settingsProvider: () => RectSettings);
    /**
