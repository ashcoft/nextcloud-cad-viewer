...
var AcApMeasureAngleJig = /** @class */ (function (_super) {
    ...
    function AcApMeasureAngleJig(view, db, vertex, arm1, canvas, color) {
        var _this = _super.call(this, view) || this;
    ...
    AcApMeasureAngleJig.prototype.update = function (p) {
        ...
        this._badge.textContent = this._db.formatter.formatAngle((deg * Math.PI) / 180, {
            showUnits: true,
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            ...
                                            case 2:
                                                ...
                                                arm2Prompt.jig = new AcApMeasureAngleJig(context.view, db, vertex, arm1, armCanvas, color);
                                                _b.label = 3;
                                            case 3:
                                                _b.trys.push([3, 5, , 6]);
                                            ...
                                            case 6:
                                                ...
                                                htManager.add("".concat(id, "-badge"), makeBadge(color, db.formatter.formatAngle((degrees * Math.PI) / 180, {
                                                    showUnits: true,
                                                    applyAngbaseAngdir: false
                                                })), badgeWorld, 'measurement');
