var xc = (n, e) => () => (e || n((e = { exports: {} }).exports, e), e.exports);
var z1 = xc((L) => {
  var se;
  (function(n) {
  ...
  function Fc(n) {
    return n === null ? null : `#${Qo(n).toString(16).padStart(6, "0")}`;
  }
  function Cc(n) {
    if (!n)
      return null;
  ...
  function Tc(n) {
    ...
    const t = Cc(e);
    if (t)
      return Qo(Number.parseInt(t.slice(1), 16));
  ...
  class Ac {
    ...
    constructor(e, t, r = {}) {
      ...
      const i = t ?? new jr();
      this.ctxStack = new Ec(i), this.yieldPropertyCommands = r.yieldPropertyCommands ?? !1, this.resetParagraphParameters = r.resetParagraphParameters ?? !1, this.mifDecoder = r.mifDecoder ?? this.decodeMultiByteChar.bind(this), this.mifCodeLength = r.mifCodeLength ?? "auto";
    }
    /**
...
`)
          ...
          if (h === "%" && this.scanner.peek(1) === "%") {
            const u = this.scanner.peek(2).toLowerCase(), f = bc[u];
            if (f) {
      ...
      for (; ; ) {
        ...
        if (a) {
          if (yield new pi(a, this.ctxStack.current.copy(), o), a === se.NEW_PARAGRAPH && this.resetParagraphParameters) {
            const h = this.ctxStack.current, c = i(h);
            this.yieldPropertyCommands && Object.keys(c).length > 0 && (yield new pi(se.PROPERTIES_CHANGED, h.copy(), {
              command: void 0,
              changes: { paragraph: c },
              depth: this.ctxStack.depth
            }));
  ...
  class Ot {
     ...
     */
    toCssColor() {
      return this._rgbValue !== null ? Fc(this._rgbValue) : null;
    }
    /**
   ...
   */
  const Ko = "172", cs = 0, Mc = 1, Qs = 1, Ks = 100, ea = 204, ta = 205, ra = 3, _c = 0, eh = 300, na = 1e3, ln = 1001, ia = 1002, Bc = 1006, Lc = 1008, Oc = 1009, Rc = 1015, Uc = 1023, th = "", qe = "srgb", sa = "srgb-linear", aa = "linear", di = "srgb", er = 7680, oa = 519, ha = 35044, fn = 2e3, ca = 2001;
  class si {
  ...
  function zc() {
    const n = {
      ...
      convert: function(i, s, a) {
        return this.enabled === !1 || s === a || !s || !a || (this.spaces[s].transfer === di && (i.r = mt(i.r), i.g = mt(i.g), i.b = mt(i.b)), this.spaces[s].primaries !== this.spaces[a].primaries && (i.applyMatrix3(this.spaces[s].toXYZ), i.applyMatrix3(this.spaces[a].fromXYZ)), this.spaces[a].transfer === di && (i.r = dr(i.r), i.g = dr(i.g), i.b = dr(i.b))), i;
      },
      ...
      getTransfer: function(i) {
        return i === th ? aa : this.spaces[i].transfer;
      },
  ...
  class Pc {
    static getDataURL(e) {
      ...
      if (e instanceof HTMLCanvasElement)
        ...
        tr === void 0 && (tr = ua("canvas")), tr.width = e.width, tr.height = e.height;
  ...
  class Gc {
    constructor(e = null) {
      this.isSource = !0, Object.defineProperty(this, "id", { value: Nc++ }), this.uuid = wr(), this.data = e, this.dataReady = !0, this.version = 0;
    }
    set needsUpdate(e) {
      e === !0 && this.version++;
    }
  ...
  function mi(n) {
    return typeof HTMLImageElement < "u" && n instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && n instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && n instanceof ImageBitmap ? Pc.getDataURL(n) : n.data ? {
  ...
  const vi = /* @__PURE__ */ new E(), pa = /* @__PURE__ */ new Qt();
  class Te {
    ...
    intersectsTriangle(e) {
      if (this.isEmpty())
        return !1;
      this.getCenter(Er), dn.subVectors(this.max, Er), rr.subVectors(e.a, Er), nr.subVectors(e.b, Er), ir.subVectors(e.c, Er), bt.subVectors(nr, rr), wt.subVectors(ir, nr), Nt.subVectors(rr, ir);
      let t = [
        0,
        -bt.z,
        bt.y,
      ...
      return !xi(t, rr, nr, ir, dn) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !xi(t, rr, nr, ir, dn)) ? !1 : (gn.crossVectors(bt, wt), t = [gn.x, gn.y, gn.z], xi(t, rr, nr, ir, dn));
    }
    clampPoint(e, t) {
  ...
  const at = [
    ...
    /* @__PURE__ */ new E(),
    /* @__PURE__ */ new E()
  ], He = /* @__PURE__ */ new E(), pn = /* @__PURE__ */ new Te(), rr = /* @__PURE__ */ new E(), nr = /* @__PURE__ */ new E(), ir = /* @__PURE__ */ new E(), bt = /* @__PURE__ */ new E(), wt = /* @__PURE__ */ new E(), Nt = /* @__PURE__ */ new E(), Er = /* @__PURE__ */ new E(), dn = /* @__PURE__ */ new E(), gn = /* @__PURE__ */ new E(), Gt = /* @__PURE__ */ new E();
  ...
  const Wc = /* @__PURE__ */ new Te(), Ar = /* @__PURE__ */ new E(), bi = /* @__PURE__ */ new E();
  class Es {
    ...
    setFromPoints(e, t) {
      const r = this.center;
      t !== void 0 ? r.copy(t) : Wc.setFromPoints(e).getCenter(r);
      let i = 0;
    ...
    expandByPoint(e) {
      ...
      if (t > this.radius * this.radius) {
        ...
        this.center.addScaledVector(Ar, i / r), this.radius += i;
      }
      return this;
    }
    union(e) {
      return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (bi.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(Ar.copy(e.center).add(bi)), this.expandByPoint(Ar.copy(e.center).sub(bi))), this);
    }
    equals(e) {
  ...
  const ot = /* @__PURE__ */ new E(), wi = /* @__PURE__ */ new E(), yn = /* @__PURE__ */ new E(), St = /* @__PURE__ */ new E(), Si = /* @__PURE__ */ new E(), mn = /* @__PURE__ */ new E(), Fi = /* @__PURE__ */ new E();
  class rh {
    ...
    distanceSqToSegment(e, t, r, i) {
      wi.copy(e).add(t).multiplyScalar(0.5), yn.copy(t).sub(e).normalize(), St.copy(this.origin).sub(wi);
      const s = e.distanceTo(t) * 0.5, a = -this.direction.dot(yn), o = St.dot(this.direction), h = -St.dot(yn), c = St.lengthSq(), u = Math.abs(1 - a * a);
      let f, l, p, d;
      if (u > 0)
      ...
      return r && r.copy(this.origin).addScaledVector(this.direction, f), i && i.copy(wi).addScaledVector(yn, l), p;
    }
    intersectSphere(e, t) {
    ...
    intersectTriangle(e, t, r, i, s) {
      ...
      const h = o * this.direction.dot(mn.crossVectors(St, mn));
      if (h < 0)
        return null;
      const c = o * this.direction.dot(Si.cross(St));
      if (c < 0 || h + c > a)
        return null;
      const u = -o * St.dot(Fi);
  ...
  class Ee {
    ...
    makeRotationFromQuaternion(e) {
      return this.compose(Vc, e, qc);
    }
    lookAt(e, t, r) {
      const i = this.elements;
      return Ae.subVectors(e, t), Ae.lengthSq() === 0 && (Ae.z = 1), Ae.normalize(), Ft.crossVectors(r, Ae), Ft.lengthSq() === 0 && (Math.abs(r.z) === 1 ? Ae.x += 1e-4 : Ae.z += 1e-4, Ae.normalize(), Ft.crossVectors(r, Ae)), Ft.normalize(), vn.crossVectors(Ae, Ft), i[0] = Ft.x, i[4] = vn.x, i[8] = Ae.x, i[1] = Ft.y, i[5] = vn.y, i[9] = Ae.y, i[2] = Ft.z, i[6] = vn.z, i[10] = Ae.z, this;
    }
    multiply(e) {
      return this.multiplyMatrices(this, e);
    }
  ...
  const sr = /* @__PURE__ */ new E(), We = /* @__PURE__ */ new Ee(), Vc = /* @__PURE__ */ new E(0, 0, 0), qc = /* @__PURE__ */ new E(1, 1, 1), Ft = /* @__PURE__ */ new E(), vn = /* @__PURE__ */ new E(), Ae = /* @__PURE__ */ new E(), da = /* @__PURE__ */ new Ee(), ga = /* @__PURE__ */ new Qt();
  class Kr {
    ...
    setFromQuaternion(e, t, r) {
      return da.makeRotationFromQuaternion(e), this.setFromRotationMatrix(da, t, r);
    }
  ...
  let Yc = 0;
  const ya = /* @__PURE__ */ new E(), ar = /* @__PURE__ */ new Qt(), ht = /* @__PURE__ */ new Ee(), xn = /* @__PURE__ */ new E(), Mr = /* @__PURE__ */ new E(), Zc = /* @__PURE__ */ new E(), Jc = /* @__PURE__ */ new Qt(), ma = /* @__PURE__ */ new E(1, 0, 0), va = /* @__PURE__ */ new E(0, 1, 0), xa = /* @__PURE__ */ new E(0, 0, 1), ba = { type: "added" }, $c = { type: "removed" }, or = { type: "childadded", child: null }, Ci = { type: "childremoved", child: null };
  class Be extends si {
    constructor() {
      super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: Yc++ }), this.uuid = wr(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = Be.DEFAULT_UP.clone();
      const e = new E(), t = new Kr(), r = new Qt(), i = new E(1, 1, 1);
      function s() {
        r.setFromEuler(t, !1);
      }
      function a() {
    ...
    lookAt(e, t, r) {
      ...
      const i = this.parent;
      this.updateWorldMatrix(!0, !1), Mr.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ht.lookAt(Mr, xn, this.up) : ht.lookAt(xn, Mr, this.up), this.quaternion.setFromRotationMatrix(ht), i && (ht.extractRotation(i.matrixWorld), ar.setFromRotationMatrix(ht), this.quaternion.premultiply(ar.invert()));
    }
    add(e) {
      ...
      return e === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(ba), or.child = e, this.dispatchEvent(or), or.child = null) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e), this);
    }
    remove(e) {
      if (arguments.length > 1) {
      ...
      return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent($c), Ci.child = e, this.dispatchEvent(Ci), Ci.child = null), this;
    }
    removeFromParent() {
      const e = this.parent;
    ...
    getWorldQuaternion(e) {
      return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Mr, e, Zc), e;
    }
    getWorldScale(e) {
      return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Mr, Jc, e), e;
    }
    getWorldDirection(e) {
  ...
  const Ve = /* @__PURE__ */ new E(), ct = /* @__PURE__ */ new E(), Ti = /* @__PURE__ */ new E(), ut = /* @__PURE__ */ new E(), hr = /* @__PURE__ */ new E(), cr = /* @__PURE__ */ new E(), wa = /* @__PURE__ */ new E(), ki = /* @__PURE__ */ new E(), Ei = /* @__PURE__ */ new E(), Ai = /* @__PURE__ */ new E(), Mi = /* @__PURE__ */ new Qr(), _i = /* @__PURE__ */ new Qr(), Bi = /* @__PURE__ */ new Qr();
  class Xe {
    ...
    static getBarycoord(e, t, r, i, s) {
      Ve.subVectors(i, t), ct.subVectors(r, t), Ti.subVectors(e, t);
      const a = Ve.dot(Ve), o = Ve.dot(ct), h = Ve.dot(Ti), c = ct.dot(ct), u = ct.dot(Ti), f = a * c - o * o;
      if (f === 0)
    ...
    closestPointToPoint(e, t) {
      ...
      Ai.subVectors(e, s);
      const p = hr.dot(Ai), d = cr.dot(Ai);
      if (d >= 0 && p <= d)
        return t.copy(s);
      const m = p * c - h * d;
      if (m <= 0 && c >= 0 && d <= 0)
        return o = c / (c - d), t.copy(r).addScaledVector(cr, o);
      const x = u * d - p * f;
      if (x <= 0 && f - u >= 0 && p - d >= 0)
        return wa.subVectors(s, i), o = (f - u) / (f - u + (p - d)), t.copy(i).addScaledVector(wa, o);
      const v = 1 / (x + m + l);
      return a = m * v, o = l * v, t.copy(r).addScaledVector(hr, a).addScaledVector(cr, o);
    }
    equals(e) {
  ...
  class Sr {
    ...
    setHSL(e, t, r, i = Ge.workingColorSpace) {
      if (e = Dc(e, 1), t = X(t, 0, 1), r = X(r, 0, 1), t === 0)
    ...
    lerpHSL(e, t) {
      this.getHSL(Ct), e.getHSL(bn);
      const r = gi(Ct.h, bn.h, t), i = gi(Ct.s, bn.s, t), s = gi(Ct.l, bn.l, t);
  ...
  const Se = /* @__PURE__ */ new Sr();
  Sr.NAMES = nh;
  let jc = 0;
  class ih extends si {
    constructor() {
      super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: jc++ }), this.uuid = wr(), this.name = "", this.type = "Material", this.blending = Qs, this.side = cs, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = ea, this.blendDst = ta, this.blendEquation = Ks, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Sr(0, 0, 0), this.blendAlpha = 0, this.depthFunc = ra, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = oa, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = er, this.stencilZFail = er, this.stencilZPass = er, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
    }
    get alphaTest() {
  ...
  const ge = /* @__PURE__ */ new E(), wn = /* @__PURE__ */ new q();
  class Ye {
    constructor(e, t, r = !1) {
      if (Array.isArray(e))
        throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
      this.isBufferAttribute = !0, this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = r, this.usage = ha, this.updateRanges = [], this.gpuType = Rc, this.version = 0;
    }
    onUploadCallback() {
    }
    set needsUpdate(e) {
    ...
    toJSON() {
      ...
      return this.name !== "" && (e.name = this.name), this.usage !== ha && (e.usage = this.usage), e;
    }
  }
  class Qc extends Ye {
    constructor(e, t, r) {
  ...
  let eu = 0;
  const Re = /* @__PURE__ */ new Ee(), Oi = /* @__PURE__ */ new Be(), ur = /* @__PURE__ */ new E(), Me = /* @__PURE__ */ new Te(), _r = /* @__PURE__ */ new Te(), ve = /* @__PURE__ */ new E();
  class ze extends si {
    constructor() {
      super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: eu++ }), this.uuid = wr(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = { start: 0, count: 1 / 0 }, this.userData = {};
    }
    getIndex() {
      return this.index;
    }
    setIndex(e) {
      return Array.isArray(e) ? this.index = new (Ic(e) ? Kc : Qc)(e, 1) : this.index = e, this;
    }
    setIndirect(e) {
    ...
    setFromPoints(e) {
      ...
      if (t === void 0) {
        ...
        this.setAttribute("position", new Zt(r, 3));
      } else {
      ...
      if (e) {
        ...
        if (Me.setFromBufferAttribute(e), t)
          for (let s = 0, a = t.length; s < a; s++) {
            const o = t[s];
            _r.setFromBufferAttribute(o), this.morphTargetsRelative ? (ve.addVectors(Me.min, _r.min), Me.expandByPoint(ve), ve.addVectors(Me.max, _r.max), Me.expandByPoint(ve)) : (Me.expandByPoint(_r.min), Me.expandByPoint(_r.max));
          }
        Me.getCenter(r);
        let i = 0;
        ...
        if (t)
          for (let s = 0, a = t.length; s < a; s++) {
            ...
            for (let c = 0, u = o.count; c < u; c++)
              ve.fromBufferAttribute(o, c), h && (ur.fromBufferAttribute(e, c), ve.add(ur)), i = Math.max(i, r.distanceToSquared(ve));
          }
  ...
  const Sa = /* @__PURE__ */ new Ee(), Ht = /* @__PURE__ */ new rh(), Sn = /* @__PURE__ */ new Es(), Fa = /* @__PURE__ */ new E(), Fn = /* @__PURE__ */ new E(), Cn = /* @__PURE__ */ new E(), Tn = /* @__PURE__ */ new E(), Ri = /* @__PURE__ */ new E(), kn = /* @__PURE__ */ new E(), Ca = /* @__PURE__ */ new E(), En = /* @__PURE__ */ new E();
  class Gr extends Be {
    constructor(e = new ze(), t = new sh()) {
    ...
    getVertexPosition(e, t) {
      ...
      if (s && o) {
        ...
        for (let h = 0, c = s.length; h < c; h++) {
          const u = o[h], f = s[h];
          u !== 0 && (Ri.fromBufferAttribute(f, e), a ? kn.addScaledVector(Ri, u) : kn.addScaledVector(Ri.sub(t), u));
        }
        t.add(kn);
      }
      return t;
        ...
        if (Array.isArray(a))
          for (let d = 0, m = l.length; d < m; d++) {
            ...
            for (let S = w, T = b; S < T; S += 3) {
              ...
              i = An(this, v, e, r, c, u, f, B, M, _), i && (i.faceIndex = Math.floor(S / 3), i.face.materialIndex = x.materialIndex, t.push(i));
            }
          }
        else {
          ...
          for (let x = d, v = m; x < v; x += 3) {
            ...
            i = An(this, a, e, r, c, u, f, w, b, S), i && (i.faceIndex = Math.floor(x / 3), t.push(i));
          }
        }
      else if (h !== void 0)
        if (Array.isArray(a))
  ...
  function tu(n, e, t, r, i, s, a, o) {
    let h;
    if (e.side === Mc ? h = r.intersectTriangle(a, s, i, !0, o) : h = r.intersectTriangle(i, s, a, e.side === cs, o), h === null) return null;
    En.copy(o), En.applyMatrix4(n.matrixWorld);
    const c = t.ray.origin.distanceTo(En);
  ...
  function An(n, e, t, r, i, s, a, o, h, c) {
    n.getVertexPosition(o, Fn), n.getVertexPosition(h, Cn), n.getVertexPosition(c, Tn);
    const u = tu(n, e, t, r, Fn, Cn, Tn, Ca);
    if (u) {
      const f = new E();
      Xe.getBarycoord(Ca, Fn, Cn, Tn, f), i && (u.uv = Xe.getInterpolatedAttribute(i, o, h, c, f, new q())), s && (u.uv1 = Xe.getInterpolatedAttribute(s, o, h, c, f, new q())), a && (u.normal = Xe.getInterpolatedAttribute(a, o, h, c, f, new E()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
      const l = {
        a: o,
        b: h,
        c,
      ...
      Xe.getNormal(Fn, Cn, Tn, l.normal), u.face = l, u.barycoord = f;
    }
    return u;
  }
  class ah extends ih {
  ...
  const Zn = /* @__PURE__ */ new E(), Jn = /* @__PURE__ */ new E(), Ta = /* @__PURE__ */ new Ee(), Br = /* @__PURE__ */ new rh(), Mn = /* @__PURE__ */ new Es(), Ui = /* @__PURE__ */ new E(), ka = /* @__PURE__ */ new E();
  class $n extends Be {
    constructor(e = new ze(), t = new ah()) {
    ...
    computeLineDistances() {
      ...
      if (e.index === null) {
        ...
        e.setAttribute("lineDistance", new Zt(r, 1));
      } else
    ...
    raycast(e, t) {
      ...
      Ta.copy(i).invert(), Br.copy(e.ray).applyMatrix4(Ta);
      ...
      if (u !== null) {
        ...
        if (this.isLineLoop) {
          const m = u.getX(d - 1), x = u.getX(p), v = _n(this, e, Br, h, m, x);
          v && t.push(v);
        }
      } else {
  ...
  function _n(n, e, t, r, i, s) {
    ...
    if (Zn.fromBufferAttribute(a, i), Jn.fromBufferAttribute(a, s), t.distanceSqToSegment(Zn, Jn, Ui, ka) > r) return;
    Ui.applyMatrix4(n.matrixWorld);
    const h = e.ray.origin.distanceTo(Ui);
    if (!(h < e.near || h > e.far))
      return {
        distance: h,
        // What do we want? intersection point on the ray or on the segment??
        // point: raycaster.ray.at( distance ),
        point: ka.clone().applyMatrix4(n.matrixWorld),
        index: i,
        face: null,
        faceIndex: null,
        barycoord: null,
  ...
  const Ea = /* @__PURE__ */ new E(), Aa = /* @__PURE__ */ new E();
  class ru extends $n {
    constructor(e, t) {
    ...
    computeLineDistances() {
      ...
      if (e.index === null) {
        ...
        for (let i = 0, s = t.count; i < s; i += 2)
          Ea.fromBufferAttribute(t, i), Aa.fromBufferAttribute(t, i + 1), r[i] = i === 0 ? 0 : r[i - 1], r[i + 1] = r[i] + Ea.distanceTo(Aa);
        e.setAttribute("lineDistance", new Zt(r, 1));
      } else
  ...
  class st {
    ...
    computeFrenetFrames(e, t) {
      const r = new E(), i = [], s = [], a = [], o = new E(), h = new Ee();
      for (let p = 0; p <= e; p++) {
        const d = p / e;
  ...
  const Bn = /* @__PURE__ */ new E(), Di = /* @__PURE__ */ new As(), Ii = /* @__PURE__ */ new As(), zi = /* @__PURE__ */ new As();
  class iu extends st {
    ...
    getPoint(e, t = new E()) {
      ...
      if (this.closed || o + 2 < s ? u = i[(o + 2) % s] : (Bn.subVectors(i[s - 1], i[s - 2]).add(i[s - 1]), u = Bn), this.curveType === "centripetal" || this.curveType === "chordal") {
        ...
        m < 1e-4 && (m = 1), d < 1e-4 && (d = m), x < 1e-4 && (x = m), Di.initNonuniformCatmullRom(c.x, f.x, l.x, u.x, d, m, x), Ii.initNonuniformCatmullRom(c.y, f.y, l.y, u.y, d, m, x), zi.initNonuniformCatmullRom(c.z, f.z, l.z, u.z, d, m, x);
      } else this.curveType === "catmullrom" && (Di.initCatmullRom(c.x, f.x, l.x, u.x, this.tension), Ii.initCatmullRom(c.y, f.y, l.y, u.y, this.tension), zi.initCatmullRom(c.z, f.z, l.z, u.z, this.tension));
      return r.set(
        Di.calc(h),
        Ii.calc(h),
        zi.calc(h)
  ...
  function Dr(n, e, t, r, i) {
    return hu(n, e) + cu(n, t) + uu(n, r) + lu(n, i);
  }
  class jn extends st {
  ...
  class oh extends st {
    ...
    getPoint(e, t = new q()) {
      ...
      return r.set(
        _a(o, h.x, c.x, u.x, f.x),
        _a(o, h.y, c.y, u.y, f.y)
      ), r;
    }
    copy(e) {
      super.copy(e), this.points = [];
  ...
  let us = class extends gu {
    ...
    splineThru(e) {
      const t = [this.currentPoint.clone()].concat(e), r = new oh(t);
  ...
  const yu = {
    triangulate: function(n, e, t = 2) {
      ...
      let o, h, c, u, f, l, p;
      if (r && (s = wu(n, e, s, t)), n.length > 80 * t) {
        o = c = n[0], h = u = n[1];
        for (let d = t; d < i; d += t)
  ...
  function hh(n, e, t, r, i) {
    let s, a;
    if (i === Lu(n, e, t, r) > 0)
      for (s = e; s < t; s += r) a = La(s, n[s], n[s + 1], a);
    else
      for (s = t - r; s >= e; s -= r) a = La(s, n[s], n[s + 1], a);
  ...
  function $t(n, e) {
    ...
    let t = n, r;
    do
      if (r = !1, !t.steiner && (ai(t, t.next) || ue(t.prev, t, t.next) === 0)) {
  ...
  function Wr(n, e, t, r, i, s, a) {
    ...
    let o = n, h, c;
    for (; n.prev !== n.next; ) {
      if (h = n.prev, c = n.next, s ? vu(n, r, i, s) : mu(n)) {
        e.push(h.i / t | 0), e.push(n.i / t | 0), e.push(c.i / t | 0), qr(n), n = c.next, o = c.next;
        continue;
      }
      if (n = c, n === o) {
        a ? a === 1 ? (n = xu($t(n), e, t), Wr(n, e, t, r, i, s, 2)) : a === 2 && bu(n, e, t, r, i, s) : Wr($t(n), e, t, r, i, s, 1);
        break;
      }
    }
  }
  function mu(n) {
    ...
    let d = r.next;
    for (; d !== e; ) {
      if (d.x >= u && d.x <= l && d.y >= f && d.y <= p && pr(i, o, s, h, a, c, d.x, d.y) && ue(d.prev, d, d.next) >= 0) return !1;
      d = d.next;
    }
    return !0;
  }
  function vu(n, e, t, r) {
    ...
    const o = i.x, h = s.x, c = a.x, u = i.y, f = s.y, l = a.y, p = o < h ? o < c ? o : c : h < c ? h : c, d = u < f ? u < l ? u : l : f < l ? f : l, m = o > h ? o > c ? o : c : h > c ? h : c, x = u > f ? u > l ? u : l : f > l ? f : l, v = ls(p, d, e, t, r), w = ls(m, x, e, t, r);
    let b = n.prevZ, S = n.nextZ;
    for (; b && b.z >= v && S && S.z <= w; ) {
      if (b.x >= p && b.x <= m && b.y >= d && b.y <= x && b !== i && b !== a && pr(o, u, h, f, c, l, b.x, b.y) && ue(b.prev, b, b.next) >= 0 || (b = b.prevZ, S.x >= p && S.x <= m && S.y >= d && S.y <= x && S !== i && S !== a && pr(o, u, h, f, c, l, S.x, S.y) && ue(S.prev, S, S.next) >= 0)) return !1;
      S = S.nextZ;
    }
    for (; b && b.z >= v; ) {
      if (b.x >= p && b.x <= m && b.y >= d && b.y <= x && b !== i && b !== a && pr(o, u, h, f, c, l, b.x, b.y) && ue(b.prev, b, b.next) >= 0) return !1;
      b = b.prevZ;
    }
    for (; S && S.z <= w; ) {
      if (S.x >= p && S.x <= m && S.y >= d && S.y <= x && S !== i && S !== a && pr(o, u, h, f, c, l, S.x, S.y) && ue(S.prev, S, S.next) >= 0) return !1;
      S = S.nextZ;
    }
    return !0;
  }
  function xu(n, e, t) {
    ...
    do {
      ...
      !ai(i, s) && ch(i, r, r.next, s) && Vr(i, s) && Vr(s, i) && (e.push(i.i / t | 0), e.push(r.i / t | 0), e.push(s.i / t | 0), qr(r), qr(r.next), r = n = s), r = r.next;
    } while (r !== n);
    return $t(r);
  }
  function bu(n, e, t, r, i, s) {
    let a = n;
    do {
      let o = a.next.next;
      for (; o !== a.prev; ) {
        if (a.i !== o.i && Mu(a, o)) {
          let h = uh(a, o);
          a = $t(a, a.next), h = $t(h, h.next), Wr(a, e, t, r, i, s, 0), Wr(h, e, t, r, i, s, 0);
          return;
        }
        o = o.next;
      }
  ...
  function wu(n, e, t, r) {
    ...
    for (s = 0, a = e.length; s < a; s++)
      o = e[s] * r, h = s < a - 1 ? e[s + 1] * r : n.length, c = hh(n, o, h, r, !1), c === c.next && (c.steiner = !0), i.push(Au(c));
    for (i.sort(Su), s = 0; s < i.length; s++)
      t = Fu(i[s], t);
    return t;
  }
  function Su(n, e) {
  ...
  function Cu(n, e) {
    ...
    t = i;
    do
      s >= t.x && t.x >= h && s !== t.x && pr(a < c ? s : r, a, h, c, a < c ? r : s, a, t.x, t.y) && (f = Math.abs(a - t.y) / (s - t.x), Vr(t, n) && (f < u || f === u && (t.x > i.x || t.x === i.x && Tu(i, t))) && (i = t, u = f)), t = t.next;
    while (t !== o);
    return i;
  }
  function Tu(n, e) {
  ...
  function ku(n, e, t, r) {
    let i = n;
    do
      i.z === 0 && (i.z = ls(i.x, i.y, e, t, r)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
    while (i !== n);
    i.prevZ.nextZ = null, i.prevZ = null, Eu(i);
  }
  function Eu(n) {
  ...
  function Mu(n, e) {
    return n.next.i !== e.i && n.prev.i !== e.i && !_u(n, e) && // doesn't intersect other edges
    (Vr(n, e) && Vr(e, n) && Bu(n, e) && // locally visible
    (ue(n.prev, n, e.prev) || ue(n, e.prev, e)) || // does not create opposite-facing sectors
    ai(n, e) && ue(n.prev, n, n.next) > 0 && ue(e.prev, e, e.next) > 0);
  }
  function ue(n, e, t) {
  ...
  function ch(n, e, t, r) {
    const i = On(ue(n, e, t)), s = On(ue(n, e, r)), a = On(ue(t, r, n)), o = On(ue(t, r, e));
  ...
  function _u(n, e) {
    let t = n;
    do {
      if (t.i !== n.i && t.next.i !== n.i && t.i !== e.i && t.next.i !== e.i && ch(t, t.next, n, e)) return !0;
      t = t.next;
    } while (t !== n);
    return !1;
  }
  ...
  function uh(n, e) {
    const t = new fs(n.i, n.x, n.y), r = new fs(e.i, e.x, e.y), i = n.next, s = e.prev;
  ...
  class Rt {
    ...
    static triangulateShape(e, t) {
      ...
      for (let h = 0; h < t.length; h++)
        i.push(a), a += t[h].length, Ra(r, t[h]);
      const o = yu.triangulate(r, i);
  ...
  class yr extends ze {
    constructor(e = new gr([new q(0, 0.5), new q(-0.5, -0.5), new q(0.5, -0.5)]), t = 12) {
      ...
      this.setIndex(r), this.setAttribute("position", new Zt(i, 3)), this.setAttribute("normal", new Zt(s, 3)), this.setAttribute("uv", new Zt(a, 2));
      function c(u) {
  ...
  lh.DEFAULT_MATERIAL_NAME = "__DEFAULT";
  const lt = {};
    ...
    load(e, t, r, i) {
      ...
      fetch(a).then((c) => {
        if (c.status === 200 || c.status === 0) {
          ...
          throw new Du(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`, c);
      }).then((c) => {
        switch (h) {
          case "arraybuffer":
  ...
  class fh {
    ...
    moveTo(e, t) {
      return this.currentPath = new us(), this.subPaths.push(this.currentPath), this.currentPath.moveTo(e, t), this;
    }
    lineTo(e, t) {
    ...
    toShapes(e) {
      ...
      for (let v = 0, w = s.length; v < w; v++)
        o = s[v], m = o.getPoints(), a = i(m), a = e ? !a : a, a ? (!u && l[d] && d++, l[d] = { s: new gr(), p: m }, l[d].s.curves = o.curves, u && d++, p[d] = []) : p[d].push({ h: o, p: m[0] });
      if (!l[0]) return t(s);
      if (l.length > 1) {
        let v = !1, w = 0;
  ...
  class ph {
    constructor(e) {
      this.names = /* @__PURE__ */ new Set(), this.unsupportedChars = {}, this.encoding = e.encoding, e.alias.forEach((t) => this.names.add(t)), this.cache = new zu();
    }
    /**
  ...
  const ps = (n, e) => e.some((t) => n instanceof t);
  let Da, Ia;
  function Pu() {
    return Da || (Da = [
      IDBDatabase,
  ...
  const ds = /* @__PURE__ */ new WeakMap(), Pi = /* @__PURE__ */ new WeakMap(), oi = /* @__PURE__ */ new WeakMap();
  function Gu(n) {
  ...
  function Wu(n) {
    return Nu().includes(n) ? function(...e) {
      return n.apply(ys(this), e), Jt(this.request);
    } : function(...e) {
      return Jt(n.apply(ys(this), e));
    };
  }
  function Vu(n) {
    return typeof n == "function" ? Wu(n) : (n instanceof IDBTransaction && Hu(n), ps(n, Pu()) ? new Proxy(n, gs) : n);
  }
  function Jt(n) {
    ...
    if (Pi.has(n))
      return Pi.get(n);
    const e = Vu(n);
    return e !== n && (Pi.set(n, e), oi.set(e, n)), e;
  }
  const ys = (n) => oi.get(n);
  function qu(n, e, { blocked: t, upgrade: r, blocking: i, terminated: s } = {}) {
  ...
  const Xu = ["get", "getKey", "getAll", "getAllKeys", "count"], Yu = ["put", "add", "delete", "clear"], Ni = /* @__PURE__ */ new Map();
  function za(n, e) {
    if (!(n instanceof IDBDatabase && !(e in n) && typeof e == "string"))
      return;
    if (Ni.get(e))
      return Ni.get(e);
    const t = e.replace(/FromIndex$/, ""), r = e !== t, i = Yu.includes(t);
    if (
      // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
      !(t in (r ? IDBIndex : IDBObjectStore).prototype) || !(i || Xu.includes(t))
    )
      return;
  ...
  gh((n) => ({
    ...n,
    get: (e, t, r) => za(e, t) || n.get(e, t, r),
    has: (e, t) => !!za(e, t) || n.has(e, t)
  }));
  const Zu = ["continue", "continuePrimaryKey", "advance"], Pa = {}, ms = /* @__PURE__ */ new WeakMap(), yh = /* @__PURE__ */ new WeakMap(), Ju = {
    get(n, e) {
      if (!Zu.includes(e))
        return n[e];
      let t = Pa[e];
      return t || (t = Pa[e] = function(...r) {
        ms.set(this, yh.get(this)[e](...r));
      }), t;
    }
  };
  async function* $u(...n) {
    ...
    if (e instanceof IDBCursor || (e = await e.openCursor(...n)), !e)
      return;
    e = e;
    const t = new Proxy(e, Ju);
    for (yh.set(t, e), oi.set(t, ys(e)); e; )
      yield t, e = await (ms.get(t) || e.continue()), ms.delete(t);
  }
  function Na(n, e) {
    return e === Symbol.asyncIterator && ps(n, [IDBIndex, IDBObjectStore, IDBCursor]) || e === "iterate" && ps(n, [IDBIndex, IDBObjectStore]);
  }
  gh((n) => ({
    ...n,
    get(e, t, r) {
      return Na(e, t) ? $u : n.get(e, t, r);
    },
    has(e, t) {
      return Na(e, t) || n.has(e, t);
    }
  }));
  const Vt = {
    fonts: "fonts"
     ...
     */
    async set(e, t) {
      await (await this.getDatabase()).put(Vt.fonts, { ...t, name: e });
    }
    /**
     ...
     */
    async get(e) {
      return await (await this.getDatabase()).get(Vt.fonts, e);
    }
    /**
     ...
     */
    async delete(e) {
      await (await this.getDatabase()).delete(Vt.fonts, e);
    }
    /**
     ...
     */
    async getAll() {
      return await (await this.getDatabase()).getAll(Vt.fonts);
    }
    /**
     * Clears all fonts from the cache
     */
    async clear() {
      await (await this.getDatabase()).clear(Vt.fonts);
    }
    /**
  ...
  _e.DATABASE_NAME = "mlightcad", _e.DATABASE_VERSION = Gi[Gi.length - 1].version;
  let zr = _e;
  class Ga {
    constructor() {
      this.listeners = [];
  ...
  var bh = new Xr(), wh = new Xr(), _s = new Uint8Array(30), Bs = new Uint16Array(30), Sh = new Uint8Array(30), Fh = new Uint16Array(30), Ku = new Uint8Array([
    16,
    17,
    18,
    0,
    ...
    1,
    15
  ]), Wa = new Xr(), et = new Uint8Array(320);
  function Ch(n, e, t, r) {
    var i, s;
    for (i = 0; i < t; ++i)
      n[i] = 0;
  ...
  function qa(n, e, t) {
    for (; ; ) {
      ...
      if (r < 256)
        ...
        var i, s, a, o;
        for (r -= 257, i = tt(n, _s[r], Bs[r]), s = vs(n, t), a = n.destLen - tt(n, Sh[s], Fh[s]), o = a; o < a + i; ++o)
  ...
  function nl(n) {
    ...
    return n.bitcount = 0, Ms;
  }
  function il(n, e) {
    var t = new Qu(n, e), r, i, s;
    do {
      switch (r = tl(t), i = tt(t, 2, 0), i) {
        case 0:
          s = nl(t);
          break;
        case 1:
          ...
          break;
        case 2:
          rl(t, t.ltree, t.dtree), s = qa(t, t.ltree, t.dtree);
          break;
        default:
          s = xh;
      }
  ...
  zt.prototype.addPoint = function(n, e) {
  ...
  zt.prototype.addX = function(n) {
    this.addPoint(n, null);
  };
  zt.prototype.addY = function(n) {
    this.addPoint(null, n);
  };
  zt.prototype.addBezier = function(n, e, t, r, i, s, a, o) {
    ...
    for (var l = 0; l <= 1; l++) {
      ...
      if (d === 0) {
        if (p === 0)
          continue;
        var x = -m / p;
        0 < x && x < 1 && (l === 0 && this.addX(lr(h[l], c[l], u[l], f[l], x)), l === 1 && this.addY(lr(h[l], c[l], u[l], f[l], x)));
        continue;
      }
      var v = Math.pow(p, 2) - 4 * m * d;
      if (!(v < 0)) {
        var w = (-p + Math.sqrt(v)) / (2 * d);
        0 < w && w < 1 && (l === 0 && this.addX(lr(h[l], c[l], u[l], f[l], w)), l === 1 && this.addY(lr(h[l], c[l], u[l], f[l], w)));
        var b = (-p - Math.sqrt(v)) / (2 * d);
        0 < b && b < 1 && (l === 0 && this.addX(lr(h[l], c[l], u[l], f[l], b)), l === 1 && this.addY(lr(h[l], c[l], u[l], f[l], b)));
      }
    }
  };
  zt.prototype.addQuad = function(n, e, t, r, i, s) {
  ...
  me.prototype.getBoundingBox = function() {
    for (var n = new zt(), e = 0, t = 0, r = 0, i = 0, s = 0; s < this.commands.length; s++) {
  ...
  var H = { fail: Th, argument: Xa, assert: Xa }, Ya = 32768, Za = 2147483648, br = {}, U = {}, V = {};
  function je(n) {
    return function() {
      return n;
    };
  ...
  V.USHORT = je(2);
  U.SHORT = function(n) {
    return n >= Ya && (n = -(2 * Ya - n)), [n >> 8 & 255, n & 255];
  };
  V.SHORT = je(2);
  U.UINT24 = function(n) {
  ...
  V.ULONG = je(4);
  U.LONG = function(n) {
    return n >= Za && (n = -(2 * Za - n)), [n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, n & 255];
  };
  V.LONG = je(4);
  U.FIXED = U.ULONG;
  V.FIXED = V.ULONG;
  ...
  var Rn = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), Un, al = function(n) {
    if (!Un) {
      Un = {};
      for (var e in xs)
        Un[e] = new String(e);
  ...
  U.VARDELTAS = function(n) {
    for (var e = 0, t = []; e < n.length; ) {
      var r = n[e];
      r === 0 ? e = ol(n, e, t) : r >= -128 && r <= 127 ? e = hl(n, e, t) : e = cl(n, e, t);
    }
    return t;
  };
  U.INDEX = function(n) {
  ...
  function ri(n, e) {
    xe.call(this, "lookupListTable", ws("lookup", n, function(t) {
      ...
      ].concat(ws("subtable", t.subtables, r)));
    }));
  }
  ...
  A.prototype.parseLongDateTime = function() {
    var n = Ls(this.data, this.offset + this.relativeOffset + 4);
  ...
  A.prototype.skip = function(n, e) {
    e === void 0 && (e = 1), this.relativeOffset += gl[n] * e;
  };
  ...
  Mh.prototype.charToGlyphIndex = function(n) {
    ...
    switch (n.version) {
      ...
      case 2:
        ...
        for (var e = 0; e < n.numberOfGlyphs; e++)
          n.glyphNameIndex[e] < qt.length ? this.names[e] = qt[n.glyphNameIndex[e]] : this.names[e] = n.names[n.glyphNameIndex[e] - qt.length];
        break;
      case 2.5:
        this.names = new Array(n.numberOfGlyphs);
        for (var t = 0; t < n.numberOfGlyphs; t++)
          this.names[t] = qt[t + n.glyphNameIndex[t]];
        break;
      case 3:
        this.names = [];
        break;
  ...
  Os.prototype.nameToGlyphIndex = function(n) {
    return this.names.indexOf(n);
  };
  Os.prototype.glyphIndexToName = function(n) {
    return this.names[n];
  };
  function Cl(n) {
  ...
  var it = { GlyphSet: Rs, glyphLoader: Ml, ttfGlyphLoader: _l, cffGlyphLoader: Bl };
  function _h(n, e) {
    if (n === e)
      return !0;
  ...
  function Bh(n, e, t) {
    ...
    for (t = t !== void 0 ? t : n.length; r.relativeOffset < t; ) {
      var a = r.parseByte();
      a <= 21 ? (a === 12 && (a = 1200 + r.parseByte()), i.push([a, s]), s = []) : s.push(Ul(r, a));
    }
    return Dl(i);
  }
  function Pr(n, e) {
    ...
    for (var r = {}, i, s = 0; s < e.length; s += 1) {
      ...
      if (Array.isArray(a.type)) {
        ...
        for (var h = 0; h < a.type.length; h++)
          i = n[a.op] !== void 0 ? n[a.op][h] : void 0, i === void 0 && (i = a.value !== void 0 && a.value[h] !== void 0 ? a.value[h] : null), a.type[h] === "SID" && (i = Pr(t, i)), o[h] = i;
        r[a.name] = o;
      } else
        i = n[a.op], i === void 0 && (i = a.value !== void 0 ? a.value : null), a.type === "SID" && (i = Pr(t, i)), r[a.name] = i;
    }
    return r;
  }
  function Il(n, e) {
  ...
  function ja(n, e, t, r) {
    for (var i = [], s = 0; s < t.length; s += 1) {
      var a = new DataView(new Uint8Array(t[s]).buffer), o = zl(a, r);
      ...
      if (h !== 0 && c !== 0) {
        ...
        if (o._defaultWidthX = u.defaultWidthX, o._nominalWidthX = u.nominalWidthX, u.subrs !== 0) {
          ...
          o._subrs = l.objects, o._subrsBias = Ss(o._subrs);
        }
        o._privateDict = u;
      }
      i.push(o);
  ...
  function Hl(n, e, t, r) {
    t.tables.cff = {};
    var i = Il(n, e), s = Et(n, i.endOffset, P.bytesToString), a = Et(n, s.endOffset), o = Et(n, a.endOffset, P.bytesToString), h = Et(n, o.endOffset);
    t.gsubrs = h.objects, t.gsubrsBias = Ss(t.gsubrs);
    var c = ja(n, e, a.objects, o.objects);
    if (c.length !== 1)
    ...
    if (t.tables.cff.topDict = u, u._privateDict && (t.defaultWidthX = u._privateDict.defaultWidthX, t.nominalWidthX = u._privateDict.nominalWidthX), u.ros[0] !== void 0 && u.ros[1] !== void 0 && (t.isCIDFont = !0), t.isCIDFont) {
      ...
      f += e;
      var p = Et(n, f), d = ja(n, e, p.objects, o.objects);
      u._fdArray = d, l += e, u._fdSelect = Gl(n, l, t.numGlyphs, d.length);
    }
    var m = e + u.private[1], x = Uh(n, m, u.private[0], o.objects);
    if (t.defaultWidthX = x.defaultWidthX, t.nominalWidthX = x.nominalWidthX, x.subrs !== 0) {
      var v = m + x.subrs, w = Et(n, v);
      t.subrs = w.objects, t.subrsBias = Ss(t.subrs);
    } else
      t.subrs = [], t.subrsBias = 0;
    var b;
    r.lowMemory ? (b = Ll(n, e + u.charStrings), t.nGlyphs = b.offsets.length) : (b = Et(n, e + u.charStrings), t.nGlyphs = b.objects.length);
    var S = Pl(n, e + u.charset, t.nGlyphs, o.objects);
    if (u.encoding === 0 ? t.cffEncoding = new ii(Sl, S) : u.encoding === 1 ? t.cffEncoding = new ii(Fl, S) : t.cffEncoding = Nl(n, e + u.encoding, S), t.encoding = t.encoding || t.cffEncoding, t.glyphs = new it.GlyphSet(t), r.lowMemory)
      t._push = function(M) {
        var _ = Ol(M, b.offsets, n, e + u.charStrings);
        t.glyphs.push(M, it.cffGlyphLoader(t, M, Qa, _));
      };
    else
      for (var T = 0; T < t.nGlyphs; T += 1) {
        var B = b.objects[T];
        t.glyphs.push(T, it.cffGlyphLoader(t, T, Qa, B));
      }
  }
  function Dh(n, e) {
  ...
  function Ih(n, e, t) {
    for (var r = {}, i = 0; i < n.length; i += 1) {
      ...
      a !== void 0 && !_h(a, s.value) && (s.type === "SID" && (a = Dh(a, t)), r[s.op] = { name: s.name, type: s.type, value: a });
    }
    return r;
  }
  function Ka(n, e) {
  ...
  function jl(n, e) {
    ...
    var c = [];
    t.header = Wl(), t.nameIndex = Vl([e.postScriptName]);
    var u = Ka(i, c);
    t.topDictIndex = eo(u), t.globalSubrIndex = Xl(), t.charsets = Yl(a, c), t.charStringsIndex = Jl(n), t.privateDict = $l(s, c), t.stringIndex = ql(c);
    var f = t.header.sizeOf() + t.nameIndex.sizeOf() + t.topDictIndex.sizeOf() + t.stringIndex.sizeOf() + t.globalSubrIndex.sizeOf();
    return i.charset = f, i.encoding = 0, i.charStrings = i.charset + t.charsets.sizeOf(), i.private[1] = i.charStrings + t.charStringsIndex.sizeOf(), u = Ka(i, c), t.topDictIndex = eo(u), t;
  }
  var zh = { parse: Hl, make: jl };
  function Ql(n, e) {
  ...
  function sf(n, e, t, r, i, s, a) {
    a.lowMemory ? nf(n, e, t, r, i) : rf(e, t, r, i, s);
  }
  function af(n) {
  ...
  function gf(n, e, t) {
    for (var r = {}, i = new P.Parser(n, e), s = i.parseUShort(), a = i.parseUShort(), o = i.offset + i.parseUShort(), h = 0; h < a; h++) {
      var c = i.parseUShort(), u = i.parseUShort(), f = i.parseUShort(), l = i.parseUShort(), p = Vh[l] || l, d = i.parseUShort(), m = i.parseUShort(), x = ff(c, f, t), v = Yh(c, u, f);
      if (v !== void 0 && x !== void 0) {
        var w = void 0;
        if (v === Fs ? w = br.UTF16(n, o + m, d) : w = br.MACSTRING(n, o + m, d, v), w) {
          var b = r[p];
  ...
  function mf(n, e) {
    ...
    for (var h = Wi(qh), c = Wi(Xh), u = [], f = [], l = 0; l < r.length; l++) {
      t = r[l];
      var p = i[t];
      for (var d in p) {
        var m = p[d], x = 1, v = h[d], w = lf[v], b = Yh(x, w, v), S = U.MACSTRING(m, b);
  ...
  var Ts = { parse: xf, make: bf, unicodeRanges: Cs, getUnicodeRange: vf };
  function wf(n, e) {
    var t = {}, r = new P.Parser(n, e);
    switch (t.version = r.parseVersion(), t.italicAngle = r.parseFixed(), t.underlinePosition = r.parseShort(), t.underlineThickness = r.parseShort(), t.isFixedPitch = r.parseULong(), t.minMemType42 = r.parseULong(), t.maxMemType42 = r.parseULong(), t.minMemType1 = r.parseULong(), t.maxMemType1 = r.parseULong(), t.version) {
      ...
      case 2:
        ...
        for (var s = 0; s < t.numberOfGlyphs; s++)
          if (t.glyphNameIndex[s] >= qt.length) {
            var a = r.parseChar();
  ...
  var Jh = { parse: wf, make: Sf }, Ze = new Array(9);
  Ze[1] = function() {
  ...
  function Qh(n) {
    ...
    var t = Math.pow(2, no(e.numTables));
    e.searchRange = 16 * t, e.entrySelector = no(t), e.rangeShift = e.numTables * 16 - e.searchRange;
    for (var r = [], i = [], s = e.sizeOf() + io().sizeOf() * e.numTables; s % 4 !== 0; )
      s += 1, i.push({ name: "padding", type: "BYTE", value: 0 });
    for (var a = 0; a < n.length; a += 1) {
      var o = n[a];
      H.argument(o.tableName.length === 4, "Table name" + o.tableName + " is invalid.");
      var h = o.sizeOf(), c = io(o.tableName, Us(o.encode()), s, h);
  ...
  function Af(n) {
    ...
    var S = Ph.make({
    ...
    }), B = Wh.make(n.glyphs.length), M = Ts.make(Object.assign({
      ...
      sxHeight: so(n, "xyvw", { yMax: Math.round(b.ascender / 2) }).yMax,
      sCapHeight: so(n, "HIKLEFJMNTZBDPRAGOQSUVWXY", b).yMax,
      usDefaultChar: n.hasChar(" ") ? 32 : 0,
      // Use space as the default character, if available.
      usBreakChar: n.hasChar(" ") ? 32 : 0
      // Use space as the break character, if available.
    }, n.tables.os2)), _ = Gh.make(n.glyphs), D = Eh.make(n.glyphs), N = n.getEnglishName("fontFamily"), G = n.getEnglishName("fontSubfamily"), ee = N + " " + G, Y = n.getEnglishName("postScriptName");
    Y || (Y = N.replace(/\s/g, "") + "-" + G);
    var Z = {};
    ...
    var K = [], ne = Zh.make(Z, K), ae = K.length > 0 ? Hh.make(K) : void 0, ie = Jh.make(), he = zh.make(n.glyphs, {
    ...
    }), W = n.metas && Object.keys(n.metas).length > 0 ? jh.make(n.metas) : void 0, $ = [S, T, B, M, ne, D, ie, he, _];
    ae && $.push(ae), n.tables.gsub && $.push($h.make(n.tables.gsub)), W && $.push(W);
    for (var Kt = Qh($), an = Kt.encode(), on = Us(an), Tr = Kt.fields, hn = !1, xt = 0; xt < Tr.length; xt += 1)
      if (Tr[xt].name === "head table") {
        Tr[xt].value.checkSumAdjustment = 2981146554 - on, hn = !0;
        break;
      }
    if (!hn)
  ...
  var Mf = { make: Qh, fontToTable: Af, computeCheckSum: Us };
  function Vi(n, e) {
  ...
  Le.prototype.addSingle = function(n, e, t, r) {
    var i = this.getLookupTables(t, r, n, 1, !0)[0], s = Ds(i, 2, {
  ...
  Le.prototype.addMultiple = function(n, e, t, r) {
    ...
    var i = this.getLookupTables(t, r, n, 2, !0)[0], s = Ds(i, 1, {
  ...
  Le.prototype.addAlternate = function(n, e, t, r) {
    var i = this.getLookupTables(t, r, n, 3, !0)[0], s = Ds(i, 1, {
      ...
      if (H.argument(i.length === c, "Bad flags."), a.length > 0) {
        ...
        if (c > 0) {
          ...
          for (var x = 0, v = 0; v < c; v += 1)
            s = i[v], d = p[v], d.x = ho(r, s, x, 2, 16), x = d.x;
          for (var w = 0, b = 0; b < c; b += 1)
            s = i[b], d = p[b], d.y = ho(r, s, w, 4, 32), w = d.y;
        }
        n.points = p;
      } else
        n.points = [];
  ...
  function ec(n) {
    ...
    if (!n)
      return e;
    for (var t = Of(n), r = 0; r < t.length; ++r) {
  ...
  function Rf(n, e, t, r) {
    for (var i = new it.GlyphSet(r), s = 0; s < t.length - 1; s += 1) {
      var a = t[s], o = t[s + 1];
      a !== o ? i.push(s, it.ttfGlyphLoader(r, s, Kh, n, e + a, tc)) : i.push(s, it.glyphLoader(r, s));
    }
    return i;
  }
  function Uf(n, e, t, r) {
  ...
  function Df(n, e, t, r, i) {
    return i.lowMemory ? Uf(n, e, t, r) : Rf(n, e, t, r);
  }
  var rc = { getPath: ec, parse: Df }, nc, jt, ic, ks;
  function sc(n) {
    this.font = n, this.getCommands = function(e) {
      return rc.getPath(e).commands;
  ...
  function nn(n, e) {
    ...
    return n /= t, e /= t, n === 1 && e === 0 ? nt : n === 0 && e === 1 ? gt : new rn(n, e);
  }
  function vt(n, e, t, r) {
  ...
  var Jr = Object.freeze(new vt(0, 0)), Hf = {
    cvCutIn: 17 / 16,
  ...
  function Bt(n, e) {
    switch (this.env = n, this.stack = [], this.prog = e, n) {
      ...
      case "prep":
        this.fv = this.pv = this.dpv = nt, this.round = ac;
    }
  }
  sc.prototype.exec = function(n, e) {
    if (typeof e != "number")
    ...
    if (!(this._errorState > 2)) {
      ...
      if (!r || r.ppem !== e) {
        ...
        if (!i) {
          Bt.prototype = Hf, i = this._fpgmState = new Bt("fpgm", t.tables.fpgm), i.funcs = [], i.font = t, L.DEBUG && (console.log("---EXEC FPGM---"), i.step = -1);
          try {
            jt(i);
          } catch (c) {
  ...
  ic = function(n, e) {
    ...
    if (Bt.prototype = e, !i)
      o = new Bt("glyf", n.instructions), L.DEBUG && (console.log("---EXEC GLYPH---"), o.step = -1), ks(n, o, t, r), a = o.gZone;
    else {
      var h = e.font;
      a = [], s = [];
      for (var c = 0; c < i.length; c++) {
        var u = i[c], f = h.glyphs.get(u.glyphIndex);
        o = new Bt("glyf", f.instructions), L.DEBUG && (console.log("---EXEC COMP " + c + "---"), o.step = -1), ks(f, o, t, r);
      ...
      ), L.DEBUG && (console.log("---EXEC COMPOSITE---"), o.step = -1), jt(o), a.length -= 2);
    }
    return a;
  };
  ks = function(n, e, t, r) {
  ...
  jt = function(n) {
    ...
    if (e) {
      ...
      for (n.ip = 0; n.ip < t; n.ip++) {
        if (L.DEBUG && n.step++, r = nc[e[n.ip]], !r)
          throw new Error(
  ...
  function n0(n) {
    L.DEBUG && console.log(n.step, "RTG[]"), n.round = ac;
  }
  function i0(n) {
    L.DEBUG && console.log(n.step, "RTHG[]"), n.round = Pf;
  }
  function s0(n) {
    var e = n.stack.pop();
  ...
  function a0(n) {
    L.DEBUG && console.log(n.step, "ELSE[]"), hc(n, !1);
  }
  function o0(n) {
    var e = n.stack.pop();
  ...
  function d0(n) {
    ...
    var t = n.ip, r = n.prog;
    n.prog = n.funcs[e], jt(n), n.ip = t, n.prog = r, L.DEBUG && console.log(++n.step, "returning from", e);
  }
  function g0(n) {
  ...
  function w0(n) {
    L.DEBUG && console.log(n.step, "RTDG[]"), n.round = zf;
  }
  function wo(n, e) {
  ...
  function z0(n) {
    var e = n.stack.pop();
    L.DEBUG && console.log(n.step, "IF[]", e), e || (hc(n, !0), L.DEBUG && console.log(n.step, "EIF[]"));
  }
  function P0(n) {
  ...
  function ep(n) {
    var e = n.stack.pop();
    L.DEBUG && console.log(n.step, "SROUND[]", e), n.round = oc;
    var t;
    switch (e & 192) {
      case 0:
        t = 0.5;
  ...
  function tp(n) {
    var e = n.stack.pop();
    L.DEBUG && console.log(n.step, "S45ROUND[]", e), n.round = oc;
    var t;
    switch (e & 192) {
      case 0:
        t = Math.sqrt(2) / 2;
  ...
  function rp(n) {
    L.DEBUG && console.log(n.step, "ROFF[]"), n.round = If;
  }
  function np(n) {
    L.DEBUG && console.log(n.step, "RUTG[]"), n.round = Nf;
  }
  function ip(n) {
    L.DEBUG && console.log(n.step, "RDTG[]"), n.round = Gf;
  }
  function sp(n) {
    var e = n.stack.pop();
  ...
  function pe(n) {
    this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], pp.call(this, n);
  }
  Cr.prototype.setState = function(n, e) {
    return this.state[n] = e, this.activeState = { key: n, value: this.state[n] }, this.activeState;
  };
  Cr.prototype.getState = function(n) {
  ...
  pe.prototype.replaceToken = function(n, e, t) {
    if (!isNaN(n) && this.inboundIndex(n) && e instanceof Cr) {
  ...
  pe.prototype.setEndOffset = function(n, e) {
    var t = this.getContext(e).openRange.startIndex, r = new Is(t, n, e), i = this.getContext(e).ranges;
  ...
  pe.prototype.runContextCheck = function(n) {
    ...
    this.contextCheckers.forEach(function(r) {
      ...
      if (!s && r.checkStart(n) && (s = new Is(t, null, i), e.getContext(i).openRange = s, e.dispatch("contextStart", [i, t])), s && r.checkEnd(n)) {
  ...
  Oe.prototype.lookupFeature = function(n) {
    ...
    for (var i = this.getFeatureLookups(r), s = [].concat(e.context), a = 0; a < i.length; a++)
      for (var o = i[a], h = this.getLookupSubtables(o), c = 0; c < h.length; c++) {
        ...
        switch (f) {
          case "11":
            p = l(e.current), p && s.splice(t, 1, new Xt({
              id: 11,
              tag: n.tag,
              substitution: p
            }));
          ...
          case "12":
            ...
            break;
          case "63":
            p = l(e), Array.isArray(p) && p.length && s.splice(t, 1, new Xt({
              id: 63,
              tag: n.tag,
              substitution: p
            }));
  ...
  function zs(n, e, t) {
    n instanceof Xt && To[n.id] && To[n.id](n, e, t);
  }
  function _p(n) {
    for (var e = [].concat(n.backtrack), t = e.length - 1; t >= 0; t--) {
      var r = e[t], i = cc(r), s = Dt(r);
      if (!i && !s)
        return !0;
      if (i)
        return !1;
        ...
        if (!Dt(o.char)) {
          ...
          if (r.indexOf(u) !== -1) {
            ...
            f.forEach(function(l, p) {
              l instanceof Xt && (zs(l, i, p), s.context[p] = l.substitution);
            });
          }
        }
      });
  ...
  function Op(n) {
    var e = this, t = "arab", r = this.tokenizer.getRangeTokens(n), i = ko(r);
  ...
  function Ip(n) {
    var e = this, t = "latn", r = this.tokenizer.getRangeTokens(n), i = Eo(r);
    i.context.forEach(function(s, a) {
      i.setCurrentIndex(a);
      var o = e.query.lookupFeature({
        tag: "liga",
  ...
  Qe.prototype.applyFeaturesToContexts = function() {
    this.checkContextReady("arabicWord") && (Np.call(this), Gp.call(this)), this.checkContextReady("latinWord") && Hp.call(this), this.checkContextReady("arabicSentence") && Pp.call(this);
  };
  Qe.prototype.processText = function(n) {
    (!this.text || this.text !== n) && (this.setText(n), zp.call(this), this.applyFeaturesToContexts());
  };
  ...
  function re(n) {
    ...
    })), this.supported = !0, this.glyphs = new it.GlyphSet(this, n.glyphs || []), this.encoding = new Ah(this), this.position = new tn(this), this.substitution = new Le(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
      get: function() {
        if (this._hinting)
          return this._hinting;
        if (this.outlinesFormat === "truetype")
          return this._hinting = new sc(this);
      }
    });
  }
  ...
  function Yp(n, e) {
    ...
    for (var r = 0; r < n.axes.length; r++)
      t.fields = t.fields.concat(Wp(r, n.axes[r], e));
    for (var i = 0; i < n.instances.length; i++)
      t.fields = t.fields.concat(qp(i, n.instances[i], n.axes, e));
    return t;
  }
  function Zp(n, e, t) {
    ...
    for (var a = r.parseUShort(), o = r.parseUShort(), h = r.parseUShort(), c = r.parseUShort(), u = [], f = 0; f < a; f++)
      u.push(Vp(n, e + s + f * o, t));
    for (var l = [], p = e + s + a * o, d = 0; d < h; d++)
      l.push(Xp(n, p + d * c, u, t));
    return { axes: u, instances: l };
  }
  var Jp = { make: Yp, parse: Zp }, $p = function() {
    return {
      coverage: this.parsePointer(A.coverage),
    ...
    return this.parseList(A.pointer(jp));
  }, Kp = function() {
    return {
      coverage: this.parsePointer(A.coverage),
      ligGlyphs: this.parseList(A.pointer(Qp))
    };
  }, ed = function() {
  ...
  function td(n, e) {
    ...
    var i = {
      ...
      attachList: t.parsePointer($p),
      ligCaretList: t.parsePointer(Kp),
      markAttachClassDef: t.parsePointer(A.classDef)
    };
    return r >= 1.2 && (i.markGlyphSets = t.parsePointer(ed)), i;
  }
  var rd = { parse: td }, $e = new Array(10);
  $e[1] = function() {
    var e = this.offset + this.relativeOffset, t = this.parseUShort();
    if (t === 1)
      return {
  ...
  function sd(n) {
    return new I.Table("GPOS", [
      ...
      { name: "scripts", type: "TABLE", value: new I.ScriptList(n.scripts) },
      { name: "features", type: "TABLE", value: new I.FeatureList(n.features) },
      { name: "lookups", type: "TABLE", value: new I.LookupList(n.lookups, id) }
    ]);
  }
  var ad = { parse: nd, make: sd };
  function od(n) {
    var e = {};
    n.skip("uShort");
    var t = n.parseUShort();
  ...
  function de(n, e) {
    if (e.compression === "WOFF") {
      ...
      if (sl(t, r), r.byteLength !== e.length)
  ...
  function dd(n, e) {
    ...
    if (h === "\0\0\0" || h === "true" || h === "typ1")
      i.outlinesFormat = "truetype", a = P.getUShort(s, 4), o = Ao(s, a);
    else if (h === "OTTO")
      i.outlinesFormat = "cff", a = P.getUShort(s, 4), o = Ao(s, a);
    else if (h === "wOFF") {
      var c = P.getTag(s, 4);
      if (c === "\0\0\0")
    ...
    for (var u, f, l, p, d, m, x, v, w, b, S, T, B = 0; B < a; B += 1) {
      ...
      switch (M.tag) {
        case "cmap":
          _ = de(s, M), i.tables.cmap = Eh.parse(_.data, _.offset), i.encoding = new Mh(i.tables.cmap);
          break;
        case "cvt ":
        ...
        case "fpgm":
          ...
          break;
        case "head":
          _ = de(s, M), i.tables.head = Ph.parse(_.data, _.offset), i.unitsPerEm = i.tables.head.unitsPerEm, t = i.tables.head.indexToLocFormat;
          break;
        case "hhea":
          _ = de(s, M), i.tables.hhea = Nh.parse(_.data, _.offset), i.ascender = i.tables.hhea.ascender, i.descender = i.tables.hhea.descender, i.numberOfHMetrics = i.tables.hhea.numberOfHMetrics;
          break;
        case "hmtx":
          x = M;
          break;
        case "ltag":
          _ = de(s, M), r = Hh.parse(_.data, _.offset);
          break;
        case "maxp":
          _ = de(s, M), i.tables.maxp = Wh.parse(_.data, _.offset), i.numGlyphs = i.tables.maxp.numGlyphs;
          break;
        case "name":
          b = M;
          break;
        case "OS/2":
          _ = de(s, M), i.tables.os2 = Ts.parse(_.data, _.offset);
          break;
        case "post":
          _ = de(s, M), i.tables.post = Jh.parse(_.data, _.offset), i.glyphNames = new Os(i.tables.post);
          break;
        case "prep":
    ...
    var D = de(s, b);
    if (i.tables.name = Zh.parse(D.data, D.offset, r), i.names = i.tables.name, l && w) {
      var N = t === 0, G = de(s, w), ee = fd.parse(G.data, G.offset, i.numGlyphs, N), Y = de(s, l);
      i.glyphs = rc.parse(Y.data, Y.offset, ee, i, e);
    } else if (u) {
      var Z = de(s, u);
      zh.parse(Z.data, Z.offset, i, e);
    } else
      throw new Error("Font doesn't contain TrueType or CFF outlines.");
    var Q = de(s, x);
    if (Gh.parse(i, Q.data, Q.offset, i.numberOfHMetrics, i.numGlyphs, i.glyphs, e), kl(i, e), v) {
      var K = de(s, v);
      i.kerningPairs = ud.parse(K.data, K.offset);
    } else
      i.kerningPairs = {};
    if (p) {
      var ne = de(s, p);
      i.tables.gdef = rd.parse(ne.data, ne.offset);
    }
    if (d) {
      var ae = de(s, d);
      i.tables.gpos = ad.parse(ae.data, ae.offset), i.position.init();
    }
    if (m) {
      var ie = de(s, m);
      i.tables.gsub = $h.parse(ie.data, ie.offset);
    }
    if (f) {
      var he = de(s, f);
      i.tables.fvar = Jp.parse(he.data, he.offset, i.names);
    }
    if (S) {
      var W = de(s, S);
      i.tables.meta = jh.parse(W.data, W.offset), i.metas = i.tables.meta;
    }
    return i;
  }
  function Mo(n, e = !1) {
  ...
  class Bo extends dh {
    ...
    toGeometry() {
      ...
      if (e == null) {
        ...
        return e = new yr(t, 4), e.hasAttribute("uv") && e.deleteAttribute("uv"), e.hasAttribute("normal") && e.deleteAttribute("normal"), gd(e, 1e-6);
      }
      return e;
    }
    /**
...
`)
  ...
  class xd extends yd {
    ...
    generateShapes(e, t = 100, r = "ltr") {
      const i = [];
      return bd(e, t, this.data, r).forEach((a) => {
        i.push(...Ed(a));
      }), i;
    }
  }
  function bd(n, e, t, r = "ltr") {
...
`)
  ...
  function Lo(n, e) {
    const t = Rt.area(n.getPoints(32)) > 0, r = e === t ? n.curves.slice() : kd(n.curves), i = new gr();
    return i.curves.push(...r), i;
  }
  function Ed(n, e = 32) {
    const t = n.subPaths;
    if (!t || t.length === 0) return [];
    const r = t.map((p) => p.getPoints(e)), i = Fd(r), s = Cd(i), a = Td(i), o = t.length, h = Array(o).fill(-1), c = Array(o).fill(-1);
    for (const p of a) {
      const d = [{ idx: p, d: 0 }];
      for (; d.length; ) {
        const m = d.pop();
  ...
  class Md extends ph {
     ...
     */
    constructor(e) {
      super(e), this.type = "mesh", this.glyphCache = new Ad(512);
      const t = e.data;
     ...
     */
    parseMeshFont(e) {
      const t = dd(e), r = Math.round, i = t.charToGlyph("A"), s = i ? t.unitsPerEm / (i.yMax || t.unitsPerEm) : 1, a = {
        glyphs: {},
        // Lazy loaded later
  ...
  var Ce = /* @__PURE__ */ ((n) => (n.SHAPES = "shapes", n.BIGFONT = "bigfont", n.UNIFONT = "unifont", n))(Ce || {});
  class _d {
    parse(e) {
      const t = this.parseHeader(e).split(" "), r = t[1].toLocaleLowerCase();
      if (!Object.values(Ce).includes(r))
      ...
      try {
        ...
        if (0 in i) {
          ...
          try {
            ...
            let h = a.findIndex((c) => Bd.includes(c));
  ...
  class $r {
    ...
    constructor(e) {
      if (e.start && e.end && e.bulge !== void 0) {
        ...
        this.center = e.center.clone(), this.radius = e.radius, this.isClockwise = e.isClockwise, this.startAngle = e.startOctant * Oo;
        const t = (e.octantCount === 0 ? 8 : e.octantCount) * Oo;
  ...
  class Id {
    ...
    handleOctantArc(e, t, r) {
      ...
      let c = o & 7;
      const u = o < 0, f = Math.PI / 4 * h, l = r.currentPoint.clone().subtract(new fe(Math.cos(f) * a, Math.sin(f) * a)), p = $r.fromOctant(l, a, h, c, u);
      if (r.isPenDown) {
    ...
    handleFractionalArc(e, t, r) {
      let i = t;
      const s = e[++i], a = e[++i], o = e[++i], h = e[++i], c = (o * 255 + h) * r.scale, u = Fe.byteToSByte(e[++i]), f = (u & 112) >> 4;
      let l = u & 7;
      l === 0 && (l = 8), a !== 0 && l--;
      const p = Math.PI / 4;
      let d = p * l, m = Dd, x = 1;
  ...
  class zd {
    ...
    constructor(e) {
      if (e instanceof ArrayBuffer) {
        const t = new Fe(e), r = new _d().parse(t), i = Ud.createParser(r.fontType).parse(t);
        this.fontData = {
          header: r,
          content: i
        };
        ...
        this.fontData = e;
      this.shapeParser = new Id(this.fontData);
    }
    /**
     * Return true if this font contains glyph of the specified character. Otherwise, return false.
     * @param char - The character to check
    ...
    getCharShape(e, t) {
      ...
      return r && this.fontData.header.fontType === Ce.BIGFONT && (r = r.normalizeToOrigin()), r;
    }
    /**
  ...
  var lc = { exports: {} }, Ns = {}, ui = {};
  ui.byteLength = Wd;
  ui.toByteArray = qd;
  ui.fromByteArray = Zd;
  var rt = [], Ue = [], Gd = typeof Uint8Array < "u" ? Uint8Array : Array, ji = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
  for (var fr = 0, Hd = ji.length; fr < Hd; ++fr)
    rt[fr] = ji[fr], Ue[ji.charCodeAt(fr)] = fr;
  Ue[45] = 62;
  Ue[95] = 63;
  function fc(n) {
    var e = n.length;
  ...
  function qd(n) {
    var e, t = fc(n), r = t[0], i = t[1], s = new Gd(Vd(n, r, i)), a = 0, o = i > 0 ? r - 4 : r, h;
    for (h = 0; h < o; h += 4)
  ...
  function Yd(n, e, t) {
    for (var r, i = [], s = e; s < t; s += 3)
      r = (n[s] << 16 & 16711680) + (n[s + 1] << 8 & 65280) + (n[s + 2] & 255), i.push(Xd(r));
    return i.join("");
  }
  function Zd(n) {
    for (var e, t = n.length, r = t % 3, i = [], s = 16383, a = 0, o = t - r; a < o; a += s)
      i.push(Yd(n, a, a + s > o ? o : a + s));
   ...
   */
  (function(n) {
    var e = ui, t = Gs, r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
    ...
    function B(F, g, y, C, k) {
      ...
      if (typeof y == "string" ? (C = y, y = 0) : y > 2147483647 ? y = 2147483647 : y < -2147483648 && (y = -2147483648), y = +y, li(y) && (y = k ? 0 : F.length - 1), y < 0 && (y = F.length + y), y >= F.length) {
        if (k) return -1;
        y = F.length - 1;
      } else if (y < 0)
        if (k) y = 0;
    ...
    function M(F, g, y, C, k) {
      ...
      function te(Js, $s) {
        return O === 1 ? Js[$s] : Js.readUInt16BE($s * O);
      }
      var oe;
      if (k) {
        var be = -1;
        ...
        for (y + J > R && (y = R - J), oe = y; oe >= 0; oe--) {
          for (var le = !0, un = 0; un < J; un++)
            if (te(F, oe + un) !== te(g, un)) {
              le = !1;
              break;
            }
          if (le) return oe;
    ...
    function D(F, g, y, C) {
      return cn(xt(g, F.length - y), F, y, C);
    }
    function N(F, g, y, C) {
      return cn(yc(g), F, y, C);
    }
    function G(F, g, y, C) {
      return cn(Zs(g), F, y, C);
    }
    function ee(F, g, y, C) {
      return cn(mc(g, F.length - y), F, y, C);
    }
    ...
    function Kt(F, g, y, C, k, O) {
      if (y + C > F.length) throw new RangeError("Index out of range");
      if (y < 0) throw new RangeError("Index out of range");
    }
    function an(F, g, y, C, k) {
      return g = +g, y = y >>> 0, k || Kt(F, g, y, 4), t.write(F, g, y, C, 23, 4), y + 4;
    }
    o.prototype.writeFloatLE = function(g, y, C) {
      return an(this, g, y, !0, C);
    }, o.prototype.writeFloatBE = function(g, y, C) {
      return an(this, g, y, !1, C);
    };
    function on(F, g, y, C, k) {
      return g = +g, y = y >>> 0, k || Kt(F, g, y, 8), t.write(F, g, y, C, 52, 8), y + 8;
    }
    ...
    function hn(F) {
      if (F = F.split("=")[0], F = F.trim().replace(Tr, ""), F.length < 2) return "";
      for (; F.length % 4 !== 0; )
        F = F + "=";
      return F;
    }
  ...
  var qn = Ns, vr = qn.Buffer, De = {}, Ie;
  for (Ie in qn)
    qn.hasOwnProperty(Ie) && (Ie === "SlowBuffer" || Ie === "Buffer" || (De[Ie] = qn[Ie]));
  var xr = De.Buffer = {};
  for (Ie in vr)
    vr.hasOwnProperty(Ie) && (Ie === "allocUnsafe" || Ie === "allocUnsafeSlow" || (xr[Ie] = vr[Ie]));
  De.Buffer.prototype = vr.prototype;
  ...
  Ws.prototype.write = function(n) {
    return this.addBOM && (n = pc + n, this.addBOM = !1), this.encoder.write(n);
  };
  ...
  Vs.prototype.write = function(n) {
    var e = this.decoder.write(n);
    return this.pass || !e || (e[0] === pc && (e = e.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), e;
  };
  Vs.prototype.end = function() {
    return this.decoder.end();
  };
  var Jd = typeof Object.hasOwn > "u" ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
  function $d(n, e) {
    for (var t in e)
      Jd(e, t) && (n[t] = e[t]);
  }
  var dc = $d, Qi = {}, Ki = {}, Pn = { exports: {} };
  /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */
  var Ro;
  function jd() {
    return Ro || (Ro = 1, function(n, e) {
      var t = Ns, r = t.Buffer;
      function i(a, o) {
        for (var h in a)
          o[h] = a[h];
  ...
  function Qd() {
    if (Uo) return Ki;
    Uo = 1;
    var n = jd().Buffer, e = n.isEncoding || function(v) {
...
\v\f\r\x1B !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[¥]^_\`abcdefghijklmnopqrstuvwxyz{|}‾��������������������������������������������������������������������������������������������������������������������������������`
  ...
  const m1 = {}, v1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    default: m1
  }, Symbol.toStringTag, { value: "Module" })), x1 = /* @__PURE__ */ Nd(v1);
  (function(n) {
    var e = Pt.Buffer, t = Hs, r = dc, i = n.exports;
  ...
  class qs extends dh {
    ...
    resolveAdvanceWidth(e) {
      ...
      if (this.font.data.header.fontType === Ce.BIGFONT) {
  ...
  class S1 extends ph {
    constructor(e) {
      super(e), this.type = "shx", this.font = new zd(e.data), this.data = this.font.fontData;
    }
    /**
     * Return true if this font contains glyph of the specified character. Otherwise, return false.
     * @param char - The character to check
    ...
    getCodeShape(e, t) {
      ...
      return r ? new qs(e, t, r, this) : void 0;
    }
    /**
     * For an unsupported char, use "？" as a replacement.
     */
    getNotFoundTextShape(e) {
      const t = this.font.fontData.header.fontType === Ce.BIGFONT ? "？" : "?";
     ...
     */
    getCode(e) {
      if (this.font.fontData.header.fontType === Ce.BIGFONT && this.encoding) {
        const r = w1.encode(e[0], this.encoding);
  ...
  class yt {
    constructor() {
      this.fontMapping = {}, this.loadedFontMap = /* @__PURE__ */ new Map(), this.unsupportedChars = {}, this.missedFonts = {}, this.enableFontCache = !0, this.defaultFont = "simkai", this.events = {
        ...
        fontLoaded: new Ga()
      }, this.loader = new Iu(), this.loader.setResponseType("arraybuffer"), this.fileNames = [], this.fontLoader = new F1();
    }
    /**
    ...
    async loadFonts(e) {
      ...
      return await Promise.allSettled(t).then((i) => {
        i.forEach((s, a) => {
          const o = s.status === "fulfilled", h = e[a].url, c = Ha(h.toLowerCase());
          r.push({
            fontName: c,
            url: h,
    ...
    async loadFont(e) {
      ...
      if (this.isFontLoaded(r.name))
        return;
      const s = await zr.instance.get(i);
      if (s) {
        ...
        o && (e.name.forEach((h) => o.names.add(h)), this.loadedFontMap.set(i, o), this.enableFontCache && await zr.instance.set(i, r));
      }
    ...
    fontInfoToFontData(e) {
      const t = Ha(e.file).toLowerCase(), r = ["ttf", "otf", "woff"].includes(e.type) ? "mesh" : e.type;
      return {
        name: t,
        alias: e.name,
        type: r,
    ...
    async getAllFontsFromCache() {
      if (this.loadedFontMap.size !== 0)
        return;
      const e = await zr.instance.getAll();
      for (const t of e) {
        const { name: r } = t;
  ...
  function Xn(n) {
    ...
    return t === 0 ? Gn(n.byBlockColor) : t === 256 ? Gn(n.byLayerColor) : t != null ? vh(t) : e.rgbValue !== null ? Gn(e.rgbValue) : Gn(n.byLayerColor);
  }
  class C1 {
    constructor() {
    ...
    getMeshBasicMaterial(e) {
      ...
      if (!this.meshBasicMaterials[t]) {
        const r = Xn(e);
        this.meshBasicMaterials[t] = new sh({
          color: r
        });
      }
    ...
    getLineBasicMaterial(e) {
      ...
      if (!this.lineBasicMaterials[t]) {
        const r = Xn(e);
        this.lineBasicMaterials[t] = new ah({
          color: r
        });
      }
  ...
  function Jo(n, e, t) {
    const r = [];
    if (n.filter((l) => l.char !== Yn).forEach((l) => {
      const p = k1(
        new Te().copy(l.box).applyMatrix4(e)
      );
      p && r.push({
        type: ye.CHAR,
        box: p,
...
`).replace(/[{}]/g, "").split(/\r?\n/).map((r) => r.length)
  ...
  function $o(n) {
    ...
    return !Number.isFinite(e) || !Number.isFinite(t) || e <= 0 || t <= 0 || e >= t * E1 ? e : M1(n.text, t);
  }
  const _1 = 1.666666, Hn = 0.3, B1 = /* @__PURE__ */ new E();
  class Xs extends jr {
    /**
     ...
     */
    getColorAsHex() {
      return this.color.isRgb && this.color.rgbValue !== null ? this.color.rgbValue : this.color.isAci && this.color.aci !== null ? vh(this.color.aci) : 16777215;
    }
    /**
  ...
  class L1 {
    ...
    get currentLineHeight() {
      const e = this.defaultLineSpaceFactor * this.currentFontSize * _1, t = this.currentMaxFontSize > 0 ? this.currentMaxFontSize : this.currentFontSize;
      return e + t;
    }
    /**
    ...
    processText(e) {
      ...
      return t.length > 0 || r.length > 0 ? this.processGeometries(
        ...
        s,
        a
      ), this.processLastLine(), this.captureCurrentLineAdvance(), this.recordCurrentLineLayout(), a.userData.lineLayouts = this._lineLayouts.map((o, h) => ({
        ...o,
    ...
    recordStackDivider(e, t, r, i, s) {
      ...
      const a = t - this.currentFontSize * 0.8 + this.defaultFontSize * Hn, o = new Te(
        new E(e, a, 0),
        new E(e + r, a, 0)
      );
    ...
    processBlank(e, t) {
      if (this._options.collectCharBoxes !== !1) {
        const r = this._hOffset, i = this.flowDirection == Mt.BOTTOM_TO_TOP ? this._vOffset : this._vOffset - this.currentLayoutFontSize, s = new Te(
          new E(r, i, 0),
          new E(
    ...
    processChar(e, t, r, i, s) {
      ...
      let u = 0;
      if (c) {
        const w = c * Math.PI / 180, b = new Ee();
        b.set(
          1,
          Math.tan(w),
          0,
      ...
      if (this.currentHorizontalAlignment == ce.DISTRIBUTED ? this._hOffset += m : this._hOffset += a.width * this.currentWordSpace * this.currentWidthFactor + u * this.currentWidthFactor, t.push(o), this._lineHasRenderableChar = !0, this._options.collectCharBoxes !== !1) {
        ...
        const w = new Te().copy(o.boundingBox);
    ...
    processAlignment() {
      ...
      switch (this.currentHorizontalAlignment) {
        case ce.LEFT:
        case ce.JUSTIFIED: {
          const a = Number.isFinite(this.maxLineWidth) ? this._currentLeftMargin - r.min.x : this._currentLeftMargin, o = /* @__PURE__ */ new Set();
          e.forEach((h) => {
    ...
    toThreeObject(e, t, r, i, s) {
      const a = new Ma(), o = this.getMaterialColorSettings(), h = this.styleManager.getMeshBasicMaterial(
        o
      ), c = this.styleManager.getLineBasicMaterial(
        o
      ), u = this._options.collectCharBoxes !== !1, f = e.filter((p) => p instanceof yr);
      if (f.length > 0) {
        const p = f.length > 1 ? Mo(f) : f[0], d = new Gr(p, h);
      ...
      if (l.length > 0) {
        const p = l.length > 1 ? Mo(l) : l[0], d = new ru(p, c);
  ...
  const Rr = /* @__PURE__ */ new E(), pt = /* @__PURE__ */ new E(), dt = /* @__PURE__ */ new E(), jo = /* @__PURE__ */ new E(1, 0, 0);
  class Ys extends Be {
    /**
    ...
    constructor(e, t, r, i, s = T1()) {
      super(), this._style = t, this._styleManager = r, this._fontManager = i, this._colorSettings = {
        ...
        layer: s.layer,
        color: s.color.copy()
      }, this._box = new Te(), this._layoutData = void 0, this._mtextData = e, this._fontsInStyleLoaded = !1;
    }
    /**
     ...
     */
    async asyncDraw() {
      const e = Array.from(Ys.getFonts(this._mtextData.text || "", !0));
    ...
    raycast(e, t) {
      this.createLayoutData().chars.forEach((i) => {
        if (i.box && e.ray.intersectBox(i.box, Rr)) {
          const s = e.ray.origin.distanceTo(Rr);
          t.push({
            distance: s,
            point: Rr.clone(),
            object: this,
    ...
    loadMText(e, t) {
      ...
      const a = new Te().setFromObject(r);
      if (!Number.isFinite(s)) {
        const d = (p = r.userData) == null ? void 0 : p.logicalAdvanceWidth, m = typeof d == "number" && d > 0 ? d : a.max.x - a.min.x;
        s = Number.isFinite(m) && m > 0 ? m : 0;
      }
      ...
      const c = (d) => {
        ...
        const m = new E(h.x, h.y, 0), x = (v) => {
          var w;
          (w = v.box) == null || w.translate(m), v.children && v.children.length > 0 && v.children.forEach(x);
        };
        d.forEach(x);
      }, u = (d) => {
        !d || d.length === 0 || d.forEach((m) => {
          m.y += h.y;
        });
      };
      r.traverse((d) => {
        var m, x, v;
        "geometry" in d && d.geometry.translate(h.x, h.y, 0), c(
          (x = (m = d.userData) == null ? void 0 : m.layout) == null ? void 0 : x.chars
        ), u(
          (v = d.userData) == null ? void 0 : v.lineLayouts
        ), d.layers.enableAll();
      });
      let f = e.rotation || 0;
      if (e.directionVector) {
        const d = e.directionVector, m = new E(d.x, d.y, d.z), x = m.clone().cross(jo), v = jo.angleTo(m);
        f = x.z > 0 ? -v : v;
      }
      const l = e.position;
      return r.position.set((l == null ? void 0 : l.x) ?? 0, (l == null ? void 0 : l.y) ?? 0, (l == null ? void 0 : l.z) ?? 0), r.quaternion.setFromAxisAngle(new E(0, 0, 1), f), r.scale.set(1, 1, 1), r.updateMatrix(), r.updateMatrixWorld(!0), r;
    }
    /**
    ...
    createMTextGroup(e, t) {
      ...
      const r = $o(e) || 0, i = Number.isFinite(r) && r > 0;
      let s = ce.LEFT;
      i && e.attachmentPoint && ([
        j.TopLeft,
        j.MiddleLeft,
    ...
    getLayout(e, t, r) {
      ...
      if (s && s.length > 0 && s.forEach((l) => {
        Rr.set(0, l.y, 0).applyMatrix4(e.matrixWorld), pt.set(0, l.y - l.height / 2, 0).applyMatrix4(e.matrixWorld), dt.set(0, l.y + l.height / 2, 0).applyMatrix4(e.matrixWorld), r.push({
          y: Rr.y,
          height: Math.abs(dt.y - pt.y),
          breakIndex: l.breakIndex
        });
      }), i && i.length > 0) {
        const l = (u = e.userData) == null ? void 0 : u.charBoxType, p = Jo(
          i,
          e.matrixWorld,
          l
        );
      ...
      if (e instanceof $n || e instanceof Gr) {
        ...
        if (!((f = l.userData) != null && f.isDecoration)) {
          ...
          const p = new Te().copy(l.boundingBox);
    ...
    updateBoxFromObject(e, t) {
      ...
      if (e instanceof $n || e instanceof Gr) {
        ...
        if (!((l = p.userData) != null && l.isDecoration)) {
          ...
          const d = new Te().copy(p.boundingBox);
  ...
  const hs = yt.instance, O1 = new C1();
    ...
    try {
      switch (e) {
        case "render": {
          ...
          const { mtextContent: i, textStyle: s, colorSettings: a } = r, o = R1(a);
          let h = new Ys(
            i,
            s,
            O1,
          ...
          const { data: c, transferableObjects: u } = U1(h);
          self.postMessage(
            {
              type: "render",
              id: t,
        ...
        case "loadFonts": {
          ...
          const { fonts: i } = r;
          await hs.loadFontsByNames(i), self.postMessage({
            type: "loadFonts",
            id: t,
            success: !0,
            data: { loaded: i }
  ...
  function U1(n) {
    const e = n.matrixWorld.clone(), t = new E(), r = new Qt(), i = new E();
    e.decompose(t, r, i);
    const s = n.box.clone();
    s.applyMatrix4(e);
  ...
  function D1(n) {
    ...
    return n.traverse((r) => {
      ...
      if (r instanceof Gr || r instanceof $n) {
        ...
        if (h instanceof ze) {
          const u = r.matrixWorld.clone(), f = new E(), l = new Qt(), p = new E();
          u.decompose(f, l, p);
          const d = {};
          ...
          const v = {
            ...
            charBoxes: Array.isArray((o = (a = r.userData) == null ? void 0 : a.layout) == null ? void 0 : o.chars) ? gc(r.userData.layout.chars) : void 0
          };
          e.push(v);
        }
      }
