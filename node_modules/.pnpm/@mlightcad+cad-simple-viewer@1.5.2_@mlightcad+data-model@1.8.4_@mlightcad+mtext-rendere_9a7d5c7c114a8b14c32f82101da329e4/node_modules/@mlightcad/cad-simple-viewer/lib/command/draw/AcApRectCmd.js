...
function resolveRectVertices(lx, ly, settings) {
    ...
    if (AcGeTol.isPositive(settings.chamferDist1) ||
...
function updateRect(rect, firstPoint, input, settings) {
    ...
    if (AcGeTol.equalToZero(lx) || AcGeTol.equalToZero(ly))
        return false;
    rect.reset(false);
...
function isPositive(value) {
    return Number.isFinite(value !== null && value !== void 0 ? value : NaN) && AcGeTol.isPositive(value !== null && value !== void 0 ? value : 0);
}
/**
