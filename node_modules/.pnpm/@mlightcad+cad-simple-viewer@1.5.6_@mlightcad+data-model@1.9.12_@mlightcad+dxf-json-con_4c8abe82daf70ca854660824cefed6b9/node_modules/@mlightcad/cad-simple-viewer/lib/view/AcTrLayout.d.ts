...
import { AcTrEntity } from '@mlightcad/three-renderer';
...
export declare class AcTrLayout {
     ...
     */
    search(box: AcGeBox2d | AcGeBox3d): import("../editor").AcEdSpatialQueryResultItemEx[];
    /**
