...
var AcApLayerLockCmd = /** @class */ (function (_super) {
    ...
    AcApLayerLockCmd.prototype.lockEntityLayer = function (context, objectId) {
        ...
        if (!layer) {
            this.showMessage("".concat(AcApI18n.t('jig.laylck.layerNotFound'), ": ").concat(layerName), 'warning');
            return;
        }
        if (layer.isLocked) {
        ...
        this.showMessage("".concat(AcApI18n.t('jig.laylck.locked'), ": ").concat(layer.name), 'success');
    };
