...
var AcApLayerIsoCmd = /** @class */ (function (_super) {
    ...
    AcApLayerIsoCmd.prototype.isolateSelectedObjectLayers = function (context, objectIds) {
        ...
        this.showMessage("".concat(AcApI18n.t('jig.layiso.isolated'), ": ").concat(layerNames.join(', '), " (").concat(AcApI18n.t('jig.layiso.affectedLayers'), ": ").concat(affectedLayerNames.size, ")"), 'success');
    };
    /**
