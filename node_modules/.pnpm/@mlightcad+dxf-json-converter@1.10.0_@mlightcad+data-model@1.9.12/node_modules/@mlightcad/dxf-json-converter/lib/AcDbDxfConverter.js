...
var AcDbDxfConverter = /** @class */ (function (_super) {
    ...
    AcDbDxfConverter.prototype.getFonts = function (dxf) {
        var _a, _b, _c, _d;
        var blocks = (_a = dxf.blocks) !== null && _a !== void 0 ? _a : {};
        return new AcDbFontNameCollector({
            styles: (_c = (_b = dxf.tables.STYLE) === null || _b === void 0 ? void 0 : _b.entries) !== null && _c !== void 0 ? _c : [],
            textStyleVar: ((_d = dxf.header) === null || _d === void 0 ? void 0 : _d['$TEXTSTYLE']) || DEFAULT_TEXT_STYLE
                ...
                if (entity.type == 'MULTILEADER' || entity.type == 'MLEADER') {
                    ...
                    var styleName = typeof mleader.textStyleName === 'string'
                        ...
                        : typeof mleader.styleName === 'string'
                            ? mleader.styleName
                            : undefined;
                    return { styleName: styleName, formattedText: text, resolveStyle: true };
                }
            ...
            getBlockEntities: function (blockName) { var _a; return (_a = blocks[blockName]) === null || _a === void 0 ? void 0 : _a.entities; }
        });
    };
    /**
        ...
        if (lineTypeTable) {
            ...
            if (lineTypes && lineTypes.length > 0) {
                lineTypes.forEach(function (item) {
                    var record = new AcDbLinetypeTableRecord({
                        name: item.name,
        ...
        if (textStyleTable) {
            ...
            if (textStyles && textStyles.length > 0) {
                textStyles.forEach(function (item) {
                    var record = new AcDbTextStyleTableRecord({
                        name: item.name,
                        standardFlag: item.standardFlag,
