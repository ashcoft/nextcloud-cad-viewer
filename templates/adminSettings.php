...
<div id="cad-viewer" class="section section-cad-viewer">
    ...
    <div class="cad-viewer-setting">
        ...
        <select id="theme">
            <option
                value="light"<?php if ($_['theme'] === 'light') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('Light')) ?></option>
            <option
                value="dark"<?php if ($_['theme'] === 'dark') {
                    echo ' selected';
                } ?>
    ...
    <div class="cad-viewer-setting">
        ...
        <select id="autosave">
            <option
                value="yes"<?php if ($_['autosave'] === 'yes') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('Yes')) ?></option>
            <option
                value="no"<?php if ($_['autosave'] === 'no') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('No')) ?></option>
        </select>
    ...
    <div class="cad-viewer-setting">
        ...
        <select id="libraries">
            <option
                value="yes"<?php if ($_['libraries'] === 'yes') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('Yes')) ?></option>
            <option
                value="no"<?php if ($_['libraries'] === 'no') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('No')) ?></option>
        </select>
    ...
    <div class="cad-viewer-setting">
        ...
        <select id="previews">
            <option
                value="yes"<?php if ($_['previews'] === 'yes') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('Yes')) ?></option>
            <option
                value="no"<?php if ($_['previews'] === 'no') {
                    echo ' selected';
                } ?>
            ><?php p($l->t('No')) ?></option>
        </select>
